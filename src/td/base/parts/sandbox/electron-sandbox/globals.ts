...
import {INodeProcess, IProcessEnvironment} from 'td/base/common/platform';
import {ISandboxConfiguration} from 'td/base/parts/sandbox/common/sandboxTypes';
import {IpcRenderer, ProcessMemoryInfo, WebFrame} from 'td/base/parts/sandbox/electron-sandbox/electronTypes';
...
export interface ISandboxGlobals {
	readonly ipcRenderer: Pick<import('td/base/parts/sandbox/electron-sandbox/electronTypes').IpcRenderer, 'send' | 'invoke'>;
	readonly webFrame: import('td/base/parts/sandbox/electron-sandbox/electronTypes').WebFrame;
}
