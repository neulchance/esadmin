...
import {MessagePortMain, isUtilityProcess, MessageEvent} from 'td/base/parts/sandbox/node/electronTypes';
import {VSBuffer} from 'td/base/common/buffer';
import {ClientConnectionEvent, IMessagePassingProtocol, IPCServer} from 'td/base/parts/ipc/common/ipc';
