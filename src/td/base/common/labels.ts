...
import {hasDriveLetter, toSlashes} from 'td/base/common/extpath';
import {posix, sep, win32} from 'td/base/common/path';
import {isMacintosh, isWindows, OperatingSystem, OS} from 'td/base/common/platform';
import {extUri, extUriIgnorePathCase} from 'td/base/common/resources';
import {rtrim, startsWithIgnoreCase} from 'td/base/common/strings';
