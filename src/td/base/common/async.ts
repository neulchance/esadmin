...
import {BugIndicatingError, CancellationError} from 'td/base/common/errors';
import {Emitter, Event} from 'td/base/common/event';
import {Disposable, DisposableMap, DisposableStore, IDisposable, MutableDisposable, toDisposable} from 'td/base/common/lifecycle';
import {extUri as defaultExtUri, IExtUri} from 'td/base/common/resources';
