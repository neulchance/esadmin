...
import {createMatches as createFuzzyMatches, fuzzyScore, IMatch, isUpper, matchesPrefix} from 'td/base/common/filters';
...
import {equalsIgnoreCase, stripWildcards} from 'td/base/common/strings';
