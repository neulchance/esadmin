...
import {transformErrorForSerialization} from 'td/base/common/errors';
import {Emitter, Event} from 'td/base/common/event';
import {Disposable, IDisposable} from 'td/base/common/lifecycle';
import {getAllMethodNames} from 'td/base/common/objects';
...
export class SimpleWorkerClient<W extends object, H extends object> extends Disposable implements IWorkerClient<W> {
	...
	constructor(workerFactory: IWorkerFactory, moduleId: string, host: H) {
		...
		this._worker = this._register(workerFactory.create(
			'td/base/common/worker/simpleWorker',
			(msg: Message) => {
