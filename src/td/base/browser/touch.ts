...
import * as DomUtils from 'td/base/browser/dom';
...
import {Event as EventUtils} from 'td/base/common/event';
import {Disposable, IDisposable, markAsSingleton, toDisposable} from 'td/base/common/lifecycle';
