...
import {getZoomFactor} from 'td/base/browser/browser';
import * as dom from 'td/base/browser/dom';
import {createFastDomNode, FastDomNode} from 'td/base/browser/fastDomNode';
import {IMouseEvent, IMouseWheelEvent, StandardWheelEvent} from 'td/base/browser/mouseEvent';
import {ScrollbarHost} from 'td/base/browser/ui/scrollbar/abstractScrollbar';
import {HorizontalScrollbar} from 'td/base/browser/ui/scrollbar/horizontalScrollbar';
import {ScrollableElementChangeOptions, ScrollableElementCreationOptions, ScrollableElementResolvedOptions} from 'td/base/browser/ui/scrollbar/scrollableElementOptions';
import {VerticalScrollbar} from 'td/base/browser/ui/scrollbar/verticalScrollbar';
import {Widget} from 'td/base/browser/ui/widget';
import {TimeoutTimer} from 'td/base/common/async';
...
import {INewScrollDimensions, INewScrollPosition, IScrollDimensions, IScrollPosition, Scrollable, ScrollbarVisibility, ScrollEvent} from 'td/base/common/scrollable';
import 'td/css!./media/scrollbars';
