...
import {IHoverDelegate, IHoverDelegateOptions, IHoverDelegateTarget, IHoverWidget} from 'td/base/browser/ui/iconLabel/iconHoverDelegate';
...
import {isFunction, isString} from 'td/base/common/types';
