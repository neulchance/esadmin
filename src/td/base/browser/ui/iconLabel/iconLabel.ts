...
import {ITooltipMarkdownString, setupCustomHover, setupNativeHover} from 'td/base/browser/ui/iconLabel/iconLabelHover';
...
import {Range} from 'td/base/common/range';
