...
import {$, addDisposableListener, append, getWindow, scheduleAtNextAnimationFrame} from 'td/base/browser/dom';
import {DomEmitter} from 'td/base/browser/event';
import {ISashEvent as IBaseSashEvent, Orientation, Sash, SashState} from 'td/base/browser/ui/sash/sash';
import {SmoothScrollableElement} from 'td/base/browser/ui/scrollbar/scrollableElement';
import {pushToEnd, pushToStart, range} from 'td/base/common/arrays';
import {Color} from 'td/base/common/color';
import {Emitter, Event} from 'td/base/common/event';
import {combinedDisposable, Disposable, dispose, IDisposable, toDisposable} from 'td/base/common/lifecycle';
import {clamp} from 'td/base/common/numbers';
import {Scrollable, ScrollbarVisibility, ScrollEvent} from 'td/base/common/scrollable';
import * as types from 'td/base/common/types';
import 'td/css!./splitview';
