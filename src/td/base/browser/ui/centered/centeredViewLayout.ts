...
import {$, IDomNodePagePosition} from 'td/base/browser/dom';
import {IView, IViewSize} from 'td/base/browser/ui/grid/grid';
import {IBoundarySashes} from 'td/base/browser/ui/sash/sash';
import {DistributeSizing, ISplitViewStyles, IView as ISplitViewView, Orientation, SplitView} from 'td/base/browser/ui/splitview/splitview';
