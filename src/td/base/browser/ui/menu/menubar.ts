...
import {cleanMnemonic, Direction, IMenuOptions, IMenuStyles, Menu, MENU_ESCAPED_MNEMONIC_REGEX, MENU_MNEMONIC_REGEX} from 'td/base/browser/ui/menu/menu';
import {ActionRunner, IAction, IActionRunner, Separator, SubmenuAction} from 'td/base/common/actions';
...
import {KeyCode, KeyMod, ScanCode, ScanCodeUtils} from 'td/base/common/keyCodes';
import {ResolvedKeybinding} from 'td/base/common/keybindings';
import {Disposable, DisposableStore, dispose, IDisposable} from 'td/base/common/lifecycle';
import {isMacintosh} from 'td/base/common/platform';
import * as strings from 'td/base/common/strings';
import 'td/css!./menubar';
