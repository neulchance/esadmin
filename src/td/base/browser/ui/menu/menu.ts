...
import {$, addDisposableListener, append, clearNode, createStyleSheet, Dimension, EventHelper, EventLike, EventType, getActiveElement, getWindow, IDomNodePagePosition, isAncestor, isInShadowDOM} from 'td/base/browser/dom';
import {StandardKeyboardEvent} from 'td/base/browser/keyboardEvent';
import {StandardMouseEvent} from 'td/base/browser/mouseEvent';
import {ActionBar, ActionsOrientation, IActionViewItemProvider} from 'td/base/browser/ui/actionbar/actionbar';
import {ActionViewItem, BaseActionViewItem, IActionViewItemOptions} from 'td/base/browser/ui/actionbar/actionViewItems';
import {AnchorAlignment, layout, LayoutAnchorPosition} from 'td/base/browser/ui/contextview/contextview';
import {DomScrollableElement} from 'td/base/browser/ui/scrollbar/scrollableElement';
import {EmptySubmenuAction, IAction, IActionRunner, Separator, SubmenuAction} from 'td/base/common/actions';
import {RunOnceScheduler} from 'td/base/common/async';
import {Codicon, getCodiconFontCharacters} from 'td/base/common/codicons';
...
import {isLinux, isMacintosh} from 'td/base/common/platform';
