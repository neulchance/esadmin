...
import {renderFormattedText, renderText} from 'td/base/browser/formattedTextRenderer';
import {IHistoryNavigationWidget} from 'td/base/browser/history';
import {MarkdownRenderOptions} from 'td/base/browser/markdownRenderer';
