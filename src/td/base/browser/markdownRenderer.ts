...
import {createElement, FormattedTextRenderOptions} from 'td/base/browser/formattedTextRenderer';
...
import {escapeDoubleQuotes, IMarkdownString, MarkdownStringTrustedOptions, parseHrefAndDimensions, removeMarkdownEscapes} from 'td/base/common/htmlContent';
import {markdownEscapeEscapedIcons} from 'td/base/common/iconLabels';
...
import {dirname, resolvePath} from 'td/base/common/resources';
import {escape} from 'td/base/common/strings';
 ...
 *
 * **Note** that for most cases you should be using [`MarkdownRenderer`](./src/td/editor/contrib/markdownRenderer/browser/markdownRenderer.ts)
 ...
 */
export function renderStringAsPlaintext(str: IMarkdownString | string) {
	return typeof str === 'string' ? str : renderMarkdownAsPlaintext(str);
}
