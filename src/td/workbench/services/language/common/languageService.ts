...
import {clearConfiguredLanguageAssociations, registerConfiguredLanguageAssociation} from 'td/editor/common/services/languagesAssociations';
...
import {FILES_ASSOCIATIONS_CONFIG, IFilesConfiguration} from 'td/platform/files/common/files';
