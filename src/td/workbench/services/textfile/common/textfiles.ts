...
import {ReadableStream} from 'td/base/common/stream';
import {IBaseFileStatWithMetadata, IFileStatWithMetadata, IWriteFileOptions, FileOperationError, FileOperationResult, IReadFileStreamOptions, IFileReadLimits} from 'td/platform/files/common/files';
...
import {ITextBufferFactory, ITextModel, ITextSnapshot} from 'td/editor/common/model';
import {VSBuffer, VSBufferReadable, VSBufferReadableStream} from 'td/base/common/buffer';
import {areFunctions, isUndefinedOrNull} from 'td/base/common/types';
import {IWorkingCopy, IWorkingCopySaveEvent} from 'td/workbench/services/workingCopy/common/workingCopy';
import {IUntitledTextEditorModelManager} from 'td/workbench/services/untitled/common/untitledTextEditorService';
...
import {IFileOperationUndoRedoInfo} from 'td/workbench/services/workingCopy/common/workingCopyFileService';
