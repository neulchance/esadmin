...
import {TextFileEditorModel} from 'td/workbench/services/textfile/common/textFileEditorModel';
import {dispose, IDisposable, Disposable, DisposableStore} from 'td/base/common/lifecycle';
import {ITextFileEditorModel, ITextFileEditorModelManager, ITextFileEditorModelResolveOrCreateOptions, ITextFileResolveEvent, ITextFileSaveEvent, ITextFileSaveParticipant} from 'td/workbench/services/textfile/common/textfiles';
import {IInstantiationService} from 'td/platform/instantiation/common/instantiation';
import {ResourceMap} from 'td/base/common/map';
import {IFileService, FileChangesEvent, FileOperation, FileChangeType, IFileSystemProviderRegistrationEvent, IFileSystemProviderCapabilitiesChangeEvent} from 'td/platform/files/common/files';
import {Promises, ResourceQueue} from 'td/base/common/async';
import {onUnexpectedError} from 'td/base/common/errors';
import {TextFileSaveParticipant} from 'td/workbench/services/textfile/common/textFileSaveParticipant';
...
import {ITextSnapshot} from 'td/editor/common/model';
import {extname, joinPath} from 'td/base/common/resources';
import {createTextBufferFactoryFromSnapshot} from 'td/editor/common/model/textModel';
import {PLAINTEXT_EXTENSION, PLAINTEXT_LANGUAGE_ID} from 'td/editor/common/languages/modesRegistry';
