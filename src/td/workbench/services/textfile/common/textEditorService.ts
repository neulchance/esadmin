...
import {IEditorFactoryRegistry, IFileEditorInput, IUntypedEditorInput, IUntypedFileEditorInput, EditorExtensions, isResourceDiffEditorInput, isResourceSideBySideEditorInput, IUntitledTextResourceEditorInput, DEFAULT_EDITOR_ASSOCIATION, isResourceMergeEditorInput} from 'td/workbench/common/editor';
import {EditorInput} from 'td/workbench/common/editor/editorInput';
import {INewUntitledTextEditorOptions, IUntitledTextEditorService} from 'td/workbench/services/untitled/common/untitledTextEditorService';
...
import {IEditorResolverService, RegisteredEditorPriority} from 'td/workbench/services/editor/common/editorResolverService';
