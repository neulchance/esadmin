...
import {IEncodingSupport, ITextFileService, ITextFileStreamContent, ITextFileContent, IResourceEncodings, IReadTextFileOptions, IWriteTextFileOptions, toBufferOrReadable, TextFileOperationError, TextFileOperationResult, ITextFileSaveOptions, ITextFileEditorModelManager, IResourceEncoding, stringToSnapshot, ITextFileSaveAsOptions, IReadTextFileEncodingOptions, TextFileEditorModelState} from 'td/workbench/services/textfile/common/textfiles';
import {IRevertOptions, SaveSourceRegistry} from 'td/workbench/common/editor';
import {ILifecycleService} from 'td/workbench/services/lifecycle/common/lifecycle';
import {IFileService, FileOperationError, FileOperationResult, IFileStatWithMetadata, ICreateFileOptions, IFileStreamContent} from 'td/platform/files/common/files';
import {Disposable} from 'td/base/common/lifecycle';
import {extname as pathExtname} from 'td/base/common/path';
import {IWorkbenchEnvironmentService} from 'td/workbench/services/environment/common/environmentService';
import {IUntitledTextEditorService, IUntitledTextEditorModelManager} from 'td/workbench/services/untitled/common/untitledTextEditorService';
import {UntitledTextEditorModel} from 'td/workbench/services/untitled/common/untitledTextEditorModel';
import {TextFileEditorModelManager} from 'td/workbench/services/textfile/common/textFileEditorModelManager';
import {IInstantiationService} from 'td/platform/instantiation/common/instantiation';
import {Schemas} from 'td/base/common/network';
import {createTextBufferFactoryFromSnapshot, createTextBufferFactoryFromStream} from 'td/editor/common/model/textModel';
import {IModelService} from 'td/editor/common/services/model';
import {joinPath, dirname, basename, toLocalResource, extname, isEqual} from 'td/base/common/resources';
import {IDialogService, IFileDialogService} from 'td/platform/dialogs/common/dialogs';
import {VSBuffer, VSBufferReadable, bufferToStream, VSBufferReadableStream} from 'td/base/common/buffer';
import {ITextSnapshot, ITextModel} from 'td/editor/common/model';
...
import {IResolvedTextEditorModel} from 'td/editor/common/services/resolverService';
import {BaseTextEditorModel} from 'td/workbench/common/editor/textEditorModel';
...
import {IWorkingCopyFileService, IFileOperationUndoRedoInfo, ICreateFileOperation} from 'td/workbench/services/workingCopy/common/workingCopyFileService';
import {IUriIdentityService} from 'td/platform/uriIdentity/common/uriIdentity';
import {IWorkspaceContextService, WORKSPACE_EXTENSION} from 'td/platform/workspace/common/workspace';
import {UTF8, UTF8_with_bom, UTF16be, UTF16le, encodingExists, toEncodeReadable, toDecodeStream, IDecodeStreamResult, DecodeStreamError, DecodeStreamErrorKind} from 'td/workbench/services/textfile/common/encoding';
import {consumeStream, ReadableStream} from 'td/base/common/stream';
...
import {listErrorForeground} from 'td/platform/theme/common/colorRegistry';
