...
import {createDecorator, refineServiceDecorator} from 'td/platform/instantiation/common/instantiation';
import {IExtension, ExtensionType, IExtensionManifest} from 'td/platform/extensions/common/extensions';
import {IExtensionManagementService, IGalleryExtension, ILocalExtension, InstallOptions, InstallExtensionEvent, DidUninstallExtensionEvent, InstallExtensionResult, Metadata, InstallVSIXOptions, UninstallExtensionEvent} from 'td/platform/extensionManagement/common/extensionManagement';
...
export const DefaultIconPath = FileAccess.asBrowserUri('td/workbench/services/extensionManagement/common/media/defaultIcon.png').toString(true);
