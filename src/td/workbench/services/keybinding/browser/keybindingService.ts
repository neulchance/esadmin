...
import {BrowserFeatures, KeyboardSupport} from 'td/base/browser/canIUse';
import * as dom from 'td/base/browser/dom';
import {printKeyboardEvent, printStandardKeyboardEvent, StandardKeyboardEvent} from 'td/base/browser/keyboardEvent';
...
import {UserSettingsLabelProvider} from 'td/base/common/keybindingLabels';
import {KeybindingParser} from 'td/base/common/keybindingParser';
import {Keybinding, KeyCodeChord, ResolvedKeybinding, ScanCodeChord} from 'td/base/common/keybindings';
import {IMMUTABLE_CODE_TO_KEY_CODE, KeyCode, KeyCodeUtils, KeyMod, ScanCode, ScanCodeUtils} from 'td/base/common/keyCodes';
import {Disposable, DisposableStore, IDisposable} from 'td/base/common/lifecycle';
import * as objects from 'td/base/common/objects';
import {isMacintosh, OperatingSystem, OS} from 'td/base/common/platform';
import {dirname} from 'td/base/common/resources';
import {mainWindow} from 'td/base/browser/window';

// platform
import {MenuRegistry} from 'td/platform/actions/common/actions';
import {CommandsRegistry, ICommandService} from 'td/platform/commands/common/commands';
import {ContextKeyExpr, ContextKeyExpression, IContextKey, IContextKeyService} from 'td/platform/contextkey/common/contextkey';
import {ExtensionIdentifier} from 'td/platform/extensions/common/extensions';
import {FileOperation, IFileService} from 'td/platform/files/common/files';
import {InstantiationType, registerSingleton} from 'td/platform/instantiation/common/extensions';
import {Extensions, IJSONContributionRegistry} from 'td/platform/jsonschemas/common/jsonContributionRegistry';
...
import {IExtensionKeybindingRule, IKeybindingItem, KeybindingsRegistry, KeybindingWeight} from 'td/platform/keybinding/common/keybindingsRegistry';
import {ResolvedKeybindingItem} from 'td/platform/keybinding/common/resolvedKeybindingItem';
import {IKeyboardLayoutService} from 'td/platform/keyboardLayout/common/keyboardLayout';
import {IKeyboardMapper} from 'td/platform/keyboardLayout/common/keyboardMapper';
...
import {ILocalizedString, isLocalizedString} from 'td/platform/action/common/action';

// workbench
import {commandsExtensionPoint} from 'td/workbench/services/actions/common/menusExtensionPoint';
import {IExtensionService} from 'td/workbench/services/extensions/common/extensions';
import {ExtensionMessageCollector, ExtensionsRegistry} from 'td/workbench/services/extensions/common/extensionsRegistry';
import {IHostService} from 'td/workbench/services/host/browser/host';
import {IKeyboard, INavigatorWithKeyboard} from 'td/workbench/services/keybinding/browser/navigatorKeyboard';
import {getAllUnboundCommands} from 'td/workbench/services/keybinding/browser/unboundCommands';
import {IUserKeybindingItem, KeybindingIO, OutputBuilder} from 'td/workbench/services/keybinding/common/keybindingIO';
...
export class WorkbenchKeybindingService extends AbstractKeybindingService {
	...
	constructor(
		...
		this._register(browser.onDidChangeFullscreen(windowId => {
			if (windowId !== mainWindow.tddevWindowId) {
				return;
			}
