...
import {IKeyboardLayoutInfo, IKeyboardLayoutService, IKeyboardMapping, ILinuxKeyboardLayoutInfo, IMacKeyboardLayoutInfo, IMacLinuxKeyboardMapping, IWindowsKeyboardLayoutInfo, IWindowsKeyboardMapping} from 'td/platform/keyboardLayout/common/keyboardLayout';
import {Emitter} from 'td/base/common/event';
import {OperatingSystem, OS} from 'td/base/common/platform';
import {CachedKeyboardMapper, IKeyboardMapper} from 'td/platform/keyboardLayout/common/keyboardMapper';
import {WindowsKeyboardMapper} from 'td/workbench/services/keybinding/common/windowsKeyboardMapper';
import {FallbackKeyboardMapper} from 'td/workbench/services/keybinding/common/fallbackKeyboardMapper';
import {MacLinuxKeyboardMapper} from 'td/workbench/services/keybinding/common/macLinuxKeyboardMapper';
import {DispatchConfig, readKeyboardConfig} from 'td/platform/keyboardLayout/common/keyboardConfig';
import {IKeyboardEvent} from 'td/platform/keybinding/common/keybinding';
import {IConfigurationService} from 'td/platform/configuration/common/configuration';
import {INativeKeyboardLayoutService} from 'td/workbench/services/keybinding/electron-sandbox/nativeKeyboardLayoutService';
