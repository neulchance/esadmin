...
import {RawContextKey, IContextKeyService} from 'td/platform/contextkey/common/contextkey';
import {IConfigurationService} from 'td/platform/configuration/common/configuration';
import {IFilesConfiguration, AutoSaveConfiguration, HotExitConfiguration, FILES_READONLY_INCLUDE_CONFIG, FILES_READONLY_EXCLUDE_CONFIG, IFileStatWithMetadata, IFileService, IBaseFileStat, hasReadonlyCapability, IFilesConfigurationNode} from 'td/platform/files/common/files';
...
import {LRUCache, ResourceMap} from 'td/base/common/map';
...
import {IMarkerService, MarkerSeverity} from 'td/platform/markers/common/markers';
