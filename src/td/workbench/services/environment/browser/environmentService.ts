...
import {IWorkbenchConstructionOptions} from 'td/workbench/browser/web.api';
...
import {parseLineAndColumnAware} from 'td/base/common/extpath';
import {LogLevelToString} from 'td/platform/log/common/log';
...
export class BrowserWorkbenchEnvironmentService implements IBrowserWorkbenchEnvironmentService {
	...
	get webviewExternalEndpoint(): string {
		const endpoint = this.options.webviewEndpoint
			...
			|| 'https://{{uuid}}.vscode-cdn.net/{{quality}}/{{commit}}/out/td/workbench/contrib/webview/browser/pre/';
