...
import {setProperty} from 'td/base/common/jsonEdit';
import {Queue} from 'td/base/common/async';
import {Edit, FormattingOptions} from 'td/base/common/jsonFormatter';
...
import {IConfigurationUpdateOptions, IConfigurationUpdateOverrides} from 'td/platform/configuration/common/configuration';
import {FOLDER_SETTINGS_PATH, WORKSPACE_STANDALONE_CONFIGURATIONS, TASKS_CONFIGURATION_KEY, LAUNCH_CONFIGURATION_KEY, USER_STANDALONE_CONFIGURATIONS, TASKS_DEFAULT, FOLDER_SCOPES, IWorkbenchConfigurationService} from 'td/workbench/services/configuration/common/configuration';
...
import {IConfigurationRegistry, Extensions as ConfigurationExtensions, ConfigurationScope, keyFromOverrideIdentifiers, OVERRIDE_PROPERTY_REGEX} from 'td/platform/configuration/common/configurationRegistry';
...
import {IOpenSettingsOptions, IPreferencesService} from 'td/workbench/services/preferences/common/preferences';
import {IUriIdentityService} from 'td/platform/uriIdentity/common/uriIdentity';
// import {ITextModel} from 'td/editor/common/model';
import {IReference} from 'td/base/common/lifecycle';
...
export class ConfigurationEditing {
	...
	private getFormattingOptions(model: /* ITextModel */any): FormattingOptions {
	...
	private toErrorMessage(error: ConfigurationEditingErrorCode, target: EditableConfigurationTarget, operation: IConfigurationEditOperation): /* string */any {
		switch (error) {
	...
	private async resolveModelReference(resource: URI): Promise</* IReference<IResolvedTextEditorModel> */any> {
