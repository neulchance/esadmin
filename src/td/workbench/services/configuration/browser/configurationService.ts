...
import {Queue, Barrier, Promises, Delayer} from 'td/base/common/async';
...
import {IWorkspaceContextService, Workspace as BaseWorkspace, WorkbenchState, IWorkspaceFolder, IWorkspaceFoldersChangeEvent, WorkspaceFolder, toWorkspaceFolder, isWorkspaceFolder, IWorkspaceFoldersWillChangeEvent, IEmptyWorkspaceIdentifier, ISingleFolderWorkspaceIdentifier, isSingleFolderWorkspaceIdentifier, isWorkspaceIdentifier, IWorkspaceIdentifier, IAnyWorkspaceIdentifier} from 'td/platform/workspace/common/workspace';
import {ConfigurationModel, ConfigurationChangeEvent, mergeChanges} from 'td/platform/configuration/common/configurationModels';
import {IConfigurationChangeEvent, ConfigurationTarget, IConfigurationOverrides, isConfigurationOverrides, IConfigurationData, IConfigurationValue, IConfigurationChange, ConfigurationTargetToString, IConfigurationUpdateOverrides, isConfigurationUpdateOverrides, IConfigurationService, IConfigurationUpdateOptions} from 'td/platform/configuration/common/configuration';
import {IPolicyConfiguration, NullPolicyConfiguration, PolicyConfiguration} from 'td/platform/configuration/common/configurations';
import {Configuration} from 'td/workbench/services/configuration/common/configurationModels';
import {FOLDER_CONFIG_FOLDER_NAME, defaultSettingsSchemaId, userSettingsSchemaId, workspaceSettingsSchemaId, folderSettingsSchemaId, IConfigurationCache, machineSettingsSchemaId, LOCAL_MACHINE_SCOPES, IWorkbenchConfigurationService, RestrictedSettings, PROFILE_SCOPES, LOCAL_MACHINE_PROFILE_SCOPES, profileSettingsSchemaId, APPLY_ALL_PROFILES_SETTING} from 'td/workbench/services/configuration/common/configuration';
import {Registry} from 'td/platform/registry/common/platform';
import {IConfigurationRegistry, Extensions, allSettings, windowSettings, resourceSettings, applicationSettings, machineSettings, machineOverridableSettings, ConfigurationScope, IConfigurationPropertySchema, keyFromOverrideIdentifiers, OVERRIDE_PROPERTY_PATTERN, resourceLanguageSettingsSchemaId, configurationDefaultsSchemaId} from 'td/platform/configuration/common/configurationRegistry';
import {IStoredWorkspaceFolder, isStoredWorkspaceFolder, IWorkspaceFolderCreationData, getStoredWorkspaceFolder, toWorkspaceFolders} from 'td/platform/workspaces/common/workspaces';
import {IInstantiationService} from 'td/platform/instantiation/common/instantiation';
import {ConfigurationEditing, EditableConfigurationTarget} from 'td/workbench/services/configuration/common/configurationEditing';
...
import {IWorkbenchContribution, IWorkbenchContributionsRegistry, WorkbenchPhase, Extensions as WorkbenchExtensions, registerWorkbenchContribution2} from 'td/workbench/common/contributions';
...
import {IUserDataProfile, IUserDataProfilesService} from 'td/platform/userDataProfile/common/userDataProfile';
...
import {workbenchConfigurationNodeBase} from 'td/workbench/common/configuration';
