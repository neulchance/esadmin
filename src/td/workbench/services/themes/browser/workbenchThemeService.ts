...
import {IConfigurationService, ConfigurationTarget} from 'td/platform/configuration/common/configuration';
import {ColorThemeData} from 'td/workbench/services/themes/common/colorThemeData';
import {IColorTheme, Extensions as ThemingExtensions, IThemingRegistry} from 'td/platform/theme/common/themeService';
import {Event, Emitter} from 'td/base/common/event';
import {registerFileIconThemeSchemas} from 'td/workbench/services/themes/common/fileIconThemeSchema';
import {IDisposable, dispose} from 'td/base/common/lifecycle';
import {FileIconThemeData, FileIconThemeLoader} from 'td/workbench/services/themes/browser/fileIconThemeData';
import {createStyleSheet} from 'td/base/browser/dom';
import {IBrowserWorkbenchEnvironmentService} from 'td/workbench/services/environment/browser/environmentService';
import {IFileService, FileChangeType} from 'td/platform/files/common/files';
import {URI} from 'td/base/common/uri';
import * as resources from 'td/base/common/resources';
import {registerColorThemeSchemas} from 'td/workbench/services/themes/common/colorThemeSchema';
...
import {ThemeRegistry, registerColorThemeExtensionPoint, registerFileIconThemeExtensionPoint, registerProductIconThemeExtensionPoint} from 'td/workbench/services/themes/common/themeExtensionPoints';
import {updateColorThemeConfigurationSchemas, updateFileIconThemeConfigurationSchemas, ThemeConfiguration, updateProductIconThemeConfigurationSchemas} from 'td/workbench/services/themes/common/themeConfiguration';
import {ProductIconThemeData, DEFAULT_PRODUCT_ICON_THEME_ID} from 'td/workbench/services/themes/browser/productIconThemeData';
import {registerProductIconThemeSchemas} from 'td/workbench/services/themes/common/productIconThemeSchema';
...
import {RunOnceScheduler, Sequencer} from 'td/base/common/async';
