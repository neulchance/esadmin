...
import {parse as parsePList} from 'td/workbench/services/themes/common/plistParser';
import {TokenStyle, SemanticTokenRule, ProbeScope, getTokenClassificationRegistry, TokenStyleValue, TokenStyleData, parseClassifierString} from 'td/platform/theme/common/tokenClassificationRegistry';
import {MatcherWithPriority, Matcher, createMatchers} from 'td/workbench/services/themes/common/textMateScopeMatcher';
...
import {StorageScope, IStorageService, StorageTarget} from 'td/platform/storage/common/storage';
import {ThemeConfiguration} from 'td/workbench/services/themes/common/themeConfiguration';
