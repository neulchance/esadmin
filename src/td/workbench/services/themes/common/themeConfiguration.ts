...
import {IConfigurationRegistry, Extensions as ConfigurationExtensions, IConfigurationPropertySchema, IConfigurationNode, ConfigurationScope} from 'td/platform/configuration/common/configurationRegistry';

import {IJSONSchema} from 'td/base/common/jsonSchema';
import {textmateColorsSchemaId, textmateColorGroupSchemaId} from 'td/workbench/services/themes/common/colorThemeSchema';
import {workbenchColorsSchemaId} from 'td/platform/theme/common/colorRegistry';
import {tokenStylingSchemaId} from 'td/platform/theme/common/tokenClassificationRegistry';
import {ThemeSettings, IWorkbenchColorTheme, IWorkbenchFileIconTheme, IColorCustomizations, ITokenColorCustomizations, IWorkbenchProductIconTheme, ISemanticTokenColorCustomizations, ThemeSettingTarget, ThemeSettingDefaults} from 'td/workbench/services/themes/common/workbenchThemeService';
