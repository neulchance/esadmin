...
import {IColorTheme, IThemeService, IFileIconTheme, IProductIconTheme} from 'td/platform/theme/common/themeService';
import {ConfigurationTarget} from 'td/platform/configuration/common/configuration';
import {isBoolean, isString} from 'td/base/common/types';
import {IconContribution, IconDefinition} from 'td/platform/theme/common/iconRegistry';
