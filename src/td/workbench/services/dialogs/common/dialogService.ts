...
import {IAsyncPromptResult, IAsyncPromptResultWithCancel, IConfirmation, IConfirmationResult, IDialogService, IInput, IInputResult, IPrompt, IPromptResult, IPromptResultWithCancel, IPromptWithCustomCancel, IPromptWithDefaultCancel} from 'td/platform/dialogs/common/dialogs';
import {DialogsModel} from 'td/workbench/common/dialogs';
