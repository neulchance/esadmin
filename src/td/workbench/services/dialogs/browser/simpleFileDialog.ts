...
import {IFileService, IFileStat, FileKind, IFileStatWithPartialMetadata} from 'td/platform/files/common/files';
import {IQuickInputService, IQuickPickItem, IQuickPick, ItemActivation} from 'td/platform/quickinput/common/quickInput';
import {URI} from 'td/base/common/uri';
import {isWindows, OperatingSystem} from 'td/base/common/platform';
import {ISaveDialogOptions, IOpenDialogOptions, IFileDialogService} from 'td/platform/dialogs/common/dialogs';
...
import {equalsIgnoreCase, format, startsWithIgnoreCase} from 'td/base/common/strings';
...
import {isValidBasename} from 'td/base/common/extpath';
import {Emitter} from 'td/base/common/event';
import {IDisposable, dispose} from 'td/base/common/lifecycle';
import {createCancelablePromise, CancelablePromise} from 'td/base/common/async';
import {CancellationToken} from 'td/base/common/cancellation';
import {ICommandHandler} from 'td/platform/commands/common/commands';
import {IEditorService} from 'td/workbench/services/editor/common/editorService';
import {normalizeDriveLetter} from 'td/base/common/labels';
