...
import {IWindowOpenable, isWorkspaceToOpen, isFileToOpen} from 'td/platform/window/common/window';
import {IPickAndOpenOptions, ISaveDialogOptions, IOpenDialogOptions, FileFilter, IFileDialogService, IDialogService, ConfirmResult, getFileNamesMessage} from 'td/platform/dialogs/common/dialogs';
import {isSavedWorkspace, isTemporaryWorkspace, IWorkspaceContextService, WorkbenchState, WORKSPACE_EXTENSION} from 'td/platform/workspace/common/workspace';
...
import {isAbsolute as localPathIsAbsolute, normalize as localPathNormalize} from 'td/base/common/path';
import {IInstantiationService,} from 'td/platform/instantiation/common/instantiation';
import {ISimpleFileDialog, SimpleFileDialog} from 'td/workbench/services/dialogs/browser/simpleFileDialog';
...
import {PLAINTEXT_EXTENSION} from 'td/editor/common/languages/modesRegistry';
