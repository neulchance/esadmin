...
import {IDisposable, Disposable, dispose} from 'td/base/common/lifecycle';
import {posix, sep, win32} from 'td/base/common/path';
import {Emitter} from 'td/base/common/event';
import {Extensions as WorkbenchExtensions, IWorkbenchContributionsRegistry, IWorkbenchContribution} from 'td/workbench/common/contributions';
...
import {IWorkspaceContextService, IWorkspace, isWorkspace, ISingleFolderWorkspaceIdentifier, isSingleFolderWorkspaceIdentifier, isWorkspaceIdentifier, IWorkspaceIdentifier, toWorkspaceIdentifier, WORKSPACE_EXTENSION, isUntitledWorkspace, isTemporaryWorkspace} from 'td/platform/workspace/common/workspace';
import {basenameOrAuthority, basename, joinPath, dirname} from 'td/base/common/resources';
import {tildify, getPathLabel} from 'td/base/common/labels';
import {ILabelService, ResourceLabelFormatter, ResourceLabelFormatting, IFormatterChangeEvent, Verbosity} from 'td/platform/label/common/label';
