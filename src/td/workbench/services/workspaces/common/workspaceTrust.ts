...
import {IPath} from 'td/platform/window/common/window';
import {IConfigurationService} from 'td/platform/configuration/common/configuration';
import {InstantiationType, registerSingleton} from 'td/platform/instantiation/common/extensions';
import {IRemoteAuthorityResolverService, ResolverResult} from 'td/platform/remote/common/remoteAuthorityResolver';
import {getRemoteAuthority} from 'td/platform/remote/common/remoteHosts';
import {isVirtualResource} from 'td/platform/workspace/common/virtualWorkspace';
import {IStorageService, StorageScope, StorageTarget} from 'td/platform/storage/common/storage';
import {ISingleFolderWorkspaceIdentifier, isSavedWorkspace, isSingleFolderWorkspaceIdentifier, isTemporaryWorkspace, IWorkspace, IWorkspaceContextService, IWorkspaceFolder, toWorkspaceIdentifier, WorkbenchState} from 'td/platform/workspace/common/workspace';
import {WorkspaceTrustRequestOptions, IWorkspaceTrustManagementService, IWorkspaceTrustInfo, IWorkspaceTrustUriInfo, IWorkspaceTrustRequestService, IWorkspaceTrustTransitionParticipant, WorkspaceTrustUriResponse, IWorkspaceTrustEnablementService} from 'td/platform/workspace/common/workspaceTrust';
