...
import {hasWorkspaceFileExtension, isSavedWorkspace, isUntitledWorkspace, isWorkspaceIdentifier, IWorkspaceContextService, IWorkspaceIdentifier, toWorkspaceIdentifier, WorkbenchState, WORKSPACE_EXTENSION, WORKSPACE_FILTER} from 'td/platform/workspace/common/workspace';
import {IJSONEditingService, JSONEditingError, JSONEditingErrorCode} from 'td/workbench/services/configuration/common/jsonEditing';
import {IWorkspaceFolderCreationData, IWorkspacesService, rewriteWorkspaceFileForNewLocation, IEnterWorkspaceResult, IStoredWorkspace} from 'td/platform/workspaces/common/workspaces';
import {WorkspaceService} from 'td/workbench/services/configuration/browser/configurationService';
import {ConfigurationScope, IConfigurationRegistry, Extensions as ConfigurationExtensions, IConfigurationPropertySchema} from 'td/platform/configuration/common/configurationRegistry';
...
import {basename, isEqual, isEqualAuthority, joinPath, removeTrailingPathSeparator} from 'td/base/common/resources';
...
import {IFileDialogService, IDialogService} from 'td/platform/dialogs/common/dialogs';
...
import {IWorkbenchConfigurationService} from 'td/workbench/services/configuration/common/configuration';
