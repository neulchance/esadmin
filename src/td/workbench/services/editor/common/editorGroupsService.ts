...
import {IGroupModelChangeEvent} from 'td/workbench/common/editor/editorGroupModel';
import {IRectangle} from 'td/platform/window/common/window';
import {IMenuChangeEvent} from 'td/platform/actions/common/actions';
import {DeepPartial} from 'td/base/common/types';
