...
import {IResourceEditorInput, IEditorOptions, EditorActivation, IResourceEditorInputIdentifier, ITextResourceEditorInput} from 'td/platform/editor/common/editor';
import {SideBySideEditor, IEditorPane, GroupIdentifier, IUntitledTextResourceEditorInput, IResourceDiffEditorInput, EditorInputWithOptions, isEditorInputWithOptions, IEditorIdentifier, IEditorCloseEvent, ITextDiffEditorPane, IRevertOptions, SaveReason, EditorsOrder, IWorkbenchEditorConfiguration, EditorResourceAccessor, IVisibleEditorPane, EditorInputCapabilities, isResourceDiffEditorInput, IUntypedEditorInput, isResourceEditorInput, isEditorInput, isEditorInputWithOptionsAndGroup, IFindEditorOptions, isResourceMergeEditorInput} from 'td/workbench/common/editor';
...
import {IFileService, FileOperationEvent, FileOperation, FileChangesEvent, FileChangeType} from 'td/platform/files/common/files';
...
import {IEditorGroupsService, IEditorGroup, GroupsOrder, IEditorReplacement, isEditorReplacement, ICloseEditorOptions, IEditorGroupsContainer} from 'td/workbench/services/editor/common/editorGroupsService';
import {IUntypedEditorReplacement, IEditorService, ISaveEditorsOptions, ISaveAllEditorsOptions, IRevertAllEditorsOptions, IBaseSaveRevertAllEditorOptions, IOpenEditorsOptions, PreferredGroup, isPreferredGroup, IEditorsChangeEvent, ISaveEditorsResult} from 'td/workbench/services/editor/common/editorService';
...
import {isCodeEditor, isDiffEditor, ICodeEditor, IDiffEditor, isCompositeEditor} from 'td/editor/browser/editorBrowser';
import {IEditorGroupView, EditorServiceImpl} from 'td/workbench/browser/parts/editor/editor';
import {registerSingleton} from 'td/platform/instantiation/common/extensions';
import {isUndefined} from 'td/base/common/types';
import {EditorsObserver} from 'td/workbench/browser/parts/editor/editorsObserver';
...
import {indexOfPath} from 'td/base/common/extpath';
import {IUriIdentityService} from 'td/platform/uriIdentity/common/uriIdentity';
import {IEditorResolverService, ResolvedStatus} from 'td/workbench/services/editor/common/editorResolverService';
import {IWorkspaceTrustRequestService, WorkspaceTrustUriResponse} from 'td/platform/workspace/common/workspaceTrust';
...
import {ITextEditorService} from 'td/workbench/services/textfile/common/textEditorService';
