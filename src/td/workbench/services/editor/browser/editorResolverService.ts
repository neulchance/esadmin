...
import {distinct, firstOrDefault, flatten, insert} from 'td/base/common/arrays';
import {Disposable, IDisposable, toDisposable} from 'td/base/common/lifecycle';
import {basename, extname, isEqual} from 'td/base/common/resources';
import {URI} from 'td/base/common/uri';
import {IConfigurationService} from 'td/platform/configuration/common/configuration';
import {EditorActivation, EditorResolution, IEditorOptions} from 'td/platform/editor/common/editor';
import {DEFAULT_EDITOR_ASSOCIATION, EditorResourceAccessor, EditorInputWithOptions, IResourceSideBySideEditorInput, isEditorInputWithOptions, isEditorInputWithOptionsAndGroup, isResourceDiffEditorInput, isResourceSideBySideEditorInput, isUntitledResourceEditorInput, isResourceMergeEditorInput, IUntypedEditorInput, SideBySideEditor, isResourceDiffListEditorInput} from 'td/workbench/common/editor';
...
import {PreferredGroup} from 'td/workbench/services/editor/common/editorService';
import {SideBySideEditorInput} from 'td/workbench/common/editor/sideBySideEditorInput';
import {PauseableEmitter} from 'td/base/common/event';
