...
import {getClientArea, getTopLeftOffset} from 'td/base/browser/dom';
import {mainWindow} from 'td/base/browser/window';
import {coalesce} from 'td/base/common/arrays';
import {language, locale} from 'td/base/common/platform';
...
import localizedStrings from 'td/platform/languagePacks/common/localizedStrings';
import {ILogFile, getLogs} from 'td/platform/log/browser/log';
...
import {IWindowDriver, IElement, ILocaleInfo, ILocalizedStrings} from 'td/workbench/services/driver/common/driver';
