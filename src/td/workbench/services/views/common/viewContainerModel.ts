...
import {ViewContainer, IViewsRegistry, IViewDescriptor, Extensions as ViewExtensions, IViewContainerModel, IAddedViewDescriptorRef, IViewDescriptorRef, IAddedViewDescriptorState, defaultViewIcon, VIEWS_LOG_ID, VIEWS_LOG_NAME} from 'td/workbench/common/views';
...
import {coalesce, move} from 'td/base/common/arrays';
import {isUndefined, isUndefinedOrNull} from 'td/base/common/types';
