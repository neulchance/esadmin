...
import {distinct, flatten} from 'td/base/common/arrays';
import {Emitter, Event} from 'td/base/common/event';
import {JSONPath, parse} from 'td/base/common/json';
import {Disposable} from 'td/base/common/lifecycle';
import {getIconClasses} from 'td/editor/common/services/getIconClasses';
import {FileKind, IFileService} from 'td/platform/files/common/files';
import {InstantiationType, registerSingleton} from 'td/platform/instantiation/common/extensions';
import {createDecorator} from 'td/platform/instantiation/common/instantiation';
import {isWorkspace, IWorkspace, IWorkspaceContextService, IWorkspaceFolder} from 'td/platform/workspace/common/workspace';
...
import {IJSONEditingService, IJSONValue} from 'td/workbench/services/configuration/common/jsonEditing';
