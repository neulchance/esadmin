...
import {ShutdownReason, ILifecycleService} from 'td/workbench/services/lifecycle/common/lifecycle';
...
import {addDisposableListener, EventType} from 'td/base/browser/dom';
import {IStorageService, WillSaveStateReason} from 'td/platform/storage/common/storage';
