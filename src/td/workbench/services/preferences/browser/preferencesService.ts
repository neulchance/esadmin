...
import {CoreEditingCommands} from 'td/editor/browser/coreCommands';
import {getCodeEditor, ICodeEditor} from 'td/editor/browser/editorBrowser';
...
import {Extensions, getDefaultValue, IConfigurationRegistry, OVERRIDE_PROPERTY_REGEX} from 'td/platform/configuration/common/configurationRegistry';
import {FileOperationError, FileOperationResult} from 'td/platform/files/common/files';
...
import {GroupDirection, IEditorGroupsService} from 'td/workbench/services/editor/common/editorGroupsService';
import {IEditorService, SIDE_GROUP, SIDE_GROUP_TYPE} from 'td/workbench/services/editor/common/editorService';
import {KeybindingsEditorInput} from 'td/workbench/services/preferences/browser/keybindingsEditorInput';
import {DEFAULT_SETTINGS_EDITOR_SETTING, FOLDER_SETTINGS_PATH, IKeybindingsEditorOptions, IKeybindingsEditorPane, IOpenSettingsOptions, IPreferencesEditorModel, IPreferencesService, ISetting, ISettingsEditorOptions, USE_SPLIT_JSON_SETTING, validateSettingsEditorOptions} from 'td/workbench/services/preferences/common/preferences';
import {SettingsEditor2Input} from 'td/workbench/services/preferences/common/preferencesEditorInput';
import {defaultKeybindingsContents, DefaultKeybindingsEditorModel, DefaultRawSettingsEditorModel, DefaultSettings, DefaultSettingsEditorModel, Settings2EditorModel, SettingsEditorModel, WorkspaceConfigurationEditorModel} from 'td/workbench/services/preferences/common/preferencesModels';
