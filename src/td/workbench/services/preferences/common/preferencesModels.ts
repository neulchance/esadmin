...
import {flatten, tail, coalesce} from 'td/base/common/arrays';
import {IStringDictionary} from 'td/base/common/collections';
import {Emitter, Event} from 'td/base/common/event';
import {JSONVisitor, visit} from 'td/base/common/json';
import {Disposable, IReference} from 'td/base/common/lifecycle';
...
import {ConfigurationScope, Extensions, IConfigurationNode, IConfigurationPropertySchema, IConfigurationRegistry, IExtensionInfo, IRegisteredConfigurationPropertySchema, OVERRIDE_PROPERTY_REGEX} from 'td/platform/configuration/common/configurationRegistry';
...
import {EditorModel} from 'td/workbench/common/editor/editorModel';
import {IFilterMetadata, IFilterResult, IGroupFilter, IKeybindingsEditorModel, ISearchResultGroup, ISetting, ISettingMatch, ISettingMatcher, ISettingsEditorModel, ISettingsGroup, SettingMatchType} from 'td/workbench/services/preferences/common/preferences';
import {FOLDER_SCOPES, WORKSPACE_SCOPES} from 'td/workbench/services/configuration/common/configuration';
import {createValidator} from 'td/workbench/services/preferences/common/preferencesValidation';
