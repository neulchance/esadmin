...
import {JSONSchemaType} from 'td/base/common/jsonSchema';
import {Color} from 'td/base/common/color';
import {isObject, isUndefinedOrNull, isString, isStringArray} from 'td/base/common/types';
import {IConfigurationPropertySchema} from 'td/platform/configuration/common/configurationRegistry';
