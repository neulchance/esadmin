...
import {ChecksumPair, IIntegrityService, IntegrityTestResult} from 'td/workbench/services/integrity/common/integrity';
...
import {FileAccess, AppResourcePath} from 'td/base/common/network';
