...
import {ILanguageDetectionService, ILanguageDetectionStats, LanguageDetectionStatsClassification, LanguageDetectionStatsId} from 'td/workbench/services/languageDetection/common/languageDetectionWorkerService';
import {AppResourcePath, FileAccess, nodeModulesAsarPath, nodeModulesPath, Schemas} from 'td/base/common/network';
...
import {LanguageDetectionSimpleWorker} from 'td/workbench/services/languageDetection/browser/languageDetectionSimpleWorker';
import {IModelService} from 'td/editor/common/services/model';
import {SimpleWorkerClient} from 'td/base/common/worker/simpleWorker';
import {ITelemetryService} from 'td/platform/telemetry/common/telemetry';
import {EditorWorkerClient, EditorWorkerHost} from 'td/editor/browser/services/editorWorkerService';
	...
	private _getOrCreateLanguageDetectionWorker(): Promise<IWorkerClient<LanguageDetectionSimpleWorker>> {
		...
		this.workerPromise = new Promise((resolve, reject) => {
			resolve(this._register(new SimpleWorkerClient<LanguageDetectionSimpleWorker, EditorWorkerHost>(
				this._workerFactory,
				'td/workbench/services/languageDetection/browser/languageDetectionSimpleWorker',
