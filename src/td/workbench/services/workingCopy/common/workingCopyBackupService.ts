...
import {IResolvedWorkingCopyBackup, IWorkingCopyBackupService} from 'td/workbench/services/workingCopy/common/workingCopyBackup';
import {IFileService, FileOperationError, FileOperationResult} from 'td/platform/files/common/files';
import {ResourceMap} from 'td/base/common/map';
import {isReadableStream, peekStream} from 'td/base/common/stream';
import {bufferToStream, prefixedBufferReadable, prefixedBufferStream, readableToBuffer, streamToBuffer, VSBuffer, VSBufferReadable, VSBufferReadableStream} from 'td/base/common/buffer';
...
import {IWorkingCopyBackupMeta, IWorkingCopyIdentifier, NO_TYPE_ID} from 'td/workbench/services/workingCopy/common/workingCopy';
