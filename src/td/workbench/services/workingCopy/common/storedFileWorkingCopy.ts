...
import {ETAG_DISABLED, FileOperationError, FileOperationResult, IFileReadLimits, IFileService, IFileStatWithMetadata, IFileStreamContent, IWriteFileOptions, NotModifiedSinceFileOperationError} from 'td/platform/files/common/files';
import {ISaveOptions, IRevertOptions, SaveReason} from 'td/workbench/common/editor';
import {IWorkingCopyService} from 'td/workbench/services/workingCopy/common/workingCopyService';
import {IWorkingCopyBackup, IWorkingCopyBackupMeta, IWorkingCopySaveEvent, WorkingCopyCapabilities} from 'td/workbench/services/workingCopy/common/workingCopy';
import {raceCancellation, TaskSequentializer, timeout} from 'td/base/common/async';
...
import {VSBufferReadableStream} from 'td/base/common/buffer';
...
import {isErrorWithActions, toErrorMessage} from 'td/base/common/errorMessage';
...
import {IResourceWorkingCopy, ResourceWorkingCopy} from 'td/workbench/services/workingCopy/common/resourceWorkingCopy';
import {IFileWorkingCopy, IFileWorkingCopyModel, IFileWorkingCopyModelFactory} from 'td/workbench/services/workingCopy/common/fileWorkingCopy';
