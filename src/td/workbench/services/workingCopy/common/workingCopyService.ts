...
import {Disposable, IDisposable, toDisposable, DisposableStore, DisposableMap} from 'td/base/common/lifecycle';
import {ResourceMap} from 'td/base/common/map';
import {IWorkingCopy, IWorkingCopyIdentifier, IWorkingCopySaveEvent as IBaseWorkingCopySaveEvent} from 'td/workbench/services/workingCopy/common/workingCopy';
