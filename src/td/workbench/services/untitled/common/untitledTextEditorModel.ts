...
import {ISaveOptions} from 'td/workbench/common/editor';
...
import {ITextResourceConfigurationChangeEvent, ITextResourceConfigurationService} from 'td/editor/common/services/textResourceConfiguration';
import {ITextModel} from 'td/editor/common/model';
import {createTextBufferFactory, createTextBufferFactoryFromStream} from 'td/editor/common/model/textModel';
import {ITextEditorModel} from 'td/editor/common/services/resolverService';
import {IWorkingCopyService} from 'td/workbench/services/workingCopy/common/workingCopyService';
import {IWorkingCopy, WorkingCopyCapabilities, IWorkingCopyBackup, NO_TYPE_ID, IWorkingCopySaveEvent} from 'td/workbench/services/workingCopy/common/workingCopy';
import {IEncodingSupport, ILanguageSupport, ITextFileService} from 'td/workbench/services/textfile/common/textfiles';
import {IModelContentChangedEvent} from 'td/editor/common/textModelEvents';
import {assertIsDefined} from 'td/base/common/types';
import {ILabelService} from 'td/platform/label/common/label';
import {ensureValidWordDefinition} from 'td/editor/common/core/wordHelper';
...
import {getCharContainingOffset} from 'td/base/common/strings';
import {UTF8} from 'td/workbench/services/textfile/common/encoding';
import {bufferToReadable, bufferToStream, VSBuffer, VSBufferReadable, VSBufferReadableStream} from 'td/base/common/buffer';
