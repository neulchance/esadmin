...
import {IAuthenticationProvider, SyncStatus, SyncResource, IUserDataSyncResource, IResourcePreview} from 'td/platform/userDataSync/common/userDataSync';
...
import {IAction2Options} from 'td/platform/actions/common/actions';
