...
import {IUserDataSyncService, IAuthenticationProvider, isAuthenticationProvider, IUserDataAutoSyncService, IUserDataSyncStoreManagementService, SyncStatus, IUserDataSyncEnablementService, IUserDataSyncResource, IResourcePreview, USER_DATA_SYNC_SCHEME, USER_DATA_SYNC_LOG_ID,} from 'td/platform/userDataSync/common/userDataSync';
import {ITelemetryService} from 'td/platform/telemetry/common/telemetry';
import {InstantiationType, registerSingleton} from 'td/platform/instantiation/common/extensions';
import {IUserDataSyncWorkbenchService, IUserDataSyncAccount, AccountStatus, CONTEXT_SYNC_ENABLEMENT, CONTEXT_SYNC_STATE, CONTEXT_ACCOUNT_STATE, SHOW_SYNC_LOG_COMMAND_ID, CONTEXT_ENABLE_ACTIVITY_VIEWS, SYNC_VIEW_CONTAINER_ID, SYNC_TITLE, SYNC_CONFLICTS_VIEW_ID, CONTEXT_ENABLE_SYNC_CONFLICTS_VIEW, CONTEXT_HAS_CONFLICTS, IUserDataSyncConflictsView} from 'td/workbench/services/userDataSync/common/userDataSync';
import {Disposable, DisposableStore} from 'td/base/common/lifecycle';
import {Emitter, Event} from 'td/base/common/event';
import {getCurrentAuthenticationSessionInfo} from 'td/workbench/services/authentication/browser/authenticationService';
import {AuthenticationSession, AuthenticationSessionsChangeEvent, IAuthenticationService} from 'td/workbench/services/authentication/common/authentication';
...
import {UserDataSyncStoreTypeSynchronizer} from 'td/platform/userDataSync/common/globalStateSync';
...
import {isDiffEditorInput} from 'td/workbench/common/editor';
...
import {escapeRegExpCharacters} from 'td/base/common/strings';
