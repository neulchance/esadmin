...
import {IUserDataProfile, IUserDataProfileOptions, IUserDataProfileUpdateOptions, ProfileResourceType} from 'td/platform/userDataProfile/common/userDataProfile';
...
import {ITreeItem, ITreeItemLabel} from 'td/workbench/common/views';
