...
import {IProgressRunner, IProgressIndicator, emptyProgressRunner} from 'td/platform/progress/common/progress';
// import {/* IEditorGroupView */ any} from 'td/workbench/browser/parts/editor/editor';
...
export class EditorProgressIndicator extends Disposable implements IProgressIndicator {
	...
	constructor(
		...
		private readonly group: /* IEditorGroupView */ any
	) {
		super();
	...
	private registerListeners() {
		...
		this._register(this.group.onDidModelChange((e: any) => {
			if (
