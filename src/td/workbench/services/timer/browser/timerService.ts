...
import {createBlobWorker} from 'td/base/browser/defaultWorkerFactory';
import {Registry} from 'td/platform/registry/common/platform';
import {ITerminalBackendRegistry, TerminalExtensions} from 'td/platform/terminal/common/terminal';
...
export interface IStartupMetrics {
	...
	/**
	 * How/why the window was created. See https://github.com/microsoft/vscode/blob/d1f57d871722f4d6ba63e4ef6f06287121ceb045/src/td/platform/lifecycle/common/lifecycle.ts#L50
	 */
