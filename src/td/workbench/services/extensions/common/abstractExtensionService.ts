...
import * as perf from 'td/base/common/performance';
import {isCI} from 'td/base/common/platform';
import {isEqualOrParent} from 'td/base/common/resources';
...
import {InstallOperation} from 'td/platform/extensionManagement/common/extensionManagement';
import {ImplicitActivationEvents} from 'td/platform/extensionManagement/common/implicitActivationEvents';
import {ExtensionIdentifier, ExtensionIdentifierMap, IExtension, IExtensionContributions, IExtensionDescription} from 'td/platform/extensions/common/extensions';
import {IFileService} from 'td/platform/files/common/files';
import {IInstantiationService} from 'td/platform/instantiation/common/instantiation';
import {handleVetos} from 'td/platform/lifecycle/common/lifecycle';
...
import {IRemoteAuthorityResolverService, RemoteAuthorityResolverError, RemoteAuthorityResolverErrorCode, ResolverResult, getRemoteAuthorityPrefix} from 'td/platform/remote/common/remoteAuthorityResolver';
...
import {IWorkbenchExtensionEnablementService, IWorkbenchExtensionManagementService} from 'td/workbench/services/extensionManagement/common/extensionManagement';
import {ExtensionDescriptionRegistryLock, ExtensionDescriptionRegistrySnapshot, IActivationEventsReader, LockableExtensionDescriptionRegistry} from 'td/workbench/services/extensions/common/extensionDescriptionRegistry';
import {parseExtensionDevOptions} from 'td/workbench/services/extensions/common/extensionDevOptions';
import {ExtensionHostKind, ExtensionRunningPreference, IExtensionHostKindPicker} from 'td/workbench/services/extensions/common/extensionHostKind';
import {ExtensionHostManager} from 'td/workbench/services/extensions/common/extensionHostManager';
import {IExtensionHostManager} from 'td/workbench/services/extensions/common/extensionHostManagers';
import {IResolveAuthorityErrorResult} from 'td/workbench/services/extensions/common/extensionHostProxy';
...
import {ExtensionRunningLocation, LocalProcessRunningLocation, LocalWebWorkerRunningLocation, RemoteRunningLocation} from 'td/workbench/services/extensions/common/extensionRunningLocation';
import {ExtensionRunningLocationTracker, filterExtensionIdentifiers} from 'td/workbench/services/extensions/common/extensionRunningLocationTracker';
import {ActivationKind, ActivationTimes, ExtensionActivationReason, ExtensionHostStartup, ExtensionPointContribution, IExtensionHost, IExtensionService, IExtensionsStatus, IInternalExtensionService, IMessage, IResponsiveStateChangeEvent, IWillActivateEvent, WillStopExtensionHostsEvent, toExtension} from 'td/workbench/services/extensions/common/extensions';
import {ExtensionsProposedApi} from 'td/workbench/services/extensions/common/extensionsProposedApi';
import {ExtensionMessageCollector, ExtensionPoint, ExtensionsRegistry, IExtensionPoint, IExtensionPointUser} from 'td/workbench/services/extensions/common/extensionsRegistry';
import {LazyCreateExtensionHostManager} from 'td/workbench/services/extensions/common/lazyCreateExtensionHostManager';
import {ResponsiveState} from 'td/workbench/services/extensions/common/rpcProtocol';
import {IExtensionActivationHost as IWorkspaceContainsActivationHost, checkActivateWorkspaceContainsExtension, checkGlobFileExists} from 'td/workbench/services/extensions/common/workspaceContains';
import {ILifecycleService} from 'td/workbench/services/lifecycle/common/lifecycle';
import {IExtensionHostExitInfo, IRemoteAgentService} from 'td/workbench/services/remote/common/remoteAgentService';
