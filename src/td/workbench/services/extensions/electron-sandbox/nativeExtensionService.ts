...
import {runWhenWindowIdle} from 'td/base/browser/dom';
...
import {isCI} from 'td/base/common/platform';
...
import {ExtensionKind} from 'td/platform/environment/common/environment';
import {IExtensionGalleryService} from 'td/platform/extensionManagement/common/extensionManagement';
import {ExtensionIdentifier, ExtensionType, IExtension, IExtensionDescription} from 'td/platform/extensions/common/extensions';
...
import {INotificationService, IPromptChoice, NotificationPriority, Severity} from 'td/platform/notification/common/notification';
...
import {PersistentConnectionEventType} from 'td/platform/remote/common/remoteAgentConnection';
import {IRemoteAgentEnvironment} from 'td/platform/remote/common/remoteAgentEnvironment';
import {IRemoteAuthorityResolverService, RemoteAuthorityResolverError, RemoteConnectionType, ResolverResult, getRemoteAuthorityPrefix} from 'td/platform/remote/common/remoteAuthorityResolver';
import {IRemoteExtensionsScannerService} from 'td/platform/remote/common/remoteExtensionsScanner';
import {getRemoteName, parseAuthorityWithPort} from 'td/platform/remote/common/remoteHosts';
import {updateProxyConfigurationsScope} from 'td/platform/request/common/request';
...
import {EnablementState, IWorkbenchExtensionEnablementService, IWorkbenchExtensionManagementService} from 'td/workbench/services/extensionManagement/common/extensionManagement';
import {IWebWorkerExtensionHostDataProvider, IWebWorkerExtensionHostInitData, WebWorkerExtensionHost} from 'td/workbench/services/extensions/browser/webWorkerExtensionHost';
import {AbstractExtensionService, ExtensionHostCrashTracker, IExtensionHostFactory, ResolvedExtensions, checkEnabledAndProposedAPI, extensionIsEnabled} from 'td/workbench/services/extensions/common/abstractExtensionService';
import {ExtensionDescriptionRegistrySnapshot} from 'td/workbench/services/extensions/common/extensionDescriptionRegistry';
import {parseExtensionDevOptions} from 'td/workbench/services/extensions/common/extensionDevOptions';
import {ExtensionHostKind, ExtensionRunningPreference, IExtensionHostKindPicker, extensionHostKindToString, extensionRunningPreferenceToString} from 'td/workbench/services/extensions/common/extensionHostKind';
import {IExtensionHostManager} from 'td/workbench/services/extensions/common/extensionHostManagers';
import {ExtensionHostExitCode} from 'td/workbench/services/extensions/common/extensionHostProtocol';
...
import {ExtensionRunningLocation, LocalProcessRunningLocation, LocalWebWorkerRunningLocation} from 'td/workbench/services/extensions/common/extensionRunningLocation';
import {ExtensionRunningLocationTracker, filterExtensionDescriptions} from 'td/workbench/services/extensions/common/extensionRunningLocationTracker';
import {ExtensionHostExtensions, ExtensionHostStartup, IExtensionHost, IExtensionService, WebWorkerExtHostConfigValue, toExtension, webWorkerExtHostConfig} from 'td/workbench/services/extensions/common/extensions';
import {ExtensionsProposedApi} from 'td/workbench/services/extensions/common/extensionsProposedApi';
import {IRemoteExtensionHostDataProvider, IRemoteExtensionHostInitData, RemoteExtensionHost} from 'td/workbench/services/extensions/common/remoteExtensionHost';
import {CachedExtensionScanner} from 'td/workbench/services/extensions/electron-sandbox/cachedExtensionScanner';
import {ILocalProcessExtensionHostDataProvider, ILocalProcessExtensionHostInitData, NativeLocalProcessExtensionHost} from 'td/workbench/services/extensions/electron-sandbox/localProcessExtensionHost';
...
import {IRemoteExplorerService} from 'td/workbench/services/remote/common/remoteExplorerService';
