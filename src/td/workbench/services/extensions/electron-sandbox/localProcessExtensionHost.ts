...
import {removeDangerousEnvVariables} from 'td/base/common/processes';
...
import {BufferedEmitter} from 'td/base/parts/ipc/common/ipc.net';
...
import {IExtensionHostProcessOptions, IExtensionHostStarter} from 'td/platform/extensions/common/extensionHostStarter';
...
import {isLoggingOnly} from 'td/platform/telemetry/common/telemetryUtils';
import {IUserDataProfilesService} from 'td/platform/userDataProfile/common/userDataProfile';
import {IWorkspaceContextService, WorkbenchState, isUntitledWorkspace} from 'td/platform/workspace/common/workspace';
...
import {MessagePortExtHostConnection, writeExtHostConnection} from 'td/workbench/services/extensions/common/extensionHostEnv';
import {IExtensionHostInitData, MessageType, NativeLogMarkers, UIKind, isMessageOfType} from 'td/workbench/services/extensions/common/extensionHostProtocol';
import {LocalProcessRunningLocation} from 'td/workbench/services/extensions/common/extensionRunningLocation';
import {ExtensionHostExtensions, ExtensionHostStartup, IExtensionHost} from 'td/workbench/services/extensions/common/extensions';
...
export class NativeLocalProcessExtensionHost implements IExtensionHost {
	...
	private async _start(): Promise<IMessagePassingProtocol> { 
		...
		const env = objects.mixin(processEnv, {
			VSCODE_AMD_ENTRYPOINT: 'td/workbench/api/node/extensionHostProcess',
