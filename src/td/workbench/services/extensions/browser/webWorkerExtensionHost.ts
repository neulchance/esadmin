...
import {COI, FileAccess} from 'td/base/common/network';
...
import {ExtensionHostExitCode, IExtensionHostInitData, MessageType, UIKind, createMessageOfType, isMessageOfType} from 'td/workbench/services/extensions/common/extensionHostProtocol';
...
export class WebWorkerExtensionHost extends Disposable implements IExtensionHost {
	...
	private async _getWebWorkerExtensionHostIframeSrc(): Promise<string> {
		...
		const iframeModulePath = 'td/workbench/services/extensions/worker/webWorkerExtensionHostIframe.html';
		if (platform.isWeb) {
