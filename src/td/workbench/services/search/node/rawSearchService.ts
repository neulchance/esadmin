...
import {compareItemsByFuzzyScore, FuzzyScorerCache, IItemAccessor, prepareQuery} from 'td/base/common/fuzzyScorer';
import {basename, dirname, join, sep} from 'td/base/common/path';
