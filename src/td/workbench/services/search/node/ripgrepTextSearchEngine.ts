...
import {splitGlobAware} from 'td/base/common/glob';
import {createRegExp, escapeRegExpCharacters} from 'td/base/common/strings';
import {URI} from 'td/base/common/uri';
import {Progress} from 'td/platform/progress/common/progress';
import {IExtendedExtensionSearchOptions, SearchError, SearchErrorCode, serializeSearchError} from 'td/workbench/services/search/common/search';
import {Range, TextSearchComplete, TextSearchContext, TextSearchMatch, TextSearchOptions, TextSearchPreviewOptions, TextSearchQuery, TextSearchResult} from 'td/workbench/services/search/common/searchExtTypes';
