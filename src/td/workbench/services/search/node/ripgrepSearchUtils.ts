...
import {SearchRange, TextSearchMatch} from 'td/workbench/services/search/common/search';
import * as searchExtTypes from 'td/workbench/services/search/common/searchExtTypes';
