...
import {flatten, mapArrayOrNot} from 'td/base/common/arrays';
import {isThenable} from 'td/base/common/async';
...
import {hasSiblingPromiseFn, IExtendedExtensionSearchOptions, IFileMatch, IFolderQuery, IPatternInfo, ISearchCompleteStats, ITextQuery, ITextSearchContext, ITextSearchMatch, ITextSearchResult, ITextSearchStats, QueryGlobTester, resolvePatternsForProvider} from 'td/workbench/services/search/common/search';
import {Range, TextSearchComplete, TextSearchMatch, TextSearchOptions, TextSearchProvider, TextSearchQuery, TextSearchResult} from 'td/workbench/services/search/common/searchExtTypes';
