...
import * as collections from 'td/base/common/collections';
import * as glob from 'td/base/common/glob';
import {untildify} from 'td/base/common/labels';
...
import {isEqual, basename, relativePath, isAbsolutePath} from 'td/base/common/resources';
import * as strings from 'td/base/common/strings';
import {assertIsDefined, isDefined} from 'td/base/common/types';
import {URI, URI as uri} from 'td/base/common/uri';
// import {isMultilineRegexSource} from 'td/editor/common/model/textModelSearch';
import * as nls from 'td/nls';
import {IConfigurationService} from 'td/platform/configuration/common/configuration';
import {ILogService} from 'td/platform/log/common/log';
import {IWorkspaceContextService, IWorkspaceFolderData, toWorkspaceFolder, WorkbenchState} from 'td/platform/workspace/common/workspace';
...
import {getExcludes, ICommonQueryProps, IFileQuery, IFolderQuery, IPatternInfo, ISearchConfiguration, ITextQuery, ITextSearchPreviewOptions, pathIncludedInQuery, QueryType} from 'td/workbench/services/search/common/search';
