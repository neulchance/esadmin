...
import {IFileMatch, IFileSearchProviderStats, IFolderQuery, ISearchCompleteStats, IFileQuery, QueryGlobTester, resolvePatternsForProvider, hasSiblingFn} from 'td/workbench/services/search/common/search';
import {FileSearchProvider, FileSearchOptions} from 'td/workbench/services/search/common/searchExtTypes';
