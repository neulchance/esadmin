...
import {mapArrayOrNot} from 'td/base/common/arrays';
...
import * as extpath from 'td/base/common/extpath';
import {fuzzyContains, getNLines} from 'td/base/common/strings';
import {URI, UriComponents} from 'td/base/common/uri';
import {IFilesConfiguration} from 'td/platform/files/common/files';
