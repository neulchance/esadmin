...
import {Language, LANGUAGE_DEFAULT} from 'td/base/common/platform';
...
import {IActiveLanguagePackService, ILocaleService} from 'td/workbench/services/localization/common/locale';
import {ILanguagePackItem, ILanguagePackService} from 'td/platform/languagePacks/common/languagePacks';
import {IPaneCompositePartService} from 'td/workbench/services/panecomposite/browser/panecomposite';
import {IViewPaneContainer, ViewContainerLocation} from 'td/workbench/common/views';
...
import {stripComments} from 'td/base/common/stripComments';
