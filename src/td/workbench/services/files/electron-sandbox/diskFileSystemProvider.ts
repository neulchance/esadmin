...
import {ReadableStreamEvents} from 'td/base/common/stream';
...
import {ILogMessage, AbstractUniversalWatcherClient} from 'td/platform/files/common/watcher';
import {UniversalWatcherClient} from 'td/workbench/services/files/electron-sandbox/watcherClient';
