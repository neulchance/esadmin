...
import {IResourceEditorInput, IEditorOptions} from 'td/platform/editor/common/editor';
...
import {GoFilter, GoScope, IHistoryService} from 'td/workbench/services/history/common/history';
import {FileChangesEvent, IFileService, FileChangeType, FILES_EXCLUDE_CONFIG, FileOperationEvent, FileOperation} from 'td/platform/files/common/files';
import {IWorkspaceContextService} from 'td/platform/workspace/common/workspace';
import {dispose, Disposable, DisposableStore, IDisposable} from 'td/base/common/lifecycle';
...
import {getExcludes, ISearchConfiguration, SEARCH_EXCLUDE_CONFIG} from 'td/workbench/services/search/common/search';
import {IInstantiationService} from 'td/platform/instantiation/common/instantiation';
import {EditorServiceImpl} from 'td/workbench/browser/parts/editor/editor';
import {IWorkbenchLayoutService} from 'td/workbench/services/layout/browser/layoutService';
import {IContextKeyService, RawContextKey} from 'td/platform/contextkey/common/contextkey';
import {coalesce, remove} from 'td/base/common/arrays';
import {InstantiationType, registerSingleton} from 'td/platform/instantiation/common/extensions';
import {addDisposableListener, EventType, EventHelper, WindowIdleValue} from 'td/base/browser/dom';
...
import {ILogService, LogLevel} from 'td/platform/log/common/log';
