...
import {URI as uri} from 'td/base/common/uri';
...
import {ConfigurationTarget, IConfigurationOverrides, IConfigurationService} from 'td/platform/configuration/common/configuration';
import {ILabelService} from 'td/platform/label/common/label';
import {IInputOptions, IPickOptions, IQuickInputService, IQuickPickItem} from 'td/platform/quickinput/common/quickInput';
import {IWorkspaceContextService, IWorkspaceFolder, WorkbenchState} from 'td/platform/workspace/common/workspace';
import {EditorResourceAccessor, SideBySideEditor} from 'td/workbench/common/editor';
import {ConfiguredInput} from 'td/workbench/services/configurationResolver/common/configurationResolver';
