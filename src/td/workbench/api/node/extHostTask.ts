...
import { win32 } from 'td/base/node/processes';
...
import { IWorkspaceFolder, WorkspaceFolder } from 'td/platform/workspace/common/workspace';
...
import { ExtHostTaskBase, TaskHandleDTO, TaskDTO, CustomExecutionDTO, HandlerData } from 'td/workbench/api/common/extHostTask';
