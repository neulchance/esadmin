...
import {IReference, dispose, Disposable} from 'td/base/common/lifecycle';
...
import {IFileService, FileOperation} from 'td/platform/files/common/files';
import {ExtHostContext, ExtHostDocumentsShape, MainThreadDocumentsShape} from 'td/workbench/api/common/extHost.protocol';
...
import {toLocalResource, extUri, IExtUri} from 'td/base/common/resources';
