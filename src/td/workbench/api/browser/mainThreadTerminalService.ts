...
import {DisposableStore, Disposable, IDisposable, MutableDisposable} from 'td/base/common/lifecycle';
import {ExtHostContext, ExtHostTerminalServiceShape, MainThreadTerminalServiceShape, MainContext, TerminalLaunchConfig, ITerminalDimensionsDto, ExtHostTerminalIdentifier, TerminalQuickFix, ITerminalCommandDto} from 'td/workbench/api/common/extHost.protocol';
...
import {IProcessProperty, IProcessReadyWindowsPty, IShellLaunchConfig, IShellLaunchConfigDto, ITerminalOutputMatch, ITerminalOutputMatcher, ProcessPropertyType, TerminalExitReason, TerminalLocation} from 'td/platform/terminal/common/terminal';
import {TerminalDataBufferer} from 'td/platform/terminal/common/terminalDataBuffering';
import {ITerminalEditorService, ITerminalExternalLinkProvider, ITerminalGroupService, ITerminalInstance, ITerminalLink, ITerminalService} from 'td/workbench/contrib/terminal/browser/terminal';
import {TerminalProcessExtHostProxy} from 'td/workbench/contrib/terminal/browser/terminalProcessExtHostProxy';
import {IEnvironmentVariableService} from 'td/workbench/contrib/terminal/common/environmentVariable';
import {deserializeEnvironmentDescriptionMap, deserializeEnvironmentVariableCollection, serializeEnvironmentVariableCollection} from 'td/platform/terminal/common/environmentVariableShared';
import {IStartExtensionTerminalRequest, ITerminalProcessExtHostProxy, ITerminalProfileResolverService, ITerminalProfileService} from 'td/workbench/contrib/terminal/common/terminal';
...
import {ITerminalQuickFixService, ITerminalQuickFix, TerminalQuickFixType} from 'td/workbench/contrib/terminalContrib/quickFix/browser/quickFix';
