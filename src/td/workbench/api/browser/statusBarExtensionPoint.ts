...
import {IStatusbarService, StatusbarAlignment as MainThreadStatusBarAlignment, IStatusbarEntryAccessor, IStatusbarEntry, StatusbarAlignment, IStatusbarEntryPriority, StatusbarEntryKind} from 'td/workbench/services/statusbar/browser/statusbar';
import {ThemeColor} from 'td/base/common/themables';
import {Command} from 'td/editor/common/languages';
import {IAccessibilityInformation, isAccessibilityInformation} from 'td/platform/accessibility/common/accessibility';
import {IMarkdownString} from 'td/base/common/htmlContent';
import {getCodiconAriaLabel} from 'td/base/common/iconLabels';
...
import {asStatusBarItemIdentifier} from 'td/workbench/api/common/extHostTypes';
import {STATUS_BAR_ERROR_ITEM_BACKGROUND, STATUS_BAR_WARNING_ITEM_BACKGROUND} from 'td/workbench/common/theme';
