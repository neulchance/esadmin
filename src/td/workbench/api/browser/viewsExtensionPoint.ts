...
import {ExtensionIdentifier, ExtensionIdentifierSet, IExtensionDescription, IExtensionManifest} from 'td/platform/extensions/common/extensions';
...
import {Extensions as ViewletExtensions, PaneCompositeRegistry} from 'td/workbench/browser/panecomposite';
import {CustomTreeView, RawCustomTreeViewContextKey, TreeViewPane} from 'td/workbench/browser/parts/views/treeView';
...
import {Extensions as ViewContainerExtensions, ICustomViewDescriptor, IViewContainersRegistry, IViewDescriptor, IViewsRegistry, ResolvableTreeItem, ViewContainer, ViewContainerLocation} from 'td/workbench/common/views';
import {VIEWLET_ID as DEBUG} from 'td/workbench/contrib/debug/common/debug';
import {VIEWLET_ID as EXPLORER} from 'td/workbench/contrib/files/common/files';
// import {VIEWLET_ID as REMOTE} from 'td/workbench/contrib/remote/browser/remoteExplorer';
import {VIEWLET_ID as SCM} from 'td/workbench/contrib/scm/common/scm';
import {WebviewViewPane} from 'td/workbench/contrib/webviewView/browser/webviewViewPane';
import {isProposedApiEnabled} from 'td/workbench/services/extensions/common/extensions';
import {ExtensionMessageCollector, ExtensionsRegistry, IExtensionPoint, IExtensionPointUser} from 'td/workbench/services/extensions/common/extensionsRegistry';
...
import {IListService, WorkbenchListFocusContextKey} from 'td/platform/list/browser/listService';
...
import {IExtensionFeatureTableRenderer, IRenderedData, ITableData, IRowData, IExtensionFeaturesRegistry, Extensions as ExtensionFeaturesRegistryExtensions} from 'td/workbench/services/extensionManagement/common/extensionFeatures';
			...
			Object.entries(value).forEach(([key, value]) => {
				...
				for (let index = 0; index < value.length; index++) {
					...
					const viewDescriptor: ICustomViewDescriptor = {
						...
						canMoveView: /* viewContainer?.id !== REMOTE */ true,
