...
import {illegalArgument} from 'td/base/common/errors';
import {IDisposable, dispose, DisposableStore} from 'td/base/common/lifecycle';
import {equals as objectEquals} from 'td/base/common/objects';
...
import {IDecorationOptions, IDecorationRenderOptions} from 'td/editor/common/editorCommon';
...
import {ITextEditorOptions, IResourceEditorInput, EditorActivation, EditorResolution} from 'td/platform/editor/common/editor';
import {ServicesAccessor} from 'td/platform/instantiation/common/instantiation';
import {MainThreadTextEditor} from 'td/workbench/api/browser/mainThreadEditor';
import {ExtHostContext, ExtHostEditorsShape, IApplyEditsOptions, ITextDocumentShowOptions, ITextEditorConfigurationUpdate, ITextEditorPositionData, IUndoStopOptions, MainThreadTextEditorsShape, TextEditorRevealType} from 'td/workbench/api/common/extHost.protocol';
import {editorGroupToColumn, columnToEditorGroup, EditorGroupColumn} from 'td/workbench/services/editor/common/editorGroupColumn';
...
import {IEditorControl} from 'td/workbench/common/editor';
import {getCodeEditor, ICodeEditor} from 'td/editor/browser/editorBrowser';
import {IConfigurationService} from 'td/platform/configuration/common/configuration';
import {DirtyDiffContribution} from 'td/workbench/contrib/scm/browser/dirtydiffDecorator';
