...
import {ExtHostContext, IExtHostEditorTabsShape, MainContext, IEditorTabDto, IEditorTabGroupDto, MainThreadEditorTabsShape, AnyInputDto, TabInputKind, TabModelOperationKind} from 'td/workbench/api/common/extHost.protocol';
import {extHostNamedCustomer, IExtHostContext} from 'td/workbench/services/extensions/common/extHostCustomers';
import {EditorResourceAccessor, GroupModelChangeKind, SideBySideEditor} from 'td/workbench/common/editor';
...
import {columnToEditorGroup, EditorGroupColumn, editorGroupToColumn} from 'td/workbench/services/editor/common/editorGroupColumn';
import {GroupDirection, IEditorGroup, IEditorGroupsService, preferredSideBySideGroupDirection} from 'td/workbench/services/editor/common/editorGroupsService';
import {IEditorsChangeEvent, IEditorService, SIDE_GROUP} from 'td/workbench/services/editor/common/editorService';
...
import {isGroupEditorMoveEvent} from 'td/workbench/common/editor/editorGroupModel';
import {InteractiveEditorInput} from 'td/workbench/contrib/interactive/browser/interactiveEditorInput';
import {MergeEditorInput} from 'td/workbench/contrib/mergeEditor/browser/mergeEditorInput';
