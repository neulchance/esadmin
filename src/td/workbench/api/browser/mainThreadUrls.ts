...
import {ExtHostContext, MainContext, MainThreadUrlsShape, ExtHostUrlsShape} from 'td/workbench/api/common/extHost.protocol';
import {extHostNamedCustomer, IExtHostContext} from '../../services/extensions/common/extHostCustomers';
import {IURLService, IOpenURLOptions} from 'td/platform/url/common/url';
import {URI, UriComponents} from 'td/base/common/uri';
import {IDisposable} from 'td/base/common/lifecycle';
import {IExtensionContributedURLHandler, IExtensionUrlHandler} from 'td/workbench/services/extensions/browser/extensionUrlHandler';
