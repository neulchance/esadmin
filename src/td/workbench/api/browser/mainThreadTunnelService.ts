...
import {MainThreadTunnelServiceShape, MainContext, ExtHostContext, ExtHostTunnelServiceShape, CandidatePortSource, PortAttributesSelector, TunnelDto} from 'td/workbench/api/common/extHost.protocol';
import {TunnelDtoConverter} from 'td/workbench/api/common/extHostTunnelService';
import {extHostNamedCustomer, IExtHostContext} from 'td/workbench/services/extensions/common/extHostCustomers';
import {IRemoteExplorerService, PORT_AUTO_FORWARD_SETTING, PORT_AUTO_SOURCE_SETTING, PORT_AUTO_SOURCE_SETTING_OUTPUT} from 'td/workbench/services/remote/common/remoteExplorerService';
import {ITunnelProvider, ITunnelService, TunnelCreationOptions, TunnelProviderFeatures, TunnelOptions, RemoteTunnel, ProvidedPortAttributes, PortAttributesProvider, TunnelProtocol} from 'td/platform/tunnel/common/tunnel';
import {Disposable} from 'td/base/common/lifecycle';
import type {TunnelDescription} from 'td/platform/remote/common/remoteAuthorityResolver';
...
import {IConfigurationRegistry, Extensions as ConfigurationExtensions} from 'td/platform/configuration/common/configurationRegistry';
import {IContextKeyService} from 'td/platform/contextkey/common/contextkey';
import {CandidatePort, TunnelCloseReason, TunnelSource, forwardedPortsViewEnabled, makeAddress} from 'td/workbench/services/remote/common/tunnelModel';
