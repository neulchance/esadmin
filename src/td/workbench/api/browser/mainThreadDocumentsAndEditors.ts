...
import {combinedDisposable, DisposableStore, DisposableMap} from 'td/base/common/lifecycle';
import {ICodeEditor, isCodeEditor, isDiffEditor, IActiveCodeEditor} from 'td/editor/browser/editorBrowser';
...
import {ITextModel, shouldSynchronizeModel} from 'td/editor/common/model';
...
import {extHostCustomer, IExtHostContext} from 'td/workbench/services/extensions/common/extHostCustomers';
import {MainThreadDocuments} from 'td/workbench/api/browser/mainThreadDocuments';
import {MainThreadTextEditor} from 'td/workbench/api/browser/mainThreadEditor';
import {MainThreadTextEditors} from 'td/workbench/api/browser/mainThreadEditors';
import {ExtHostContext, ExtHostDocumentsAndEditorsShape, IDocumentsAndEditorsDelta, IModelAddedData, ITextEditorAddData, MainContext} from 'td/workbench/api/common/extHost.protocol';
...
import {EditorGroupColumn, editorGroupToColumn} from 'td/workbench/services/editor/common/editorGroupColumn';
...
import {diffSets, diffMaps} from 'td/base/common/collections';
