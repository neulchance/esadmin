...
import {WorkspaceTrustRequestOptions, IWorkspaceTrustManagementService, IWorkspaceTrustRequestService} from 'td/platform/workspace/common/workspaceTrust';
import {IWorkspace, IWorkspaceContextService, WorkbenchState, isUntitledWorkspace, WorkspaceFolder} from 'td/platform/workspace/common/workspace';
...
import {IEditorService, ISaveEditorsResult} from 'td/workbench/services/editor/common/editorService';
import {IFileMatch, IPatternInfo, ISearchProgressItem, ISearchService} from 'td/workbench/services/search/common/search';
...
import {IEditSessionIdentityService} from 'td/platform/workspace/common/editSessions';
import {EditorResourceAccessor, SaveReason, SideBySideEditor} from 'td/workbench/common/editor';
import {coalesce, firstOrDefault} from 'td/base/common/arrays';
import {ICanonicalUriService} from 'td/platform/workspace/common/canonicalUri';
...
export class MainThreadWorkspace implements MainThreadWorkspaceShape {
	...
	constructor(
		...
		// this._proxy.$checkWorking('11111111111111111111111111111111111111111111111111111111111111111111111111111111')
