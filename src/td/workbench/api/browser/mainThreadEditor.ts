...
import {RenderLineNumbersType, TextEditorCursorStyle, cursorStyleToString, EditorOption} from 'td/editor/common/config/editorOptions';
import {IRange, Range} from 'td/editor/common/core/range';
import {ISelection, Selection} from 'td/editor/common/core/selection';
import {IDecorationOptions, ScrollType} from 'td/editor/common/editorCommon';
import {ITextModel, ITextModelUpdateOptions} from 'td/editor/common/model';
...
import {IApplyEditsOptions, IEditorPropertiesChangeData, IResolvedTextEditorConfiguration, ITextEditorConfigurationUpdate, IUndoStopOptions, TextEditorRevealType} from 'td/workbench/api/common/extHost.protocol';
import {IEditorPane} from 'td/workbench/common/editor';
import {equals} from 'td/base/common/arrays';
import {CodeEditorStateFlag, EditorState} from 'td/editor/contrib/editorState/browser/editorState';
...
import {ISnippetEdit} from 'td/editor/contrib/snippet/browser/snippetSession';
