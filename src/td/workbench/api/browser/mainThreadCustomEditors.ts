...
import {multibyteAwareBtoa} from 'td/base/browser/dom';
...
import {isCancellationError, onUnexpectedError} from 'td/base/common/errors';
import {Emitter, Event} from 'td/base/common/event';
import {Disposable, DisposableMap, DisposableStore, IReference} from 'td/base/common/lifecycle';
import {Schemas} from 'td/base/common/network';
import {basename} from 'td/base/common/path';
import {isEqual, isEqualOrParent, toLocalResource} from 'td/base/common/resources';
...
import {IUndoRedoService, UndoRedoElementType} from 'td/platform/undoRedo/common/undoRedo';
...
import {IRevertOptions, ISaveOptions} from 'td/workbench/common/editor';
import {CustomEditorInput} from 'td/workbench/contrib/customEditor/browser/customEditorInput';
import {CustomDocumentBackupData} from 'td/workbench/contrib/customEditor/browser/customEditorInputFactory';
import {ICustomEditorModel, ICustomEditorService} from 'td/workbench/contrib/customEditor/common/customEditor';
import {CustomTextEditorModel} from 'td/workbench/contrib/customEditor/common/customTextEditorModel';
import {ExtensionKeyedWebviewOriginStore, WebviewExtensionDescription} from 'td/workbench/contrib/webview/browser/webview';
import {WebviewInput} from 'td/workbench/contrib/webviewPanel/browser/webviewEditorInput';
import {IWebviewWorkbenchService} from 'td/workbench/contrib/webviewPanel/browser/webviewWorkbenchService';
...
import {ResourceWorkingCopy} from 'td/workbench/services/workingCopy/common/resourceWorkingCopy';
import {IWorkingCopy, IWorkingCopyBackup, IWorkingCopySaveEvent, NO_TYPE_ID, WorkingCopyCapabilities} from 'td/workbench/services/workingCopy/common/workingCopy';
import {IWorkingCopyFileService, WorkingCopyFileEvent} from 'td/workbench/services/workingCopy/common/workingCopyFileService';
