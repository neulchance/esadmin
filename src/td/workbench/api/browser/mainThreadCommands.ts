...
import {DisposableMap, IDisposable} from 'td/base/common/lifecycle';
import {revive} from 'td/base/common/marshalling';
import {CommandsRegistry, ICommandMetadata, ICommandService} from 'td/platform/commands/common/commands';
...
import {Dto, SerializableObjectWithBuffers} from 'td/workbench/services/extensions/common/proxyIdentifier';
