...
import { ExtHostNotebookRenderersShape, IMainContext, MainContext, MainThreadNotebookRenderersShape } from 'td/workbench/api/common/extHost.protocol';
import { ExtHostNotebookController } from 'td/workbench/api/common/extHostNotebook';
import { ExtHostNotebookEditor } from 'td/workbench/api/common/extHostNotebookEditor';
