...
import {ExtHostDocumentsShape, IMainContext, MainContext, MainThreadDocumentsShape} from 'td/workbench/api/common/extHost.protocol';
import {ExtHostDocumentData, setWordDefinitionFor} from 'td/workbench/api/common/extHostDocumentData';
...
import {TextDocumentChangeReason} from 'td/workbench/api/common/extHostTypes';
