...
import {ok} from 'td/base/common/assert';
import {ReadonlyError, illegalArgument} from 'td/base/common/errors';
...
import {IResolvedTextEditorConfiguration, ITextEditorConfigurationUpdate, MainThreadTextEditorsShape} from 'td/workbench/api/common/extHost.protocol';
import * as TypeConverters from 'td/workbench/api/common/extHostTypeConverters';
import {EndOfLine, Position, Range, Selection, SnippetString, TextEditorLineNumbersStyle, TextEditorRevealType} from 'td/workbench/api/common/extHostTypes';
