...
import {Cache} from 'td/workbench/api/common/cache';
import {ExtHostNotebookShape, IMainContext, IModelAddedData, INotebookCellStatusBarListDto, INotebookDocumentsAndEditorsDelta, INotebookDocumentShowOptions, INotebookEditorAddData, INotebookPartialFileStatsWithMetadata, MainContext, MainThreadNotebookDocumentsShape, MainThreadNotebookEditorsShape, MainThreadNotebookShape, NotebookDataDto} from 'td/workbench/api/common/extHost.protocol';
import {ApiCommand, ApiCommandArgument, ApiCommandResult, CommandsConverter, ExtHostCommands} from 'td/workbench/api/common/extHostCommands';
...
import {INotebookExclusiveDocumentFilter, INotebookContributionData} from 'td/workbench/contrib/notebook/common/notebookCommon';
...
import {filter} from 'td/base/common/objects';
import {Schemas} from 'td/base/common/network';
import {IFileQuery, ITextQuery, QueryType} from 'td/workbench/services/search/common/search';
...
import {INotebookCellMatchNoModel, INotebookFileMatchNoModel, IRawClosedNotebookFileMatch, genericCellMatchesToTextSearchMatches} from 'td/workbench/contrib/search/common/searchNotebookHelpers';
import {NotebookPriorityInfo} from 'td/workbench/contrib/search/common/search';
import {globMatchesResource} from 'td/workbench/services/editor/common/editorResolverService';
