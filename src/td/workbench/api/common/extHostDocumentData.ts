...
import {MirrorTextModel} from 'td/editor/common/model/mirrorTextModel';
import {ensureValidWordDefinition, getWordAtText} from 'td/editor/common/core/wordHelper';
import {MainThreadDocumentsShape} from 'td/workbench/api/common/extHost.protocol';
import {EndOfLine, Position, Range} from 'td/workbench/api/common/extHostTypes';
