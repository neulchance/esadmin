...
import {originalFSPath, joinPath, extUriBiasedIgnorePathCase} from 'td/base/common/resources';
import {asPromise, Barrier, IntervalTimer, timeout} from 'td/base/common/async';
import {dispose, toDisposable, Disposable} from 'td/base/common/lifecycle';
import {TernarySearchTree} from 'td/base/common/ternarySearchTree';
import {URI, UriComponents} from 'td/base/common/uri';
import {ILogService} from 'td/platform/log/common/log';
import {ExtHostExtensionServiceShape, MainContext, MainThreadExtensionServiceShape, MainThreadTelemetryShape, MainThreadWorkspaceShape} from 'td/workbench/api/common/extHost.protocol';
import {IExtensionDescriptionDelta, IExtensionHostInitData} from 'td/workbench/services/extensions/common/extensionHostProtocol';
import {ExtHostConfiguration, IExtHostConfiguration} from 'td/workbench/api/common/extHostConfiguration';
import {ActivatedExtension, EmptyExtension, ExtensionActivationTimes, ExtensionActivationTimesBuilder, ExtensionsActivator, IExtensionAPI, IExtensionModule, HostExtension, ExtensionActivationTimesFragment} from 'td/workbench/api/common/extHostExtensionActivator';
import {ExtHostStorage, IExtHostStorage} from 'td/workbench/api/common/extHostStorage';
import {ExtHostWorkspace, IExtHostWorkspace} from 'td/workbench/api/common/extHostWorkspace';
import {MissingExtensionDependency, ActivationKind, checkProposedApiEnabled, isProposedApiEnabled, ExtensionActivationReason} from 'td/workbench/services/extensions/common/extensions';
import {ExtensionDescriptionRegistry, IActivationEventsReader} from 'td/workbench/services/extensions/common/extensionDescriptionRegistry';
import * as errors from 'td/base/common/errors';
import type * as vscode from 'vscode';
import {ExtensionIdentifier, ExtensionIdentifierMap, ExtensionIdentifierSet, IExtensionDescription, IRelaxedExtensionDescription} from 'td/platform/extensions/common/extensions';
import {VSBuffer} from 'td/base/common/buffer';
import {ExtensionGlobalMemento, ExtensionMemento} from 'td/workbench/api/common/extHostMemento';
import {RemoteAuthorityResolverError, ExtensionKind, ExtensionMode, ExtensionRuntime, ManagedResolvedAuthority as ExtHostManagedResolvedAuthority} from 'td/workbench/api/common/extHostTypes';
import {ResolvedAuthority, ResolvedOptions, RemoteAuthorityResolverErrorCode, IRemoteConnectionData, getRemoteAuthorityPrefix, TunnelInformation, ManagedRemoteConnection, WebSocketRemoteConnection} from 'td/platform/remote/common/remoteAuthorityResolver';
import {IInstantiationService, createDecorator} from 'td/platform/instantiation/common/instantiation';
...
import {IExtensionActivationHost, checkActivateWorkspaceContainsExtension} from 'td/workbench/services/extensions/common/workspaceContains';
import {ExtHostSecretState, IExtHostSecretState} from 'td/workbench/api/common/extHostSecretState';
import {ExtensionSecrets} from 'td/workbench/api/common/extHostSecrets';
...
import {isCI, setTimeout0} from 'td/base/common/platform';
...
export abstract class AbstractExtHostExtensionService extends Disposable implements ExtHostExtensionServiceShape {
	...
	public async initialize(): Promise<void> {
		try {
			...
			if (false/* Coloring Flow Check */) console.log(`\x1b[32mthis._almostReadyToRunExtensions.open() done\x1b[0m`)

			await this._extHostWorkspace.waitForInitializeCall();
			performance.mark('code/extHost/ready');
			this._readyToStartExtensionHost.open();
			if (false/* Coloring Flow Check */) console.log(`\x1b[32mthis._readyToStartExtensionHost.open()\x1b[0m`)
			
			if (this._initData.autoStart) {
				if (false/* Coloring Flow Check */) console.log(`\x1b[32mthis._initData.autoStart\x1b[0m`)
