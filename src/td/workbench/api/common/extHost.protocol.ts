...
import {IChatAsyncContent, IChatDynamicRequest, IChatFollowup, IChatProgress, IChatReplyFollowup, IChatResponseErrorDetails, IChatUserActionEvent, InteractiveSessionVoteDirection} from 'td/workbench/contrib/chat/common/chatService';
import {IChatRequestVariableValue, IChatVariableData} from 'td/workbench/contrib/chat/common/chatVariables';
import {DebugConfigurationProviderTriggerKind, IAdapterDescriptor, IConfig, IDebugSessionReplMode} from 'td/workbench/contrib/debug/common/debug';
...
import {ISpeechProviderMetadata, ISpeechToTextEvent} from 'td/workbench/contrib/speech/common/speechService';
