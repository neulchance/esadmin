...
import {IRemoteConsoleLog} from 'td/base/common/console';
import {SerializedError} from 'td/base/common/errors';
import {IRelativePattern} from 'td/base/common/glob';
...
import {ThemeColor, ThemeIcon} from 'td/base/common/themables';
import {URI, UriComponents, UriDto} from 'td/base/common/uri';
import {RenderLineNumbersType, TextEditorCursorStyle} from 'td/editor/common/config/editorOptions';
...
import {CharacterPair, CommentRule, EnterAction} from 'td/editor/common/languages/languageConfiguration';
import {EndOfLineSequence} from 'td/editor/common/model';
import {IModelChangedEvent} from 'td/editor/common/model/mirrorTextModel';
...
import {ConfigurationTarget, IConfigurationChange, IConfigurationData, IConfigurationOverrides} from 'td/platform/configuration/common/configuration';
import {ConfigurationScope} from 'td/platform/configuration/common/configurationRegistry';
...
import {ResourceLabelFormatter} from 'td/platform/label/common/label';
import {ILoggerOptions, ILoggerResource, LogLevel} from 'td/platform/log/common/log';
import {IMarkerData} from 'td/platform/markers/common/markers';
import {IProgressOptions, IProgressStep} from 'td/platform/progress/common/progress';
import * as quickInput from 'td/platform/quickinput/common/quickInput';
import {IRemoteConnectionData, TunnelDescription} from 'td/platform/remote/common/remoteAuthorityResolver';
import {ClassifiedEvent, IGDPRProperty, OmitMetadata, StrictPropertyCheck} from 'td/platform/telemetry/common/gdprTypings';
import {TelemetryLevel} from 'td/platform/telemetry/common/telemetry';
import {ISerializableEnvironmentDescriptionMap, ISerializableEnvironmentVariableCollection} from 'td/platform/terminal/common/environmentVariable';
import {ICreateContributedTerminalProfileOptions, IProcessProperty, IProcessReadyWindowsPty, IShellLaunchConfigDto, ITerminalEnvironment, ITerminalLaunchError, ITerminalProfile, TerminalExitReason, TerminalLocation} from 'td/platform/terminal/common/terminal';
import {ProvidedPortAttributes, TunnelCreationOptions, TunnelOptions, TunnelPrivacyId, TunnelProviderFeatures} from 'td/platform/tunnel/common/tunnel';
import {EditSessionIdentityMatch} from 'td/platform/workspace/common/editSessions';
import {WorkspaceTrustRequestOptions} from 'td/platform/workspace/common/workspaceTrust';
import * as tasks from 'td/workbench/api/common/shared/tasks';
import {SaveReason} from 'td/workbench/common/editor';
import {IRevealOptions, ITreeItem, IViewBadge} from 'td/workbench/common/views';
import {CallHierarchyItem} from 'td/workbench/contrib/callHierarchy/common/callHierarchy';
import {IChatAgentCommand, IChatAgentMetadata, IChatAgentRequest, IChatAgentResult} from 'td/workbench/contrib/chat/common/chatAgents';
import {IChatProgressResponseContent} from 'td/workbench/contrib/chat/common/chatModel';
import {IChatMessage, IChatResponseFragment, IChatResponseProviderMetadata} from 'td/workbench/contrib/chat/common/chatProvider';
import {IChatDynamicRequest, IChatFollowup, IChatProgress, IChatReplyFollowup, IChatResponseErrorDetails, IChatUserActionEvent, InteractiveSessionVoteDirection} from 'td/workbench/contrib/chat/common/chatService';
import {IChatRequestVariableValue, IChatVariableData} from 'td/workbench/contrib/chat/common/chatVariables';
import {DebugConfigurationProviderTriggerKind, MainThreadDebugVisualization, IAdapterDescriptor, IConfig, IDebugSessionReplMode, IDebugVisualization, IDebugVisualizationContext} from 'td/workbench/contrib/debug/common/debug';
import {IInlineChatBulkEditResponse, IInlineChatEditResponse, IInlineChatProgressItem, IInlineChatRequest, IInlineChatSession, InlineChatResponseFeedbackKind} from 'td/workbench/contrib/inlineChat/common/inlineChat';
import * as notebookCommon from 'td/workbench/contrib/notebook/common/notebookCommon';
...
import * as search from 'td/workbench/services/search/common/search';
...
export const MainContext = {
	...
	/* ✔︎ */MainThreadExtensionService: createProxyIdentifier<MainThreadExtensionServiceShape>('MainThreadExtensionService'),
