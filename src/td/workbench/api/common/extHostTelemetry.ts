...
import {ExtHostTelemetryShape} from 'td/workbench/api/common/extHost.protocol';
import {ICommonProperties, TelemetryLevel} from 'td/platform/telemetry/common/telemetry';
import {ILogger, ILoggerService, LogLevel, isLogLevel} from 'td/platform/log/common/log';
...
import {cleanData, cleanRemoteAuthority, extensionTelemetryLogChannelId} from 'td/platform/telemetry/common/telemetryUtils';
