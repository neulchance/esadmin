...
import {FileSystemError} from 'td/workbench/api/common/extHostTypes';
...
import {ResourceQueue} from 'td/base/common/async';
import {IExtUri, extUri, extUriIgnorePathCase} from 'td/base/common/resources';
