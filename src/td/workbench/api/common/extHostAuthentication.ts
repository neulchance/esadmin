...
import { IMainContext, MainContext, MainThreadAuthenticationShape, ExtHostAuthenticationShape } from 'td/workbench/api/common/extHost.protocol';
import { Disposable } from 'td/workbench/api/common/extHostTypes';
import { IExtensionDescription, ExtensionIdentifier } from 'td/platform/extensions/common/extensions';
