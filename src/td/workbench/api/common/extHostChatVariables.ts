...
import { ExtHostChatVariablesShape, IMainContext, MainContext, MainThreadChatVariablesShape } from 'td/workbench/api/common/extHost.protocol';
...
import { ChatVariable } from 'td/workbench/api/common/extHostTypeConverters';
