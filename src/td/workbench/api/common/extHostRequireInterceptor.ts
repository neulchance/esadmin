...
import {IExtensionApiFactory, IExtensionRegistries} from 'td/workbench/api/common/extHost.api.impl';
...
import {ExtensionPaths, IExtHostExtensionService} from 'td/workbench/api/common/extHostExtensionService';
