...
import {asArray, coalesce, isNonEmptyArray} from 'td/base/common/arrays';
import {VSBuffer, encodeBase64} from 'td/base/common/buffer';
import {IDataTransferFile, IDataTransferItem, UriList} from 'td/base/common/dataTransfer';
import {createSingleCallFunction} from 'td/base/common/functional';
import * as htmlContent from 'td/base/common/htmlContent';
import {DisposableStore} from 'td/base/common/lifecycle';
import {ResourceMap, ResourceSet} from 'td/base/common/map';
import {marked} from 'td/base/common/marked/marked';
import {parse, revive} from 'td/base/common/marshalling';
import {Mimes} from 'td/base/common/mime';
import {cloneAndChange} from 'td/base/common/objects';
import {isEmptyObject, isNumber, isString, isUndefinedOrNull} from 'td/base/common/types';
import {URI, UriComponents, isUriComponents} from 'td/base/common/uri';
import {IURITransformer} from 'td/base/common/uriIpc';
import {RenderLineNumbersType} from 'td/editor/common/config/editorOptions';
import {IPosition} from 'td/editor/common/core/position';
import * as editorRange from 'td/editor/common/core/range';
import {ISelection} from 'td/editor/common/core/selection';
import {IContentDecorationRenderOptions, IDecorationOptions, IDecorationRenderOptions, IThemeDecorationRenderOptions} from 'td/editor/common/editorCommon';
import * as encodedTokenAttributes from 'td/editor/common/encodedTokenAttributes';
import * as languageSelector from 'td/editor/common/languageSelector';
import * as languages from 'td/editor/common/languages';
import {EndOfLineSequence, TrackedRangeStickiness} from 'td/editor/common/model';
...
import {IMarkerData, IRelatedInformation, MarkerSeverity, MarkerTag} from 'td/platform/markers/common/markers';
import {ProgressLocation as MainProgressLocation} from 'td/platform/progress/common/progress';
import * as extHostProtocol from 'td/workbench/api/common/extHost.protocol';
import {getPrivateApiFor} from 'td/workbench/api/common/extHostTestingPrivateApi';
import {DEFAULT_EDITOR_ASSOCIATION, SaveReason} from 'td/workbench/common/editor';
import {IViewBadge} from 'td/workbench/common/views';
import {IChatAgentRequest} from 'td/workbench/contrib/chat/common/chatAgents';
import * as chatProvider from 'td/workbench/contrib/chat/common/chatProvider';
import {IChatFollowup, IChatReplyFollowup, IChatResponseCommandFollowup} from 'td/workbench/contrib/chat/common/chatService';
import {IChatRequestVariableValue} from 'td/workbench/contrib/chat/common/chatVariables';
import {InlineChatResponseFeedbackKind} from 'td/workbench/contrib/inlineChat/common/inlineChat';
import * as notebooks from 'td/workbench/contrib/notebook/common/notebookCommon';
import {ICellRange} from 'td/workbench/contrib/notebook/common/notebookRange';
import * as search from 'td/workbench/contrib/search/common/search';
import {TestId, TestPosition} from 'td/workbench/contrib/testing/common/testId';
import {CoverageDetails, DetailType, ICoveredCount, IFileCoverage, ISerializedTestResults, ITestErrorMessage, ITestItem, ITestTag, TestMessageType, TestResultItem, denamespaceTestTag, namespaceTestTag} from 'td/workbench/contrib/testing/common/testTypes';
import {EditorGroupColumn} from 'td/workbench/services/editor/common/editorGroupColumn';
import {ACTIVE_GROUP, SIDE_GROUP} from 'td/workbench/services/editor/common/editorService';
