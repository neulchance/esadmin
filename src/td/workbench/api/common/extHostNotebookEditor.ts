...
import { MainThreadNotebookEditorsShape } from 'td/workbench/api/common/extHost.protocol';
import * as extHostConverter from 'td/workbench/api/common/extHostTypeConverters';
