...
import { MainContext, MainThreadTaskShape, ExtHostTaskShape } from 'td/workbench/api/common/extHost.protocol';
import * as types from 'td/workbench/api/common/extHostTypes';
import { IExtHostWorkspaceProvider, IExtHostWorkspace } from 'td/workbench/api/common/extHostWorkspace';
...
import { IExtHostConfiguration } from 'td/workbench/api/common/extHostConfiguration';
...
import { USER_TASKS_GROUP_KEY } from 'td/workbench/contrib/tasks/common/tasks';
import { ErrorNoTelemetry, NotSupportedError } from 'td/base/common/errors';
