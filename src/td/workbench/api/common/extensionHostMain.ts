...
import {RPCProtocol} from 'td/workbench/services/extensions/common/rpcProtocol';
import {ExtensionIdentifier, IExtensionDescription, IRelaxedExtensionDescription} from 'td/platform/extensions/common/extensions';
