...
import {ExtHostDocumentSaveParticipantShape, IWorkspaceEditDto, MainThreadBulkEditsShape} from 'td/workbench/api/common/extHost.protocol';
import {TextEdit} from 'td/workbench/api/common/extHostTypes';
import {Range, TextDocumentSaveReason, EndOfLine} from 'td/workbench/api/common/extHostTypeConverters';
