...
import {EditorInputCapabilities, Verbosity, GroupIdentifier, ISaveOptions, IRevertOptions, IMoveResult, IEditorDescriptor, IEditorPane, IUntypedEditorInput, EditorResourceAccessor, AbstractEditorInput, isEditorInput, IEditorIdentifier} from 'td/workbench/common/editor';
import {isEqual} from 'td/base/common/resources';
import {ConfirmResult} from 'td/platform/dialogs/common/dialogs';
