...
import {$, addDisposableListener, append, EventType, getWindow, getWindowId, hide, show} from 'td/base/browser/dom';
...
import {isMacintosh, isWindows, isLinux, isNative, isBigSurOrNewer} from 'td/base/common/platform';
import {IMenuService, MenuId} from 'td/platform/actions/common/actions';
import {BrowserTitlebarPart as BrowserTitlebarPart, BrowserTitleService, IAuxiliaryTitlebarPart} from 'td/workbench/browser/parts/titlebar/titlebarPart';
...
import {getTitleBarStyle, useWindowControlsOverlay} from 'td/platform/window/common/window';
import {IInstantiationService} from 'td/platform/instantiation/common/instantiation';
import {Codicon} from 'td/base/common/codicons';
import {ThemeIcon} from 'td/base/common/themables';
import {NativeMenubarControl} from 'td/workbench/electron-sandbox/parts/titlebar/menubarControl';
