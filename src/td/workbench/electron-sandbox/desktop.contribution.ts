...
import {ConfigureRuntimeArgumentsAction, ToggleDevToolsAction, ReloadWindowWithExtensionsDisabledAction, OpenUserDataFolderAction} from 'td/workbench/electron-sandbox/actions/developerActions';
import {ZoomResetAction, ZoomOutAction, ZoomInAction, CloseWindowAction, SwitchWindowAction, QuickSwitchWindowAction, NewWindowTabHandler, ShowPreviousWindowTabHandler, ShowNextWindowTabHandler, MoveWindowTabToNewWindowHandler, MergeWindowTabsHandlerHandler, ToggleWindowTabsBarHandler} from 'td/workbench/electron-sandbox/actions/windowActions';
...
import {IsMacContext} from 'td/platform/contextkey/common/contextkeys';
...
import {InstallShellScriptAction, UninstallShellScriptAction} from 'td/workbench/electron-sandbox/actions/installActions';
import {EditorsVisibleContext, SingleEditorGroupsContext} from 'td/workbench/common/contextkeys';
import {TELEMETRY_SETTING_ID} from 'td/platform/telemetry/common/telemetry';
import {IConfigurationService} from 'td/platform/configuration/common/configuration';
import {ShutdownReason} from 'td/workbench/services/lifecycle/common/lifecycle';
import {NativeWindow} from 'td/workbench/electron-sandbox/window';
import {ModifierKeyEmitter} from 'td/base/browser/dom';
import {applicationConfigurationNodeBase, securityConfigurationNodeBase} from 'td/workbench/common/configuration';
import {MAX_ZOOM_LEVEL, MIN_ZOOM_LEVEL} from 'td/platform/window/electron-sandbox/window';
