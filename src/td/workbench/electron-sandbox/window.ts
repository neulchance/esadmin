...
import {EventType, EventHelper, addDisposableListener, ModifierKeyEmitter, getActiveElement, hasWindow, getWindow, getWindowById, getWindowId, getWindows} from 'td/base/browser/dom';
import {Action, Separator, WorkbenchActionExecutedClassification, WorkbenchActionExecutedEvent} from 'td/base/common/actions';
import {IFileService} from 'td/platform/files/common/files';
import {EditorResourceAccessor, IUntitledTextResourceEditorInput, SideBySideEditor, pathsToEditors, IResourceDiffEditorInput, IUntypedEditorInput, IEditorPane, isResourceEditorInput, IResourceMergeEditorInput} from 'td/workbench/common/editor';
...
import {WindowMinimumSize, IOpenFileRequest, getTitleBarStyle, IAddFoldersRequest, INativeRunActionInWindowRequest, INativeRunKeybindingInWindowRequest, INativeOpenFileRequest} from 'td/platform/window/common/window';
import {ITitleService} from 'td/workbench/services/title/browser/titleService';
import {IWorkbenchThemeService} from 'td/workbench/services/themes/common/workbenchThemeService';
import {ApplyZoomTarget, applyZoom} from 'td/platform/window/electron-sandbox/window';
import {setFullscreen, getZoomLevel, onDidChangeZoomLevel, getZoomFactor} from 'td/base/browser/browser';
import {ICommandService, CommandsRegistry} from 'td/platform/commands/common/commands';
import {IResourceEditorInput} from 'td/platform/editor/common/editor';
import {ipcRenderer, process} from 'td/base/parts/sandbox/electron-sandbox/globals';
import {IWorkspaceEditingService} from 'td/workbench/services/workspaces/common/workspaceEditing';
import {IMenuService, MenuId, IMenu, MenuItemAction, MenuRegistry} from 'td/platform/actions/common/actions';
import {ICommandAction} from 'td/platform/action/common/action';
import {createAndFillInActionBarActions} from 'td/platform/actions/browser/menuEntryActionViewItem';
import {RunOnceScheduler} from 'td/base/common/async';
import {Disposable, DisposableStore, MutableDisposable, toDisposable} from 'td/base/common/lifecycle';
import {LifecyclePhase, ILifecycleService, WillShutdownEvent, ShutdownReason, BeforeShutdownErrorEvent, BeforeShutdownEvent} from 'td/workbench/services/lifecycle/common/lifecycle';
import {IWorkspaceFolderCreationData} from 'td/platform/workspaces/common/workspaces';
import {IIntegrityService} from 'td/workbench/services/integrity/common/integrity';
import {isWindows, isMacintosh, isCI} from 'td/base/common/platform';
import {IProductService} from 'td/platform/product/common/productService';
import {INotificationService, NeverShowAgainScope, NotificationPriority, Severity} from 'td/platform/notification/common/notification';
...
import {WorkbenchState, IWorkspaceContextService} from 'td/platform/workspace/common/workspace';
import {coalesce} from 'td/base/common/arrays';
import {ConfigurationTarget, IConfigurationService} from 'td/platform/configuration/common/configuration';
...
import {IOpenerService, OpenOptions} from 'td/platform/opener/common/opener';
import {Schemas} from 'td/base/common/network';
import {INativeHostService} from 'td/platform/native/common/native';
import {posix} from 'td/base/common/path';
import {ITunnelService, extractLocalHostUriMetaDataForPortMapping} from 'td/platform/tunnel/common/tunnel';
import {IWorkbenchLayoutService, Parts, positionFromString, Position} from 'td/workbench/services/layout/browser/layoutService';
import {IWorkingCopyService} from 'td/workbench/services/workingCopy/common/workingCopyService';
import {WorkingCopyCapabilities} from 'td/workbench/services/workingCopy/common/workingCopy';
...
import {IAddressProvider, IAddress} from 'td/platform/remote/common/remoteAgentConnection';
...
import {AuthInfo} from 'td/base/parts/sandbox/electron-sandbox/electronTypes';
import {ILogService} from 'td/platform/log/common/log';
import {IInstantiationService} from 'td/platform/instantiation/common/instantiation';
import {whenEditorClosed} from 'td/workbench/browser/editor';
...
import {dirname} from 'td/base/common/resources';
...
import {registerWindowDriver} from 'td/workbench/services/driver/electron-sandbox/driver';
import {mainWindow} from 'td/base/browser/window';
import {BaseWindow} from 'td/workbench/browser/window';
import {IHostService} from 'td/workbench/services/host/browser/host';
import {IStatusbarService, ShowTooltipCommand, StatusbarAlignment} from 'td/workbench/services/statusbar/browser/statusbar';
...
export class NativeWindow extends BaseWindow {
	...
	private registerListeners(): void {
		...
		if (isMacintosh && getTitleBarStyle(this.configurationService) === 'custom') {
			this._register(Event.runAndSubscribe(this.layoutService.onDidAddContainer, ({container, disposables}) => {
				...
				const targetWindowId = targetWindow.tddevWindowId;
	...
	private create(): void {
		...
		for (const {window, disposables} of getWindows()) {
			this.createWindowZoomStatusEntry(this.instantiationService, window.tddevWindowId, disposables);
		}
	...
	private handleOnDidChangeZoomLevel(targetWindowId: number): void {
		...
		if (targetWindowId === mainWindow.tddevWindowId) {
