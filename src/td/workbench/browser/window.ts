...
import {isSafari, setFullscreen} from 'td/base/browser/browser';
import {addDisposableListener, detectFullscreen, EventHelper, EventType, getActiveWindow, getWindow, getWindowById, getWindows, getWindowsCount, windowOpenNoOpener, windowOpenPopup, windowOpenWithSuccess} from 'td/base/browser/dom';
import {DomEmitter} from 'td/base/browser/event';
import {HidDeviceData, requestHidDevice, requestSerialPort, requestUsbDevice, SerialPortData, UsbDeviceData} from 'td/base/browser/deviceAccess';
import {timeout} from 'td/base/common/async';
import {Event} from 'td/base/common/event';
import {Disposable, IDisposable, dispose, toDisposable} from 'td/base/common/lifecycle';
import {matchesScheme, Schemas} from 'td/base/common/network';
import {isIOS, isMacintosh} from 'td/base/common/platform';
...
import {BrowserLifecycleService} from 'td/workbench/services/lifecycle/browser/lifecycleService';
import {ILifecycleService, ShutdownReason} from 'td/workbench/services/lifecycle/common/lifecycle';
import {IHostService} from 'td/workbench/services/host/browser/host';
import {registerWindowDriver} from 'td/workbench/services/driver/browser/driver';
import {DevWindow, isAuxiliaryWindow, mainWindow} from 'td/base/browser/window';
...
export abstract class BaseWindow extends Disposable {
	...
	constructor(
		...
		this.registerFullScreenListeners(targetWindow.tddevWindowId);
	}

	//#region focus handling in multi-window applications

	protected enableWindowFocusOnElementFocus(targetWindow: DevWindow): void {
