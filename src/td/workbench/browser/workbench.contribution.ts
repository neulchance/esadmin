...
import {isMacintosh, isWindows, isLinux, isWeb} from 'td/base/common/platform';
import {ConfigurationMigrationWorkbenchContribution, DynamicWorkbenchSecurityConfiguration, IConfigurationMigrationRegistry, workbenchConfigurationNodeBase, Extensions, ConfigurationKeyValuePairs, problemsConfigurationNodeBase} from 'td/workbench/common/configuration';
import {isStandalone} from 'td/base/browser/browser';
import {WorkbenchPhase, registerWorkbenchContribution2} from 'td/workbench/common/contributions';
import {ActivityBarPosition, EditorActionsLocation, EditorTabsMode, LayoutSettings} from 'td/workbench/services/layout/browser/layoutService';
import {defaultWindowTitle, defaultWindowTitleSeparator} from 'td/workbench/browser/parts/titlebar/windowTitle';
