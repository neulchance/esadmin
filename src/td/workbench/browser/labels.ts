...
import {dirname, isEqual, basenameOrAuthority} from 'td/base/common/resources';
import {IconLabel, IIconLabelValueOptions, IIconLabelCreationOptions} from 'td/base/browser/ui/iconLabel/iconLabel';
...
import {IDecoration, IDecorationsService, IResourceDecorationChangeEvent} from 'td/workbench/services/decorations/common/decorations';
import {Schemas} from 'td/base/common/network';
import {FileKind, FILES_ASSOCIATIONS_CONFIG} from 'td/platform/files/common/files';
...
import {Disposable, dispose, IDisposable, MutableDisposable} from 'td/base/common/lifecycle';
