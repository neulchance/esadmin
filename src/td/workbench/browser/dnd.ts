...
import {DragAndDropObserver, EventType, addDisposableListener, onDidRegisterWindow} from 'td/base/browser/dom';
import {DragMouseEvent} from 'td/base/browser/mouseEvent';
import {IListDragAndDrop} from 'td/base/browser/ui/list/list';
import {ElementsDragAndDropData, ListViewTargetSector} from 'td/base/browser/ui/list/listView';
import {ITreeDragOverReaction} from 'td/base/browser/ui/tree/tree';
import {coalesce} from 'td/base/common/arrays';
import {UriList, VSDataTransfer} from 'td/base/common/dataTransfer';
import {Emitter, Event} from 'td/base/common/event';
import {Disposable, DisposableStore, IDisposable, markAsSingleton} from 'td/base/common/lifecycle';
import {stringify} from 'td/base/common/marshalling';
...
import {basename, isEqual} from 'td/base/common/resources';
import {URI} from 'td/base/common/uri';
import {CodeDataTransfers, Extensions, IDragAndDropContributionRegistry, IDraggedResourceEditorInput, IResourceStat, LocalSelectionTransfer, createDraggedEditorInputFromRawResourcesData, extractEditorsAndFilesDropData} from 'td/platform/dnd/browser/dnd';
...
import {extractSelection} from 'td/platform/opener/common/opener';
import {Registry} from 'td/platform/registry/common/platform';
import {IWindowOpenable} from 'td/platform/window/common/window';
import {IWorkspaceContextService, hasWorkspaceFileExtension, isTemporaryWorkspace} from 'td/platform/workspace/common/workspace';
import {IWorkspaceFolderCreationData, IWorkspacesService} from 'td/platform/workspaces/common/workspaces';
import {EditorResourceAccessor, GroupIdentifier, IEditorIdentifier, isEditorIdentifier, isResourceDiffEditorInput, isResourceMergeEditorInput, isResourceSideBySideEditorInput} from 'td/workbench/common/editor';
// import {/* IEditorGroup */any} from 'td/workbench/services/editor/common/editorGroupsService';
...
import {BroadcastDataChannel} from 'td/base/browser/broadcast';
...
export class ResourcesDropHandler {
	...
	async handleDrop(event: DragEvent, targetWindow: Window, resolveTargetGroup?: () => /* IEditorGroup */any | undefined, afterDrop?: (targetGroup: /* IEditorGroup */any | undefined) => void, options?: IEditorOptions): Promise<void> {
