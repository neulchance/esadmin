...
import {ITelemetryData} from 'td/platform/telemetry/common/telemetry';
import {IWorkspaceContextService, WorkbenchState, IWorkspaceFolder, hasWorkspaceFileExtension} from 'td/platform/workspace/common/workspace';
...
import {ADD_ROOT_FOLDER_COMMAND_ID, ADD_ROOT_FOLDER_LABEL, PICK_WORKSPACE_FOLDER_COMMAND_ID, SET_ROOT_FOLDER_COMMAND_ID} from 'td/workbench/browser/actions/workspaceCommands';
import {IFileDialogService} from 'td/platform/dialogs/common/dialogs';
import {MenuRegistry, MenuId, Action2, registerAction2} from 'td/platform/actions/common/actions';
import {EmptyWorkspaceSupportContext, EnterMultiRootWorkspaceSupportContext, OpenFolderWorkspaceSupportContext, WorkbenchStateContext, WorkspaceFolderCountContext} from 'td/workbench/common/contextkeys';
