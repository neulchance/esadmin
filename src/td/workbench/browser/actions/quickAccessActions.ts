...
import {KeybindingsRegistry, KeybindingWeight, IKeybindingRule} from 'td/platform/keybinding/common/keybindingsRegistry';
...
import {inQuickPickContext, defaultQuickAccessContext, getQuickNavigateHandler} from 'td/workbench/browser/quickaccess';
import {ILocalizedString} from 'td/platform/action/common/action';
import {AnythingQuickAccessProviderRunOptions} from 'td/platform/quickinput/common/quickAccess';
