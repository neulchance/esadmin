...
import {hasWorkspaceFileExtension, IWorkspaceContextService} from 'td/platform/workspace/common/workspace';
...
import {IQuickInputService, IPickOptions, IQuickPickItem} from 'td/platform/quickinput/common/quickInput';
...
import {IFileDialogService, IPickAndOpenOptions} from 'td/platform/dialogs/common/dialogs';
import {URI, UriComponents} from 'td/base/common/uri';
import {Schemas} from 'td/base/common/network';
import {IOpenEmptyWindowOptions, IOpenWindowOptions, IWindowOpenable} from 'td/platform/window/common/window';
import {IRecent, IWorkspacesService} from 'td/platform/workspaces/common/workspaces';
