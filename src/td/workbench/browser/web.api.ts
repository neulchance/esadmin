...
import type {PerformanceMark} from 'td/base/common/performance';
import type {UriComponents, URI} from 'td/base/common/uri';
import type {IWebSocketFactory} from 'td/platform/remote/browser/browserSocketFactory';
import type {IURLCallbackProvider} from 'td/workbench/services/url/browser/urlService';
import type {LogLevel} from 'td/platform/log/common/log';
import type {IUpdateProvider} from 'td/workbench/services/update/browser/updateService';
import type {Event} from 'td/base/common/event';
import type {IProductConfiguration} from 'td/base/common/product';
import type {ISecretStorageProvider} from 'td/platform/secrets/common/secrets';
import type {TunnelProviderFeatures} from 'td/platform/tunnel/common/tunnel';
import type {IProgress, IProgressCompositeOptions, IProgressDialogOptions, IProgressNotificationOptions, IProgressOptions, IProgressStep, IProgressWindowOptions} from 'td/platform/progress/common/progress';
import type {ITextEditorOptions} from 'td/platform/editor/common/editor';
import type {IFolderToOpen, IWorkspaceToOpen} from 'td/platform/window/common/window';
// import type {EditorGroupLayout} from 'td/workbench/services/editor/common/editorGroupsService';
// import type {IEmbedderTerminalOptions} from 'td/workbench/services/terminal/common/embedderTerminalService';
// import type {IAuthenticationProvider} from 'td/workbench/services/authentication/common/authentication';
...
export interface IWorkbench {
	...
	window: {
		 ...
		 */
		createTerminal(options: /* IEmbedderTerminalOptions */any): Promise<void>;
	};
...
export interface IWorkbenchConstructionOptions {
	 ...
	 */
	readonly authenticationProviders?: readonly /* IAuthenticationProvider */any[];
