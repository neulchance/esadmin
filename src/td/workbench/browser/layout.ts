...
import {Disposable, DisposableMap, DisposableStore, IDisposable, toDisposable} from 'td/base/common/lifecycle';
import {Event, Emitter} from 'td/base/common/event';
import {EventType, addDisposableListener, getClientArea, position, size, IDimension, isAncestorUsingFlowTo, computeScreenAwareSize, getActiveDocument, getWindows, getActiveWindow, focusWindow, isActiveDocument, getWindow, getWindowId, getActiveElement} from 'td/base/browser/dom';
import {onDidChangeFullscreen, isFullscreen, isWCOEnabled} from 'td/base/browser/browser';
import {IWorkingCopyBackupService} from 'td/workbench/services/workingCopy/common/workingCopyBackup';
import {isWindows, isLinux, isMacintosh, isWeb, isNative, isIOS} from 'td/base/common/platform';
import {EditorInputCapabilities, GroupIdentifier, isResourceEditorInput, IUntypedEditorInput, pathsToEditors} from 'td/workbench/common/editor';
...
import {StartupKind, ILifecycleService} from 'td/workbench/services/lifecycle/common/lifecycle';
import {getTitleBarStyle, getMenuBarVisibility, IPath} from 'td/platform/window/common/window';
...
import {isCodeEditor} from 'td/editor/browser/editorBrowser';
...
import {LineNumbersType} from 'td/editor/common/config/editorOptions';
