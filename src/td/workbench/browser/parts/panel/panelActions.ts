...
import {MenuId, MenuRegistry, registerAction2, Action2, IAction2Options} from 'td/platform/actions/common/actions';
import {Categories} from 'td/platform/action/common/actionCommonCategories';
import {IWorkbenchLayoutService, PanelAlignment, Parts, Position, positionToString} from 'td/workbench/services/layout/browser/layoutService';
import {AuxiliaryBarVisibleContext, PanelAlignmentContext, PanelMaximizedContext, PanelPositionContext, PanelVisibleContext} from 'td/workbench/common/contextkeys';
...
import {ViewContainerLocationToString, ViewContainerLocation, IViewDescriptorService, IViewsService} from 'td/workbench/common/views';
