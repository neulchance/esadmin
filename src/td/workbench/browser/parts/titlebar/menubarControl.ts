...
import 'td/css!./media/menubarControl';
import {localize, localize2} from 'td/nls';
import {IMenuService, MenuId, IMenu, SubmenuItemAction, registerAction2, Action2, MenuItemAction, MenuRegistry} from 'td/platform/actions/common/actions';
import {MenuBarVisibility, getTitleBarStyle, IWindowOpenable, getMenuBarVisibility} from 'td/platform/window/common/window';
import {IContextKeyService} from 'td/platform/contextkey/common/contextkey';
import {IAction, Action, SubmenuAction, Separator, IActionRunner, ActionRunner, WorkbenchActionExecutedEvent, WorkbenchActionExecutedClassification, toAction} from 'td/base/common/actions';
import {addDisposableListener, Dimension, EventType} from 'td/base/browser/dom';
import {IKeybindingService} from 'td/platform/keybinding/common/keybinding';
import {isMacintosh, isWeb, isIOS, isNative} from 'td/base/common/platform';
...
import {IRecentlyOpened, isRecentFolder, IRecent, isRecentWorkspace, IWorkspacesService} from 'td/platform/workspaces/common/workspaces';
...
import {MenuBar, IMenuBarOptions} from 'td/base/browser/ui/menu/menubar';
import {Direction} from 'td/base/browser/ui/menu/menu';
import {mnemonicMenuLabel, unmnemonicLabel} from 'td/base/common/labels';
import {IAccessibilityService} from 'td/platform/accessibility/common/accessibility';
import {isFullscreen, onDidChangeFullscreen} from 'td/base/browser/browser';
...
import {IsMacNativeContext, IsWebContext} from 'td/platform/contextkey/common/contextkeys';
...
import {defaultMenuStyles} from 'td/platform/theme/browser/defaultStyles';
