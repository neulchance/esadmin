...
import {LayoutSettings} from 'td/workbench/services/layout/browser/layoutService';
...
import {IsAuxiliaryWindowFocusedContext} from 'td/workbench/common/contextkeys';
