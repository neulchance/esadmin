...
import 'td/css!./media/titlebarpart';
import {localize, localize2} from 'td/nls';
import {MultiWindowParts, Part} from 'td/workbench/browser/part';
import {ITitleService} from 'td/workbench/services/title/browser/titleService';
import {getZoomFactor, isWCOEnabled} from 'td/base/browser/browser';
import {MenuBarVisibility, getTitleBarStyle, getMenuBarVisibility, TitlebarStyle, hasCustomTitlebar, hasNativeTitlebar} from 'td/platform/window/common/window';
...
import {IConfigurationService, IConfigurationChangeEvent} from 'td/platform/configuration/common/configuration';
...
import {TITLE_BAR_ACTIVE_BACKGROUND, TITLE_BAR_ACTIVE_FOREGROUND, TITLE_BAR_INACTIVE_FOREGROUND, TITLE_BAR_INACTIVE_BACKGROUND, TITLE_BAR_BORDER, WORKBENCH_BACKGROUND} from 'td/workbench/common/theme';
import {isMacintosh, isWindows, isLinux, isWeb, isNative, platformLocale} from 'td/base/common/platform';
import {Color} from 'td/base/common/color';
import {EventType, EventHelper, Dimension, append, $, addDisposableListener, prepend, reset, getWindow, getWindowId, isAncestor, getActiveDocument} from 'td/base/browser/dom';
import {CustomMenubarControl} from 'td/workbench/browser/parts/titlebar/menubarControl';
...
import {Parts, IWorkbenchLayoutService, ActivityBarPosition, LayoutSettings, EditorActionsLocation, EditorTabsMode} from 'td/workbench/services/layout/browser/layoutService';
import {createActionViewItem, createAndFillInActionBarActions} from 'td/platform/actions/browser/menuEntryActionViewItem';
import {Action2, IMenu, IMenuService, MenuId, registerAction2} from 'td/platform/actions/common/actions';
...
import {CommandCenterControl} from 'td/workbench/browser/parts/titlebar/commandCenterControl';
import {IHoverDelegate} from 'td/base/browser/ui/iconLabel/iconHoverDelegate';
...
import {WorkbenchToolBar} from 'td/platform/actions/browser/toolbar';
import {ACCOUNTS_ACTIVITY_ID, GLOBAL_ACTIVITY_ID} from 'td/workbench/common/activity';
import {SimpleAccountActivityActionViewItem, SimpleGlobalActivityActionViewItem} from 'td/workbench/browser/parts/globalCompositeBar';
import {HoverPosition} from 'td/base/browser/ui/hover/hoverWidget';
import {IEditorGroupsContainer, IEditorGroupsService} from 'td/workbench/services/editor/common/editorGroupsService';
...
import {ActionsOrientation, IActionViewItem, prepareActions} from 'td/base/browser/ui/actionbar/actionbar';
import {EDITOR_CORE_NAVIGATION_COMMANDS} from 'td/workbench/browser/parts/editor/editorCommands';
import {AnchorAlignment} from 'td/base/browser/ui/contextview/contextview';
...
import {EditorCommandsContextActionRunner} from 'td/workbench/browser/parts/editor/editorTabsControl';
import {IEditorCommandsContext, IEditorPartOptionsChangeEvent, IToolbarActions} from 'td/workbench/common/editor';
import {mainWindow} from 'td/base/browser/window';
import {ACCOUNTS_ACTIVITY_TILE_ACTION, GLOBAL_ACTIVITY_TITLE_ACTION} from 'td/workbench/browser/parts/titlebar/titlebarActions';
import {IView} from 'td/base/browser/ui/grid/grid';
