...
import {MenuBarVisibility, getTitleBarStyle, getMenuBarVisibility} from 'td/platform/window/common/window';
...
import {Parts, IWorkbenchLayoutService, ActivityBarPosition, LayoutSettings} from 'td/workbench/services/layout/browser/layoutService';
