...
import {addDisposableListener, Dimension, DragAndDropObserver, EventType, getWindow, isAncestor} from 'td/base/browser/dom';
import {StandardMouseEvent} from 'td/base/browser/mouseEvent';
import {EventType as TouchEventType, Gesture} from 'td/base/browser/touch';
import {IActionViewItem} from 'td/base/browser/ui/actionbar/actionbar';
import {IBoundarySashes, Orientation} from 'td/base/browser/ui/sash/sash';
import {IPaneViewOptions, PaneView} from 'td/base/browser/ui/splitview/paneview';
...
import {combinedDisposable, DisposableStore, dispose, IDisposable, toDisposable} from 'td/base/common/lifecycle';
...
import {Action2, IAction2Options, IMenuService, ISubmenuItem, MenuId, MenuRegistry, registerAction2} from 'td/platform/actions/common/actions';
...
import {activeContrastBorder, asCssVariable} from 'td/platform/theme/common/colorRegistry';
