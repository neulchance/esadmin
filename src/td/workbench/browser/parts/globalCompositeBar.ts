...
import {ActionBar, ActionsOrientation} from 'td/base/browser/ui/actionbar/actionbar';
import {ACCOUNTS_ACTIVITY_ID, GLOBAL_ACTIVITY_ID} from 'td/workbench/common/activity';
import {IActivity, IActivityService, NumberBadge} from 'td/workbench/services/activity/common/activity';
import {IInstantiationService} from 'td/platform/instantiation/common/instantiation';
import {DisposableStore, Disposable} from 'td/base/common/lifecycle';
...
import {CompoisteBarActionViewItem, CompositeBarAction, IActivityHoverOptions, ICompositeBarActionViewItemOptions, ICompositeBarColors} from 'td/workbench/browser/parts/compositeBarActions';
...
import {Action, IAction, Separator, SubmenuAction, toAction} from 'td/base/common/actions';
import {IMenu, IMenuService, MenuId} from 'td/platform/actions/common/actions';
import {addDisposableListener, EventType, append, clearNode, hide, show, EventHelper, $, runWhenWindowIdle, getWindow} from 'td/base/browser/dom';
...
import {AnchorAlignment, AnchorAxisAlignment} from 'td/base/browser/ui/contextview/contextview';
...
import {ISecretStorageService} from 'td/platform/secrets/common/secrets';
import {AuthenticationSessionInfo, getCurrentAuthenticationSessionInfo} from 'td/workbench/services/authentication/browser/authenticationService';
import {AuthenticationSessionAccount, IAuthenticationService} from 'td/workbench/services/authentication/common/authentication';
...
import {DEFAULT_ICON} from 'td/workbench/services/userDataProfile/common/userDataProfileIcons';
import {isString} from 'td/base/common/types';
import {KeyCode} from 'td/base/common/keyCodes';
import {ACTIVITY_BAR_BADGE_BACKGROUND, ACTIVITY_BAR_BADGE_FOREGROUND} from 'td/workbench/common/theme';
