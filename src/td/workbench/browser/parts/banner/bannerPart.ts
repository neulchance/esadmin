...
import 'td/css!./media/bannerpart';
import {localize} from 'td/nls';
import {$, addDisposableListener, append, asCSSUrl, clearNode, EventType} from 'td/base/browser/dom';
...
import {IBannerItem, IBannerService} from 'td/workbench/services/banner/browser/bannerService';
...
import {BannerFocused} from 'td/workbench/common/contextkeys';
