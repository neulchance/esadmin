...
import {IActivity} from 'td/workbench/services/activity/common/activity';
import {IInstantiationService} from 'td/platform/instantiation/common/instantiation';
import {ActionBar, ActionsOrientation} from 'td/base/browser/ui/actionbar/actionbar';
import {CompositeActionViewItem, CompositeOverflowActivityAction, CompositeOverflowActivityActionViewItem, CompositeBarAction, ICompositeBar, ICompositeBarColors, IActivityHoverOptions} from 'td/workbench/browser/parts/compositeBarActions';
import {Dimension, $, addDisposableListener, EventType, EventHelper, isAncestor, getWindow} from 'td/base/browser/dom';
...
import {isUndefinedOrNull} from 'td/base/common/types';
import {IColorTheme} from 'td/platform/theme/common/themeService';
import {Emitter} from 'td/base/common/event';
import {ViewContainerLocation, IViewDescriptorService} from 'td/workbench/common/views';
import {IPaneComposite} from 'td/workbench/common/panecomposite';
import {IComposite} from 'td/workbench/common/composite';
import {CompositeDragAndDropData, CompositeDragAndDropObserver, IDraggedCompositeData, ICompositeDragAndDrop, Before2D, toggleDropEffect} from 'td/workbench/browser/dnd';
import {Gesture, EventType as TouchEventType, GestureEvent} from 'td/base/browser/touch';
