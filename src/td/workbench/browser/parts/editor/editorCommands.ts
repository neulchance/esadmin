...
import {isNumber, isObject, isString, isUndefined} from 'td/base/common/types';
import {URI, UriComponents} from 'td/base/common/uri';
import {isDiffEditor} from 'td/editor/browser/editorBrowser';
...
import {EditorResolution, IEditorOptions, IResourceEditorInput, ITextEditorOptions} from 'td/platform/editor/common/editor';
...
import {IListService, IOpenEvent} from 'td/platform/list/browser/listService';
...
import {ActiveGroupEditorsByMostRecentlyUsedQuickAccess} from 'td/workbench/browser/parts/editor/editorQuickAccess';
...
import {ActiveEditorCanSplitInGroupContext, ActiveEditorGroupEmptyContext, ActiveEditorGroupLockedContext, ActiveEditorStickyContext, MultipleEditorGroupsContext, SideBySideEditorActiveContext, TextCompareEditorActiveContext, TextCompareEditorVisibleContext} from 'td/workbench/common/contextkeys';
import {CloseDirection, EditorInputCapabilities, EditorsOrder, IEditorCommandsContext, IEditorIdentifier, IResourceDiffEditorInput, IUntitledTextResourceEditorInput, IVisibleEditorPane, isEditorIdentifier, isEditorInputWithOptionsAndGroup} from 'td/workbench/common/editor';
...
import {EditorGroupColumn, columnToEditorGroup} from 'td/workbench/services/editor/common/editorGroupColumn';
import {EditorGroupLayout, GroupDirection, GroupLocation, GroupsOrder, IEditorGroup, IEditorGroupsService, isEditorGroup, preferredSideBySideGroupDirection} from 'td/workbench/services/editor/common/editorGroupsService';
import {IEditorResolverService} from 'td/workbench/services/editor/common/editorResolverService';
import {IEditorService, SIDE_GROUP} from 'td/workbench/services/editor/common/editorService';
...
function registerOpenEditorAPICommands(): void {
	...
	// complements https://github.com/microsoft/vscode/blob/2b164efb0e6a5de3826bff62683eaeafe032284f/src/td/workbench/api/common/extHostApiCommands.ts#L373
	CommandsRegistry.registerCommand({
		id: 'vscode.open',
	...
	// complements https://github.com/microsoft/vscode/blob/2b164efb0e6a5de3826bff62683eaeafe032284f/src/td/workbench/api/common/extHostApiCommands.ts#L397
	CommandsRegistry.registerCommand({
		id: 'vscode.diff',
