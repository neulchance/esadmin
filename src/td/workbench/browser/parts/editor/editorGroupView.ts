...
import 'td/css!./media/editorgroupview';
import {EditorGroupModel, IEditorOpenOptions, IGroupModelChangeEvent, ISerializedEditorGroupModel, isGroupEditorCloseEvent, isGroupEditorOpenEvent, isSerializedEditorGroupModel} from 'td/workbench/common/editor/editorGroupModel';
import {GroupIdentifier, CloseDirection, IEditorCloseEvent, IEditorPane, SaveReason, IEditorPartOptionsChangeEvent, EditorsOrder, IVisibleEditorPane, EditorResourceAccessor, EditorInputCapabilities, IUntypedEditorInput, DEFAULT_EDITOR_ASSOCIATION, SideBySideEditor, EditorCloseContext, IEditorWillMoveEvent, IEditorWillOpenEvent, IMatchEditorOptions, GroupModelChangeKind, IActiveEditorChangeEvent, IFindEditorOptions, IToolbarActions} from 'td/workbench/common/editor';
import {ActiveEditorGroupLockedContext, ActiveEditorDirtyContext, EditorGroupEditorsCountContext, ActiveEditorStickyContext, ActiveEditorPinnedContext, ActiveEditorLastInGroupContext, ActiveEditorFirstInGroupContext, ResourceContextKey, applyAvailableEditorIds, ActiveEditorAvailableEditorIdsContext, ActiveEditorCanSplitInGroupContext, SideBySideEditorActiveContext} from 'td/workbench/common/contextkeys';
import {EditorInput} from 'td/workbench/common/editor/editorInput';
import {SideBySideEditorInput} from 'td/workbench/common/editor/sideBySideEditorInput';
import {Emitter, Relay} from 'td/base/common/event';
import {IInstantiationService} from 'td/platform/instantiation/common/instantiation';
import {Dimension, trackFocus, addDisposableListener, EventType, EventHelper, findParentWithClass, isAncestor, IDomNodePagePosition, isMouseEvent, isActiveElement, focusWindow, getWindow, getActiveElement} from 'td/base/browser/dom';
...
import {ProgressBar} from 'td/base/browser/ui/progressbar/progressbar';
import {IThemeService, Themable} from 'td/platform/theme/common/themeService';
import {editorBackground, contrastBorder} from 'td/platform/theme/common/colorRegistry';
import {EDITOR_GROUP_HEADER_TABS_BACKGROUND, EDITOR_GROUP_HEADER_NO_TABS_BACKGROUND, EDITOR_GROUP_EMPTY_BACKGROUND, EDITOR_GROUP_HEADER_BORDER} from 'td/workbench/common/theme';
import {ICloseEditorsFilter, GroupsOrder, ICloseEditorOptions, ICloseAllEditorsOptions, IEditorReplacement, IActiveEditorActions} from 'td/workbench/services/editor/common/editorGroupsService';
import {EditorPanes} from 'td/workbench/browser/parts/editor/editorPanes';
import {IEditorProgressService} from 'td/platform/progress/common/progress';
import {EditorProgressIndicator} from 'td/workbench/services/progress/browser/progressIndicator';
import {localize} from 'td/nls';
import {coalesce, firstOrDefault} from 'td/base/common/arrays';
import {DisposableStore, MutableDisposable, toDisposable} from 'td/base/common/lifecycle';
import {ITelemetryService} from 'td/platform/telemetry/common/telemetry';
import {DeferredPromise, Promises, RunOnceWorker} from 'td/base/common/async';
import {EventType as TouchEventType, GestureEvent} from 'td/base/browser/touch';
import {IEditorGroupsView, IEditorGroupView, fillActiveEditorViewState, EditorServiceImpl, IEditorGroupTitleHeight, IInternalEditorOpenOptions, IInternalMoveCopyOptions, IInternalEditorCloseOptions, IInternalEditorTitleControlOptions, IEditorPartsView} from 'td/workbench/browser/parts/editor/editor';
...
import {IAction, SubmenuAction} from 'td/base/common/actions';
...
import {getMimeTypes} from 'td/editor/common/services/languagesAssociations';
import {extname, isEqual} from 'td/base/common/resources';
import {Schemas} from 'td/base/common/network';
import {EditorActivation, IEditorOptions} from 'td/platform/editor/common/editor';
import {IFileDialogService, ConfirmResult} from 'td/platform/dialogs/common/dialogs';
import {IFilesConfigurationService, AutoSaveMode} from 'td/workbench/services/filesConfiguration/common/filesConfigurationService';
import {URI} from 'td/base/common/uri';
import {IUriIdentityService} from 'td/platform/uriIdentity/common/uriIdentity';
import {isLinux, isMacintosh, isNative, isWindows} from 'td/base/common/platform';
import {ILogService} from 'td/platform/log/common/log';
import {TelemetryTrustedValue} from 'td/platform/telemetry/common/telemetryUtils';
import {defaultProgressBarStyles} from 'td/platform/theme/browser/defaultStyles';
import {IBoundarySashes} from 'td/base/browser/ui/sash/sash';
import {EditorGroupWatermark} from 'td/workbench/browser/parts/editor/editorGroupWatermark';
import {EditorTitleControl} from 'td/workbench/browser/parts/editor/editorTitleControl';
