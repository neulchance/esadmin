...
import 'td/css!./media/singleeditortabscontrol';
import {EditorResourceAccessor, Verbosity, IEditorPartOptions, SideBySideEditor, preventEditorClose, EditorCloseMethod, IToolbarActions} from 'td/workbench/common/editor';
import {EditorInput} from 'td/workbench/common/editor/editorInput';
import {EditorTabsControl} from 'td/workbench/browser/parts/editor/editorTabsControl';
import {ResourceLabel, IResourceLabel} from 'td/workbench/browser/labels';
import {TAB_ACTIVE_FOREGROUND, TAB_UNFOCUSED_ACTIVE_FOREGROUND} from 'td/workbench/common/theme';
import {EventType as TouchEventType, GestureEvent, Gesture} from 'td/base/browser/touch';
import {addDisposableListener, EventType, EventHelper, Dimension, isAncestor, DragAndDropObserver} from 'td/base/browser/dom';
import {CLOSE_EDITOR_COMMAND_ID, UNLOCK_GROUP_COMMAND_ID} from 'td/workbench/browser/parts/editor/editorCommands';
import {Color} from 'td/base/common/color';
import {assertIsDefined, assertAllDefined} from 'td/base/common/types';
...
import {BreadcrumbsControlFactory} from 'td/workbench/browser/parts/editor/breadcrumbsControl';
