...
import {BreadcrumbsWidget} from 'td/base/browser/ui/breadcrumbs/breadcrumbsWidget';
...
import {IConfigurationOverrides, IConfigurationService} from 'td/platform/configuration/common/configuration';
import {Extensions, IConfigurationRegistry, ConfigurationScope} from 'td/platform/configuration/common/configurationRegistry';
...
import {GroupIdentifier, IEditorPartOptions} from 'td/workbench/common/editor';
