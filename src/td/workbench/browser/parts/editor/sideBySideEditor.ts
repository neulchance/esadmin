...
import 'td/css!./media/sidebysideeditor';
import {localize} from 'td/nls';
import {Dimension, $, clearNode, multibyteAwareBtoa} from 'td/base/browser/dom';
import {Registry} from 'td/platform/registry/common/platform';
import {IEditorControl, IEditorPane, IEditorOpenContext, EditorExtensions, SIDE_BY_SIDE_EDITOR_ID, SideBySideEditor as Side, IEditorPaneSelection, IEditorPaneWithSelection, IEditorPaneSelectionChangeEvent, isEditorPaneWithSelection, EditorPaneSelectionCompareResult} from 'td/workbench/common/editor';
...
import {IEditorPaneRegistry} from 'td/workbench/browser/editor';
...
import {SplitView, Sizing, Orientation} from 'td/base/browser/ui/splitview/splitview';
import {Event, Relay, Emitter} from 'td/base/common/event';
...
import {DEFAULT_EDITOR_MIN_DIMENSIONS} from 'td/workbench/browser/parts/editor/editor';
import {DisposableStore} from 'td/base/common/lifecycle';
import {SIDE_BY_SIDE_EDITOR_HORIZONTAL_BORDER, SIDE_BY_SIDE_EDITOR_VERTICAL_BORDER} from 'td/workbench/common/theme';
