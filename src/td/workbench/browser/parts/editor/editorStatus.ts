...
import 'td/css!./media/editorstatus';
import {localize, localize2} from 'td/nls';
import {getWindowById, runAtThisOrScheduleAtNextAnimationFrame} from 'td/base/browser/dom';
import {format, compare, splitLines} from 'td/base/common/strings';
import {extname, basename, isEqual} from 'td/base/common/resources';
import {areFunctions, assertIsDefined} from 'td/base/common/types';
...
import {IFileEditorInput, EditorResourceAccessor, IEditorPane, SideBySideEditor} from 'td/workbench/common/editor';
import {EditorInput} from 'td/workbench/common/editor/editorInput';
import {Disposable, MutableDisposable, DisposableStore} from 'td/base/common/lifecycle';
import {IEditorAction} from 'td/editor/common/editorCommon';
import {EndOfLineSequence} from 'td/editor/common/model';
import {TrimTrailingWhitespaceAction} from 'td/editor/contrib/linesOperations/browser/linesOperations';
import {IndentUsingSpaces, IndentUsingTabs, ChangeTabDisplaySize, DetectIndentation, IndentationToSpacesAction, IndentationToTabsAction} from 'td/editor/contrib/indentation/browser/indentation';
import {BaseBinaryResourceEditor} from 'td/workbench/browser/parts/editor/binaryEditor';
import {BinaryResourceDiffEditor} from 'td/workbench/browser/parts/editor/binaryDiffEditor';
import {IEditorService} from 'td/workbench/services/editor/common/editorService';
import {IFileService, FILES_ASSOCIATIONS_CONFIG} from 'td/platform/files/common/files';
import {IInstantiationService} from 'td/platform/instantiation/common/instantiation';
import {ILanguageService, ILanguageSelection} from 'td/editor/common/languages/language';
...
import {SUPPORTED_ENCODINGS} from 'td/workbench/services/textfile/common/encoding';
...
import {ICodeEditor, getCodeEditor} from 'td/editor/browser/editorBrowser';
...
import {IQuickInputService, IQuickPickItem, QuickPickInput} from 'td/platform/quickinput/common/quickInput';
import {getIconClassesForLanguageId} from 'td/editor/common/services/getIconClasses';
import {Promises, timeout} from 'td/base/common/async';
import {Emitter, Event} from 'td/base/common/event';
import {IWorkbenchContribution} from 'td/workbench/common/contributions';
import {IStatusbarEntryAccessor, IStatusbarService, StatusbarAlignment, IStatusbarEntry} from 'td/workbench/services/statusbar/browser/statusbar';
import {IMarker, IMarkerService, MarkerSeverity, IMarkerData} from 'td/platform/markers/common/markers';
...
import {AutomaticLanguageDetectionLikelyWrongClassification, AutomaticLanguageDetectionLikelyWrongId, IAutomaticLanguageDetectionLikelyWrongData, ILanguageDetectionService} from 'td/workbench/services/languageDetection/common/languageDetectionWorkerService';
...
export class EditorStatusContribution extends Disposable implements IWorkbenchContribution {
	...
	constructor(
		...
		this._register(mainInstantiationService.createInstance(EditorStatus, mainWindow.tddevWindowId));
