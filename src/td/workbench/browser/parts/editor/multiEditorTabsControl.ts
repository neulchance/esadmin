...
import 'td/css!./media/multieditortabscontrol';
import {isMacintosh, isWindows} from 'td/base/common/platform';
import {shorten} from 'td/base/common/labels';
import {EditorResourceAccessor, Verbosity, IEditorPartOptions, SideBySideEditor, DEFAULT_EDITOR_ASSOCIATION, EditorInputCapabilities, IUntypedEditorInput, preventEditorClose, EditorCloseMethod, EditorsOrder, IToolbarActions} from 'td/workbench/common/editor';
import {EditorInput} from 'td/workbench/common/editor/editorInput';
import {computeEditorAriaLabel} from 'td/workbench/browser/editor';
import {StandardKeyboardEvent} from 'td/base/browser/keyboardEvent';
import {EventType as TouchEventType, GestureEvent, Gesture} from 'td/base/browser/touch';
import {KeyCode} from 'td/base/common/keyCodes';
import {ResourceLabels, IResourceLabel, DEFAULT_LABELS_CONTAINER} from 'td/workbench/browser/labels';
...
import {EditorCommandsContextActionRunner, EditorTabsControl} from 'td/workbench/browser/parts/editor/editorTabsControl';
import {IQuickInputService} from 'td/platform/quickinput/common/quickInput';
import {IDisposable, dispose, DisposableStore, combinedDisposable, MutableDisposable, toDisposable} from 'td/base/common/lifecycle';
import {ScrollableElement} from 'td/base/browser/ui/scrollbar/scrollableElement';
import {ScrollbarVisibility} from 'td/base/common/scrollable';
import {getOrSet} from 'td/base/common/map';
import {IThemeService, registerThemingParticipant} from 'td/platform/theme/common/themeService';
import {TAB_INACTIVE_BACKGROUND, TAB_ACTIVE_BACKGROUND, TAB_ACTIVE_FOREGROUND, TAB_INACTIVE_FOREGROUND, TAB_BORDER, EDITOR_DRAG_AND_DROP_BACKGROUND, TAB_UNFOCUSED_ACTIVE_FOREGROUND, TAB_UNFOCUSED_INACTIVE_FOREGROUND, TAB_UNFOCUSED_ACTIVE_BACKGROUND, TAB_UNFOCUSED_ACTIVE_BORDER, TAB_ACTIVE_BORDER, TAB_HOVER_BACKGROUND, TAB_HOVER_BORDER, TAB_UNFOCUSED_HOVER_BACKGROUND, TAB_UNFOCUSED_HOVER_BORDER, EDITOR_GROUP_HEADER_TABS_BACKGROUND, WORKBENCH_BACKGROUND, TAB_ACTIVE_BORDER_TOP, TAB_UNFOCUSED_ACTIVE_BORDER_TOP, TAB_ACTIVE_MODIFIED_BORDER, TAB_INACTIVE_MODIFIED_BORDER, TAB_UNFOCUSED_ACTIVE_MODIFIED_BORDER, TAB_UNFOCUSED_INACTIVE_MODIFIED_BORDER, TAB_UNFOCUSED_INACTIVE_BACKGROUND, TAB_HOVER_FOREGROUND, TAB_UNFOCUSED_HOVER_FOREGROUND, EDITOR_GROUP_HEADER_TABS_BORDER, TAB_LAST_PINNED_BORDER} from 'td/workbench/common/theme';
import {activeContrastBorder, contrastBorder, editorBackground} from 'td/platform/theme/common/colorRegistry';
import {ResourcesDropHandler, DraggedEditorIdentifier, DraggedEditorGroupIdentifier, extractTreeDropData, isWindowDraggedOver} from 'td/workbench/browser/dnd';
import {Color} from 'td/base/common/color';
import {INotificationService} from 'td/platform/notification/common/notification';
import {MergeGroupMode, IMergeGroupOptions} from 'td/workbench/services/editor/common/editorGroupsService';
import {addDisposableListener, EventType, EventHelper, Dimension, scheduleAtNextAnimationFrame, findParentWithClass, clearNode, DragAndDropObserver, isMouseEvent, getWindow} from 'td/base/browser/dom';
import {localize} from 'td/nls';
import {IEditorGroupsView, EditorServiceImpl, IEditorGroupView, IInternalEditorOpenOptions, IEditorPartsView} from 'td/workbench/browser/parts/editor/editor';
import {CloseOneEditorAction, UnpinEditorAction} from 'td/workbench/browser/parts/editor/editorActions';
import {assertAllDefined, assertIsDefined} from 'td/base/common/types';
import {IEditorService} from 'td/workbench/services/editor/common/editorService';
import {basenameOrAuthority} from 'td/base/common/resources';
import {RunOnceScheduler} from 'td/base/common/async';
import {IPathService} from 'td/workbench/services/path/common/pathService';
import {IPath, win32, posix} from 'td/base/common/path';
import {coalesce, insert} from 'td/base/common/arrays';
import {isHighContrast} from 'td/platform/theme/common/theme';
import {isSafari} from 'td/base/browser/browser';
import {equals} from 'td/base/common/objects';
import {EditorActivation, IEditorOptions} from 'td/platform/editor/common/editor';
import {UNLOCK_GROUP_COMMAND_ID} from 'td/workbench/browser/parts/editor/editorCommands';
...
import {IEditorTitleControlDimensions} from 'td/workbench/browser/parts/editor/editorTitleControl';
import {StickyEditorGroupModel, UnstickyEditorGroupModel} from 'td/workbench/common/editor/filteredEditorGroupModel';
