...
import {Dimension, $, EventHelper, addDisposableGenericMouseDownListener, getWindow, isAncestorOfActiveElement, getActiveElement} from 'td/base/browser/dom';
import {Event, Emitter, Relay} from 'td/base/common/event';
import {contrastBorder, editorBackground} from 'td/platform/theme/common/colorRegistry';
import {GroupDirection, GroupsArrangement, GroupOrientation, IMergeGroupOptions, MergeGroupMode, GroupsOrder, GroupLocation, IFindGroupScope, EditorGroupLayout, GroupLayoutArgument, IEditorSideGroup, IEditorDropTargetDelegate, IEditorPart} from 'td/workbench/services/editor/common/editorGroupsService';
import {IInstantiationService} from 'td/platform/instantiation/common/instantiation';
import {IView, orthogonal, LayoutPriority, IViewSize, Direction, SerializableGrid, Sizing, ISerializedGrid, ISerializedNode, Orientation, GridBranchNode, isGridBranchNode, GridNode, createSerializedGrid, Grid} from 'td/base/browser/ui/grid/grid';
import {GroupIdentifier, EditorInputWithOptions, IEditorPartOptions, IEditorPartOptionsChangeEvent, GroupModelChangeKind} from 'td/workbench/common/editor';
import {EDITOR_GROUP_BORDER, EDITOR_PANE_BACKGROUND} from 'td/workbench/common/theme';
import {distinct, coalesce} from 'td/base/common/arrays';
import {IEditorGroupView, getEditorPartOptions, impactsEditorPartOptions, IEditorPartCreationOptions, IEditorPartsView, IEditorGroupsView} from 'td/workbench/browser/parts/editor/editor';
import {EditorGroupView} from 'td/workbench/browser/parts/editor/editorGroupView';
import {IConfigurationService, IConfigurationChangeEvent} from 'td/platform/configuration/common/configuration';
import {IDisposable, dispose, toDisposable, DisposableStore} from 'td/base/common/lifecycle';
import {IStorageService, IStorageValueChangeEvent, StorageScope, StorageTarget} from 'td/platform/storage/common/storage';
import {ISerializedEditorGroupModel, isSerializedEditorGroupModel} from 'td/workbench/common/editor/editorGroupModel';
import {EditorDropTarget} from 'td/workbench/browser/parts/editor/editorDropTarget';
import {Color} from 'td/base/common/color';
import {CenteredViewLayout} from 'td/base/browser/ui/centered/centeredViewLayout';
import {onUnexpectedError} from 'td/base/common/errors';
import {Parts, IWorkbenchLayoutService, Position} from 'td/workbench/services/layout/browser/layoutService';
import {DeepPartial, assertIsDefined, assertType} from 'td/base/common/types';
import {CompositeDragAndDropObserver} from 'td/workbench/browser/dnd';
import {DeferredPromise, Promises} from 'td/base/common/async';
import {findGroup} from 'td/workbench/services/editor/common/editorGroupFinder';
...
import {EditorPartMaximizedEditorGroupContext, EditorPartMultipleEditorGroupsContext, IsAuxiliaryEditorPartContext} from 'td/workbench/common/contextkeys';
...
export class EditorPart extends Part implements IEditorPart, IEditorGroupsView {
	...
	protected override createContentArea(parent: HTMLElement, options?: IEditorPartCreationOptions): HTMLElement {
		...
		if (this.windowId !== mainWindow.tddevWindowId) {
	...
	private handleContextKeys(contextKeyService: IContextKeyService): void {
		...
		isAuxiliaryEditorPartContext.set(this.windowId !== mainWindow.tddevWindowId);
...
export class MainEditorPart extends EditorPart {
	...
	constructor(
		...
		super(editorPartsView, Parts.EDITOR_PART, '', mainWindow.tddevWindowId, instantiationService, themeService, configurationService, storageService, layoutService, hostService, contextKeyService);
	}
}
