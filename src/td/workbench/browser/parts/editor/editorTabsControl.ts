...
import 'td/css!./media/editortabscontrol';
import {localize} from 'td/nls';
import {applyDragImage, DataTransfers} from 'td/base/browser/dnd';
import {Dimension, getActiveWindow, getWindow, isMouseEvent} from 'td/base/browser/dom';
...
import {IAction, ActionRunner} from 'td/base/common/actions';
...
import {listActiveSelectionBackground, listActiveSelectionForeground} from 'td/platform/theme/common/colorRegistry';
import {IThemeService, Themable} from 'td/platform/theme/common/themeService';
import {DraggedEditorGroupIdentifier, DraggedEditorIdentifier, fillEditorsDragData, isWindowDraggedOver} from 'td/workbench/browser/dnd';
import {EditorPane} from 'td/workbench/browser/parts/editor/editorPane';
import {IEditorGroupsView, IEditorGroupView, IEditorPartsView, IInternalEditorOpenOptions} from 'td/workbench/browser/parts/editor/editor';
import {IEditorCommandsContext, EditorResourceAccessor, IEditorPartOptions, SideBySideEditor, EditorsOrder, EditorInputCapabilities, IToolbarActions, GroupIdentifier} from 'td/workbench/common/editor';
import {EditorInput} from 'td/workbench/common/editor/editorInput';
import {ResourceContextKey, ActiveEditorPinnedContext, ActiveEditorStickyContext, ActiveEditorGroupLockedContext, ActiveEditorCanSplitInGroupContext, SideBySideEditorActiveContext, ActiveEditorFirstInGroupContext, ActiveEditorAvailableEditorIdsContext, applyAvailableEditorIds, ActiveEditorLastInGroupContext} from 'td/workbench/common/contextkeys';
...
import {LocalSelectionTransfer} from 'td/platform/dnd/browser/dnd';
...
import {IAuxiliaryEditorPart, MergeGroupMode} from 'td/workbench/services/editor/common/editorGroupsService';
