...
import {isObject, assertIsDefined} from 'td/base/common/types';
import {ICodeEditor, IDiffEditor} from 'td/editor/browser/editorBrowser';
import {IDiffEditorOptions, IEditorOptions as ICodeEditorOptions} from 'td/editor/common/config/editorOptions';
import {AbstractTextEditor, IEditorConfiguration} from 'td/workbench/browser/parts/editor/textEditor';
import {TEXT_DIFF_EDITOR_ID, IEditorFactoryRegistry, EditorExtensions, ITextDiffEditorPane, IEditorOpenContext, isEditorInput, isTextEditorViewState, createTooLargeFileError} from 'td/workbench/common/editor';
...
import {TextDiffEditorModel} from 'td/workbench/common/editor/textDiffEditorModel';
...
import {TextFileOperationError, TextFileOperationResult} from 'td/workbench/services/textfile/common/textfiles';
import {ScrollType, IDiffEditorViewState, IDiffEditorModel, IDiffEditorViewModel} from 'td/editor/common/editorCommon';
...
import {EditorActivation, ITextEditorOptions} from 'td/platform/editor/common/editor';
import {IContextKeyService} from 'td/platform/contextkey/common/contextkey';
import {isEqual} from 'td/base/common/resources';
import {Dimension, multibyteAwareBtoa} from 'td/base/browser/dom';
