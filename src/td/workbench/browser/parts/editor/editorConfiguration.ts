...
import {IConfigurationRegistry, Extensions as ConfigurationExtensions, IConfigurationNode, ConfigurationScope} from 'td/platform/configuration/common/configurationRegistry';
import {workbenchConfigurationNodeBase} from 'td/workbench/common/configuration';
import {IEditorResolverService, RegisteredEditorInfo, RegisteredEditorPriority} from 'td/workbench/services/editor/common/editorResolverService';
import {IJSONSchemaMap} from 'td/base/common/jsonSchema';
...
import {ByteSize, getLargeFileConfirmationLimit} from 'td/platform/files/common/files';
