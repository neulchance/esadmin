...
import {BreadcrumbsItem, BreadcrumbsWidget, IBreadcrumbsItemEvent, IBreadcrumbsWidgetStyles} from 'td/base/browser/ui/breadcrumbs/breadcrumbsWidget';
import {tail} from 'td/base/common/arrays';
import {timeout} from 'td/base/common/async';
import {KeyCode, KeyMod} from 'td/base/common/keyCodes';
import {combinedDisposable, DisposableStore, MutableDisposable, toDisposable} from 'td/base/common/lifecycle';
import {extUri} from 'td/base/common/resources';
...
import {IListService, WorkbenchAsyncDataTree, WorkbenchDataTree, WorkbenchListFocusContextKey} from 'td/platform/list/browser/listService';
import {IQuickInputService} from 'td/platform/quickinput/common/quickInput';
import {DEFAULT_LABELS_CONTAINER, ResourceLabels} from 'td/workbench/browser/labels';
import {BreadcrumbsConfig, IBreadcrumbsService} from 'td/workbench/browser/parts/editor/breadcrumbs';
import {BreadcrumbsModel, FileElement, OutlineElement2} from 'td/workbench/browser/parts/editor/breadcrumbsModel';
import {BreadcrumbsFilePicker, BreadcrumbsOutlinePicker, BreadcrumbsPicker} from 'td/workbench/browser/parts/editor/breadcrumbsPicker';
import {IEditorPartOptions, EditorResourceAccessor, SideBySideEditor} from 'td/workbench/common/editor';
import {ACTIVE_GROUP, ACTIVE_GROUP_TYPE, IEditorService, SIDE_GROUP, SIDE_GROUP_TYPE} from 'td/workbench/services/editor/common/editorService';
import {IEditorGroupsService} from 'td/workbench/services/editor/common/editorGroupsService';
import {IEditorGroupView} from 'td/workbench/browser/parts/editor/editor';
...
import {ITreeNode} from 'td/base/browser/ui/tree/tree';
import {IOutline} from 'td/workbench/services/outline/browser/outline';
import {registerIcon} from 'td/platform/theme/common/iconRegistry';
import {Codicon} from 'td/base/common/codicons';
import {defaultBreadcrumbsWidgetStyles} from 'td/platform/theme/browser/defaultStyles';
