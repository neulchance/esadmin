...
import 'td/css!./media/editordroptarget';
import {DataTransfers} from 'td/base/browser/dnd';
import {addDisposableListener, DragAndDropObserver, EventHelper, EventType, getWindow, isAncestor} from 'td/base/browser/dom';
...
import {activeContrastBorder} from 'td/platform/theme/common/colorRegistry';
import {IThemeService, Themable} from 'td/platform/theme/common/themeService';
import {isTemporaryWorkspace, IWorkspaceContextService} from 'td/platform/workspace/common/workspace';
import {CodeDataTransfers, containsDragType, Extensions as DragAndDropExtensions, IDragAndDropContributionRegistry, LocalSelectionTransfer} from 'td/platform/dnd/browser/dnd';
import {DraggedEditorGroupIdentifier, DraggedEditorIdentifier, extractTreeDropData, ResourcesDropHandler} from 'td/workbench/browser/dnd';
import {fillActiveEditorViewState, IEditorGroupView} from 'td/workbench/browser/parts/editor/editor';
import {EditorInputCapabilities, IEditorIdentifier, IUntypedEditorInput} from 'td/workbench/common/editor';
import {EDITOR_DRAG_AND_DROP_BACKGROUND, EDITOR_DROP_INTO_PROMPT_BACKGROUND, EDITOR_DROP_INTO_PROMPT_BORDER, EDITOR_DROP_INTO_PROMPT_FOREGROUND} from 'td/workbench/common/theme';
import {GroupDirection, IEditorDropTargetDelegate, IEditorGroup, IEditorGroupsService, IMergeGroupOptions, MergeGroupMode} from 'td/workbench/services/editor/common/editorGroupsService';
