...
import {GroupIdentifier, IWorkbenchEditorConfiguration, IEditorIdentifier, IEditorCloseEvent, IEditorPartOptions, IEditorPartOptionsChangeEvent, SideBySideEditor, EditorCloseContext, IEditorPane, IEditorPartLimitOptions, IEditorPartDecorationOptions, IEditorWillOpenEvent} from 'td/workbench/common/editor';
import {EditorInput} from 'td/workbench/common/editor/editorInput';
import {IEditorGroup, GroupDirection, IMergeGroupOptions, GroupsOrder, GroupsArrangement, IAuxiliaryEditorPart, IEditorPart} from 'td/workbench/services/editor/common/editorGroupsService';
...
import {ISerializableView} from 'td/base/browser/ui/grid/grid';
...
import {IWindowsConfiguration} from 'td/platform/window/common/window';
import {BooleanVerifier, EnumVerifier, NumberVerifier, ObjectVerifier, SetVerifier, verifyObject} from 'td/base/common/verifier';
import {IAuxiliaryWindowOpenOptions} from 'td/workbench/services/auxiliaryWindow/browser/auxiliaryWindowService';
