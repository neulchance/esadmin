...
import {IEditorIdentifier, IEditorCommandsContext, CloseDirection, SaveReason, EditorsOrder, EditorInputCapabilities, DEFAULT_EDITOR_ASSOCIATION, GroupIdentifier, EditorResourceAccessor} from 'td/workbench/common/editor';
...
import {GoFilter, IHistoryService} from 'td/workbench/services/history/common/history';
...
import {IFileDialogService, ConfirmResult, IDialogService} from 'td/platform/dialogs/common/dialogs';
import {ItemActivation, IQuickInputService} from 'td/platform/quickinput/common/quickInput';
import {AllEditorsByMostRecentlyUsedQuickAccess, ActiveGroupEditorsByMostRecentlyUsedQuickAccess, AllEditorsByAppearanceQuickAccess} from 'td/workbench/browser/parts/editor/editorQuickAccess';
...
import {isLinux, isNative, isWindows} from 'td/base/common/platform';
import {Action2, IAction2Options, MenuId} from 'td/platform/actions/common/actions';
