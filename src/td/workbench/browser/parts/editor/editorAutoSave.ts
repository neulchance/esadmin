...
import {Disposable, DisposableStore, IDisposable, dispose, toDisposable} from 'td/base/common/lifecycle';
import {IFilesConfigurationService, AutoSaveMode, AutoSaveDisabledReason} from 'td/workbench/services/filesConfiguration/common/filesConfigurationService';
import {IHostService} from 'td/workbench/services/host/browser/host';
import {SaveReason, IEditorIdentifier, GroupIdentifier, EditorInputCapabilities} from 'td/workbench/common/editor';
