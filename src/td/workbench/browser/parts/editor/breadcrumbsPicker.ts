...
import {compareFileNames} from 'td/base/common/comparers';
...
import {IDisposable, DisposableStore, MutableDisposable, Disposable} from 'td/base/common/lifecycle';
import {posix, relative} from 'td/base/common/path';
import {basename, dirname, isEqual} from 'td/base/common/resources';
import {URI} from 'td/base/common/uri';
import 'td/css!./media/breadcrumbscontrol';
import {IConfigurationService} from 'td/platform/configuration/common/configuration';
import {FileKind, IFileService, IFileStat} from 'td/platform/files/common/files';
import {IInstantiationService} from 'td/platform/instantiation/common/instantiation';
import {WorkbenchDataTree, WorkbenchAsyncDataTree} from 'td/platform/list/browser/listService';
import {breadcrumbsPickerBackground, widgetBorder, widgetShadow} from 'td/platform/theme/common/colorRegistry';
import {isWorkspace, isWorkspaceFolder, IWorkspace, IWorkspaceContextService, IWorkspaceFolder} from 'td/platform/workspace/common/workspace';
import {ResourceLabels, IResourceLabel, DEFAULT_LABELS_CONTAINER} from 'td/workbench/browser/labels';
import {BreadcrumbsConfig} from 'td/workbench/browser/parts/editor/breadcrumbs';
import {OutlineElement2, FileElement} from 'td/workbench/browser/parts/editor/breadcrumbsModel';
import {IAsyncDataSource, ITreeRenderer, ITreeNode, ITreeFilter, TreeVisibility, ITreeSorter} from 'td/base/browser/ui/tree/tree';
import {IIdentityProvider, IListVirtualDelegate, IKeyboardNavigationLabelProvider} from 'td/base/browser/ui/list/list';
...
import {IOutline, IOutlineComparator} from 'td/workbench/services/outline/browser/outline';
