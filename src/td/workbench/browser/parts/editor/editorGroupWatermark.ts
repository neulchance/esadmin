...
import {isMacintosh, isWeb, OS} from 'td/base/common/platform';
...
import {append, clearNode, $, h} from 'td/base/browser/dom';
...
import {defaultKeybindingLabelStyles} from 'td/platform/theme/browser/defaultStyles';
import {editorForeground, registerColor, transparent} from 'td/platform/theme/common/colorRegistry';
