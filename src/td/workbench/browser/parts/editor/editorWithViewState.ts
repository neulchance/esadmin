...
import {IEditorMemento, IEditorCloseEvent, IEditorOpenContext, EditorResourceAccessor, SideBySideEditor} from 'td/workbench/common/editor';
...
import {IDisposable, MutableDisposable} from 'td/base/common/lifecycle';
