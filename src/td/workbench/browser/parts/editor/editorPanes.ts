...
import {EditorExtensions, EditorInputCapabilities, IEditorOpenContext, IVisibleEditorPane, createEditorOpenError, isEditorOpenError} from 'td/workbench/common/editor';
import {EditorInput} from 'td/workbench/common/editor/editorInput';
import {Dimension, show, hide, IDomNodePagePosition, isAncestor, getWindow, getActiveElement} from 'td/base/browser/dom';
import {Registry} from 'td/platform/registry/common/platform';
import {IEditorPaneRegistry, IEditorPaneDescriptor} from 'td/workbench/browser/editor';
...
import {IDialogService, IPromptButton, IPromptCancelButton} from 'td/platform/dialogs/common/dialogs';
