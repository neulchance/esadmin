...
import {distinct, deepClone} from 'td/base/common/objects';
import {Emitter, Event} from 'td/base/common/event';
import {isObject, assertIsDefined} from 'td/base/common/types';
import {MutableDisposable} from 'td/base/common/lifecycle';
import {ICodeEditor} from 'td/editor/browser/editorBrowser';
import {IEditorOpenContext, IEditorPaneSelection, EditorPaneSelectionCompareResult, EditorPaneSelectionChangeReason, IEditorPaneWithSelection, IEditorPaneSelectionChangeEvent} from 'td/workbench/common/editor';
...
import {AbstractEditorWithViewState} from 'td/workbench/browser/parts/editor/editorWithViewState';
import {IEditorViewState} from 'td/editor/common/editorCommon';
...
import {IEditorGroupsService, IEditorGroup} from 'td/workbench/services/editor/common/editorGroupsService';
...
import {IEditorOptions, ITextEditorOptions, TextEditorSelectionRevealType, TextEditorSelectionSource} from 'td/platform/editor/common/editor';
