...
import {IEditorFactoryRegistry, EditorExtensions} from 'td/workbench/common/editor';
import {
...
import {SideBySideEditorInput, SideBySideEditorInputSerializer} from 'td/workbench/common/editor/sideBySideEditorInput';
import {TextResourceEditor} from 'td/workbench/browser/parts/editor/textResourceEditor';
import {SideBySideEditor} from 'td/workbench/browser/parts/editor/sideBySideEditor';
import {DiffEditorInput, DiffEditorInputSerializer} from 'td/workbench/common/editor/diffEditorInput';
...
import {TextDiffEditor} from 'td/workbench/browser/parts/editor/textDiffEditor';
import {BinaryResourceDiffEditor} from 'td/workbench/browser/parts/editor/binaryDiffEditor';
import {ChangeEncodingAction, ChangeEOLAction, ChangeLanguageAction, EditorStatusContribution} from 'td/workbench/browser/parts/editor/editorStatus';
import {Categories} from 'td/platform/action/common/actionCommonCategories';
import {MenuRegistry, MenuId, IMenuItem, registerAction2} from 'td/platform/actions/common/actions';
...
} from 'td/workbench/browser/parts/editor/editorActions';
import {
...
} from 'td/workbench/browser/parts/editor/editorCommands';
...
import {EditorAutoSave} from 'td/workbench/browser/parts/editor/editorAutoSave';
import {IQuickAccessRegistry, Extensions as QuickAccessExtensions} from 'td/platform/quickinput/common/quickAccess';
import {ActiveGroupEditorsByMostRecentlyUsedQuickAccess, AllEditorsByAppearanceQuickAccess, AllEditorsByMostRecentlyUsedQuickAccess} from 'td/workbench/browser/parts/editor/editorQuickAccess';
...
import {UntitledTextEditorInputSerializer, UntitledTextEditorWorkingCopyEditorHandler} from 'td/workbench/services/untitled/common/untitledTextEditorHandler';
import {DynamicEditorConfigurations} from 'td/workbench/browser/parts/editor/editorConfiguration';
import {EditorActionsDefaultAction, EditorActionsTitleBarAction, HideEditorActionsAction, HideEditorTabsAction, ShowMultipleEditorTabsAction, ShowSingleEditorTabAction, ZenHideEditorTabsAction, ZenShowMultipleEditorTabsAction, ZenShowSingleEditorTabAction} from 'td/workbench/browser/actions/layoutActions';
...
if (isMacintosh) {
	MenuRegistry.appendMenuItem(MenuId.TouchBarContext, {
		command: {id: NavigateBackwardsAction.ID, title: NavigateBackwardsAction.LABEL, icon: {dark: FileAccess.asFileUri('td/workbench/browser/parts/editor/media/back-tb.png')}},
		group: 'navigation',
		order: 0
	});

	MenuRegistry.appendMenuItem(MenuId.TouchBarContext, {
		command: {id: NavigateForwardAction.ID, title: NavigateForwardAction.LABEL, icon: {dark: FileAccess.asFileUri('td/workbench/browser/parts/editor/media/forward-tb.png')}},
		group: 'navigation',
		order: 1
	});
}
