...
import {IEditorFactoryRegistry, IEditorIdentifier, GroupIdentifier, EditorExtensions, IEditorPartOptionsChangeEvent, EditorsOrder, GroupModelChangeKind, EditorInputCapabilities} from 'td/workbench/common/editor';
...
import {dispose, Disposable, DisposableStore} from 'td/base/common/lifecycle';
...
import {IEditorGroupsService, IEditorGroup, GroupsOrder, IEditorGroupsContainer} from 'td/workbench/services/editor/common/editorGroupsService';
import {coalesce} from 'td/base/common/arrays';
import {LinkedMap, Touch, ResourceMap} from 'td/base/common/map';
import {equals} from 'td/base/common/objects';
import {IResourceEditorInputIdentifier} from 'td/platform/editor/common/editor';
