...
import 'td/css!./media/activitybarpart';
import 'td/css!./media/activityaction';
...
import {IThemeService, IColorTheme, registerThemingParticipant} from 'td/platform/theme/common/themeService';
import {ACTIVITY_BAR_BACKGROUND, ACTIVITY_BAR_BORDER, ACTIVITY_BAR_FOREGROUND, ACTIVITY_BAR_ACTIVE_BORDER, ACTIVITY_BAR_BADGE_BACKGROUND, ACTIVITY_BAR_BADGE_FOREGROUND, ACTIVITY_BAR_INACTIVE_FOREGROUND, ACTIVITY_BAR_ACTIVE_BACKGROUND, ACTIVITY_BAR_DRAG_AND_DROP_BORDER, ACTIVITY_BAR_ACTIVE_FOCUS_BORDER} from 'td/workbench/common/theme';
import {activeContrastBorder, contrastBorder, focusBorder} from 'td/platform/theme/common/colorRegistry';
import {addDisposableListener, append, EventType, isAncestor, $, clearNode} from 'td/base/browser/dom';
...
import {getMenuBarVisibility} from 'td/platform/window/common/window';
...
import {GestureEvent} from 'td/base/browser/touch';
...
import {GlobalCompositeBar} from 'td/workbench/browser/parts/globalCompositeBar';
import {IStorageService} from 'td/platform/storage/common/storage';
import {Action2, IAction2Options, IMenuService, MenuId, MenuRegistry, registerAction2} from 'td/platform/actions/common/actions';
...
import {IViewDescriptorService, ViewContainerLocation, ViewContainerLocationToString} from 'td/workbench/common/views';
import {IPaneCompositePartService} from 'td/workbench/services/panecomposite/browser/panecomposite';
import {TitleBarStyleContext} from 'td/workbench/common/contextkeys';
