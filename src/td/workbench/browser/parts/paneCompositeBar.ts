...
import {IActivityService} from 'td/workbench/services/activity/common/activity';
import {IWorkbenchLayoutService, Parts} from 'td/workbench/services/layout/browser/layoutService';
import {IInstantiationService} from 'td/platform/instantiation/common/instantiation';
import {IDisposable, DisposableStore, Disposable, DisposableMap} from 'td/base/common/lifecycle';
import {IColorTheme} from 'td/platform/theme/common/themeService';
import {CompositeBar, ICompositeBarItem, CompositeDragAndDrop} from 'td/workbench/browser/parts/compositeBar';
import {Dimension, createCSSRule, asCSSUrl, isMouseEvent} from 'td/base/browser/dom';
import {IStorageService, StorageScope, StorageTarget, IProfileStorageValueChangeEvent} from 'td/platform/storage/common/storage';
...
import {ToggleCompositePinnedAction, ICompositeBarColors, IActivityHoverOptions, ToggleCompositeBadgeAction, CompositeBarAction, ICompositeBar, ICompositeBarActionItem} from 'td/workbench/browser/parts/compositeBarActions';
import {IViewDescriptorService, ViewContainer, IViewContainerModel, ViewContainerLocation} from 'td/workbench/common/views';
import {IContextKeyService, ContextKeyExpr} from 'td/platform/contextkey/common/contextkey';
...
import {Before2D, ICompositeDragAndDrop} from 'td/workbench/browser/dnd';
import {ThemeIcon} from 'td/base/common/themables';
import {IAction, toAction} from 'td/base/common/actions';
import {StringSHA1} from 'td/base/common/hash';
