...
import 'td/css!./media/compositepart';
import {localize} from 'td/nls';
import {defaultGenerator} from 'td/base/common/idGenerator';
import {IDisposable, dispose, DisposableStore, MutableDisposable,} from 'td/base/common/lifecycle';
...
import {Part, IPartOptions} from 'td/workbench/browser/part';
import {Composite, CompositeRegistry} from 'td/workbench/browser/composite';
...
import {IProgressIndicator, IEditorProgressService} from 'td/platform/progress/common/progress';
...
import {Dimension, append, $, hide, show} from 'td/base/browser/dom';
