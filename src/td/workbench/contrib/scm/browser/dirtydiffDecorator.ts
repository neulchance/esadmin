...
import 'td/css!./media/dirtydiffDecorator';
import {ThrottledDelayer} from 'td/base/common/async';
import {IDisposable, dispose, toDisposable, Disposable, DisposableStore} from 'td/base/common/lifecycle';
import {Event, Emitter} from 'td/base/common/event';
import * as ext from 'td/workbench/common/contributions';
import {IInstantiationService} from 'td/platform/instantiation/common/instantiation';
import {IResolvedTextEditorModel, ITextModelService} from 'td/editor/common/services/resolverService';
import {IEditorWorkerService} from 'td/editor/common/services/editorWorker';
import {IConfigurationService} from 'td/platform/configuration/common/configuration';
import {URI} from 'td/base/common/uri';
import {ISCMService, ISCMRepository} from 'td/workbench/contrib/scm/common/scm';
import {ModelDecorationOptions} from 'td/editor/common/model/textModel';
import {IColorTheme, themeColorFromId, IThemeService} from 'td/platform/theme/common/themeService';
import {editorErrorForeground, registerColor, transparent} from 'td/platform/theme/common/colorRegistry';
import {ICodeEditor, IEditorMouseEvent, isCodeEditor, MouseTargetType} from 'td/editor/browser/editorBrowser';
import {registerEditorAction, registerEditorContribution, ServicesAccessor, EditorAction, EditorContributionInstantiation} from 'td/editor/browser/editorExtensions';
import {PeekViewWidget, getOuterEditor, peekViewBorder, peekViewTitleBackground, peekViewTitleForeground, peekViewTitleInfoForeground} from 'td/editor/contrib/peekView/browser/peekView';
import {IContextKeyService, IContextKey, ContextKeyExpr, RawContextKey} from 'td/platform/contextkey/common/contextkey';
...
import {rot} from 'td/base/common/numbers';
import {KeybindingsRegistry, KeybindingWeight} from 'td/platform/keybinding/common/keybindingsRegistry';
import {EmbeddedDiffEditorWidget} from 'td/editor/browser/widget/embeddedCodeEditorWidget';
import {IDiffEditorOptions, EditorOption} from 'td/editor/common/config/editorOptions';
import {Action, IAction, ActionRunner} from 'td/base/common/actions';
import {IActionBarOptions} from 'td/base/browser/ui/actionbar/actionbar';
import {IKeybindingService} from 'td/platform/keybinding/common/keybinding';
import {basename} from 'td/base/common/resources';
import {MenuId, IMenuService, IMenu, MenuItemAction, MenuRegistry} from 'td/platform/actions/common/actions';
import {createAndFillInActionBarActions} from 'td/platform/actions/browser/menuEntryActionViewItem';
import {ScrollType, IEditorContribution, IDiffEditorModel, IEditorModel, IEditorDecorationsCollection} from 'td/editor/common/editorCommon';
import {OverviewRulerLane, ITextModel, IModelDecorationOptions, MinimapPosition, shouldSynchronizeModel} from 'td/editor/common/model';
import {equals, sortedDiff} from 'td/base/common/arrays';
import {ICodeEditorService} from 'td/editor/browser/services/codeEditorService';
import {ISplice} from 'td/base/common/sequence';
import * as dom from 'td/base/browser/dom';
import {EncodingMode, ITextFileEditorModel, IResolvedTextFileEditorModel, ITextFileService, isTextFileEditorModel} from 'td/workbench/services/textfile/common/textfiles';
import {gotoNextLocation, gotoPreviousLocation} from 'td/platform/theme/common/iconRegistry';
...
import {TextCompareEditorActiveContext} from 'td/workbench/common/contextkeys';
...
import {IQuickDiffService, QuickDiff} from 'td/workbench/contrib/scm/common/quickDiff';
import {IQuickDiffSelectItem, SwitchQuickDiffBaseAction, SwitchQuickDiffViewItem} from 'td/workbench/contrib/scm/browser/dirtyDiffSwitcher';
