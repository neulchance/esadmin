...
import {promiseWithResolvers} from 'td/base/common/async';
...
import {Action2, IMenuService, MenuId, registerAction2, IMenu, MenuRegistry, MenuItemAction} from 'td/platform/actions/common/actions';
