...
import {combinedDisposable, IDisposable, DisposableStore} from 'td/base/common/lifecycle';
...
import {setSnippetSuggestSupport} from 'td/editor/contrib/suggest/browser/suggest';
import {localize} from 'td/nls';
import {IEnvironmentService} from 'td/platform/environment/common/environment';
import {FileChangeType, IFileService} from 'td/platform/files/common/files';
import {ILifecycleService, LifecyclePhase} from 'td/workbench/services/lifecycle/common/lifecycle';
import {ILogService} from 'td/platform/log/common/log';
import {IWorkspace, IWorkspaceContextService} from 'td/platform/workspace/common/workspace';
import {ISnippetGetOptions, ISnippetsService} from 'td/workbench/contrib/snippets/browser/snippets';
import {Snippet, SnippetFile, SnippetSource} from 'td/workbench/contrib/snippets/browser/snippetsFile';
import {ExtensionsRegistry, IExtensionPointUser} from 'td/workbench/services/extensions/common/extensionsRegistry';
import {languagesExtPoint} from 'td/workbench/services/language/common/languageService';
...
import {isStringArray} from 'td/base/common/types';
...
import {insertInto} from 'td/base/common/arrays';
