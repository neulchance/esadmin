...
import {extname} from 'td/base/common/path';
import {basename, joinPath} from 'td/base/common/resources';
...
import {SnippetSource} from 'td/workbench/contrib/snippets/browser/snippetsFile';
