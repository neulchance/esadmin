...
import {compare, compareSubstring} from 'td/base/common/strings';
...
import {CompletionItem, CompletionItemKind, CompletionItemProvider, CompletionList, CompletionItemInsertTextRule, CompletionContext, CompletionTriggerKind, CompletionItemLabel, Command} from 'td/editor/common/languages';
...
import {isPatternInWord} from 'td/base/common/filters';
