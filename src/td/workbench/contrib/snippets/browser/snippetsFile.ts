...
import {parse as jsonParse, getNodeType} from 'td/base/common/json';
import {localize} from 'td/nls';
import {extname, basename} from 'td/base/common/path';
import {SnippetParser, Variable, Placeholder, Text} from 'td/editor/contrib/snippet/browser/snippetParser';
import {KnownSnippetVariableNames} from 'td/editor/contrib/snippet/browser/snippetVariables';
...
import {relativePath} from 'td/base/common/resources';
...
import {WindowIdleValue, getActiveWindow} from 'td/base/browser/dom';
