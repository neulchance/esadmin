...
import {ILoggerService, LogLevel, isLogLevel} from 'td/platform/log/common/log';
...
import {dirname, basename, isEqual} from 'td/base/common/resources';
...
import {extensionTelemetryLogChannelId, telemetryLogId} from 'td/platform/telemetry/common/telemetryUtils';
