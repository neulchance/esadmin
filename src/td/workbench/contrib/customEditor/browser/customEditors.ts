...
import 'td/css!./media/customEditor';
...
import {RedoCommand, UndoCommand} from 'td/editor/browser/editorExtensions';
...
import {DEFAULT_EDITOR_ASSOCIATION, EditorExtensions, GroupIdentifier, IEditorFactoryRegistry, IResourceDiffEditorInput} from 'td/workbench/common/editor';
...
import {CONTEXT_ACTIVE_CUSTOM_EDITOR_ID, CONTEXT_FOCUSED_CUSTOM_EDITOR_IS_EDITABLE, CustomEditorCapabilities, CustomEditorInfo, CustomEditorInfoCollection, ICustomEditorService} from 'td/workbench/contrib/customEditor/common/customEditor';
import {CustomEditorModelManager} from 'td/workbench/contrib/customEditor/common/customEditorModelManager';
import {IEditorGroup, IEditorGroupsService} from 'td/workbench/services/editor/common/editorGroupsService';
import {IEditorResolverService, IEditorType, RegisteredEditorPriority} from 'td/workbench/services/editor/common/editorResolverService';
