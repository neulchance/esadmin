...
import 'td/workbench/contrib/welcomeWalkthrough/common/walkThroughUtils';
import 'td/css!./media/walkThroughPart';
...
import {IEditorMemento, IEditorOpenContext} from 'td/workbench/common/editor';
...
import {RawContextKey, IContextKey, IContextKeyService} from 'td/platform/contextkey/common/contextkey';
...
import {IEditorOptions as ICodeEditorOptions, EditorOption} from 'td/editor/common/config/editorOptions';
...
import {OS, OperatingSystem} from 'td/base/common/platform';
...
import {addDisposableListener, Dimension, getWindow, safeInnerHtml, size} from 'td/base/browser/dom';
