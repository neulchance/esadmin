...
import {DisposableStore, IReference} from 'td/base/common/lifecycle';
...
import {requireToContent} from 'td/workbench/contrib/welcomeWalkthrough/common/walkThroughContentProvider';
