...
import {dispose, IDisposable, IReference} from 'td/base/common/lifecycle';
...
import {IUndoRedoService, UndoRedoGroup, UndoRedoSource} from 'td/platform/undoRedo/common/undoRedo';
import {SingleModelEditStackElement, MultiModelEditStackElement} from 'td/editor/common/model/editStack';
