...
import {IBulkEditOptions, IBulkEditPreviewHandler, IBulkEditResult, IBulkEditService, ResourceEdit, ResourceFileEdit, ResourceTextEdit} from 'td/editor/browser/services/bulkEditService';
...
import {IProgress, IProgressStep, Progress} from 'td/platform/progress/common/progress';
import {Registry} from 'td/platform/registry/common/platform';
import {UndoRedoGroup, UndoRedoSource} from 'td/platform/undoRedo/common/undoRedo';
import {BulkCellEdits, ResourceNotebookCellEdit} from 'td/workbench/contrib/bulkEdit/browser/bulkCellEdits';
import {BulkFileEdits} from 'td/workbench/contrib/bulkEdit/browser/bulkFileEdits';
import {BulkTextEdits} from 'td/workbench/contrib/bulkEdit/browser/bulkTextEdits';
