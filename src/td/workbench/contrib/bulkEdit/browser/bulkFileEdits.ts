...
import {WorkspaceFileEditOptions} from 'td/editor/common/languages';
import {IFileService, FileSystemProviderCapabilities, IFileContent, IFileStatWithMetadata} from 'td/platform/files/common/files';
import {IProgress} from 'td/platform/progress/common/progress';
import {IConfigurationService} from 'td/platform/configuration/common/configuration';
import {IWorkingCopyFileService, IFileOperationUndoRedoInfo, IMoveOperation, ICopyOperation, IDeleteOperation, ICreateOperation, ICreateFileOperation} from 'td/workbench/services/workingCopy/common/workingCopyFileService';
import {IWorkspaceUndoRedoElement, UndoRedoElementType, IUndoRedoService, UndoRedoGroup, UndoRedoSource} from 'td/platform/undoRedo/common/undoRedo';
