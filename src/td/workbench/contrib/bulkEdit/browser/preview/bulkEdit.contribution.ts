...
import {IBulkEditService, ResourceEdit} from 'td/editor/browser/services/bulkEditService';
import {BulkEditPane} from 'td/workbench/contrib/bulkEdit/browser/preview/bulkEditPane';
import {IViewContainersRegistry, Extensions as ViewContainerExtensions, ViewContainerLocation, IViewsRegistry} from 'td/workbench/common/views';
...
import {RawContextKey, IContextKeyService, IContextKey, ContextKeyExpr} from 'td/platform/contextkey/common/contextkey';
import {IEditorGroupsService} from 'td/workbench/services/editor/common/editorGroupsService';
import {BulkEditPreviewProvider} from 'td/workbench/contrib/bulkEdit/browser/preview/bulkEditPreview';
...
import {WorkbenchListFocusContextKey} from 'td/platform/list/browser/listService';
...
import type {ServicesAccessor} from 'td/platform/instantiation/common/instantiation';
