...
import {compareFileExtensions, compareFileNames, comparePaths} from 'td/base/common/comparers';
import {memoize} from 'td/base/common/decorators';
import * as errors from 'td/base/common/errors';
import {Emitter, Event, PauseableEmitter} from 'td/base/common/event';
...
import {lcut} from 'td/base/common/strings';
import {TernarySearchTree} from 'td/base/common/ternarySearchTree';
import {URI} from 'td/base/common/uri';
import {Range} from 'td/editor/common/core/range';
import {FindMatch, IModelDeltaDecoration, ITextModel, MinimapPosition, OverviewRulerLane, TrackedRangeStickiness} from 'td/editor/common/model';
...
import {IFileService, IFileStatWithPartialMetadata} from 'td/platform/files/common/files';
...
import {minimapFindMatch, overviewRulerFindMatchForeground} from 'td/platform/theme/common/colorRegistry';
import {themeColorFromId} from 'td/platform/theme/common/themeService';
import {IUriIdentityService} from 'td/platform/uriIdentity/common/uriIdentity';
import {FindMatchDecorationModel} from 'td/workbench/contrib/notebook/browser/contrib/find/findMatchDecorationModel';
import {CellFindMatchWithIndex, CellWebviewFindMatch, ICellViewModel} from 'td/workbench/contrib/notebook/browser/notebookBrowser';
...
import {NotebookCellsChangeType} from 'td/workbench/contrib/notebook/common/notebookCommon';
import {IReplaceService} from 'td/workbench/contrib/search/browser/replace';
import {contentMatchesToTextSearchMatches, webviewMatchesToTextSearchMatches, INotebookCellMatchWithModel, isINotebookFileMatchWithModel, isINotebookCellMatchWithModel, getIDFromINotebookCellMatch} from 'td/workbench/contrib/search/browser/notebookSearch/searchNotebookHelpers';
import {INotebookSearchService} from 'td/workbench/contrib/search/common/notebookSearch';
import {rawCellPrefix, INotebookCellMatchNoModel, isINotebookFileMatchNoModel} from 'td/workbench/contrib/search/common/searchNotebookHelpers';
import {ReplacePattern} from 'td/workbench/services/search/common/replace';
import {IFileMatch, IPatternInfo, ISearchComplete, ISearchConfigurationProperties, ISearchProgressItem, ISearchRange, ISearchService, ITextQuery, ITextSearchContext, ITextSearchMatch, ITextSearchPreviewOptions, ITextSearchResult, ITextSearchStats, OneLineRange, resultIsMatch, SearchCompletionExitCode, SearchSortOrder} from 'td/workbench/services/search/common/search';
import {getTextSearchMatchWithModelContext, editorMatchesToTextSearchResults} from 'td/workbench/services/search/common/searchHelpers';
import {CellSearchModel} from 'td/workbench/contrib/search/common/cellSearchModel';
