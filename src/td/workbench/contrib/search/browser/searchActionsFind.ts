...
import {IListService, WorkbenchCompressibleObjectTree} from 'td/platform/list/browser/listService';
...
import {FileMatch, FolderMatchWithResource, Match, RenderableMatch} from 'td/workbench/contrib/search/browser/searchModel';
import {OpenSearchEditorArgs} from 'td/workbench/contrib/searchEditor/browser/searchEditor.contribution';
import {IEditorService} from 'td/workbench/services/editor/common/editorService';
import {ISearchConfiguration, ISearchConfigurationProperties} from 'td/workbench/services/search/common/search';
...
import {resolveResourcesForSearchIncludes} from 'td/workbench/services/search/common/queryBuilder';
import {getMultiSelectedResources, IExplorerService} from 'td/workbench/contrib/files/browser/files';
...
import {ExplorerFolderContext, ExplorerRootContext, FilesExplorerFocusCondition, VIEWLET_ID as VIEWLET_ID_FILES} from 'td/workbench/contrib/files/common/files';
...
import {category, getElementsToOperateOn, getSearchView, openSearchView} from 'td/workbench/contrib/search/browser/searchActionsBase';
...
export async function findInFilesCommand(accessor: ServicesAccessor, _args: IFindInFilesArgs = {}) {
	...
	if (Object.keys(_args).length !== 0) {
		...
		// https://github.com/microsoft/vscode/blob/8b76efe9d317d50cb5b57a7658e09ce6ebffaf36/src/td/workbench/contrib/searchEditor/browser/searchEditorActions.ts#L152-L158
