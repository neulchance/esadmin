...
import {WorkbenchCompressibleObjectTree} from 'td/platform/list/browser/listService';
...
import {FileMatch, FolderMatch, Match, RenderableMatch, searchComparer} from 'td/workbench/contrib/search/browser/searchModel';
import {ISearchConfigurationProperties, VIEW_ID} from 'td/workbench/services/search/common/search';
