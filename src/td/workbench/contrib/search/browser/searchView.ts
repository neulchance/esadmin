...
import {MessageType} from 'td/base/browser/ui/inputbox/inputBox';
import {IIdentityProvider} from 'td/base/browser/ui/list/list';
import {ICompressedTreeElement} from 'td/base/browser/ui/tree/compressedObjectTreeModel';
import {ITreeContextMenuEvent, ObjectTreeElementCollapseState} from 'td/base/browser/ui/tree/tree';
import {Delayer, RunOnceScheduler} from 'td/base/common/async';
...
import * as env from 'td/base/common/platform';
import * as strings from 'td/base/common/strings';
import {URI} from 'td/base/common/uri';
import * as network from 'td/base/common/network';
import 'td/css!./media/searchview';
import {getCodeEditor, isCodeEditor, isDiffEditor} from 'td/editor/browser/editorBrowser';
import {ICodeEditorService} from 'td/editor/browser/services/codeEditorService';
import {EmbeddedCodeEditorWidget} from 'td/editor/browser/widget/embeddedCodeEditorWidget';
...
import {CommonFindController} from 'td/editor/contrib/find/browser/findController';
import {MultiCursorSelectionController} from 'td/editor/contrib/multicursor/browser/multicursor';
...
import {IConfirmation, IDialogService} from 'td/platform/dialogs/common/dialogs';
import {FileChangesEvent, FileChangeType, IFileService} from 'td/platform/files/common/files';
...
import {getSelectionKeyboardEvent, WorkbenchCompressibleObjectTree} from 'td/platform/list/browser/listService';
import {INotificationService} from 'td/platform/notification/common/notification';
import {IOpenerService, withSelection} from 'td/platform/opener/common/opener';
import {IProgress, IProgressService, IProgressStep} from 'td/platform/progress/common/progress';
...
import {defaultInputBoxStyles, defaultToggleStyles} from 'td/platform/theme/browser/defaultStyles';
import {IFileIconTheme, IThemeService} from 'td/platform/theme/common/themeService';
...
import {OpenFileFolderAction, OpenFolderAction} from 'td/workbench/browser/actions/workspaceActions';
import {ResourceListDnDHandler} from 'td/workbench/browser/dnd';
import {ResourceLabels} from 'td/workbench/browser/labels';
import {IViewPaneOptions, ViewPane} from 'td/workbench/browser/parts/views/viewPane';
...
import {NotebookEditor} from 'td/workbench/contrib/notebook/browser/notebookEditor';
import {ExcludePatternInputWidget, IncludePatternInputWidget} from 'td/workbench/contrib/search/browser/patternInputWidget';
import {appendKeyBindingLabel} from 'td/workbench/contrib/search/browser/searchActionsBase';
import {IFindInFilesArgs} from 'td/workbench/contrib/search/browser/searchActionsFind';
import {searchDetailsIcon} from 'td/workbench/contrib/search/browser/searchIcons';
import {renderSearchMessage} from 'td/workbench/contrib/search/browser/searchMessage';
import {FileMatchRenderer, FolderMatchRenderer, MatchRenderer, SearchAccessibilityProvider, SearchDelegate} from 'td/workbench/contrib/search/browser/searchResultsView';
import {SearchWidget} from 'td/workbench/contrib/search/browser/searchWidget';
import * as Constants from 'td/workbench/contrib/search/common/constants';
import {IReplaceService} from 'td/workbench/contrib/search/browser/replace';
import {getOutOfWorkspaceEditorResources, SearchStateKey, SearchUIState} from 'td/workbench/contrib/search/common/search';
import {ISearchHistoryService, ISearchHistoryValues, SearchHistoryService} from 'td/workbench/contrib/search/common/searchHistoryService';
import {FileMatch, FileMatchOrMatch, FolderMatch, FolderMatchWithResource, IChangeEvent, ISearchViewModelWorkbenchService, Match, MatchInNotebook, RenderableMatch, searchMatchComparer, SearchModel, SearchModelLocation, SearchResult} from 'td/workbench/contrib/search/browser/searchModel';
import {createEditorFromSearchResult} from 'td/workbench/contrib/searchEditor/browser/searchEditorActions';
import {ACTIVE_GROUP, IEditorService, SIDE_GROUP} from 'td/workbench/services/editor/common/editorService';
import {IPreferencesService, ISettingsEditorOptions} from 'td/workbench/services/preferences/common/preferences';
import {ITextQueryBuilderOptions, QueryBuilder} from 'td/workbench/services/search/common/queryBuilder';
import {IPatternInfo, ISearchComplete, ISearchConfiguration, ISearchConfigurationProperties, ITextQuery, SearchCompletionExitCode, SearchSortOrder, TextSearchCompleteMessageType, ViewMode} from 'td/workbench/services/search/common/search';
import {TextSearchCompleteMessage} from 'td/workbench/services/search/common/searchExtTypes';
