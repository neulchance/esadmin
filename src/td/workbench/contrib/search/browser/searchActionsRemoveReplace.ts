...
import {ITreeNavigator} from 'td/base/browser/ui/tree/tree';
...
import {searchRemoveIcon, searchReplaceIcon} from 'td/workbench/contrib/search/browser/searchIcons';
...
import {arrayContainsElementOrParent, FileMatch, FolderMatch, Match, MatchInNotebook, RenderableMatch, SearchResult} from 'td/workbench/contrib/search/browser/searchModel';
...
import {category, getElementsToOperateOn, getSearchView, shouldRefocus} from 'td/workbench/contrib/search/browser/searchActionsBase';
