...
import * as paths from 'td/base/common/path';
...
import {SearchView} from 'td/workbench/contrib/search/browser/searchView';
import {FileMatch, Match, RenderableMatch, SearchModel, FolderMatch, FolderMatchNoRoot, FolderMatchWorkspaceRoot, MatchInNotebook} from 'td/workbench/contrib/search/browser/searchModel';
...
import {ISearchActionContext} from 'td/workbench/contrib/search/browser/searchActionsRemoveReplace';
...
import {IsEditableItemKey, FileFocusKey, FolderFocusKey, MatchFocusKey} from 'td/workbench/contrib/search/common/constants';
