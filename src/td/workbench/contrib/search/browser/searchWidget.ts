...
import {Button, IButtonOptions} from 'td/base/browser/ui/button/button';
...
import {IInputBoxStyles, IMessage, InputBox} from 'td/base/browser/ui/inputbox/inputBox';
...
import {CONTEXT_FIND_WIDGET_NOT_VISIBLE} from 'td/editor/contrib/find/browser/findModel';
import * as nls from 'td/nls';
import {IClipboardService} from 'td/platform/clipboard/common/clipboardService';
import {IConfigurationService} from 'td/platform/configuration/common/configuration';
import {ContextKeyExpr, IContextKey, IContextKeyService} from 'td/platform/contextkey/common/contextkey';
...
import {ISearchConfigurationProperties} from 'td/workbench/services/search/common/search';
import {ThemeIcon} from 'td/base/common/themables';
import {ContextScopedReplaceInput} from 'td/platform/history/browser/contextScopedHistoryWidget';
import {appendKeyBindingLabel, isSearchViewFocused, getSearchView} from 'td/workbench/contrib/search/browser/searchActionsBase';
...
import {IToggleStyles, Toggle} from 'td/base/browser/ui/toggle/toggle';
import {IViewsService} from 'td/workbench/services/views/common/viewsService';
import {searchReplaceAllIcon, searchHideReplaceIcon, searchShowContextIcon, searchShowReplaceIcon} from 'td/workbench/contrib/search/browser/searchIcons';
import {ToggleSearchEditorContextLinesCommandId} from 'td/workbench/contrib/searchEditor/browser/constants';
import {showHistoryKeybindingHint} from 'td/platform/history/browser/historyWidgetKeybindingHint';
...
import {GroupModelChangeKind} from 'td/workbench/common/editor';
import {SearchFindInput} from 'td/workbench/contrib/search/browser/searchFindInput';
