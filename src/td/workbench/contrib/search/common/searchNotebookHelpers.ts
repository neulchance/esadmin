...
import {FindMatch, IReadonlyTextBuffer} from 'td/editor/common/model';
import {TextSearchMatch, IFileMatch, ITextSearchMatch} from 'td/workbench/services/search/common/search';
