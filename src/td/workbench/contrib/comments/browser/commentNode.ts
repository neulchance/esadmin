...
import {ActionsOrientation, ActionBar} from 'td/base/browser/ui/actionbar/actionbar';
import {Action, IActionRunner, IAction, Separator, ActionRunner} from 'td/base/common/actions';
...
import {LayoutableEditor, MIN_EDITOR_HEIGHT, SimpleCommentEditor, calculateEditorHeight} from 'td/workbench/contrib/comments/browser/simpleCommentEditor';
...
import {MenuItemAction, SubmenuItemAction, IMenu, MenuId} from 'td/platform/actions/common/actions';
import {MenuEntryActionViewItem, SubmenuEntryActionViewItem} from 'td/platform/actions/browser/menuEntryActionViewItem';
...
import {TimestampWidget} from 'td/workbench/contrib/comments/browser/timestamp';
...
import {Scrollable, ScrollbarVisibility} from 'td/base/common/scrollable';
