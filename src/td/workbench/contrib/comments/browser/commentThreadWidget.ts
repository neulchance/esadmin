...
import 'td/css!./media/review';
import * as dom from 'td/base/browser/dom';
import {Emitter} from 'td/base/common/event';
import {Disposable, dispose, IDisposable} from 'td/base/common/lifecycle';
import {URI} from 'td/base/common/uri';
import * as languages from 'td/editor/common/languages';
import {IMarkdownRendererOptions} from 'td/editor/browser/widget/markdownRenderer/browser/markdownRenderer';
...
import {CommentReply} from 'td/workbench/contrib/comments/browser/commentReply';
import {ICommentService} from 'td/workbench/contrib/comments/browser/commentService';
import {CommentThreadBody} from 'td/workbench/contrib/comments/browser/commentThreadBody';
import {CommentThreadHeader} from 'td/workbench/contrib/comments/browser/commentThreadHeader';
import {CommentThreadAdditionalActions} from 'td/workbench/contrib/comments/browser/commentThreadAdditionalActions';
...
import {contrastBorder, focusBorder, inputValidationErrorBackground, inputValidationErrorBorder, inputValidationErrorForeground, textBlockQuoteBackground, textBlockQuoteBorder, textLinkActiveForeground, textLinkForeground} from 'td/platform/theme/common/colorRegistry';
import {PANEL_BORDER} from 'td/workbench/common/theme';
import {IRange} from 'td/editor/common/core/range';
import {commentThreadStateBackgroundColorVar, commentThreadStateColorVar} from 'td/workbench/contrib/comments/browser/commentColors';
...
import {COMMENTS_SECTION, ICommentsConfiguration} from 'td/workbench/contrib/comments/common/commentsConfiguration';
...
import {LayoutableEditor} from 'td/workbench/contrib/comments/browser/simpleCommentEditor';
