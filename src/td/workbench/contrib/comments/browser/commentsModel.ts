...
import {CommentThread} from 'td/editor/common/languages';
import {localize} from 'td/nls';
import {ResourceWithCommentThreads, ICommentThreadChangedEvent} from 'td/workbench/contrib/comments/common/commentModel';
