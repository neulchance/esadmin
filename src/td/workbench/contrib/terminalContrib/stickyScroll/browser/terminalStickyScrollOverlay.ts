...
import {$, addDisposableListener, addStandardDisposableListener, getWindow} from 'td/base/browser/dom';
import {CancelablePromise, createCancelablePromise} from 'td/base/common/async';
import {debounce, memoize, throttle} from 'td/base/common/decorators';
import {Event} from 'td/base/common/event';
import {Disposable, MutableDisposable, combinedDisposable, toDisposable} from 'td/base/common/lifecycle';
import {removeAnsiEscapeCodes} from 'td/base/common/strings';
...
import {ICommandDetectionCapability, ITerminalCommand} from 'td/platform/terminal/common/capabilities/capabilities';
...
import {ITerminalInstance, IXtermColorProvider, IXtermTerminal} from 'td/workbench/contrib/terminal/browser/terminal';
import {openContextMenu} from 'td/workbench/contrib/terminal/browser/terminalContextMenu';
import {IXtermCore} from 'td/workbench/contrib/terminal/browser/xterm-private';
import {TERMINAL_CONFIG_SECTION, TerminalCommandId} from 'td/workbench/contrib/terminal/common/terminal';
import {terminalStrings} from 'td/workbench/contrib/terminal/common/terminalStrings';
import {terminalStickyScrollBackground, terminalStickyScrollHoverBackground} from 'td/workbench/contrib/terminalContrib/stickyScroll/browser/terminalStickyScrollColorRegistry';
