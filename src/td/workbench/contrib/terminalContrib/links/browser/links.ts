...
import {IParsedLink} from 'td/workbench/contrib/terminalContrib/links/browser/terminalLinkParsing';
import {IDisposable} from 'td/base/common/lifecycle';
import {ITerminalExternalLinkProvider} from 'td/workbench/contrib/terminal/browser/terminal';
