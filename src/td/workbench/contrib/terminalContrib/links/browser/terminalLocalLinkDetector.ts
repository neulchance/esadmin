...
import {ITerminalLinkDetector, ITerminalLinkResolver, ITerminalSimpleLink, ResolvedLink, TerminalBuiltinLinkType} from 'td/workbench/contrib/terminalContrib/links/browser/links';
import {convertLinkRangeToBuffer, getXtermLineContent, getXtermRangesByAttr, osPathModule, updateLinkWithRelativeCwd} from 'td/workbench/contrib/terminalContrib/links/browser/terminalLinkHelpers';
import {ITerminalCapabilityStore, TerminalCapability} from 'td/platform/terminal/common/capabilities/capabilities';
import type {IBufferLine, IBufferRange, Terminal} from '@xterm/xterm';
import {ITerminalProcessManager} from 'td/workbench/contrib/terminal/common/terminal';
import {detectLinks} from 'td/workbench/contrib/terminalContrib/links/browser/terminalLinkParsing';
import {ITerminalBackend, ITerminalLogService} from 'td/platform/terminal/common/terminal';
