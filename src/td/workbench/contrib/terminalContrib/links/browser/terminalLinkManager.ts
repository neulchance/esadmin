...
import {EventType} from 'td/base/browser/dom';
import {IMarkdownString, MarkdownString} from 'td/base/common/htmlContent';
import {DisposableStore, dispose, IDisposable, toDisposable} from 'td/base/common/lifecycle';
import {isMacintosh, OS} from 'td/base/common/platform';
...
import {ITerminalLinkDetector, ITerminalLinkOpener, ITerminalLinkResolver, ITerminalSimpleLink, OmitFirstArg, TerminalBuiltinLinkType, TerminalLinkType} from 'td/workbench/contrib/terminalContrib/links/browser/links';
import {TerminalExternalLinkDetector} from 'td/workbench/contrib/terminalContrib/links/browser/terminalExternalLinkDetector';
import {TerminalLink} from 'td/workbench/contrib/terminalContrib/links/browser/terminalLink';
import {TerminalLinkDetectorAdapter} from 'td/workbench/contrib/terminalContrib/links/browser/terminalLinkDetectorAdapter';
import {TerminalLocalFileLinkOpener, TerminalLocalFolderInWorkspaceLinkOpener, TerminalLocalFolderOutsideWorkspaceLinkOpener, TerminalSearchLinkOpener, TerminalUrlLinkOpener} from 'td/workbench/contrib/terminalContrib/links/browser/terminalLinkOpeners';
import {TerminalLocalLinkDetector} from 'td/workbench/contrib/terminalContrib/links/browser/terminalLocalLinkDetector';
import {TerminalUriLinkDetector} from 'td/workbench/contrib/terminalContrib/links/browser/terminalUriLinkDetector';
import {TerminalWordLinkDetector} from 'td/workbench/contrib/terminalContrib/links/browser/terminalWordLinkDetector';
import {ITerminalExternalLinkProvider, TerminalLinkQuickPickEvent} from 'td/workbench/contrib/terminal/browser/terminal';
import {ILinkHoverTargetOptions, TerminalHover} from 'td/workbench/contrib/terminal/browser/widgets/terminalHoverWidget';
import {TerminalWidgetManager} from 'td/workbench/contrib/terminal/browser/widgets/widgetManager';
import {IXtermCore} from 'td/workbench/contrib/terminal/browser/xterm-private';
import {ITerminalCapabilityStore} from 'td/platform/terminal/common/capabilities/capabilities';
import {ITerminalConfiguration, ITerminalProcessInfo, TERMINAL_CONFIG_SECTION} from 'td/workbench/contrib/terminal/common/terminal';
import {IHoverAction} from 'td/platform/hover/browser/hover';
import type {ILink, ILinkProvider, IViewportRange, Terminal} from '@xterm/xterm';
import {convertBufferRangeToViewport} from 'td/workbench/contrib/terminalContrib/links/browser/terminalLinkHelpers';
import {RunOnceScheduler} from 'td/base/common/async';
import {ITerminalLogService} from 'td/platform/terminal/common/terminal';
import {TerminalMultiLineLinkDetector} from 'td/workbench/contrib/terminalContrib/links/browser/terminalMultiLineLinkDetector';
