...
import {XtermAttributes, IXtermCore} from 'td/workbench/contrib/terminal/browser/xterm-private';
import {DEFAULT_LOCAL_ECHO_EXCLUDE, IBeforeProcessDataEvent, ITerminalConfiguration, ITerminalProcessManager, TERMINAL_CONFIG_SECTION} from 'td/workbench/contrib/terminal/common/terminal';
