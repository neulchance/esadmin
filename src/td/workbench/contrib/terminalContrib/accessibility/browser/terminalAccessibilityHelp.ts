...
import {ShellIntegrationStatus, TerminalSettingId, WindowsShellType} from 'td/platform/terminal/common/terminal';
import {AccessibilityVerbositySettingId, AccessibleViewProviderId, accessibleViewCurrentProviderId, accessibleViewIsShown} from 'td/workbench/contrib/accessibility/browser/accessibilityConfiguration';
import {AccessibleViewType, IAccessibleContentProvider, IAccessibleViewOptions} from 'td/workbench/contrib/accessibility/browser/accessibleView';
import {AccessibilityCommandId} from 'td/workbench/contrib/accessibility/common/accessibilityCommands';
import {ITerminalInstance, IXtermTerminal} from 'td/workbench/contrib/terminal/browser/terminal';
