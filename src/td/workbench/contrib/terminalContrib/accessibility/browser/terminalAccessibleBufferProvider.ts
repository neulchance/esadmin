...
import {TerminalCapability, ITerminalCommand} from 'td/platform/terminal/common/capabilities/capabilities';
...
import {AccessibilityVerbositySettingId, AccessibleViewProviderId} from 'td/workbench/contrib/accessibility/browser/accessibilityConfiguration';
import {AccessibleViewType, IAccessibleContentProvider, IAccessibleViewOptions, IAccessibleViewSymbol} from 'td/workbench/contrib/accessibility/browser/accessibleView';
import {ITerminalInstance, ITerminalService} from 'td/workbench/contrib/terminal/browser/terminal';
