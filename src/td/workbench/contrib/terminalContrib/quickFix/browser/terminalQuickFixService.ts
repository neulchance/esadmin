...
import {ITerminalQuickFixService, ITerminalQuickFixProvider, ITerminalQuickFixProviderSelector} from 'td/workbench/contrib/terminalContrib/quickFix/browser/quickFix';
