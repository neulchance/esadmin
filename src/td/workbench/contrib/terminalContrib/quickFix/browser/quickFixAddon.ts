...
import {DecorationSelector, updateLayout} from 'td/workbench/contrib/terminal/browser/xterm/decorationStyles';
...
import {ActionSet} from 'td/platform/actionWidget/common/actionWidget';
import {getLinesForCommand} from 'td/platform/terminal/common/capabilities/commandDetectionCapability';
