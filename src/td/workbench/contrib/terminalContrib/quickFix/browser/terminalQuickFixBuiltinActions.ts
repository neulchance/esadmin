...
import {ITerminalQuickFixInternalOptions, ITerminalCommandMatchResult, ITerminalQuickFixTerminalCommandAction, TerminalQuickFixActionInternal, TerminalQuickFixType} from 'td/workbench/contrib/terminalContrib/quickFix/browser/quickFix';
