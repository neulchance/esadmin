...
import 'td/css!./media/developer';
import {VSBuffer} from 'td/base/common/buffer';
import {Disposable, IDisposable, MutableDisposable, combinedDisposable, dispose} from 'td/base/common/lifecycle';
...
import {ITerminalLogService, TerminalSettingId} from 'td/platform/terminal/common/terminal';
import {IWorkspaceContextService} from 'td/platform/workspace/common/workspace';
import {IInternalXtermTerminal, ITerminalContribution, ITerminalInstance, ITerminalService, IXtermTerminal} from 'td/workbench/contrib/terminal/browser/terminal';
