...
import {findInFilesCommand} from 'td/workbench/contrib/search/browser/searchActionsFind';
import {IDetachedTerminalInstance, ITerminalContribution, ITerminalInstance, ITerminalService, IXtermTerminal, isDetachedTerminalInstance} from 'td/workbench/contrib/terminal/browser/terminal';
import {registerActiveInstanceAction, registerActiveXtermAction} from 'td/workbench/contrib/terminal/browser/terminalActions';
...
import {ITerminalProcessInfo, ITerminalProcessManager, TerminalCommandId} from 'td/workbench/contrib/terminal/common/terminal';
import {TerminalContextKeys} from 'td/workbench/contrib/terminal/common/terminalContextKey';
import {TerminalFindWidget} from 'td/workbench/contrib/terminalContrib/find/browser/terminalFindWidget';
