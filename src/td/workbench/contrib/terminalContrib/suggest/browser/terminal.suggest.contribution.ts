...
import {SuggestAddon} from 'td/workbench/contrib/terminalContrib/suggest/browser/terminalSuggestAddon';
import {ITerminalProcessManager, TerminalCommandId} from 'td/workbench/contrib/terminal/common/terminal';
import type {Terminal as RawXtermTerminal} from '@xterm/xterm';
import {ContextKeyExpr, IContextKey, IContextKeyService, IReadableSet} from 'td/platform/contextkey/common/contextkey';
