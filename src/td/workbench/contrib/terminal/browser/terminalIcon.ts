...
import {IExtensionTerminalProfile, ITerminalProfile} from 'td/platform/terminal/common/terminal';
...
import {ansiColorMap} from 'td/workbench/contrib/terminal/common/terminalColorRegistry';
