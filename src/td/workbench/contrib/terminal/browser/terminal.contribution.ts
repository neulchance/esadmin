...
import 'td/css!./media/scrollbar';
import 'td/css!./media/widgets';
import 'td/css!./media/xterm';
import 'td/css!./media/terminal';
import 'td/css!./media/terminalVoice';
...
import {KeybindingWeight, KeybindingsRegistry, IKeybindings} from 'td/platform/keybinding/common/keybindingsRegistry';
import {Registry} from 'td/platform/registry/common/platform';
import {getQuickNavigateHandler} from 'td/workbench/browser/quickaccess';
import {Extensions as ViewContainerExtensions, IViewContainersRegistry, ViewContainerLocation, IViewsRegistry} from 'td/workbench/common/views';
import {Extensions as DragAndDropExtensions, IDragAndDropContributionRegistry, IDraggedResourceEditorInput} from 'td/platform/dnd/browser/dnd';
import {registerTerminalActions, terminalSendSequenceCommand} from 'td/workbench/contrib/terminal/browser/terminalActions';
import {TerminalViewPane} from 'td/workbench/contrib/terminal/browser/terminalView';
import {TERMINAL_VIEW_ID, TerminalCommandId, ITerminalProfileService} from 'td/workbench/contrib/terminal/common/terminal';
import {registerColors} from 'td/workbench/contrib/terminal/common/terminalColorRegistry';
import {setupTerminalCommands} from 'td/workbench/contrib/terminal/browser/terminalCommands';
import {TerminalService} from 'td/workbench/contrib/terminal/browser/terminalService';
import {InstantiationType, registerSingleton} from 'td/platform/instantiation/common/extensions';
import {ITerminalEditorService, ITerminalGroupService, ITerminalInstanceService, ITerminalService, TerminalDataTransfers, terminalEditorId} from 'td/workbench/contrib/terminal/browser/terminal';
import {SyncDescriptor} from 'td/platform/instantiation/common/descriptors';
import {ViewPaneContainer} from 'td/workbench/browser/parts/views/viewPaneContainer';
import {IQuickAccessRegistry, Extensions as QuickAccessExtensions} from 'td/platform/quickinput/common/quickAccess';
import {TerminalQuickAccessProvider} from 'td/workbench/contrib/terminal/browser/terminalQuickAccess';
import {registerTerminalConfiguration} from 'td/workbench/contrib/terminal/common/terminalConfiguration';
import {CONTEXT_ACCESSIBILITY_MODE_ENABLED} from 'td/platform/accessibility/common/accessibility';
import {terminalViewIcon} from 'td/workbench/contrib/terminal/browser/terminalIcons';
import {ITerminalLogService, TerminalSettingId, WindowsShellType} from 'td/platform/terminal/common/terminal';
import {isIOS, isWindows} from 'td/base/common/platform';
import {setupTerminalMenus} from 'td/workbench/contrib/terminal/browser/terminalMenus';
import {TerminalInstanceService} from 'td/workbench/contrib/terminal/browser/terminalInstanceService';
import {registerTerminalPlatformConfiguration} from 'td/platform/terminal/common/terminalPlatformConfiguration';
...
import {TerminalEditor} from 'td/workbench/contrib/terminal/browser/terminalEditor';
...
import {TerminalEditorService} from 'td/workbench/contrib/terminal/browser/terminalEditorService';
import {TerminalInputSerializer} from 'td/workbench/contrib/terminal/browser/terminalEditorSerializer';
import {TerminalGroupService} from 'td/workbench/contrib/terminal/browser/terminalGroupService';
import {TerminalContextKeys, TerminalContextKeyStrings} from 'td/workbench/contrib/terminal/common/terminalContextKey';
import {TerminalProfileService} from 'td/workbench/contrib/terminal/browser/terminalProfileService';
import {IWorkbenchContributionsRegistry, Extensions as WorkbenchExtensions} from 'td/workbench/common/contributions';
import {RemoteTerminalBackendContribution} from 'td/workbench/contrib/terminal/browser/remoteTerminalBackend';
import {LifecyclePhase} from 'td/workbench/services/lifecycle/common/lifecycle';
import {TerminalMainContribution} from 'td/workbench/contrib/terminal/browser/terminalMainContribution';
import {Schemas} from 'td/base/common/network';
import {TerminalLogService} from 'td/platform/terminal/common/terminalLogService';
