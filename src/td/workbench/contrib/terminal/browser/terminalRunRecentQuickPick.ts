...
import {isMacintosh, OperatingSystem} from 'td/base/common/platform';
...
import {IQuickInputButton, IQuickInputService, IQuickPickItem, IQuickPickSeparator} from 'td/platform/quickinput/common/quickInput';
import {ITerminalCommand, TerminalCapability} from 'td/platform/terminal/common/capabilities/capabilities';
import {collapseTildePath} from 'td/platform/terminal/common/terminalEnvironment';
import {asCssVariable, inputActiveOptionBackground, inputActiveOptionBorder, inputActiveOptionForeground} from 'td/platform/theme/common/colorRegistry';
import {ThemeIcon} from 'td/base/common/themables';
import {ITerminalInstance} from 'td/workbench/contrib/terminal/browser/terminal';
import {commandHistoryFuzzySearchIcon, commandHistoryOutputIcon, commandHistoryRemoveIcon} from 'td/workbench/contrib/terminal/browser/terminalIcons';
import {getCommandHistory, getDirectoryHistory, getShellFileHistory} from 'td/workbench/contrib/terminal/common/history';
...
import {showWithPinnedItems} from 'td/platform/quickinput/browser/quickPickPin';
import {IStorageService} from 'td/platform/storage/common/storage';
import {IContextKey} from 'td/platform/contextkey/common/contextkey';
import {IAccessibleViewService} from 'td/workbench/contrib/accessibility/browser/accessibleView';
import {AccessibleViewProviderId} from 'td/workbench/contrib/accessibility/browser/accessibilityConfiguration';
