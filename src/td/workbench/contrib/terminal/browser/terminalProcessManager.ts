...
import {IProcessEnvironment, isMacintosh, isWindows, OperatingSystem, OS} from 'td/base/common/platform';
...
import {ISerializedCommandDetectionCapability, TerminalCapability} from 'td/platform/terminal/common/capabilities/capabilities';
import {NaiveCwdDetectionCapability} from 'td/platform/terminal/common/capabilities/naiveCwdDetectionCapability';
import {TerminalCapabilityStore} from 'td/platform/terminal/common/capabilities/terminalCapabilityStore';
import {FlowControlConstants, IProcessDataEvent, IProcessProperty, IProcessPropertyMap, IProcessReadyEvent, IReconnectionProperties, IShellLaunchConfig, ITerminalBackend, ITerminalChildProcess, ITerminalDimensions, ITerminalEnvironment, ITerminalLaunchError, ITerminalLogService, ITerminalProcessOptions, ProcessPropertyType, TerminalSettingId} from 'td/platform/terminal/common/terminal';
import {TerminalRecorder} from 'td/platform/terminal/common/terminalRecorder';
import {IWorkspaceContextService, IWorkspaceFolder} from 'td/platform/workspace/common/workspace';
import {EnvironmentVariableInfoChangesActive, EnvironmentVariableInfoStale} from 'td/workbench/contrib/terminal/browser/environmentVariableInfo';
import {ITerminalConfigHelper, ITerminalInstanceService} from 'td/workbench/contrib/terminal/browser/terminal';
import {IEnvironmentVariableInfo, IEnvironmentVariableService} from 'td/workbench/contrib/terminal/common/environmentVariable';
import {MergedEnvironmentVariableCollection} from 'td/platform/terminal/common/environmentVariableCollection';
import {serializeEnvironmentVariableCollections} from 'td/platform/terminal/common/environmentVariableShared';
import {IBeforeProcessDataEvent, ITerminalProcessManager, ITerminalProfileResolverService, ProcessState} from 'td/workbench/contrib/terminal/common/terminal';
import * as terminalEnvironment from 'td/workbench/contrib/terminal/common/terminalEnvironment';
...
import {TaskSettingId} from 'td/workbench/contrib/tasks/common/tasks';
...
import {getActiveWindow, runWhenWindowIdle} from 'td/base/browser/dom';
