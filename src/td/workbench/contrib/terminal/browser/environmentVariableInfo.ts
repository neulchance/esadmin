...
import {ITerminalStatus, ITerminalStatusHoverAction, TerminalCommandId} from 'td/workbench/contrib/terminal/common/terminal';
import {ITerminalService} from 'td/workbench/contrib/terminal/browser/terminal';
import {localize} from 'td/nls';
import {Codicon} from 'td/base/common/codicons';
import {EnvironmentVariableScope, IExtensionOwnedEnvironmentVariableMutator, IMergedEnvironmentVariableCollection, IMergedEnvironmentVariableCollectionDiff} from 'td/platform/terminal/common/environmentVariable';
