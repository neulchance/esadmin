...
import {IPickerQuickAccessItem, PickerQuickAccessProvider, TriggerAction} from 'td/platform/quickinput/browser/pickerQuickAccess';
import {matchesFuzzy} from 'td/base/common/filters';
import {ITerminalEditorService, ITerminalGroupService, ITerminalInstance, ITerminalService} from 'td/workbench/contrib/terminal/browser/terminal';
...
import {killTerminalIcon, renameTerminalIcon} from 'td/workbench/contrib/terminal/browser/terminalIcons';
...
import {TerminalLocation} from 'td/platform/terminal/common/terminal';
