...
import {PerformanceMark, mark} from 'td/base/common/performance';
...
import {ISerializedTerminalCommand} from 'td/platform/terminal/common/capabilities/capabilities';
import {IPtyHostLatencyMeasurement, IShellLaunchConfig, IShellLaunchConfigDto, ITerminalBackend, ITerminalBackendRegistry, ITerminalChildProcess, ITerminalEnvironment, ITerminalLogService, ITerminalProcessOptions, ITerminalProfile, ITerminalsLayoutInfo, ITerminalsLayoutInfoById, ProcessPropertyType, TerminalExtensions, TerminalIcon, TerminalSettingId, TitleEventSource} from 'td/platform/terminal/common/terminal';
...
import {RemotePty} from 'td/workbench/contrib/terminal/browser/remotePty';
import {ITerminalInstanceService} from 'td/workbench/contrib/terminal/browser/terminal';
import {RemoteTerminalChannelClient, REMOTE_TERMINAL_CHANNEL_NAME} from 'td/workbench/contrib/terminal/common/remote/remoteTerminalChannel';
import {ICompleteTerminalConfiguration, ITerminalConfiguration, TERMINAL_CONFIG_SECTION} from 'td/workbench/contrib/terminal/common/terminal';
