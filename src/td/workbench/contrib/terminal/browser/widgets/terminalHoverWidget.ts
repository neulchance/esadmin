...
import {ITerminalWidget} from 'td/workbench/contrib/terminal/browser/widgets/widgets';
import * as dom from 'td/base/browser/dom';
import type {IViewportRange} from '@xterm/xterm';
import {IHoverTarget, IHoverService, IHoverAction} from 'td/platform/hover/browser/hover';
