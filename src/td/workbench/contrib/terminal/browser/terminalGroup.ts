...
import {TERMINAL_VIEW_ID} from 'td/workbench/contrib/terminal/common/terminal';
import {Event, Emitter} from 'td/base/common/event';
import {IDisposable, Disposable, DisposableStore, dispose, toDisposable} from 'td/base/common/lifecycle';
import {SplitView, Orientation, IView, Sizing} from 'td/base/browser/ui/splitview/splitview';
import {IWorkbenchLayoutService, Parts, Position} from 'td/workbench/services/layout/browser/layoutService';
import {IInstantiationService} from 'td/platform/instantiation/common/instantiation';
import {ITerminalInstance, Direction, ITerminalGroup, ITerminalService, ITerminalInstanceService} from 'td/workbench/contrib/terminal/browser/terminal';
import {ViewContainerLocation, IViewDescriptorService} from 'td/workbench/common/views';
import {IShellLaunchConfig, ITerminalTabLayoutInfoById, TerminalLocation} from 'td/platform/terminal/common/terminal';
import {TerminalStatus} from 'td/workbench/contrib/terminal/browser/terminalStatusList';
import {getWindow} from 'td/base/browser/dom';
import {getPartByLocation} from 'td/workbench/services/views/browser/viewsService';
