...
import {IDimension} from 'td/base/browser/dom';
import {Orientation} from 'td/base/browser/ui/splitview/splitview';
import {Color} from 'td/base/common/color';
import {Event, IDynamicListEventMultiplexer} from 'td/base/common/event';
...
import {IMarkProperties, ITerminalCapabilityImplMap, ITerminalCapabilityStore, ITerminalCommand, TerminalCapability} from 'td/platform/terminal/common/capabilities/capabilities';
import {IMergedEnvironmentVariableCollection} from 'td/platform/terminal/common/environmentVariable';
import {IExtensionTerminalProfile, IReconnectionProperties, IShellIntegration, IShellLaunchConfig, ITerminalBackend, ITerminalDimensions, ITerminalLaunchError, ITerminalProfile, ITerminalTabLayoutInfoById, TerminalExitReason, TerminalIcon, TerminalLocation, TerminalShellType, TerminalType, TitleEventSource, WaitOnExitValue} from 'td/platform/terminal/common/terminal';
...
import {ITerminalStatusList} from 'td/workbench/contrib/terminal/browser/terminalStatusList';
import {XtermTerminal} from 'td/workbench/contrib/terminal/browser/xterm/xtermTerminal';
import {IRegisterContributedProfileArgs, IRemoteTerminalAttachTarget, IStartExtensionTerminalRequest, ITerminalConfiguration, ITerminalFont, ITerminalProcessExtHostProxy, ITerminalProcessInfo} from 'td/workbench/contrib/terminal/common/terminal';
import {ISimpleSelectedSuggestion} from 'td/workbench/services/suggest/browser/simpleSuggestWidget';
import type {IMarker, ITheme, Terminal as RawXtermTerminal} from '@xterm/xterm';
import {ScrollPosition} from 'td/workbench/contrib/terminal/browser/xterm/markNavigationAddon';
...
import {ACTIVE_GROUP_TYPE, AUX_WINDOW_GROUP_TYPE, SIDE_GROUP_TYPE} from 'td/workbench/services/editor/common/editorService';
