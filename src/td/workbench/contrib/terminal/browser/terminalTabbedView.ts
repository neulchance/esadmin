...
import {LayoutPriority, Orientation, Sizing, SplitView} from 'td/base/browser/ui/splitview/splitview';
import {Disposable, dispose, IDisposable} from 'td/base/common/lifecycle';
import {IConfigurationService} from 'td/platform/configuration/common/configuration';
import {IInstantiationService} from 'td/platform/instantiation/common/instantiation';
import {ITerminalGroupService, ITerminalInstance, ITerminalService, TerminalConnectionState} from 'td/workbench/contrib/terminal/browser/terminal';
import {TerminalTabsListSizes, TerminalTabList} from 'td/workbench/contrib/terminal/browser/terminalTabsList';
