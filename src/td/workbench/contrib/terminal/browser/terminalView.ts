...
import {switchTerminalActionViewItemSeparator, switchTerminalShowTabsTitle} from 'td/workbench/contrib/terminal/browser/terminalActions';
import {INotificationService, IPromptChoice, Severity} from 'td/platform/notification/common/notification';
import {ICreateTerminalOptions, ITerminalGroupService, ITerminalInstance, ITerminalService, TerminalConnectionState, TerminalDataTransfers} from 'td/workbench/contrib/terminal/browser/terminal';
...
import {IMenu, IMenuService, MenuId, MenuItemAction} from 'td/platform/actions/common/actions';
import {ITerminalProfileResolverService, ITerminalProfileService, TerminalCommandId} from 'td/workbench/contrib/terminal/common/terminal';
import {TerminalSettingId, ITerminalProfile, TerminalLocation} from 'td/platform/terminal/common/terminal';
import {ActionViewItem, SelectActionViewItem} from 'td/base/browser/ui/actionbar/actionViewItems';
import {asCssVariable, selectBorder} from 'td/platform/theme/common/colorRegistry';
import {ISelectOptionItem} from 'td/base/browser/ui/selectBox/selectBox';
import {IActionViewItem} from 'td/base/browser/ui/actionbar/actionbar';
import {TerminalTabbedView} from 'td/workbench/contrib/terminal/browser/terminalTabbedView';
...
import {getColorForSeverity} from 'td/workbench/contrib/terminal/browser/terminalStatusList';
import {createAndFillInContextMenuActions, MenuEntryActionViewItem} from 'td/platform/actions/browser/menuEntryActionViewItem';
import {DropdownWithPrimaryActionViewItem} from 'td/platform/actions/browser/dropdownWithPrimaryActionViewItem';
import {dispose, IDisposable, toDisposable} from 'td/base/common/lifecycle';
import {URI} from 'td/base/common/uri';
import {ColorScheme} from 'td/platform/theme/common/theme';
import {getColorClass, getUriClasses} from 'td/workbench/contrib/terminal/browser/terminalIcon';
import {getTerminalActionBarArgs} from 'td/workbench/contrib/terminal/browser/terminalMenus';
import {TerminalContextKeys} from 'td/workbench/contrib/terminal/common/terminalContextKey';
import {getInstanceHoverInfo} from 'td/workbench/contrib/terminal/browser/terminalTooltip';
...
import {defaultSelectBoxStyles} from 'td/platform/theme/browser/defaultStyles';
...
import {InstanceContext, TerminalContextActionRunner} from 'td/workbench/contrib/terminal/browser/terminalContextMenu';
