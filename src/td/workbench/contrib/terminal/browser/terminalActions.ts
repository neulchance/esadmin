...
import {isLinux, isWindows} from 'td/base/common/platform';
import {IDisposable} from 'td/base/common/lifecycle';
import {isObject, isString} from 'td/base/common/types';
...
import {Action2, registerAction2, IAction2Options, MenuId} from 'td/platform/actions/common/actions';
...
import {IPickOptions, IQuickInputService, IQuickPickItem} from 'td/platform/quickinput/common/quickInput';
import {ITerminalProfile, TerminalExitReason, TerminalIcon, TerminalLocation, TerminalSettingId} from 'td/platform/terminal/common/terminal';
...
import {CLOSE_EDITOR_COMMAND_ID} from 'td/workbench/browser/parts/editor/editorCommands';
import {Direction, ICreateTerminalOptions, IDetachedTerminalInstance, ITerminalConfigHelper, ITerminalEditorService, ITerminalGroupService, ITerminalInstance, ITerminalInstanceService, ITerminalService, IXtermTerminal} from 'td/workbench/contrib/terminal/browser/terminal';
import {TerminalQuickAccessProvider} from 'td/workbench/contrib/terminal/browser/terminalQuickAccess';
import {IRemoteTerminalAttachTarget, ITerminalProfileResolverService, ITerminalProfileService, TERMINAL_VIEW_ID, TerminalCommandId} from 'td/workbench/contrib/terminal/common/terminal';
import {TerminalContextKeys} from 'td/workbench/contrib/terminal/common/terminalContextKey';
import {createProfileSchemaEnums} from 'td/platform/terminal/common/terminalProfiles';
...
import {SIDE_GROUP} from 'td/workbench/services/editor/common/editorService';
import {isAbsolute} from 'td/base/common/path';
import {AbstractVariableResolverService} from 'td/workbench/services/configurationResolver/common/variableResolver';
import {ITerminalQuickPickItem} from 'td/workbench/contrib/terminal/browser/terminalProfileQuickpick';
import {IThemeService} from 'td/platform/theme/common/themeService';
import {getIconId, getColorClass, getUriClasses} from 'td/workbench/contrib/terminal/browser/terminalIcon';
import {clearShellFileHistory, getCommandHistory} from 'td/workbench/contrib/terminal/common/history';
...
import {killTerminalIcon, newTerminalIcon} from 'td/workbench/contrib/terminal/browser/terminalIcons';
...
import {AccessibleViewProviderId, accessibleViewCurrentProviderId, accessibleViewIsShown, accessibleViewOnLastLine} from 'td/workbench/contrib/accessibility/browser/accessibilityConfiguration';
import {isKeyboardEvent, isMouseEvent, isPointerEvent} from 'td/base/browser/dom';
import {editorGroupToColumn} from 'td/workbench/services/editor/common/editorGroupColumn';
import {InstanceContext} from 'td/workbench/contrib/terminal/browser/terminalContextMenu';
import {TerminalVoiceSession} from 'td/workbench/contrib/terminal/browser/terminalVoice';
import {HasSpeechProvider} from 'td/workbench/contrib/speech/common/speechService';
