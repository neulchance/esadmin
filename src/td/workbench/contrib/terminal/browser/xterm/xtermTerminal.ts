...
import {IShellIntegration, ITerminalLogService, TerminalSettingId} from 'td/platform/terminal/common/terminal';
import {ITerminalFont, ITerminalConfiguration} from 'td/workbench/contrib/terminal/common/terminal';
import {isSafari} from 'td/base/browser/browser';
import {IMarkTracker, IInternalXtermTerminal, IXtermTerminal, IXtermColorProvider, XtermTerminalConstants, IXtermAttachToElementOptions, IDetachedXtermTerminal} from 'td/workbench/contrib/terminal/browser/terminal';
import {LogLevel} from 'td/platform/log/common/log';
import {IStorageService, StorageScope, StorageTarget} from 'td/platform/storage/common/storage';
import {TerminalStorageKeys} from 'td/workbench/contrib/terminal/common/terminalStorageKeys';
import {INotificationService, IPromptChoice, Severity} from 'td/platform/notification/common/notification';
import {MarkNavigationAddon, ScrollPosition} from 'td/workbench/contrib/terminal/browser/xterm/markNavigationAddon';
import {localize} from 'td/nls';
import {IColorTheme, IThemeService} from 'td/platform/theme/common/themeService';
import {PANEL_BACKGROUND} from 'td/workbench/common/theme';
import {TERMINAL_FOREGROUND_COLOR, TERMINAL_BACKGROUND_COLOR, TERMINAL_CURSOR_FOREGROUND_COLOR, TERMINAL_CURSOR_BACKGROUND_COLOR, ansiColorIdentifiers, TERMINAL_SELECTION_BACKGROUND_COLOR, TERMINAL_FIND_MATCH_BACKGROUND_COLOR, TERMINAL_FIND_MATCH_HIGHLIGHT_BACKGROUND_COLOR, TERMINAL_FIND_MATCH_BORDER_COLOR, TERMINAL_OVERVIEW_RULER_FIND_MATCH_FOREGROUND_COLOR, TERMINAL_FIND_MATCH_HIGHLIGHT_BORDER_COLOR, TERMINAL_OVERVIEW_RULER_CURSOR_FOREGROUND_COLOR, TERMINAL_SELECTION_FOREGROUND_COLOR, TERMINAL_INACTIVE_SELECTION_BACKGROUND_COLOR} from 'td/workbench/contrib/terminal/common/terminalColorRegistry';
import {ShellIntegrationAddon} from 'td/platform/terminal/common/xterm/shellIntegrationAddon';
import {IInstantiationService} from 'td/platform/instantiation/common/instantiation';
import {DecorationAddon} from 'td/workbench/contrib/terminal/browser/xterm/decorationAddon';
import {ITerminalCapabilityStore, ITerminalCommand, TerminalCapability} from 'td/platform/terminal/common/capabilities/capabilities';
...
import {MouseWheelClassifier} from 'td/base/browser/ui/scrollbar/scrollableElement';
import {IMouseWheelEvent, StandardWheelEvent} from 'td/base/browser/mouseEvent';
