...
import {AccessibilityVoiceSettingId, SpeechTimeoutDefault} from 'td/workbench/contrib/accessibility/browser/accessibilityConfiguration';
import {ISpeechService, ISpeechToTextEvent, SpeechToTextStatus} from 'td/workbench/contrib/speech/common/speechService';
...
import {IXtermMarker} from 'td/platform/terminal/common/capabilities/capabilities';
