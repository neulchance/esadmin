...
import {debounce, memoize} from 'td/base/common/decorators';
import {DynamicListEventMultiplexer, Emitter, Event, IDynamicListEventMultiplexer} from 'td/base/common/event';
...
import {IKeyMods} from 'td/platform/quickinput/common/quickInput';
...
import {VirtualWorkspaceContext} from 'td/workbench/common/contextkeys';
...
import {getColorStyleContent, getUriClasses} from 'td/workbench/contrib/terminal/browser/terminalIcon';
import {TerminalProfileQuickpick} from 'td/workbench/contrib/terminal/browser/terminalProfileQuickpick';
import {getInstanceFromResource, getTerminalUri, parseTerminalUri} from 'td/workbench/contrib/terminal/browser/terminalUri';
import {TerminalViewPane} from 'td/workbench/contrib/terminal/browser/terminalView';
import {IRemoteTerminalAttachTarget, IStartExtensionTerminalRequest, ITerminalProcessExtHostProxy, ITerminalProfileService, TERMINAL_VIEW_ID} from 'td/workbench/contrib/terminal/common/terminal';
import {TerminalContextKeys} from 'td/workbench/contrib/terminal/common/terminalContextKey';
import {columnToEditorGroup} from 'td/workbench/services/editor/common/editorGroupColumn';
import {IEditorGroupsService} from 'td/workbench/services/editor/common/editorGroupsService';
import {ACTIVE_GROUP_TYPE, AUX_WINDOW_GROUP, AUX_WINDOW_GROUP_TYPE, IEditorService, SIDE_GROUP, SIDE_GROUP_TYPE} from 'td/workbench/services/editor/common/editorService';
...
import {ILifecycleService, ShutdownReason, StartupKind, WillShutdownEvent} from 'td/workbench/services/lifecycle/common/lifecycle';
import {IRemoteAgentService} from 'td/workbench/services/remote/common/remoteAgentService';
import {XtermTerminal} from 'td/workbench/contrib/terminal/browser/xterm/xtermTerminal';
...
import {TerminalCapabilityStore} from 'td/platform/terminal/common/capabilities/terminalCapabilityStore';
import {ITimerService} from 'td/workbench/services/timer/browser/timerService';
import {mark} from 'td/base/common/performance';
import {DetachedTerminal} from 'td/workbench/contrib/terminal/browser/detachedTerminal';
import {ITerminalCapabilityImplMap, TerminalCapability} from 'td/platform/terminal/common/capabilities/capabilities';
import {createInstanceCapabilityEventMultiplexer} from 'td/workbench/contrib/terminal/browser/terminalEvents';
