...
import {ITerminalConfiguration, TERMINAL_CONFIG_SECTION, DEFAULT_LETTER_SPACING, DEFAULT_LINE_HEIGHT, MINIMUM_LETTER_SPACING, MINIMUM_FONT_WEIGHT, MAXIMUM_FONT_WEIGHT, DEFAULT_FONT_WEIGHT, DEFAULT_BOLD_FONT_WEIGHT, FontWeight, ITerminalFont} from 'td/workbench/contrib/terminal/common/terminal';
import Severity from 'td/base/common/severity';
import {INotificationService, NeverShowAgainScope} from 'td/platform/notification/common/notification';
import {ITerminalConfigHelper, LinuxDistro} from 'td/workbench/contrib/terminal/browser/terminal';
...
import {type IXtermCore} from 'td/workbench/contrib/terminal/browser/xterm-private';
import {IShellLaunchConfig} from 'td/platform/terminal/common/terminal';
