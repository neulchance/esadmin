...
import {listErrorForeground, listWarningForeground} from 'td/platform/theme/common/colorRegistry';
import {spinningLoading} from 'td/platform/theme/common/iconRegistry';
import {ThemeIcon} from 'td/base/common/themables';
import {ITerminalStatus} from 'td/workbench/contrib/terminal/common/terminal';
