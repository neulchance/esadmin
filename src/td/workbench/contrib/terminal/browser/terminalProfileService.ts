...
import {AutoOpenBarrier} from 'td/base/common/async';
import {throttle} from 'td/base/common/decorators';
import {Emitter, Event} from 'td/base/common/event';
import {Disposable, IDisposable, toDisposable} from 'td/base/common/lifecycle';
import {isMacintosh, isWeb, isWindows, OperatingSystem, OS} from 'td/base/common/platform';
...
import {ITerminalProfile, IExtensionTerminalProfile, TerminalSettingPrefix, TerminalSettingId, ITerminalProfileObject, IShellLaunchConfig, ITerminalExecutable} from 'td/platform/terminal/common/terminal';
import {registerTerminalDefaultProfileConfiguration} from 'td/platform/terminal/common/terminalPlatformConfiguration';
import {terminalIconsEqual, terminalProfileArgsMatch} from 'td/platform/terminal/common/terminalProfiles';
import {ITerminalInstanceService} from 'td/workbench/contrib/terminal/browser/terminal';
import {refreshTerminalActions} from 'td/workbench/contrib/terminal/browser/terminalActions';
import {IRegisterContributedProfileArgs, ITerminalProfileProvider, ITerminalProfileService} from 'td/workbench/contrib/terminal/common/terminal';
import {TerminalContextKeys} from 'td/workbench/contrib/terminal/common/terminalContextKey';
import {ITerminalContributionService} from 'td/workbench/contrib/terminal/common/terminalExtensionPoints';
