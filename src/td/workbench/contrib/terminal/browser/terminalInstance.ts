...
import {BrowserFeatures} from 'td/base/browser/canIUse';
import {DataTransfers} from 'td/base/browser/dnd';
import * as dom from 'td/base/browser/dom';
import {StandardKeyboardEvent} from 'td/base/browser/keyboardEvent';
import {Orientation} from 'td/base/browser/ui/sash/sash';
import {DomScrollableElement} from 'td/base/browser/ui/scrollbar/scrollableElement';
import {AutoOpenBarrier, Promises, disposableTimeout, timeout} from 'td/base/common/async';
import {Codicon, getAllCodicons} from 'td/base/common/codicons';
import {debounce} from 'td/base/common/decorators';
import {ErrorNoTelemetry, onUnexpectedError} from 'td/base/common/errors';
import {Emitter, Event} from 'td/base/common/event';
import {KeyCode} from 'td/base/common/keyCodes';
import {ISeparator, template} from 'td/base/common/labels';
import {Disposable, DisposableStore, IDisposable, MutableDisposable, dispose, toDisposable} from 'td/base/common/lifecycle';
import {Schemas} from 'td/base/common/network';
import * as path from 'td/base/common/path';
import {OS, OperatingSystem, isMacintosh, isWindows} from 'td/base/common/platform';
...
import {CodeDataTransfers, containsDragType} from 'td/platform/dnd/browser/dnd';
import {FileSystemProviderCapabilities, IFileService} from 'td/platform/files/common/files';
...
import {IQuickInputService, IQuickPickItem, QuickPickItem} from 'td/platform/quickinput/common/quickInput';
...
import {IMarkProperties, ITerminalCommand, TerminalCapability} from 'td/platform/terminal/common/capabilities/capabilities';
import {TerminalCapabilityStoreMultiplexer} from 'td/platform/terminal/common/capabilities/terminalCapabilityStore';
import {IEnvironmentVariableCollection, IMergedEnvironmentVariableCollection} from 'td/platform/terminal/common/environmentVariable';
import {deserializeEnvironmentVariableCollections} from 'td/platform/terminal/common/environmentVariableShared';
import {IProcessDataEvent, IProcessPropertyMap, IReconnectionProperties, IShellLaunchConfig, ITerminalDimensionsOverride, ITerminalLaunchError, ITerminalLogService, PosixShellType, ProcessPropertyType, ShellIntegrationStatus, TerminalExitReason, TerminalIcon, TerminalLocation, TerminalSettingId, TerminalShellType, TitleEventSource, WindowsShellType} from 'td/platform/terminal/common/terminal';
import {formatMessageForTerminal} from 'td/platform/terminal/common/terminalStrings';
import {editorBackground} from 'td/platform/theme/common/colorRegistry';
import {getIconRegistry} from 'td/platform/theme/common/iconRegistry';
import {IColorTheme, IThemeService} from 'td/platform/theme/common/themeService';
import {IWorkspaceContextService, IWorkspaceFolder} from 'td/platform/workspace/common/workspace';
import {IWorkspaceTrustRequestService} from 'td/platform/workspace/common/workspaceTrust';
import {PANEL_BACKGROUND, SIDE_BAR_BACKGROUND} from 'td/workbench/common/theme';
...
import {IRequestAddInstanceToGroupEvent, ITerminalContribution, ITerminalInstance, IXtermColorProvider, TerminalDataTransfers} from 'td/workbench/contrib/terminal/browser/terminal';
import {TerminalLaunchHelpAction} from 'td/workbench/contrib/terminal/browser/terminalActions';
...
import {TerminalExtensionsRegistry} from 'td/workbench/contrib/terminal/browser/terminalExtensions';
import {getColorClass, createColorStyleElement, getStandardColors} from 'td/workbench/contrib/terminal/browser/terminalIcon';
import {TerminalProcessManager} from 'td/workbench/contrib/terminal/browser/terminalProcessManager';
import {showRunRecentQuickPick} from 'td/workbench/contrib/terminal/browser/terminalRunRecentQuickPick';
import {ITerminalStatusList, TerminalStatus, TerminalStatusList} from 'td/workbench/contrib/terminal/browser/terminalStatusList';
import {getTerminalResourcesFromDragEvent, getTerminalUri} from 'td/workbench/contrib/terminal/browser/terminalUri';
import {TerminalWidgetManager} from 'td/workbench/contrib/terminal/browser/widgets/widgetManager';
import {LineDataEventAddon} from 'td/workbench/contrib/terminal/browser/xterm/lineDataEventAddon';
import {XtermTerminal, getXtermScaledDimensions} from 'td/workbench/contrib/terminal/browser/xterm/xtermTerminal';
import {IEnvironmentVariableInfo} from 'td/workbench/contrib/terminal/common/environmentVariable';
import {getCommandHistory, getDirectoryHistory} from 'td/workbench/contrib/terminal/common/history';
import {DEFAULT_COMMANDS_TO_SKIP_SHELL, ITerminalProcessManager, ITerminalProfileResolverService, ProcessState, TERMINAL_CREATION_COMMANDS, TERMINAL_VIEW_ID, TerminalCommandId} from 'td/workbench/contrib/terminal/common/terminal';
import {TERMINAL_BACKGROUND_COLOR} from 'td/workbench/contrib/terminal/common/terminalColorRegistry';
import {TerminalContextKeys} from 'td/workbench/contrib/terminal/common/terminalContextKey';
import {getWorkspaceForTerminal, preparePathForShell} from 'td/workbench/contrib/terminal/common/terminalEnvironment';
...
import {IWorkbenchLayoutService, Position} from 'td/workbench/services/layout/browser/layoutService';
...
import {importAMDNodeModule} from 'td/amdX';
...
import {shouldPasteTerminalText} from 'td/workbench/contrib/terminal/common/terminalClipboard';
...
export class TerminalInstance extends Disposable implements ITerminalInstance {
	...
	protected async _createXterm(): Promise<XtermTerminal> {
		...
		this.xterm = xterm;
		this.updateAccessibilitySupport();
		this.xterm.onDidRequestRunCommand((e: any) => {
			if (e.copyAsHtml) {
		...
		this.xterm.onDidRequestSendText((e: any) => this.sendText(e, false));
