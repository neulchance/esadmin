...
import {env} from 'td/base/common/process';
...
import {IProcessEnvironment, OperatingSystem, OS} from 'td/base/common/platform';
import {IShellLaunchConfig, ITerminalLogService, ITerminalProfile, TerminalIcon, TerminalSettingId} from 'td/platform/terminal/common/terminal';
import {IShellLaunchConfigResolveOptions, ITerminalProfileResolverService, ITerminalProfileService} from 'td/workbench/contrib/terminal/common/terminal';
import * as path from 'td/base/common/path';
import {Codicon} from 'td/base/common/codicons';
import {getIconRegistry, IIconRegistry} from 'td/platform/theme/common/iconRegistry';
...
import {isUriComponents} from 'td/platform/terminal/common/terminalProfiles';
