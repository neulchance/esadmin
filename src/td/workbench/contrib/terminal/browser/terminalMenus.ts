...
import {Action, IAction, Separator, SubmenuAction} from 'td/base/common/actions';
...
import {IMenu, MenuId, MenuRegistry} from 'td/platform/actions/common/actions';
import {ContextKeyExpr} from 'td/platform/contextkey/common/contextkey';
import {IExtensionTerminalProfile, ITerminalProfile, TerminalLocation, TerminalSettingId} from 'td/platform/terminal/common/terminal';
import {ResourceContextKey} from 'td/workbench/common/contextkeys';
import {TaskExecutionSupportedContext} from 'td/workbench/contrib/tasks/common/taskService';
import {ICreateTerminalOptions, ITerminalLocationOptions, ITerminalService} from 'td/workbench/contrib/terminal/browser/terminal';
import {TerminalCommandId, TERMINAL_VIEW_ID} from 'td/workbench/contrib/terminal/common/terminal';
