...
import {IProcessReadyEvent, IShellLaunchConfig, ITerminalChildProcess, ITerminalDimensions, ITerminalLaunchError, IProcessProperty, ProcessPropertyType, IProcessPropertyMap} from 'td/platform/terminal/common/terminal';
import {ITerminalService} from 'td/workbench/contrib/terminal/browser/terminal';
import {ITerminalProcessExtHostProxy} from 'td/workbench/contrib/terminal/common/terminal';
