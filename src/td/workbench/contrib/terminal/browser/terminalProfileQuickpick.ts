...
import {IQuickInputService, IKeyMods, IPickOptions, IQuickPickSeparator, IQuickInputButton, IQuickPickItem} from 'td/platform/quickinput/common/quickInput';
import {IExtensionTerminalProfile, ITerminalProfile, ITerminalProfileObject, TerminalSettingPrefix} from 'td/platform/terminal/common/terminal';
import {getUriClasses, getColorClass, createColorStyleElement} from 'td/workbench/contrib/terminal/browser/terminalIcon';
import {configureTerminalProfileIcon} from 'td/workbench/contrib/terminal/browser/terminalIcons';
...
import {ITerminalProfileResolverService, ITerminalProfileService} from 'td/workbench/contrib/terminal/common/terminal';
import {IQuickPickTerminalObject, ITerminalInstance} from 'td/workbench/contrib/terminal/browser/terminal';
import {IPickerQuickAccessItem} from 'td/platform/quickinput/browser/pickerQuickAccess';
