...
import {IListService, WorkbenchList} from 'td/platform/list/browser/listService';
...
import {ITerminalGroupService, ITerminalInstance, ITerminalService, TerminalDataTransfers} from 'td/workbench/contrib/terminal/browser/terminal';
...
import {ITerminalBackend, TerminalLocation, TerminalSettingId} from 'td/platform/terminal/common/terminal';
import {Codicon} from 'td/base/common/codicons';
import {Action} from 'td/base/common/actions';
import {DEFAULT_LABELS_CONTAINER, IResourceLabel, ResourceLabels} from 'td/workbench/browser/labels';
import {IDecorationData, IDecorationsProvider, IDecorationsService} from 'td/workbench/services/decorations/common/decorations';
import {IHoverAction, IHoverService} from 'td/platform/hover/browser/hover';
import Severity from 'td/base/common/severity';
import {Disposable, DisposableStore, dispose, IDisposable, toDisposable} from 'td/base/common/lifecycle';
import {IListDragAndDrop, IListDragOverReaction, IListRenderer, ListDragOverEffectPosition, ListDragOverEffectType} from 'td/base/browser/ui/list/list';
...
import {getColorClass, getIconId, getUriClasses} from 'td/workbench/contrib/terminal/browser/terminalIcon';
...
import {IProcessDetails} from 'td/platform/terminal/common/terminalProcess';
import {TerminalContextKeys} from 'td/workbench/contrib/terminal/common/terminalContextKey';
import {getTerminalResourcesFromDragEvent, parseTerminalUri} from 'td/workbench/contrib/terminal/browser/terminalUri';
...
import {TerminalContextActionRunner} from 'td/workbench/contrib/terminal/browser/terminalContextMenu';
