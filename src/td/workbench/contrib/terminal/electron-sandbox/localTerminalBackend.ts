...
import {IProcessEnvironment, isMacintosh, isWindows, OperatingSystem} from 'td/base/common/platform';
...
import {ILocalPtyService, IProcessPropertyMap, IPtyHostLatencyMeasurement, IPtyService, IShellLaunchConfig, ITerminalBackend, ITerminalBackendRegistry, ITerminalChildProcess, ITerminalEnvironment, ITerminalLogService, ITerminalProcessOptions, ITerminalsLayoutInfo, ITerminalsLayoutInfoById, ProcessPropertyType, TerminalExtensions, TerminalIpcChannels, TerminalSettingId, TitleEventSource} from 'td/platform/terminal/common/terminal';
import {IGetTerminalLayoutInfoArgs, IProcessDetails, ISetTerminalLayoutInfoArgs} from 'td/platform/terminal/common/terminalProcess';
...
import {ITerminalConfiguration, ITerminalProfileResolverService, TERMINAL_CONFIG_SECTION} from 'td/workbench/contrib/terminal/common/terminal';
import {TerminalStorageKeys} from 'td/workbench/contrib/terminal/common/terminalStorageKeys';
import {LocalPty} from 'td/workbench/contrib/terminal/electron-sandbox/localPty';
...
import {BaseTerminalBackend} from 'td/workbench/contrib/terminal/browser/baseTerminalBackend';
import {INativeHostService} from 'td/platform/native/common/native';
import {Client as MessagePortClient} from 'td/base/parts/ipc/common/ipc.mp';
import {acquirePort} from 'td/base/parts/ipc/electron-sandbox/ipc.mp';
import {getDelayedChannel, ProxyChannel} from 'td/base/parts/ipc/common/ipc';
import {mark, PerformanceMark} from 'td/base/common/performance';
