...
import * as extensionsRegistry from 'td/workbench/services/extensions/common/extensionsRegistry';
import {terminalContributionsDescriptor} from 'td/workbench/contrib/terminal/common/terminal';
import {createDecorator} from 'td/platform/instantiation/common/instantiation';
import {IExtensionTerminalProfile, ITerminalContributions, ITerminalProfileContribution} from 'td/platform/terminal/common/terminal';
