...
import {DEFAULT_LETTER_SPACING, DEFAULT_LINE_HEIGHT, DEFAULT_COMMANDS_TO_SKIP_SHELL, SUGGESTIONS_FONT_WEIGHT, MINIMUM_FONT_WEIGHT, MAXIMUM_FONT_WEIGHT, DEFAULT_LOCAL_ECHO_EXCLUDE} from 'td/workbench/contrib/terminal/common/terminal';
import {TerminalLocationString, TerminalSettingId} from 'td/platform/terminal/common/terminal';
...
import {terminalColorSchema, terminalIconSchema} from 'td/platform/terminal/common/terminalPlatformConfiguration';
