...
import {SideBySideEditor, EditorResourceAccessor} from 'td/workbench/common/editor';
...
import {IProcessEnvironment, OperatingSystem} from 'td/base/common/platform';
import {ICompleteTerminalConfiguration} from 'td/workbench/contrib/terminal/common/terminal';
import {IPtyHostProcessReplayEvent} from 'td/platform/terminal/common/capabilities/capabilities';
import {ISerializableEnvironmentDescriptionMap as ISerializableEnvironmentDescriptionMap, ISerializableEnvironmentVariableCollection} from 'td/platform/terminal/common/environmentVariable';
import type * as performance from 'td/base/common/performance';
import {RemoteTerminalChannelEvent, RemoteTerminalChannelRequest} from 'td/workbench/contrib/terminal/common/remote/terminal';
