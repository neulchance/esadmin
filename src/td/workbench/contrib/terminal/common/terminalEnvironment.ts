...
import {IShellLaunchConfig, ITerminalBackend, ITerminalEnvironment, TerminalShellType, WindowsShellType} from 'td/platform/terminal/common/terminal';
import {IProcessEnvironment, isWindows, language, OperatingSystem} from 'td/base/common/platform';
import {escapeNonWindowsPath, sanitizeCwd} from 'td/platform/terminal/common/terminalEnvironment';
