...
import {$, Dimension, addDisposableListener, append, clearNode, getWindow, reset} from 'td/base/browser/dom';
import {renderFormattedText} from 'td/base/browser/formattedTextRenderer';
...
import {Toggle} from 'td/base/browser/ui/toggle/toggle';
import {coalesce, equals, flatten} from 'td/base/common/arrays';
import {Delayer, Throttler} from 'td/base/common/async';
...
import {ILink, LinkedText} from 'td/base/common/linkedText';
...
import {ContextKeyExpr, ContextKeyExpression, IContextKeyService, RawContextKey} from 'td/platform/contextkey/common/contextkey';
...
import {ITelemetryService, TelemetryLevel, firstSessionDateStorageKey} from 'td/platform/telemetry/common/telemetry';
import {getTelemetryLevel} from 'td/platform/telemetry/common/telemetryUtils';
import {defaultButtonStyles, defaultToggleStyles} from 'td/platform/theme/browser/defaultStyles';
...
import {IWorkspaceContextService, UNKNOWN_EMPTY_WINDOW_WORKSPACE} from 'td/platform/workspace/common/workspace';
import {IRecentFolder, IRecentWorkspace, IRecentlyOpened, IWorkspacesService, isRecentFolder, isRecentWorkspace} from 'td/platform/workspaces/common/workspaces';
import {OpenRecentAction} from 'td/workbench/browser/actions/windowActions';
import {OpenFileFolderAction, OpenFolderAction, OpenFolderViaWorkspaceAction} from 'td/workbench/browser/actions/workspaceActions';
import {EditorPane} from 'td/workbench/browser/parts/editor/editorPane';
import {WorkbenchStateContext} from 'td/workbench/common/contextkeys';
import {IEditorOpenContext, IEditorSerializer} from 'td/workbench/common/editor';
import {IWebviewElement, IWebviewService} from 'td/workbench/contrib/webview/browser/webview';
import 'td/workbench/contrib/welcomeGettingStarted/browser/gettingStartedColors';
import {GettingStartedDetailsRenderer} from 'td/workbench/contrib/welcomeGettingStarted/browser/gettingStartedDetailsRenderer';
import {gettingStartedCheckedCodicon, gettingStartedUncheckedCodicon} from 'td/workbench/contrib/welcomeGettingStarted/browser/gettingStartedIcons';
import {GettingStartedInput} from 'td/workbench/contrib/welcomeGettingStarted/browser/gettingStartedInput';
import {IResolvedWalkthrough, IResolvedWalkthroughStep, IWalkthroughsService, hiddenEntriesConfigurationKey} from 'td/workbench/contrib/welcomeGettingStarted/browser/gettingStartedService';
import {RestoreWalkthroughsConfigurationValue, restoreWalkthroughsConfigurationKey} from 'td/workbench/contrib/welcomeGettingStarted/browser/startupPage';
import {startEntries} from 'td/workbench/contrib/welcomeGettingStarted/common/gettingStartedContent';
import {GroupDirection, GroupsOrder, IEditorGroupsService} from 'td/workbench/services/editor/common/editorGroupsService';
...
import {ThemeSettings} from 'td/workbench/services/themes/common/workbenchThemeService';
