...
import {GettingStartedInputSerializer, GettingStartedPage, inWelcomeContext} from 'td/workbench/contrib/welcomeGettingStarted/browser/gettingStarted';
...
import {MenuId, registerAction2, Action2} from 'td/platform/actions/common/actions';
...
import {IWalkthroughsService} from 'td/workbench/contrib/welcomeGettingStarted/browser/gettingStartedService';
import {GettingStartedEditorOptions, GettingStartedInput} from 'td/workbench/contrib/welcomeGettingStarted/browser/gettingStartedInput';
import {registerWorkbenchContribution2, WorkbenchPhase} from 'td/workbench/common/contributions';
import {ConfigurationScope, Extensions as ConfigurationExtensions, IConfigurationRegistry} from 'td/platform/configuration/common/configurationRegistry';
...
import {isLinux, isMacintosh, isWindows, OperatingSystem as OS} from 'td/base/common/platform';
...
import {StartupPageEditorResolverContribution, StartupPageRunnerContribution} from 'td/workbench/contrib/welcomeGettingStarted/browser/startupPage';
...
export * as icons from 'td/workbench/contrib/welcomeGettingStarted/browser/gettingStartedIcons';
