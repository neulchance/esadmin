...
import {IWorkspaceContextService, UNKNOWN_EMPTY_WINDOW_WORKSPACE, WorkbenchState} from 'td/platform/workspace/common/workspace';
import {IConfigurationService} from 'td/platform/configuration/common/configuration';
import {IWorkingCopyBackupService} from 'td/workbench/services/workingCopy/common/workingCopyBackup';
import {ILifecycleService, LifecyclePhase, StartupKind} from 'td/workbench/services/lifecycle/common/lifecycle';
...
import {GettingStartedEditorOptions, GettingStartedInput, gettingStartedInputTypeId} from 'td/workbench/contrib/welcomeGettingStarted/browser/gettingStartedInput';
