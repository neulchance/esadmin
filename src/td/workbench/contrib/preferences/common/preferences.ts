...
import {IExtensionRecommendations} from 'td/base/common/product';
...
import {ISearchResult, ISettingsEditorModel} from 'td/workbench/services/preferences/common/preferences';
