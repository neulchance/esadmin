...
import 'td/css!./media/extension';
import {append, $, addDisposableListener} from 'td/base/browser/dom';
import {IDisposable, dispose, combinedDisposable} from 'td/base/common/lifecycle';
...
import {IPagedRenderer} from 'td/base/browser/ui/list/listPaging';
import {Event} from 'td/base/common/event';
import {IExtension, ExtensionContainers, ExtensionState, IExtensionsWorkbenchService} from 'td/workbench/contrib/extensions/common/extensions';
...
import {RatingsWidget, InstallCountWidget, RecommendationWidget, RemoteBadgeWidget, ExtensionPackCountWidget as ExtensionPackBadgeWidget, SyncIgnoredWidget, ExtensionHoverWidget, ExtensionActivationStatusWidget, PreReleaseBookmarkWidget, extensionVerifiedPublisherIconColor, VerifiedPublisherWidget} from 'td/workbench/contrib/extensions/browser/extensionsWidgets';
...
import {isLanguagePackExtension} from 'td/platform/extensions/common/extensions';
...
import {WORKBENCH_BACKGROUND} from 'td/workbench/common/theme';
...
import {verifiedPublisherIcon as verifiedPublisherThemeIcon} from 'td/workbench/contrib/extensions/browser/extensionsIcons';
