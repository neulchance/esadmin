...
import {index} from 'td/base/common/arrays';
import {CancelablePromise, Promises, ThrottledDelayer, createCancelablePromise} from 'td/base/common/async';
import {CancellationError, isCancellationError} from 'td/base/common/errors';
import {Disposable, toDisposable} from 'td/base/common/lifecycle';
import {IPager, singlePagePager} from 'td/base/common/paging';
...
import {IWorkbenchExtensionEnablementService, EnablementState, IExtensionManagementServerService, IExtensionManagementServer, IWorkbenchExtensionManagementService, DefaultIconPath} from 'td/workbench/services/extensionManagement/common/extensionManagement';
import {getGalleryExtensionTelemetryData, getLocalExtensionTelemetryData, areSameExtensions, groupByExtension, getGalleryExtensionId} from 'td/platform/extensionManagement/common/extensionManagementUtil';
import {IInstantiationService} from 'td/platform/instantiation/common/instantiation';
import {IConfigurationService} from 'td/platform/configuration/common/configuration';
import {IHostService} from 'td/workbench/services/host/browser/host';
import {URI} from 'td/base/common/uri';
import {IExtension, ExtensionState, IExtensionsWorkbenchService, AutoUpdateConfigurationKey, AutoCheckUpdatesConfigurationKey, HasOutdatedExtensionsContext, AutoUpdateConfigurationValue} from 'td/workbench/contrib/extensions/common/extensions';
...
import {IProgressOptions, IProgressService, ProgressLocation} from 'td/platform/progress/common/progress';
...
import {IExtensionManifest, ExtensionType, IExtension as IPlatformExtension, TargetPlatform, ExtensionIdentifier, IExtensionIdentifier, IExtensionDescription, isApplicationScopedExtension} from 'td/platform/extensions/common/extensions';
...
import {isBoolean, isString, isUndefined} from 'td/base/common/types';
...
import {IExtensionService, IExtensionsStatus, toExtension, toExtensionDescription} from 'td/workbench/services/extensions/common/extensions';
import {ExtensionEditor} from 'td/workbench/contrib/extensions/browser/extensionEditor';
import {isWeb, language} from 'td/base/common/platform';
		...
		if (this.type === ExtensionType.System && this.local) {
			if (this.local.manifest && this.local.manifest.contributes) {
				if (Array.isArray(this.local.manifest.contributes.themes) && this.local.manifest.contributes.themes.length) {
					return FileAccess.asBrowserUri('td/workbench/contrib/extensions/browser/media/theme-icon.png').toString(true);
				}
				if (Array.isArray(this.local.manifest.contributes.grammars) && this.local.manifest.contributes.grammars.length) {
					return FileAccess.asBrowserUri('td/workbench/contrib/extensions/browser/media/language-icon.svg').toString(true);
				}
			}
		}
