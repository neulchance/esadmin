...
import {ExtensionRecommendationReason, IExtensionIgnoredRecommendationsService} from 'td/workbench/services/extensionRecommendations/common/extensionRecommendations';
import {IExtensionsWorkbenchService, IExtension} from 'td/workbench/contrib/extensions/common/extensions';
...
import {IFileContentCondition, IFilePathCondition, IFileLanguageCondition, IFileOpenCondition} from 'td/base/common/product';
...
import {basename, extname} from 'td/base/common/resources';
import {match} from 'td/base/common/glob';
...
import {IExtensionRecommendationNotificationService, RecommendationsNotificationResult, RecommendationSource} from 'td/platform/extensionRecommendations/common/extensionRecommendations';
import {distinct} from 'td/base/common/arrays';
import {DisposableStore} from 'td/base/common/lifecycle';
import {CellUri} from 'td/workbench/contrib/notebook/common/notebookCommon';
