...
import 'td/css!./media/extensionsWidgets';
import * as semver from 'td/base/common/semver/semver';
import {Disposable, toDisposable, DisposableStore, MutableDisposable, IDisposable} from 'td/base/common/lifecycle';
import {IExtension, IExtensionsWorkbenchService, IExtensionContainer, ExtensionState, ExtensionEditorTab} from 'td/workbench/contrib/extensions/common/extensions';
import {append, $, reset, addDisposableListener, EventType, finalHandler} from 'td/base/browser/dom';
import * as platform from 'td/base/common/platform';
import {localize} from 'td/nls';
import {EnablementState, IExtensionManagementServerService} from 'td/workbench/services/extensionManagement/common/extensionManagement';
...
import {extensionButtonProminentBackground, ExtensionStatusAction} from 'td/workbench/contrib/extensions/browser/extensionsActions';
...
import {EXTENSION_BADGE_REMOTE_BACKGROUND, EXTENSION_BADGE_REMOTE_FOREGROUND} from 'td/workbench/common/theme';
...
import {activationTimeIcon, errorIcon, infoIcon, installCountIcon, preReleaseIcon, ratingIcon, remoteIcon, sponsorIcon, starEmptyIcon, starFullIcon, starHalfIcon, syncIgnoredIcon, verifiedPublisherIcon, warningIcon} from 'td/workbench/contrib/extensions/browser/extensionsIcons';
import {registerColor, textLinkForeground} from 'td/platform/theme/common/colorRegistry';
...
import {setupCustomHover} from 'td/base/browser/ui/iconLabel/iconLabelHover';
