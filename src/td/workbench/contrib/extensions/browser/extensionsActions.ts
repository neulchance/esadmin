...
import 'td/css!./media/extensionActions';
import {localize, localize2} from 'td/nls';
import {IAction, Action, Separator, SubmenuAction} from 'td/base/common/actions';
import {Delayer, Promises, Throttler} from 'td/base/common/async';
import * as DOM from 'td/base/browser/dom';
import {Emitter, Event} from 'td/base/common/event';
import * as json from 'td/base/common/json';
import {IContextMenuService} from 'td/platform/contextview/browser/contextView';
import {disposeIfDisposable} from 'td/base/common/lifecycle';
import {IExtension, ExtensionState, IExtensionsWorkbenchService, VIEWLET_ID, IExtensionsViewPaneContainer, IExtensionContainer, TOGGLE_IGNORE_EXTENSION_ACTION_ID, SELECT_INSTALL_VSIX_EXTENSION_COMMAND_ID, THEME_ACTIONS_GROUP, INSTALL_ACTIONS_GROUP, UPDATE_ACTIONS_GROUP, AutoUpdateConfigurationKey, AutoUpdateConfigurationValue, ExtensionEditorTab} from 'td/workbench/contrib/extensions/common/extensions';
import {ExtensionsConfigurationInitialContent} from 'td/workbench/contrib/extensions/common/extensionsFileTemplate';
import {IGalleryExtension, IExtensionGalleryService, ILocalExtension, InstallOptions, InstallOperation, TargetPlatformToString, ExtensionManagementErrorCode} from 'td/platform/extensionManagement/common/extensionManagement';
import {IWorkbenchExtensionEnablementService, EnablementState, IExtensionManagementServerService, IExtensionManagementServer} from 'td/workbench/services/extensionManagement/common/extensionManagement';
import {ExtensionRecommendationReason, IExtensionIgnoredRecommendationsService, IExtensionRecommendationsService} from 'td/workbench/services/extensionRecommendations/common/extensionRecommendations';
import {areSameExtensions, getExtensionId} from 'td/platform/extensionManagement/common/extensionManagementUtil';
import {ExtensionType, ExtensionIdentifier, IExtensionDescription, IExtensionManifest, isLanguagePackExtension, getWorkspaceSupportTypeMessage, TargetPlatform, isApplicationScopedExtension} from 'td/platform/extensions/common/extensions';
import {IInstantiationService, ServicesAccessor} from 'td/platform/instantiation/common/instantiation';
import {IFileService, IFileContent} from 'td/platform/files/common/files';
import {IWorkspaceContextService, WorkbenchState, IWorkspaceFolder} from 'td/platform/workspace/common/workspace';
import {IHostService} from 'td/workbench/services/host/browser/host';
import {IExtensionService, toExtension, toExtensionDescription} from 'td/workbench/services/extensions/common/extensions';
import {URI} from 'td/base/common/uri';
import {CommandsRegistry, ICommandService} from 'td/platform/commands/common/commands';
import {IConfigurationService} from 'td/platform/configuration/common/configuration';
import {registerThemingParticipant, IColorTheme, ICssStyleCollector} from 'td/platform/theme/common/themeService';
import {ThemeIcon} from 'td/base/common/themables';
import {buttonBackground, buttonForeground, buttonHoverBackground, registerColor, editorWarningForeground, editorInfoForeground, editorErrorForeground, buttonSeparator} from 'td/platform/theme/common/colorRegistry';
import {IJSONEditingService} from 'td/workbench/services/configuration/common/jsonEditing';
import {ITextEditorSelection} from 'td/platform/editor/common/editor';
...
import {MenuId, IMenuService, MenuItemAction, SubmenuItemAction} from 'td/platform/actions/common/actions';
import {PICK_WORKSPACE_FOLDER_COMMAND_ID} from 'td/workbench/browser/actions/workspaceCommands';
...
import {IQuickPickItem, IQuickInputService, IQuickPickSeparator, QuickPickItem} from 'td/platform/quickinput/common/quickInput';
import {CancellationToken} from 'td/base/common/cancellation';
import {alert} from 'td/base/browser/ui/aria/aria';
import {IWorkbenchThemeService, IWorkbenchTheme, IWorkbenchColorTheme, IWorkbenchFileIconTheme, IWorkbenchProductIconTheme} from 'td/workbench/services/themes/common/workbenchThemeService';
import {ILabelService} from 'td/platform/label/common/label';
import {ITextFileService} from 'td/workbench/services/textfile/common/textfiles';
...
import {IActionViewItemOptions, ActionViewItem} from 'td/base/browser/ui/actionbar/actionViewItems';
import {EXTENSIONS_CONFIG, IExtensionsConfigContent} from 'td/workbench/services/extensionRecommendations/common/workspaceExtensionsConfig';
import {getErrorMessage, isCancellationError} from 'td/base/common/errors';
import {IUserDataSyncEnablementService} from 'td/platform/userDataSync/common/userDataSync';
import {ActionWithDropdownActionViewItem, IActionWithDropdownActionViewItemOptions} from 'td/base/browser/ui/dropdown/dropdownActionViewItem';
import {IContextMenuProvider} from 'td/base/browser/contextmenu';
import {ILogService} from 'td/platform/log/common/log';
import {errorIcon, infoIcon, manageExtensionIcon, syncEnabledIcon, syncIgnoredIcon, trustIcon, warningIcon} from 'td/workbench/contrib/extensions/browser/extensionsIcons';
import {isIOS, isWeb, language} from 'td/base/common/platform';
...
import {IWorkspaceTrustEnablementService, IWorkspaceTrustManagementService} from 'td/platform/workspace/common/workspaceTrust';
import {isVirtualWorkspace} from 'td/platform/workspace/common/virtualWorkspace';
import {escapeMarkdownSyntaxTokens, IMarkdownString, MarkdownString} from 'td/base/common/htmlContent';
...
import {fromNow} from 'td/base/common/date';
import {IPreferencesService} from 'td/workbench/services/preferences/common/preferences';
import {getLocale} from 'td/platform/languagePacks/common/languagePacks';
import {ILocaleService} from 'td/workbench/services/localization/common/locale';
import {isString} from 'td/base/common/types';
import {showWindowLogActionId} from 'td/workbench/services/log/common/logConstants';
import {ITelemetryService} from 'td/platform/telemetry/common/telemetry';
import {Extensions, IExtensionFeaturesManagementService, IExtensionFeaturesRegistry} from 'td/workbench/services/extensionManagement/common/extensionFeatures';
