...
import {MenuRegistry, MenuId, registerAction2, Action2, ISubmenuItem, IMenuItem, IAction2Options} from 'td/platform/actions/common/actions';
import {InstantiationType, registerSingleton} from 'td/platform/instantiation/common/extensions';
import {ExtensionsLocalizedLabel, IExtensionManagementService, IExtensionGalleryService, PreferencesLocalizedLabel, InstallOperation, InstallOptions} from 'td/platform/extensionManagement/common/extensionManagement';
import {EnablementState, IExtensionManagementServerService, IWorkbenchExtensionEnablementService, IWorkbenchExtensionManagementService} from 'td/workbench/services/extensionManagement/common/extensionManagement';
import {IExtensionIgnoredRecommendationsService, IExtensionRecommendationsService} from 'td/workbench/services/extensionRecommendations/common/extensionRecommendations';
...
import {KeymapExtensions} from 'td/workbench/contrib/extensions/common/extensionsUtils';
import {areSameExtensions, getIdAndVersion} from 'td/platform/extensionManagement/common/extensionManagementUtil';
...
import {ExtensionActivationProgress} from 'td/workbench/contrib/extensions/browser/extensionsActivationProgress';
import {onUnexpectedError} from 'td/base/common/errors';
import {ExtensionDependencyChecker} from 'td/workbench/contrib/extensions/browser/extensionsDependencyChecker';
import {CancellationToken} from 'td/base/common/cancellation';
import {IViewContainersRegistry, ViewContainerLocation, Extensions as ViewContainerExtensions} from 'td/workbench/common/views';
...
import {MultiCommand} from 'td/editor/browser/editorExtensions';
import {IWebview} from 'td/workbench/contrib/webview/browser/webview';
import {ExtensionsWorkbenchService} from 'td/workbench/contrib/extensions/browser/extensionsWorkbenchService';
...
import {ExtensionRecommendationNotificationService} from 'td/workbench/contrib/extensions/browser/extensionRecommendationNotificationService';
import {IExtensionService, toExtensionDescription} from 'td/workbench/services/extensions/common/extensions';
...
import {ResourceContextKey, WorkbenchStateContext} from 'td/workbench/common/contextkeys';
import {IAction} from 'td/base/common/actions';
import {IWorkspaceExtensionsConfigService} from 'td/workbench/services/extensionRecommendations/common/workspaceExtensionsConfig';
import {Schemas} from 'td/base/common/network';
import {ShowRuntimeExtensionsAction} from 'td/workbench/contrib/extensions/browser/abstractRuntimeExtensionsEditor';
// import {ExtensionEnablementWorkspaceTrustTransitionParticipant} from 'td/workbench/contrib/extensions/browser/extensionEnablementWorkspaceTrustTransitionParticipant';
import {clearSearchResultsIcon, configureRecommendedIcon, extensionsViewIcon, filterIcon, installWorkspaceRecommendedIcon, refreshIcon} from 'td/workbench/contrib/extensions/browser/extensionsIcons';
import {EXTENSION_CATEGORIES} from 'td/platform/extensions/common/extensions';
import {Disposable, DisposableStore, IDisposable, isDisposable} from 'td/base/common/lifecycle';
import {IConfigurationService} from 'td/platform/configuration/common/configuration';
import {IDialogService, IFileDialogService} from 'td/platform/dialogs/common/dialogs';
import {mnemonicButtonLabel} from 'td/base/common/labels';
import {Query} from 'td/workbench/contrib/extensions/common/extensionQuery';
import {Promises} from 'td/base/common/async';
import {EditorExtensions} from 'td/workbench/common/editor';
import {WORKSPACE_TRUST_EXTENSION_SUPPORT} from 'td/workbench/services/workspaces/common/workspaceTrust';
import {ExtensionsCompletionItemsProvider} from 'td/workbench/contrib/extensions/browser/extensionsCompletionItemsProvider';
...
import {UnsupportedExtensionsMigrationContrib} from 'td/workbench/contrib/extensions/browser/unsupportedExtensionsMigrationContribution';
import {isWeb} from 'td/base/common/platform';
import {ExtensionStorageService} from 'td/platform/extensionManagement/common/extensionStorage';
import {IStorageService} from 'td/platform/storage/common/storage';
import {IStringDictionary} from 'td/base/common/collections';
import {CONTEXT_KEYBINDINGS_EDITOR} from 'td/workbench/contrib/preferences/common/preferences';
import {DeprecatedExtensionsChecker} from 'td/workbench/contrib/extensions/browser/deprecatedExtensionsChecker';
