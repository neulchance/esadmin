...
import 'td/css!./media/extensionsViewlet';
import {localize, localize2} from 'td/nls';
import {timeout, Delayer, Promises} from 'td/base/common/async';
...
import {append, $, Dimension, hide, show, DragAndDropObserver, trackFocus} from 'td/base/browser/dom';
...
import {IViewsRegistry, IViewDescriptor, Extensions, ViewContainer, IViewDescriptorService, IAddedViewDescriptorRef, ViewContainerLocation} from 'td/workbench/common/views';
...
import {IContextKeyService, ContextKeyExpr, RawContextKey, IContextKey} from 'td/platform/contextkey/common/contextkey';
import {IContextMenuService} from 'td/platform/contextview/browser/contextView';
import {ILogService} from 'td/platform/log/common/log';
import {INotificationService, NotificationPriority} from 'td/platform/notification/common/notification';
...
import {SuggestEnabledInput} from 'td/workbench/contrib/codeEditor/browser/suggestEnabledInput/suggestEnabledInput';
import {alert} from 'td/base/browser/ui/aria/aria';
import {EXTENSION_CATEGORIES, ExtensionType} from 'td/platform/extensions/common/extensions';
import {Registry} from 'td/platform/registry/common/platform';
import {ILabelService} from 'td/platform/label/common/label';
import {MementoObject} from 'td/workbench/common/memento';
...
import {SIDE_BAR_DRAG_AND_DROP_BACKGROUND} from 'td/workbench/common/theme';
import {IWorkbenchEnvironmentService} from 'td/workbench/services/environment/common/environmentService';
import {VirtualWorkspaceContext, WorkbenchStateContext} from 'td/workbench/common/contextkeys';
import {ICommandService} from 'td/platform/commands/common/commands';
import {installLocalInRemoteIcon} from 'td/workbench/contrib/extensions/browser/extensionsIcons';
import {registerAction2, Action2, MenuId} from 'td/platform/actions/common/actions';
...
import {extractEditorsAndFilesDropData} from 'td/platform/dnd/browser/dnd';
import {extname} from 'td/base/common/resources';
...
import {registerNavigableContainer} from 'td/workbench/browser/actions/widgetNavigationCommands';
