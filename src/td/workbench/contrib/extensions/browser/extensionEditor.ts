...
import {$, Dimension, addDisposableListener, append, join, reset, setParentFlowTo} from 'td/base/browser/dom';
import {renderMarkdown} from 'td/base/browser/markdownRenderer';
import {ActionBar} from 'td/base/browser/ui/actionbar/actionbar';
import {KeybindingLabel} from 'td/base/browser/ui/keybindingLabel/keybindingLabel';
import {DomScrollableElement} from 'td/base/browser/ui/scrollbar/scrollableElement';
import {CheckboxActionViewItem} from 'td/base/browser/ui/toggle/toggle';
import {Action, IAction} from 'td/base/common/actions';
import * as arrays from 'td/base/common/arrays';
import {Cache, CacheResult} from 'td/base/common/cache';
import {CancellationToken, CancellationTokenSource} from 'td/base/common/cancellation';
import {Color} from 'td/base/common/color';
import {getErrorMessage, isCancellationError, onUnexpectedError} from 'td/base/common/errors';
...
import {Disposable, DisposableStore, MutableDisposable, dispose, toDisposable} from 'td/base/common/lifecycle';
import {Schemas, matchesScheme} from 'td/base/common/network';
import {OS, language} from 'td/base/common/platform';
import {platform} from 'td/base/common/process';
import * as semver from 'td/base/common/semver/semver';
...
import 'td/css!./media/extensionEditor';
...
import {getDefaultValue} from 'td/platform/configuration/common/configurationRegistry';
import {ContextKeyExpr, IContextKey, IContextKeyService, IScopedContextKeyService, RawContextKey} from 'td/platform/contextkey/common/contextkey';
import {IContextMenuService} from 'td/platform/contextview/browser/contextView';
import {IExtensionGalleryService, IGalleryExtension} from 'td/platform/extensionManagement/common/extensionManagement';
import {areSameExtensions} from 'td/platform/extensionManagement/common/extensionManagementUtil';
import {ExtensionIdentifier, IExtensionManifest, IKeyBinding, IView, IViewContainer} from 'td/platform/extensions/common/extensions';
...
import {defaultCheckboxStyles, defaultKeybindingLabelStyles} from 'td/platform/theme/browser/defaultStyles';
import {buttonForeground, buttonHoverBackground, editorBackground, textLinkActiveForeground, textLinkForeground} from 'td/platform/theme/common/colorRegistry';
import {IColorTheme, ICssStyleCollector, IThemeService, registerThemingParticipant} from 'td/platform/theme/common/themeService';
...
import {errorIcon, infoIcon, preReleaseIcon, warningIcon} from 'td/workbench/contrib/extensions/browser/extensionsIcons';
import {Delegate} from 'td/workbench/contrib/extensions/browser/extensionsList';
import {ExtensionData, ExtensionsGridView, ExtensionsTree, getExtensions} from 'td/workbench/contrib/extensions/browser/extensionsViewer';
import {ExtensionRecommendationWidget, ExtensionStatusWidget, ExtensionWidget, InstallCountWidget, RatingsWidget, RemoteBadgeWidget, SponsorWidget, VerifiedPublisherWidget, onClick} from 'td/workbench/contrib/extensions/browser/extensionsWidgets';
import {ExtensionContainers, ExtensionEditorTab, ExtensionState, IExtension, IExtensionContainer, IExtensionsViewPaneContainer, IExtensionsWorkbenchService, VIEWLET_ID} from 'td/workbench/contrib/extensions/common/extensions';
import {ExtensionsInput, IExtensionEditorOptions} from 'td/workbench/contrib/extensions/common/extensionsInput';
...
import {ShowCurrentReleaseNotesActionId} from 'td/workbench/contrib/update/common/update';
import {IWebview, IWebviewService, KEYBINDING_CONTEXT_WEBVIEW_FIND_WIDGET_FOCUSED} from 'td/workbench/contrib/webview/browser/webview';
import {IEditorService} from 'td/workbench/services/editor/common/editorService';
import {IExtensionRecommendationsService} from 'td/workbench/services/extensionRecommendations/common/extensionRecommendations';
