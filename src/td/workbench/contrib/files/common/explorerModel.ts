...
import {IFileStat, IFileService, FileSystemProviderCapabilities} from 'td/platform/files/common/files';
import {rtrim, startsWithIgnoreCase, equalsIgnoreCase} from 'td/base/common/strings';
...
import {joinPath, isEqualOrParent, basenameOrAuthority} from 'td/base/common/resources';
import {IFilesConfiguration, SortOrder} from 'td/workbench/contrib/files/common/files';
import {IUriIdentityService} from 'td/platform/uriIdentity/common/uriIdentity';
import {ExplorerFileNestingTrie} from 'td/workbench/contrib/files/common/explorerFileNestingTrie';
