...
import {IWorkbenchEditorConfiguration, IEditorIdentifier, EditorResourceAccessor, SideBySideEditor} from 'td/workbench/common/editor';
import {EditorInput} from 'td/workbench/common/editor/editorInput';
import {IFilesConfiguration as PlatformIFilesConfiguration, FileChangeType, IFileService} from 'td/platform/files/common/files';
import {ContextKeyExpr, RawContextKey} from 'td/platform/contextkey/common/contextkey';
import {ITextModelContentProvider} from 'td/editor/common/services/resolverService';
import {Disposable, DisposableStore, MutableDisposable} from 'td/base/common/lifecycle';
