...
import {isWindows, OperatingSystem, OS} from 'td/base/common/platform';
import {extname, basename, isAbsolute} from 'td/base/common/path';
...
import {dispose, IDisposable} from 'td/base/common/lifecycle';
import {VIEWLET_ID, IFilesConfiguration, VIEW_ID, UndoConfirmLevel} from 'td/workbench/contrib/files/common/files';
...
import {REVEAL_IN_EXPLORER_COMMAND_ID, SAVE_ALL_IN_GROUP_COMMAND_ID, NEW_UNTITLED_FILE_COMMAND_ID} from 'td/workbench/contrib/files/browser/fileConstants';
...
import {IDialogService, IConfirmationResult, getFileNamesMessage} from 'td/platform/dialogs/common/dialogs';
...
import {CLOSE_EDITORS_AND_GROUP_COMMAND_ID} from 'td/workbench/browser/parts/editor/editorCommands';
...
import {triggerUpload} from 'td/base/browser/dom';
...
import {IWorkingCopy} from 'td/workbench/services/workingCopy/common/workingCopy';
...
import {trim, rtrim} from 'td/base/common/strings';
...
import {BrowserFileUpload, FileDownload} from 'td/workbench/contrib/files/browser/fileImportExport';
...
import {ActiveEditorCanToggleReadonlyContext, ActiveEditorContext, EmptyWorkspaceSupportContext} from 'td/workbench/common/contextkeys';
