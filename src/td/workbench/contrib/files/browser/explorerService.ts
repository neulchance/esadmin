...
import {IFilesConfiguration, ISortOrderConfiguration, SortOrder, LexicographicOptions} from 'td/workbench/contrib/files/common/files';
import {ExplorerItem, ExplorerModel} from 'td/workbench/contrib/files/common/explorerModel';
import {URI} from 'td/base/common/uri';
import {FileOperationEvent, FileOperation, IFileService, FileChangesEvent, FileChangeType, IResolveFileOptions} from 'td/platform/files/common/files';
import {dirname, basename} from 'td/base/common/resources';
...
import {IBulkEditService, ResourceFileEdit} from 'td/editor/browser/services/bulkEditService';
import {UndoRedoSource} from 'td/platform/undoRedo/common/undoRedo';
import {IExplorerView, IExplorerService} from 'td/workbench/contrib/files/browser/files';
import {IProgressService, ProgressLocation, IProgressNotificationOptions, IProgressCompositeOptions} from 'td/platform/progress/common/progress';
...
import {IExpression} from 'td/base/common/glob';
import {ResourceGlobMatcher} from 'td/workbench/common/resources';
