...
import {VIEWLET_ID, TEXT_FILE_EDITOR_ID, BINARY_TEXT_FILE_MODE} from 'td/workbench/contrib/files/common/files';
import {ITextFileService, TextFileOperationError, TextFileOperationResult} from 'td/workbench/services/textfile/common/textfiles';
import {AbstractTextCodeEditor} from 'td/workbench/browser/parts/editor/textCodeEditor';
import {IEditorOpenContext, isTextEditorViewState, DEFAULT_EDITOR_ASSOCIATION, createEditorOpenError, IFileEditorInputOptions, createTooLargeFileError} from 'td/workbench/common/editor';
...
import {BinaryEditorModel} from 'td/workbench/common/editor/binaryEditorModel';
import {FileEditorInput} from 'td/workbench/contrib/files/browser/editors/fileEditorInput';
import {FileOperationError, FileOperationResult, FileChangesEvent, IFileService, FileOperationEvent, FileOperation, ByteSize, TooLargeFileOperationError} from 'td/platform/files/common/files';
