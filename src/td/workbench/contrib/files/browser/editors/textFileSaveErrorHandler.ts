...
import {FileOperationError, FileOperationResult, IWriteFileOptions} from 'td/platform/files/common/files';
import {ITextFileService, ISaveErrorHandler, ITextFileEditorModel, ITextFileSaveAsOptions} from 'td/workbench/services/textfile/common/textfiles';
...
import {TextFileContentProvider} from 'td/workbench/contrib/files/common/files';
import {FileEditorInput} from 'td/workbench/contrib/files/browser/editors/fileEditorInput';
import {SAVE_FILE_AS_LABEL} from 'td/workbench/contrib/files/browser/fileConstants';
import {INotificationService, INotificationHandle, INotificationActions, Severity} from 'td/platform/notification/common/notification';
...
import {IEditorIdentifier, SaveReason, SideBySideEditor} from 'td/workbench/common/editor';
