...
import 'td/css!./media/explorerviewlet';
import {localize, localize2} from 'td/nls';
import {mark} from 'td/base/common/performance';
import {VIEWLET_ID, VIEW_ID, IFilesConfiguration, ExplorerViewletVisibleContext} from 'td/workbench/contrib/files/common/files';
...
import {EmptyView} from 'td/workbench/contrib/files/browser/views/emptyView';
...
import {IViewsRegistry, IViewDescriptor, Extensions, ViewContainer, IViewContainersRegistry, ViewContainerLocation, IViewDescriptorService, ViewContentGroups} from 'td/workbench/common/views';
...
import {KeyChord, KeyMod, KeyCode} from 'td/base/common/keyCodes';
...
import {WorkbenchStateContext, RemoteNameContext, OpenFolderWorkspaceSupportContext} from 'td/workbench/common/contextkeys';
import {IsWebContext} from 'td/platform/contextkey/common/contextkeys';
import {AddRootFolderAction, OpenFolderAction, OpenFileFolderAction, OpenFolderViaWorkspaceAction} from 'td/workbench/browser/actions/workspaceActions';
...
import {isMouseEvent} from 'td/base/browser/dom';
