...
import {getFileNamesMessage, IConfirmation, IDialogService, IFileDialogService, IPromptButton} from 'td/platform/dialogs/common/dialogs';
import {ByteSize, FileSystemProviderCapabilities, IFileService, IFileStatWithMetadata} from 'td/platform/files/common/files';
import {INotificationService, Severity} from 'td/platform/notification/common/notification';
import {IProgress, IProgressService, IProgressStep, ProgressLocation} from 'td/platform/progress/common/progress';
import {IExplorerService} from 'td/workbench/contrib/files/browser/files';
import {IFilesConfiguration, UndoConfirmLevel, VIEW_ID} from 'td/workbench/contrib/files/common/files';
import {IEditorService} from 'td/workbench/services/editor/common/editorService';
import {Limiter, Promises, RunOnceWorker} from 'td/base/common/async';
import {newWriteableBufferStream, VSBuffer} from 'td/base/common/buffer';
import {basename, dirname, joinPath} from 'td/base/common/resources';
...
import {getActiveWindow, isDragEvent, triggerDownload} from 'td/base/browser/dom';
