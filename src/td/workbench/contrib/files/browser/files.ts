...
import {OpenEditor, ISortOrderConfiguration} from 'td/workbench/contrib/files/common/files';
import {EditorResourceAccessor, SideBySideEditor, IEditorIdentifier} from 'td/workbench/common/editor';
