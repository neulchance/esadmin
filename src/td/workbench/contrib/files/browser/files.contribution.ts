...
import {sep} from 'td/base/common/path';
import {Registry} from 'td/platform/registry/common/platform';
import {IConfigurationRegistry, Extensions as ConfigurationExtensions, ConfigurationScope, IConfigurationPropertySchema} from 'td/platform/configuration/common/configurationRegistry';
import {IWorkbenchContributionsRegistry, Extensions as WorkbenchExtensions, IWorkbenchContribution, WorkbenchPhase, registerWorkbenchContribution2} from 'td/workbench/common/contributions';
import {IFileEditorInput, IEditorFactoryRegistry, EditorExtensions} from 'td/workbench/common/editor';
import {AutoSaveConfiguration, HotExitConfiguration, FILES_EXCLUDE_CONFIG, FILES_ASSOCIATIONS_CONFIG, FILES_READONLY_INCLUDE_CONFIG, FILES_READONLY_EXCLUDE_CONFIG, FILES_READONLY_FROM_PERMISSIONS_CONFIG} from 'td/platform/files/common/files';
import {SortOrder, LexicographicOptions, FILE_EDITOR_INPUT_ID, BINARY_TEXT_FILE_MODE, UndoConfirmLevel, IFilesConfiguration} from 'td/workbench/contrib/files/common/files';
import {TextFileEditorTracker} from 'td/workbench/contrib/files/browser/editors/textFileEditorTracker';
import {TextFileSaveErrorHandler} from 'td/workbench/contrib/files/browser/editors/textFileSaveErrorHandler';
import {FileEditorInput} from 'td/workbench/contrib/files/browser/editors/fileEditorInput';
import {BinaryFileEditor} from 'td/workbench/contrib/files/browser/editors/binaryFileEditor';
...
import {isNative, isWeb, isWindows} from 'td/base/common/platform';
import {ExplorerViewletViewsContribution} from 'td/workbench/contrib/files/browser/explorerViewlet';
...
import {ExplorerService, UNDO_REDO_SOURCE} from 'td/workbench/contrib/files/browser/explorerService';
import {SUPPORTED_ENCODINGS} from 'td/workbench/services/textfile/common/encoding';
import {Schemas} from 'td/base/common/network';
import {WorkspaceWatcher} from 'td/workbench/contrib/files/browser/workspaceWatcher';
import {editorConfigurationBaseNode} from 'td/editor/common/config/editorConfigurationSchema';
import {DirtyFilesIndicator} from 'td/workbench/contrib/files/common/dirtyFilesIndicator';
import {UndoCommand, RedoCommand} from 'td/editor/browser/editorExtensions';
...
import {FileEditorInputSerializer, FileEditorWorkingCopyEditorHandler} from 'td/workbench/contrib/files/browser/editors/fileEditorHandler';
import {ModesRegistry} from 'td/editor/common/languages/modesRegistry';
import {IConfigurationService} from 'td/platform/configuration/common/configuration';
import {TextFileEditor} from 'td/workbench/contrib/files/browser/editors/textFileEditor';
