...
import {IFilesConfiguration, ExplorerFolderContext, FilesExplorerFocusedContext, ExplorerFocusedContext, ExplorerRootContext, ExplorerResourceReadonlyContext, ExplorerResourceCut, ExplorerResourceMoveableToTrash, ExplorerCompressedFocusContext, ExplorerCompressedFirstFocusContext, ExplorerCompressedLastFocusContext, ExplorerResourceAvailableEditorIdsContext, VIEW_ID, ExplorerResourceNotReadonlyContext, ViewHasSomeCollapsibleRootItemContext, FoldersViewVisibleContext} from 'td/workbench/contrib/files/common/files';
import {FileCopiedContext, NEW_FILE_COMMAND_ID, NEW_FOLDER_COMMAND_ID} from 'td/workbench/contrib/files/browser/fileActions';
...
import {ExplorerDecorationsProvider} from 'td/workbench/contrib/files/browser/views/explorerDecorationsProvider';
...
import {WorkbenchCompressibleAsyncDataTree} from 'td/platform/list/browser/listService';
import {DelayedDragHandler} from 'td/base/browser/dnd';
import {IEditorService, SIDE_GROUP, ACTIVE_GROUP} from 'td/workbench/services/editor/common/editorService';
...
import {ExplorerDelegate, ExplorerDataSource, FilesRenderer, ICompressedNavigationController, FilesFilter, FileSorter, FileDragAndDrop, ExplorerCompressionDelegate, isCompressedFolderName} from 'td/workbench/contrib/files/browser/views/explorerViewer';
import {IThemeService, IFileIconTheme} from 'td/platform/theme/common/themeService';
import {IWorkbenchThemeService} from 'td/workbench/services/themes/common/workbenchThemeService';
import {ITreeContextMenuEvent, TreeVisibility} from 'td/base/browser/ui/tree/tree';
import {MenuId, Action2, registerAction2} from 'td/platform/actions/common/actions';
...
import {IAsyncDataTreeViewState} from 'td/base/browser/ui/tree/asyncDataTree';
import {FuzzyScore} from 'td/base/common/filters';
import {IClipboardService} from 'td/platform/clipboard/common/clipboardService';
import {IFileService, FileSystemProviderCapabilities} from 'td/platform/files/common/files';
...
import {EditorResourceAccessor, SideBySideEditor} from 'td/workbench/common/editor';
import {IExplorerService, IExplorerView} from 'td/workbench/contrib/files/browser/files';
...
import {isInputElement} from 'td/base/browser/ui/list/listWidget';
import {AbstractTreePart} from 'td/base/browser/ui/tree/abstractTree';
