...
import {IListAccessibilityProvider} from 'td/base/browser/ui/list/listWidget';
import * as DOM from 'td/base/browser/dom';
import * as glob from 'td/base/common/glob';
import {IListVirtualDelegate, ListDragOverEffectPosition, ListDragOverEffectType} from 'td/base/browser/ui/list/list';
...
import {IFileService, FileKind, FileOperationError, FileOperationResult, FileChangeType} from 'td/platform/files/common/files';
...
import {IDisposable, Disposable, dispose, toDisposable, DisposableStore} from 'td/base/common/lifecycle';
import {KeyCode} from 'td/base/common/keyCodes';
import {IFileLabelOptions, IResourceLabel, ResourceLabels} from 'td/workbench/browser/labels';
import {ITreeNode, ITreeFilter, TreeVisibility, IAsyncDataSource, ITreeSorter, ITreeDragAndDrop, ITreeDragOverReaction, TreeDragOverBubble} from 'td/base/browser/ui/tree/tree';
...
import {IFilesConfiguration, UndoConfirmLevel} from 'td/workbench/contrib/files/common/files';
import {dirname, joinPath, distinctParents} from 'td/base/common/resources';
import {InputBox, MessageType} from 'td/base/browser/ui/inputbox/inputBox';
...
import {equals, deepClone} from 'td/base/common/objects';
import * as path from 'td/base/common/path';
import {ExplorerItem, NewExplorerItem} from 'td/workbench/contrib/files/common/explorerModel';
import {compareFileExtensionsDefault, compareFileNamesDefault, compareFileNamesUpper, compareFileExtensionsUpper, compareFileNamesLower, compareFileExtensionsLower, compareFileNamesUnicode, compareFileExtensionsUnicode} from 'td/base/common/comparers';
import {CodeDataTransfers, containsDragType} from 'td/platform/dnd/browser/dnd';
import {fillEditorsDragData} from 'td/workbench/browser/dnd';
import {IInstantiationService} from 'td/platform/instantiation/common/instantiation';
import {IDragAndDropData, DataTransfers} from 'td/base/browser/dnd';
import {Schemas} from 'td/base/common/network';
import {NativeDragAndDropData, ExternalElementsDragAndDropData, ElementsDragAndDropData, ListViewTargetSector} from 'td/base/browser/ui/list/listView';
import {isMacintosh, isWeb} from 'td/base/common/platform';
import {IDialogService, getFileNamesMessage} from 'td/platform/dialogs/common/dialogs';
...
import {findValidPasteFileTarget} from 'td/workbench/contrib/files/browser/fileActions';
import {FuzzyScore, createMatches} from 'td/base/common/filters';
import {Emitter, Event, EventMultiplexer} from 'td/base/common/event';
import {ITreeCompressionDelegate} from 'td/base/browser/ui/tree/asyncDataTree';
import {ICompressibleTreeRenderer} from 'td/base/browser/ui/tree/objectTree';
import {ICompressedTreeNode} from 'td/base/browser/ui/tree/compressedObjectTreeModel';
import {ILabelService} from 'td/platform/label/common/label';
import {isNumber, isStringArray} from 'td/base/common/types';
import {IEditableData} from 'td/workbench/common/views';
...
import {ResourceFileEdit} from 'td/editor/browser/services/bulkEditService';
import {IExplorerService} from 'td/workbench/contrib/files/browser/files';
import {BrowserFileUpload, ExternalFileImport, getMultipleFilesOverwriteConfirm} from 'td/workbench/contrib/files/browser/fileImportExport';
import {toErrorMessage} from 'td/base/common/errorMessage';
import {WebFileSystemAccess} from 'td/platform/files/browser/webFileSystemAccess';
import {IgnoreFile} from 'td/workbench/services/search/common/ignoreFile';
import {ResourceSet} from 'td/base/common/map';
import {TernarySearchTree} from 'td/base/common/ternarySearchTree';
import {defaultInputBoxStyles} from 'td/platform/theme/browser/defaultStyles';
import {timeout} from 'td/base/common/async';
import {IHoverDelegate, IHoverDelegateOptions, IHoverWidget} from 'td/base/browser/ui/iconLabel/iconHoverDelegate';
...
import {IExplorerFileContribution, explorerFileContribRegistry} from 'td/workbench/contrib/files/browser/explorerFileContrib';
...
export class FilesRenderer implements ICompressibleTreeRenderer<ExplorerItem, FuzzyScore, IFileTemplateData>, IListAccessibilityProvider<ExplorerItem>, IDisposable {
	...
	private readonly hoverDelegate = new class implements IHoverDelegate {
		...
		get delay() {
			// Delay implementation borrowed froms src/td/workbench/browser/parts/statusbar/statusbarPart.ts
