...
import 'td/css!./media/openeditors';
import * as nls from 'td/nls';
import {RunOnceScheduler} from 'td/base/common/async';
import {IAction, ActionRunner, WorkbenchActionExecutedEvent, WorkbenchActionExecutedClassification} from 'td/base/common/actions';
...
import {IEditorGroupsService, IEditorGroup, GroupsOrder, GroupOrientation} from 'td/workbench/services/editor/common/editorGroupsService';
...
import {Verbosity, EditorResourceAccessor, SideBySideEditor, IEditorIdentifier, GroupModelChangeKind, preventEditorClose, EditorCloseMethod} from 'td/workbench/common/editor';
import {EditorInput} from 'td/workbench/common/editor/editorInput';
import {SaveAllInGroupAction, CloseGroupAction} from 'td/workbench/contrib/files/browser/fileActions';
import {OpenEditorsFocusedContext, ExplorerFocusedContext, IFilesConfiguration, OpenEditor} from 'td/workbench/contrib/files/common/files';
import {CloseAllEditorsAction, CloseEditorAction, UnpinEditorAction} from 'td/workbench/browser/parts/editor/editorActions';
import {IContextKeyService, IContextKey, ContextKeyExpr} from 'td/platform/contextkey/common/contextkey';
import {IThemeService} from 'td/platform/theme/common/themeService';
import {asCssVariable, badgeBackground, badgeForeground, contrastBorder} from 'td/platform/theme/common/colorRegistry';
import {WorkbenchList} from 'td/platform/list/browser/listService';
import {IListVirtualDelegate, IListRenderer, IListContextMenuEvent, IListDragAndDrop, IListDragOverReaction, ListDragOverEffectPosition, ListDragOverEffectType} from 'td/base/browser/ui/list/list';
import {ResourceLabels, IResourceLabel} from 'td/workbench/browser/labels';
...
import {MenuId, Action2, registerAction2, MenuRegistry} from 'td/platform/actions/common/actions';
import {OpenEditorsDirtyEditorContext, OpenEditorsGroupContext, OpenEditorsReadonlyEditorContext, SAVE_ALL_LABEL, SAVE_ALL_COMMAND_ID, NEW_UNTITLED_FILE_COMMAND_ID} from 'td/workbench/contrib/files/browser/fileConstants';
import {ResourceContextKey, MultipleEditorGroupsContext} from 'td/workbench/common/contextkeys';
import {CodeDataTransfers, containsDragType} from 'td/platform/dnd/browser/dnd';
import {ResourcesDropHandler, fillEditorsDragData} from 'td/workbench/browser/dnd';
...
import {memoize} from 'td/base/common/decorators';
import {ElementsDragAndDropData, ListViewTargetSector, NativeDragAndDropData} from 'td/base/browser/ui/list/listView';
...
import {Orientation} from 'td/base/browser/ui/splitview/splitview';
import {IListAccessibilityProvider} from 'td/base/browser/ui/list/listWidget';
import {compareFileNamesDefault} from 'td/base/common/comparers';
...
import {extUriIgnorePathCase} from 'td/base/common/resources';
