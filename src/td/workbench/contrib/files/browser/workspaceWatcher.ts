...
import {IDisposable, Disposable, dispose, DisposableStore} from 'td/base/common/lifecycle';
import {URI} from 'td/base/common/uri';
import {IConfigurationService, IConfigurationChangeEvent} from 'td/platform/configuration/common/configuration';
import {IFileService, IFilesConfiguration} from 'td/platform/files/common/files';
import {IWorkspaceContextService, IWorkspaceFolder, IWorkspaceFoldersChangeEvent} from 'td/platform/workspace/common/workspace';
import {ResourceMap} from 'td/base/common/map';
import {INotificationService, Severity, NeverShowAgainScope, NotificationPriority} from 'td/platform/notification/common/notification';
