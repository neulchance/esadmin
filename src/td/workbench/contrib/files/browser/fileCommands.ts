...
import {EditorResourceAccessor, IEditorCommandsContext, SideBySideEditor, IEditorIdentifier, SaveReason, EditorsOrder, EditorInputCapabilities} from 'td/workbench/common/editor';
import {SideBySideEditorInput} from 'td/workbench/common/editor/sideBySideEditorInput';
import {IWindowOpenable, IOpenWindowOptions, isWorkspaceToOpen, IOpenEmptyWindowOptions} from 'td/platform/window/common/window';
...
import {IWorkspaceContextService, UNTITLED_WORKSPACE_NAME} from 'td/platform/workspace/common/workspace';
import {ExplorerFocusCondition, TextFileContentProvider, VIEWLET_ID, ExplorerCompressedFocusContext, ExplorerCompressedFirstFocusContext, ExplorerCompressedLastFocusContext, FilesExplorerFocusCondition, ExplorerFolderContext, VIEW_ID} from 'td/workbench/contrib/files/common/files';
import {ExplorerViewPaneContainer} from 'td/workbench/contrib/files/browser/explorerViewlet';
...
import {IContextKey, IContextKeyService, ContextKeyExpr} from 'td/platform/contextkey/common/contextkey';
...
import {KeyMod, KeyCode, KeyChord} from 'td/base/common/keyCodes';
...
import {getResourceForCommand, getMultiSelectedResources, getOpenEditorsViewMultiSelection, IExplorerService} from 'td/workbench/contrib/files/browser/files';
import {IWorkspaceEditingService} from 'td/workbench/services/workspaces/common/workspaceEditing';
import {getMultiSelectedEditorContexts} from 'td/workbench/browser/parts/editor/editorCommands';
...
import {IEditorService, SIDE_GROUP, ISaveEditorsOptions} from 'td/workbench/services/editor/common/editorService';
import {IEditorGroupsService, GroupsOrder, IEditorGroup} from 'td/workbench/services/editor/common/editorGroupsService';
import {ILabelService} from 'td/platform/label/common/label';
import {basename, joinPath, isEqual} from 'td/base/common/resources';
...
import {toAction} from 'td/base/common/actions';
import {EditorOpenSource, EditorResolution} from 'td/platform/editor/common/editor';
...
import {RemoveRootFolderAction} from 'td/workbench/browser/actions/workspaceActions';
import {OpenEditorsView} from 'td/workbench/contrib/files/browser/views/openEditorsView';
import {ExplorerView} from 'td/workbench/contrib/files/browser/views/explorerView';
