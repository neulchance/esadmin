...
import {Disposable, DisposableStore, MutableDisposable, toDisposable, IDisposable} from 'td/base/common/lifecycle';
import {isEqual} from 'td/base/common/resources';
import {URI} from 'td/base/common/uri';
import {ServicesAccessor} from 'td/editor/browser/editorExtensions';
import type {ITextModel} from 'td/editor/common/model';
...
import {ITextModelContentProvider, ITextModelService} from 'td/editor/common/services/resolverService';
import {localize, localize2} from 'td/nls';
import {MenuId, MenuRegistry, registerAction2, Action2} from 'td/platform/actions/common/actions';
import {ICommandService} from 'td/platform/commands/common/commands';
import {ContextKeyExpr, ContextKeyTrueExpr, IContextKey, IContextKeyService, RawContextKey} from 'td/platform/contextkey/common/contextkey';
...
import {QuickPickItem, IQuickInputService} from 'td/platform/quickinput/common/quickInput';
...
} from 'td/platform/userDataSync/common/userDataSync';
...
import {IActivityService, IBadge, NumberBadge, ProgressBadge} from 'td/workbench/services/activity/common/activity';
...
import {ViewContainerLocation, IViewContainersRegistry, Extensions, ViewContainer} from 'td/workbench/common/views';
import {UserDataSyncDataViews} from 'td/workbench/contrib/userDataSync/browser/userDataSyncViews';
import {IUserDataSyncWorkbenchService, getSyncAreaLabel, AccountStatus, CONTEXT_SYNC_STATE, CONTEXT_SYNC_ENABLEMENT, CONTEXT_ACCOUNT_STATE, CONFIGURE_SYNC_COMMAND_ID, SHOW_SYNC_LOG_COMMAND_ID, SYNC_VIEW_CONTAINER_ID, SYNC_TITLE, SYNC_VIEW_ICON, CONTEXT_HAS_CONFLICTS, DOWNLOAD_ACTIVITY_ACTION_DESCRIPTOR} from 'td/workbench/services/userDataSync/common/userDataSync';
...
import {ctxIsMergeResultEditor, ctxMergeBaseUri} from 'td/workbench/contrib/mergeEditor/common/mergeEditor';
