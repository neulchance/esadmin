...
import {ITreeItem, TreeItemCollapsibleState, TreeViewItemHandleArg, IViewDescriptorService} from 'td/workbench/common/views';
import {localize} from 'td/nls';
import {TreeViewPane} from 'td/workbench/browser/parts/views/treeView';
import {IInstantiationService, ServicesAccessor} from 'td/platform/instantiation/common/instantiation';
import {IUserDataSyncService, Change, MergeState, IUserDataSyncResource, IResourcePreview, IUserDataSyncEnablementService} from 'td/platform/userDataSync/common/userDataSync';
...
import {getSyncAreaLabel, IUserDataSyncConflictsView, IUserDataSyncWorkbenchService, SYNC_CONFLICTS_VIEW_ID} from 'td/workbench/services/userDataSync/common/userDataSync';
...
import {IUserDataProfile, IUserDataProfilesService, reviveProfile} from 'td/platform/userDataProfile/common/userDataProfile';
