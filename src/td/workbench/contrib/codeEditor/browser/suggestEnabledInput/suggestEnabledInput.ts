...
import 'td/css!./suggestEnabledInput';
import {$, Dimension, append} from 'td/base/browser/dom';
...
import {ColorIdentifier, asCssVariable, asCssVariableWithDefault, editorSelectionBackground, inputBackground, inputBorder, inputForeground, inputPlaceholderForeground, selectionBackground} from 'td/platform/theme/common/colorRegistry';
...
import {registerAndCreateHistoryNavigationContext, IHistoryNavigationContext} from 'td/platform/history/browser/contextScopedHistoryWidget';
...
import {ensureValidWordDefinition, getWordAtText} from 'td/editor/common/core/wordHelper';
