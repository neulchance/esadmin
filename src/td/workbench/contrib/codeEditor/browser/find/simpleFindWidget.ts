...
import 'td/css!./simpleFindWidget';
...
import {FindReplaceState, INewFindReplaceState} from 'td/editor/contrib/find/browser/findState';
import {IMessage as InputBoxMessage} from 'td/base/browser/ui/inputbox/inputBox';
import {SimpleButton, findPreviousMatchIcon, findNextMatchIcon, NLS_NO_RESULTS, NLS_MATCHES_LOCATION} from 'td/editor/contrib/find/browser/findWidget';
...
import {widgetClose} from 'td/platform/theme/common/iconRegistry';
