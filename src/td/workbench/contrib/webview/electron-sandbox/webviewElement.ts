...
import {consumeStream} from 'td/base/common/stream';
...
import {FindInFrameOptions, IWebviewManagerService} from 'td/platform/webview/common/webviewManagerService';
import {WebviewThemeDataProvider} from 'td/workbench/contrib/webview/browser/themeing';
import {WebviewInitInfo} from 'td/workbench/contrib/webview/browser/webview';
import {WebviewElement} from 'td/workbench/contrib/webview/browser/webviewElement';
import {WindowIgnoreMenuShortcutsManager} from 'td/workbench/contrib/webview/electron-sandbox/windowIgnoreMenuShortcutsManager';
