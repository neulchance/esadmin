...
import {isUNC} from 'td/base/common/extpath';
import {Schemas} from 'td/base/common/network';
import {normalize, sep} from 'td/base/common/path';
import {URI} from 'td/base/common/uri';
import {FileOperationError, FileOperationResult, IFileService, IWriteFileOptions} from 'td/platform/files/common/files';
import {ILogService} from 'td/platform/log/common/log';
import {getWebviewContentMimeType} from 'td/platform/webview/common/mimeTypes';
