...
import {Dimension, getWindow, h, runAtThisOrScheduleAtNextAnimationFrame} from 'td/base/browser/dom';
...
import {EditorOption, IDiffEditorOptions} from 'td/editor/common/config/editorOptions';
...
import * as colorRegistry from 'td/platform/theme/common/colorRegistry';
import * as editorColorRegistry from 'td/editor/common/core/editorColorRegistry';
import {IThemeService} from 'td/platform/theme/common/themeService';
import {INLINE_CHAT_ID, inlineChatDiffInserted, inlineChatDiffRemoved, inlineChatRegionHighlight} from 'td/workbench/contrib/inlineChat/common/inlineChat';
...
import {invertLineRange, asRange} from 'td/workbench/contrib/inlineChat/browser/utils';
import {ResourceLabel} from 'td/workbench/browser/labels';
import {FileKind} from 'td/platform/files/common/files';
import {HunkInformation, Session} from 'td/workbench/contrib/inlineChat/browser/inlineChatSession';
import {FoldingController} from 'td/editor/contrib/folding/browser/folding';
...
import {ButtonBar, IButton} from 'td/base/browser/ui/button/button';
import {defaultButtonStyles} from 'td/platform/theme/browser/defaultStyles';
import {SaveReason, SideBySideEditor} from 'td/workbench/common/editor';
...
import {TAB_ACTIVE_MODIFIED_BORDER} from 'td/workbench/common/theme';
