...
import 'td/css!./inlineChat';
import {DisposableStore, MutableDisposable, toDisposable} from 'td/base/common/lifecycle';
import {IActiveCodeEditor, ICodeEditor, IDiffEditorConstructionOptions} from 'td/editor/browser/editorBrowser';
...
import {EmbeddedCodeEditorWidget, EmbeddedDiffEditorWidget} from 'td/editor/browser/widget/embeddedCodeEditorWidget';
import {HiddenItemStrategy, MenuWorkbenchToolBar} from 'td/platform/actions/browser/toolbar';
...
import {DEFAULT_FONT_FAMILY} from 'td/workbench/browser/style';
import {CompletionItem, CompletionItemInsertTextRule, CompletionItemKind, CompletionItemProvider, CompletionList, ProviderResult} from 'td/editor/common/languages';
import {ResourceLabel} from 'td/workbench/browser/labels';
...
import {asRange, invertLineRange} from 'td/workbench/contrib/inlineChat/browser/utils';
import {ICodeEditorViewState, ScrollType} from 'td/editor/common/editorCommon';
...
import {ExpansionState, HunkData} from 'td/workbench/contrib/inlineChat/browser/inlineChatSession';
import * as aria from 'td/base/browser/ui/aria/aria';
import {IWorkbenchButtonBarOptions, MenuWorkbenchButtonBar} from 'td/platform/actions/browser/buttonbar';
import {SlashCommandContentWidget} from 'td/workbench/contrib/chat/browser/chatSlashCommandContentWidget';
...
import {editorForeground, inputBackground, editorBackground} from 'td/platform/theme/common/colorRegistry';
import {Lazy} from 'td/base/common/lazy';
import {ChatResponseViewModel} from 'td/workbench/contrib/chat/common/chatViewModel';
import {ChatModel, ChatResponseModel} from 'td/workbench/contrib/chat/common/chatModel';
import {ILogService} from 'td/platform/log/common/log';
import {ChatListItemRenderer, IChatListItemRendererOptions, IChatRendererDelegate} from 'td/workbench/contrib/chat/browser/chatListRenderer';
