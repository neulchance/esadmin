...
import {EventType as TouchEventType} from 'td/base/browser/touch';
...
import {CellFoldingState, INotebookEditor} from 'td/workbench/contrib/notebook/browser/notebookBrowser';
import {INotebookCellList} from 'td/workbench/contrib/notebook/browser/view/notebookRenderingCommon';
import {OutlineEntry} from 'td/workbench/contrib/notebook/browser/viewModel/OutlineEntry';
...
import {foldingCollapsedIcon, foldingExpandedIcon} from 'td/editor/contrib/folding/browser/foldingDecorations';
import {MarkupCellViewModel} from 'td/workbench/contrib/notebook/browser/viewModel/markupCellViewModel';
import {FoldingController} from 'td/workbench/contrib/notebook/browser/controller/foldingController';
