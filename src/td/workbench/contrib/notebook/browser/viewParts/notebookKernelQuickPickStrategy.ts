...
import {groupBy} from 'td/base/common/arrays';
import {createCancelablePromise} from 'td/base/common/async';
...
import {uppercaseFirstLetter} from 'td/base/common/strings';
...
import {ProgressLocation} from 'td/platform/progress/common/progress';
import {IQuickInputButton, IQuickInputService, IQuickPick, IQuickPickItem, QuickPickInput} from 'td/platform/quickinput/common/quickInput';
import {ThemeIcon} from 'td/base/common/themables';
import {ViewContainerLocation} from 'td/workbench/common/views';
import {IExtension, IExtensionsViewPaneContainer, IExtensionsWorkbenchService, VIEWLET_ID as EXTENSION_VIEWLET_ID} from 'td/workbench/contrib/extensions/common/extensions';
import {IActiveNotebookEditor, INotebookExtensionRecommendation, JUPYTER_EXTENSION_ID, KERNEL_RECOMMENDATIONS} from 'td/workbench/contrib/notebook/browser/notebookBrowser';
import {NotebookEditorWidget} from 'td/workbench/contrib/notebook/browser/notebookEditorWidget';
import {executingStateIcon, selectKernelIcon} from 'td/workbench/contrib/notebook/browser/notebookIcons';
import {NotebookTextModel} from 'td/workbench/contrib/notebook/common/model/notebookTextModel';
import {INotebookKernel, INotebookKernelHistoryService, INotebookKernelMatchResult, INotebookKernelService, ISourceAction} from 'td/workbench/contrib/notebook/common/notebookKernelService';
...
import {INotebookTextModel} from 'td/workbench/contrib/notebook/common/notebookCommon';
