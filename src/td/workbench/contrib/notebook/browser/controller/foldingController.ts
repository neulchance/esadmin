...
import {NOTEBOOK_EDITOR_FOCUSED, NOTEBOOK_IS_ACTIVE_EDITOR} from 'td/workbench/contrib/notebook/common/notebookContextKeys';
import {INotebookEditor, INotebookEditorMouseEvent, INotebookEditorContribution, getNotebookEditorFromEditorPane, CellFoldingState} from 'td/workbench/contrib/notebook/browser/notebookBrowser';
import {FoldingModel} from 'td/workbench/contrib/notebook/browser/viewModel/foldingModel'; import {CellKind} from 'td/workbench/contrib/notebook/common/notebookCommon';
import {ICellRange} from 'td/workbench/contrib/notebook/common/notebookRange';
import {registerNotebookContribution} from 'td/workbench/contrib/notebook/browser/notebookEditorExtensions';
import {registerAction2, Action2} from 'td/platform/actions/common/actions';
...
import {NOTEBOOK_ACTIONS_CATEGORY} from 'td/workbench/contrib/notebook/browser/controller/coreActions';
import {localize, localize2} from 'td/nls';
import {FoldingRegion} from 'td/editor/contrib/folding/browser/foldingRanges';
import {ICommandMetadata} from 'td/platform/commands/common/commands';
import {NotebookViewModel} from 'td/workbench/contrib/notebook/browser/viewModel/notebookViewModelImpl';
