...
import {Action2, IAction2Options, MenuId, MenuRegistry} from 'td/platform/actions/common/actions';
...
import {getNotebookEditorFromEditorPane, IActiveNotebookEditor, ICellViewModel, cellRangeToViewCells, ICellOutputViewModel} from 'td/workbench/contrib/notebook/browser/notebookBrowser';
import {INTERACTIVE_WINDOW_IS_ACTIVE_EDITOR, NOTEBOOK_EDITOR_EDITABLE, NOTEBOOK_EDITOR_FOCUSED, NOTEBOOK_IS_ACTIVE_EDITOR, NOTEBOOK_KERNEL_COUNT, NOTEBOOK_KERNEL_SOURCE_COUNT} from 'td/workbench/contrib/notebook/common/notebookContextKeys';
import {ICellRange, isICellRange} from 'td/workbench/contrib/notebook/common/notebookRange';
import {IEditorService} from 'td/workbench/services/editor/common/editorService';
import {IEditorCommandsContext} from 'td/workbench/common/editor';
...
import {TypeConstraint} from 'td/base/common/types';
