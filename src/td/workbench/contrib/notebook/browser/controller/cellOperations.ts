...
import {IBulkEditService, ResourceEdit, ResourceTextEdit} from 'td/editor/browser/services/bulkEditService';
import {IPosition, Position} from 'td/editor/common/core/position';
import {Range} from 'td/editor/common/core/range';
import {EndOfLinePreference, IReadonlyTextBuffer} from 'td/editor/common/model';
...
import {INotebookActionContext, INotebookCellActionContext} from 'td/workbench/contrib/notebook/browser/controller/coreActions';
import {CellEditState, CellFocusMode, expandCellRangesWithHiddenCells, IActiveNotebookEditor, ICellViewModel} from 'td/workbench/contrib/notebook/browser/notebookBrowser';
import {CellViewModel, NotebookViewModel} from 'td/workbench/contrib/notebook/browser/viewModel/notebookViewModelImpl';
import {cloneNotebookCellTextModel} from 'td/workbench/contrib/notebook/common/model/notebookCellTextModel';
import {CellEditType, CellKind, ICellEditOperation, ICellReplaceEdit, IOutputDto, ISelectionState, NotebookCellMetadata, SelectionStateType} from 'td/workbench/contrib/notebook/common/notebookCommon';
import {cellRangeContains, cellRangesToIndexes, ICellRange} from 'td/workbench/contrib/notebook/common/notebookRange';
