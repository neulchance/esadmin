...
import {InputFocusedContext, InputFocusedContextKey} from 'td/platform/contextkey/common/contextkeys';
...
import {changeCellToKind, runDeleteAction} from 'td/workbench/contrib/notebook/browser/controller/cellOperations';
import {CellToolbarOrder, CELL_TITLE_CELL_GROUP_ID, CELL_TITLE_OUTPUT_GROUP_ID, executeNotebookCondition, INotebookActionContext, INotebookCellActionContext, NotebookAction, NotebookCellAction, NOTEBOOK_EDITOR_WIDGET_ACTION_WEIGHT, findTargetCellEditor} from 'td/workbench/contrib/notebook/browser/controller/coreActions';
import {NOTEBOOK_CELL_EDITABLE, NOTEBOOK_CELL_HAS_OUTPUTS, NOTEBOOK_CELL_LIST_FOCUSED, NOTEBOOK_CELL_MARKDOWN_EDIT_MODE, NOTEBOOK_CELL_TYPE, NOTEBOOK_EDITOR_EDITABLE, NOTEBOOK_EDITOR_FOCUSED, NOTEBOOK_HAS_OUTPUTS, NOTEBOOK_IS_ACTIVE_EDITOR, NOTEBOOK_OUTPUT_FOCUSED, NOTEBOOK_USE_CONSOLIDATED_OUTPUT_BUTTON} from 'td/workbench/contrib/notebook/common/notebookContextKeys';
import {CellEditState, CHANGE_CELL_LANGUAGE, DETECT_CELL_LANGUAGE, QUIT_EDIT_CELL_COMMAND_ID} from 'td/workbench/contrib/notebook/browser/notebookBrowser';
import * as icons from 'td/workbench/contrib/notebook/browser/notebookIcons';
import {CellEditType, CellKind, ICellEditOperation, NotebookCellExecutionState, NotebookSetting} from 'td/workbench/contrib/notebook/common/notebookCommon';
import {ICellRange} from 'td/workbench/contrib/notebook/common/notebookRange';
import {ILanguageDetectionService} from 'td/workbench/services/languageDetection/common/languageDetectionWorkerService';
...
import {IDialogService, IConfirmationResult} from 'td/platform/dialogs/common/dialogs';
