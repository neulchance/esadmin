...
import {IAction2Options, MenuId, MenuRegistry, registerAction2} from 'td/platform/actions/common/actions';
...
import {INotebookActionContext, NotebookAction} from 'td/workbench/contrib/notebook/browser/controller/coreActions';
import {NOTEBOOK_CELL_LIST_FOCUSED, NOTEBOOK_EDITOR_EDITABLE} from 'td/workbench/contrib/notebook/common/notebookContextKeys';
import {CellViewModel} from 'td/workbench/contrib/notebook/browser/viewModel/notebookViewModelImpl';
import {CellKind, NotebookSetting} from 'td/workbench/contrib/notebook/common/notebookCommon';
