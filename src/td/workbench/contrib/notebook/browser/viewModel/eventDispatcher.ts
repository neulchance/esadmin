...
import {NotebookCellStateChangedEvent, NotebookLayoutChangedEvent, NotebookMetadataChangedEvent, NotebookViewEvent, NotebookViewEventType} from 'td/workbench/contrib/notebook/browser/notebookViewEvents';
