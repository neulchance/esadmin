...
import {Disposable, dispose, IDisposable, IReference} from 'td/base/common/lifecycle';
...
import {SearchParams} from 'td/editor/common/model/textModelSearch';
...
import {IWordWrapTransientState, readTransientState, writeTransientState} from 'td/workbench/contrib/codeEditor/browser/toggleWordWrap';
import {CellEditState, CellFocusMode, CursorAtBoundary, CursorAtLineBoundary, IEditableCellViewModel, INotebookCellDecorationOptions} from 'td/workbench/contrib/notebook/browser/notebookBrowser';
import {CellViewModelStateChangeEvent} from 'td/workbench/contrib/notebook/browser/notebookViewEvents';
...
import {CellKind, INotebookCellStatusBarItem, INotebookSearchOptions} from 'td/workbench/contrib/notebook/common/notebookCommon';
import {getEditorTopPadding, NotebookOptionsChangeEvent} from 'td/workbench/contrib/notebook/browser/notebookOptions';
