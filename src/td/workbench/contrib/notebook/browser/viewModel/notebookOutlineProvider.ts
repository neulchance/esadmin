...
import {DisposableStore, MutableDisposable, combinedDisposable} from 'td/base/common/lifecycle';
...
import {IActiveNotebookEditor, INotebookEditor, INotebookViewCellsUpdateEvent} from 'td/workbench/contrib/notebook/browser/notebookBrowser';
...
import {OutlineChangeEvent, OutlineConfigKeys, OutlineTarget} from 'td/workbench/services/outline/browser/outline';
...
import {NotebookOutlineEntryFactory} from 'td/workbench/contrib/notebook/browser/viewModel/notebookOutlineEntryFactory';
