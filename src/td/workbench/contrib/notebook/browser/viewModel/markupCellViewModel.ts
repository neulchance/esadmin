...
import {CellEditState, CellFindMatch, CellFoldingState, CellLayoutContext, CellLayoutState, EditorFoldingStateDelegate, ICellOutputViewModel, ICellViewModel, MarkupCellLayoutChangeEvent, MarkupCellLayoutInfo} from 'td/workbench/contrib/notebook/browser/notebookBrowser';
import {BaseCellViewModel} from 'td/workbench/contrib/notebook/browser/viewModel/baseCellViewModel';
import {NotebookCellTextModel} from 'td/workbench/contrib/notebook/common/model/notebookCellTextModel';
import {CellKind, INotebookSearchOptions} from 'td/workbench/contrib/notebook/common/notebookCommon';
...
import {NotebookCellStateChangedEvent, NotebookLayoutInfo} from 'td/workbench/contrib/notebook/browser/notebookViewEvents';
