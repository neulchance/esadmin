...
import {groupBy} from 'td/base/common/collections';
...
import {IBulkEditService, ResourceTextEdit} from 'td/editor/browser/services/bulkEditService';
import {Range} from 'td/editor/common/core/range';
import * as editorCommon from 'td/editor/common/editorCommon';
import {FindMatch, IModelDecorationOptions, IModelDeltaDecoration, TrackedRangeStickiness} from 'td/editor/common/model';
import {MultiModelEditStackElement, SingleModelEditStackElement} from 'td/editor/common/model/editStack';
import {IntervalNode, IntervalTree} from 'td/editor/common/model/intervalTree';
import {ModelDecorationOptions} from 'td/editor/common/model/textModel';
import {IWorkspaceTextEdit} from 'td/editor/common/languages';
import {ITextModelService} from 'td/editor/common/services/resolverService';
import {FoldingRegions} from 'td/editor/contrib/folding/browser/foldingRanges';
import {IInstantiationService} from 'td/platform/instantiation/common/instantiation';
import {IUndoRedoService} from 'td/platform/undoRedo/common/undoRedo';
import {CellEditState, CellFindMatchWithIndex, CellFoldingState, EditorFoldingStateDelegate, ICellViewModel, INotebookDeltaCellStatusBarItems, INotebookDeltaDecoration, ICellModelDecorations, ICellModelDeltaDecorations, IModelDecorationsChangeAccessor, INotebookEditorViewState, INotebookViewCellsUpdateEvent, INotebookViewModel} from 'td/workbench/contrib/notebook/browser/notebookBrowser';
import {NotebookCellSelectionCollection} from 'td/workbench/contrib/notebook/browser/viewModel/cellSelectionCollection';
...
import {CellKind, ICell, INotebookSearchOptions, ISelectionState, NotebookCellsChangeType, NotebookCellTextModelSplice, SelectionStateType} from 'td/workbench/contrib/notebook/common/notebookCommon';
import {cellIndexesToRanges, cellRangesToIndexes, ICellRange, reduceCellRanges} from 'td/workbench/contrib/notebook/common/notebookRange';
import {NotebookLayoutInfo, NotebookMetadataChangedEvent} from 'td/workbench/contrib/notebook/browser/notebookViewEvents';
import {CellFindMatchModel} from 'td/workbench/contrib/notebook/browser/contrib/find/findModel';
import {INotebookExecutionStateService, NotebookExecutionType} from 'td/workbench/contrib/notebook/common/notebookExecutionStateService';
