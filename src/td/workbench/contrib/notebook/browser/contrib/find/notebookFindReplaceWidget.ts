...
import {FindInput, IFindInputOptions} from 'td/base/browser/ui/findinput/findInput';
import {ReplaceInput} from 'td/base/browser/ui/findinput/replaceInput';
import {IMessage as InputBoxMessage} from 'td/base/browser/ui/inputbox/inputBox';
import {ProgressBar} from 'td/base/browser/ui/progressbar/progressbar';
import {Widget} from 'td/base/browser/ui/widget';
import {Delayer} from 'td/base/common/async';
import {KeyCode} from 'td/base/common/keyCodes';
import 'td/css!./notebookFindReplaceWidget';
import {FindReplaceState, FindReplaceStateChangedEvent} from 'td/editor/contrib/find/browser/findState';
import {findNextMatchIcon, findPreviousMatchIcon, findReplaceAllIcon, findReplaceIcon, SimpleButton} from 'td/editor/contrib/find/browser/findWidget';
import * as nls from 'td/nls';
import {ContextScopedReplaceInput, registerAndCreateHistoryNavigationContext} from 'td/platform/history/browser/contextScopedHistoryWidget';
...
import {registerIcon, widgetClose} from 'td/platform/theme/common/iconRegistry';
...
import {parseReplaceString, ReplacePattern} from 'td/editor/contrib/find/browser/replacePattern';
import {Codicon} from 'td/base/common/codicons';
import {IConfigurationService} from 'td/platform/configuration/common/configuration';
import {Action, ActionRunner, IAction, IActionRunner, Separator} from 'td/base/common/actions';
import {IInstantiationService} from 'td/platform/instantiation/common/instantiation';
import {IMenu} from 'td/platform/actions/common/actions';
import {createAndFillInActionBarActions} from 'td/platform/actions/browser/menuEntryActionViewItem';
import {AnchorAlignment, IContextViewProvider} from 'td/base/browser/ui/contextview/contextview';
...
import {filterIcon} from 'td/workbench/contrib/extensions/browser/extensionsIcons';
import {NotebookFindFilters} from 'td/workbench/contrib/notebook/browser/contrib/find/findFilters';
import {isSafari} from 'td/base/common/platform';
import {ISashEvent, Orientation, Sash} from 'td/base/browser/ui/sash/sash';
import {INotebookEditor} from 'td/workbench/contrib/notebook/browser/notebookBrowser';
import {defaultInputBoxStyles, defaultProgressBarStyles, defaultToggleStyles} from 'td/platform/theme/browser/defaultStyles';
import {IToggleStyles} from 'td/base/browser/ui/toggle/toggle';
import {Disposable} from 'td/base/common/lifecycle';
import {NotebookSetting} from 'td/workbench/contrib/notebook/common/notebookCommon';
