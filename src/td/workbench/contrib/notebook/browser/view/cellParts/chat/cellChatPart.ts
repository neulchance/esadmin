...
import {NotebookCellChatController} from 'td/workbench/contrib/notebook/browser/view/cellParts/chat/cellChatController';

import 'td/workbench/contrib/notebook/browser/view/cellParts/chat/cellChatActions';
