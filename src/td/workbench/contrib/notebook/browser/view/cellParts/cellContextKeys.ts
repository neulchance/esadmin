...
import {CellEditState, CellFocusMode, ICellViewModel, INotebookEditorDelegate} from 'td/workbench/contrib/notebook/browser/notebookBrowser';
...
import {NotebookCellExecutionState} from 'td/workbench/contrib/notebook/common/notebookCommon';
import {NotebookCellExecutionStateContext, NOTEBOOK_CELL_EDITABLE, NOTEBOOK_CELL_EDITOR_FOCUSED, NOTEBOOK_CELL_EXECUTING, NOTEBOOK_CELL_EXECUTION_STATE, NOTEBOOK_CELL_FOCUSED, NOTEBOOK_CELL_HAS_OUTPUTS, NOTEBOOK_CELL_INPUT_COLLAPSED, NOTEBOOK_CELL_LINE_NUMBERS, NOTEBOOK_CELL_MARKDOWN_EDIT_MODE, NOTEBOOK_CELL_OUTPUT_COLLAPSED, NOTEBOOK_CELL_RESOURCE, NOTEBOOK_CELL_TYPE} from 'td/workbench/contrib/notebook/common/notebookContextKeys';
