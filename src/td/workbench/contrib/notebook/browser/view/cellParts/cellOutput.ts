...
import {IQuickInputService, IQuickPickItem} from 'td/platform/quickinput/common/quickInput';
import {ThemeIcon} from 'td/base/common/themables';
import {ViewContainerLocation} from 'td/workbench/common/views';
import {IExtensionsViewPaneContainer, VIEWLET_ID as EXTENSION_VIEWLET_ID} from 'td/workbench/contrib/extensions/common/extensions';
import {INotebookOutputActionContext} from 'td/workbench/contrib/notebook/browser/controller/coreActions';
import {ICellOutputViewModel, ICellViewModel, IInsetRenderOutput, INotebookEditorDelegate, JUPYTER_EXTENSION_ID, RenderOutputType} from 'td/workbench/contrib/notebook/browser/notebookBrowser';
import {mimetypeIcon} from 'td/workbench/contrib/notebook/browser/notebookIcons';
import {CellContentPart} from 'td/workbench/contrib/notebook/browser/view/cellPart';
import {CodeCellRenderTemplate} from 'td/workbench/contrib/notebook/browser/view/notebookRenderingCommon';
...
import {CellUri, IOrderedMimeType, NotebookCellExecutionState, NotebookCellOutputsSplice, RENDERER_NOT_AVAILABLE, isTextStreamMime} from 'td/workbench/contrib/notebook/common/notebookCommon';
...
import {COPY_OUTPUT_COMMAND_ID} from 'td/workbench/contrib/notebook/browser/controller/cellOutputActions';
import {CLEAR_CELL_OUTPUTS_COMMAND_ID} from 'td/workbench/contrib/notebook/browser/controller/editActions';
import {TEXT_BASED_MIMETYPES} from 'td/workbench/contrib/notebook/browser/contrib/clipboard/cellOutputClipboard';
