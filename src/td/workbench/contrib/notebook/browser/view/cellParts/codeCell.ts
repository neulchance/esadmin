...
import {IReadonlyTextBuffer, ITextModel} from 'td/editor/common/model';
...
import {CellFocusMode, EXPAND_CELL_INPUT_COMMAND_ID, IActiveNotebookEditorDelegate} from 'td/workbench/contrib/notebook/browser/notebookBrowser';
...
import {CellOutputContainer} from 'td/workbench/contrib/notebook/browser/view/cellParts/cellOutput';
import {CollapsedCodeCellExecutionIcon} from 'td/workbench/contrib/notebook/browser/view/cellParts/codeCellExecutionIcon';
