...
import {IEditorContributionDescription} from 'td/editor/browser/editorExtensions';
...
import {FindMatch, IModelDeltaDecoration, IReadonlyTextBuffer, ITextModel, TrackedRangeStickiness} from 'td/editor/common/model';
import {MenuId} from 'td/platform/actions/common/actions';
import {ITextEditorOptions, ITextResourceEditorInput} from 'td/platform/editor/common/editor';
import {IConstructorSignature} from 'td/platform/instantiation/common/instantiation';
import {IEditorPane, IEditorPaneWithSelection} from 'td/workbench/common/editor';
import {CellViewModelStateChangeEvent, NotebookCellStateChangedEvent, NotebookLayoutInfo} from 'td/workbench/contrib/notebook/browser/notebookViewEvents';
...
import {CellKind, ICellOutput, INotebookCellStatusBarItem, INotebookRendererInfo, INotebookSearchOptions, IOrderedMimeType, NotebookCellInternalMetadata, NotebookCellMetadata, NOTEBOOK_EDITOR_ID} from 'td/workbench/contrib/notebook/common/notebookCommon';
import {isCompositeNotebookEditorInput} from 'td/workbench/contrib/notebook/common/notebookEditorInput';
...
import {cellRangesToIndexes, ICellRange, reduceCellRanges} from 'td/workbench/contrib/notebook/common/notebookRange';
...
// !! IMPORTANT !! ----------------------------------------------------------------------------------
// NOTE that you MUST update td/workbench/contrib/notebook/browser/view/renderers/webviewPreloads.ts#L1986
