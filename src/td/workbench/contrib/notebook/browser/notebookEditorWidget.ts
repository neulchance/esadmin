...
import 'td/css!./media/notebook';
import 'td/css!./media/notebookCellChat';
import 'td/css!./media/notebookCellEditorHint';
import 'td/css!./media/notebookCellInsertToolbar';
import 'td/css!./media/notebookCellStatusBar';
import 'td/css!./media/notebookCellTitleToolbar';
import 'td/css!./media/notebookFocusIndicator';
import 'td/css!./media/notebookToolbar';
import 'td/css!./media/notebookDnd';
import 'td/css!./media/notebookFolding';
import 'td/css!./media/notebookCellOutput';
import 'td/css!./media/notebookEditorStickyScroll';
import 'td/css!./media/notebookKernelActionViewItem';
import 'td/css!./media/notebookOutline';
import {PixelRatio} from 'td/base/browser/browser';
import * as DOM from 'td/base/browser/dom';
import {IMouseWheelEvent, StandardMouseEvent} from 'td/base/browser/mouseEvent';
import {IListContextMenuEvent} from 'td/base/browser/ui/list/list';
import {mainWindow} from 'td/base/browser/window';
import {DeferredPromise, SequencerByKey} from 'td/base/common/async';
...
import {combinedDisposable, Disposable, DisposableStore, dispose, IDisposable, toDisposable} from 'td/base/common/lifecycle';
import {setTimeout0} from 'td/base/common/platform';
import {extname, isEqual} from 'td/base/common/resources';
...
import {registerZIndex, ZIndex} from 'td/platform/layout/browser/zIndexRegistry';
import {IEditorProgressService, IProgressRunner} from 'td/platform/progress/common/progress';
import {ITelemetryService} from 'td/platform/telemetry/common/telemetry';
import {contrastBorder, errorForeground, focusBorder, foreground, listInactiveSelectionBackground, registerColor, scrollbarSliderActiveBackground, scrollbarSliderBackground, scrollbarSliderHoverBackground, transparent} from 'td/platform/theme/common/colorRegistry';
import {EDITOR_PANE_BACKGROUND, PANEL_BORDER, SIDE_BAR_BACKGROUND} from 'td/workbench/common/theme';
import {debugIconStartForeground} from 'td/workbench/contrib/debug/browser/debugColors';
import {CellEditState, CellFindMatchWithIndex, CellFocusMode, CellLayoutContext, CellRevealRangeType, CellRevealType, IActiveNotebookEditorDelegate, IBaseCellEditorOptions, ICellOutputViewModel, ICellViewModel, ICommonCellInfo, IDisplayOutputLayoutUpdateRequest, IFocusNotebookCellOptions, IInsetRenderOutput, IModelDecorationsChangeAccessor, INotebookDeltaDecoration, INotebookEditor, INotebookEditorContribution, INotebookEditorContributionDescription, INotebookEditorCreationOptions, INotebookEditorDelegate, INotebookEditorMouseEvent, INotebookEditorOptions, INotebookEditorViewState, INotebookViewCellsUpdateEvent, INotebookWebviewMessage, RenderOutputType, ScrollToRevealBehavior} from 'td/workbench/contrib/notebook/browser/notebookBrowser';
import {NotebookEditorExtensionsRegistry} from 'td/workbench/contrib/notebook/browser/notebookEditorExtensions';
import {INotebookEditorService} from 'td/workbench/contrib/notebook/browser/services/notebookEditorService';
import {notebookDebug} from 'td/workbench/contrib/notebook/browser/notebookLogger';
import {NotebookCellStateChangedEvent, NotebookLayoutChangedEvent, NotebookLayoutInfo} from 'td/workbench/contrib/notebook/browser/notebookViewEvents';
import {CellContextKeyManager} from 'td/workbench/contrib/notebook/browser/view/cellParts/cellContextKeys';
import {CellDragAndDropController} from 'td/workbench/contrib/notebook/browser/view/cellParts/cellDnd';
import {ListViewInfoAccessor, NotebookCellList, NOTEBOOK_WEBVIEW_BOUNDARY} from 'td/workbench/contrib/notebook/browser/view/notebookCellList';
import {INotebookCellList} from 'td/workbench/contrib/notebook/browser/view/notebookRenderingCommon';
import {BackLayerWebView} from 'td/workbench/contrib/notebook/browser/view/renderers/backLayerWebView';
import {CodeCellRenderer, MarkupCellRenderer, NotebookCellListDelegate} from 'td/workbench/contrib/notebook/browser/view/renderers/cellRenderer';
import {IAckOutputHeight, IMarkupCellInitialization} from 'td/workbench/contrib/notebook/browser/view/renderers/webviewMessages';
import {CodeCellViewModel, outputDisplayLimit} from 'td/workbench/contrib/notebook/browser/viewModel/codeCellViewModel';
import {NotebookEventDispatcher} from 'td/workbench/contrib/notebook/browser/viewModel/eventDispatcher';
import {MarkupCellViewModel} from 'td/workbench/contrib/notebook/browser/viewModel/markupCellViewModel';
import {CellViewModel, NotebookViewModel} from 'td/workbench/contrib/notebook/browser/viewModel/notebookViewModelImpl';
import {ViewContext} from 'td/workbench/contrib/notebook/browser/viewModel/viewContext';
import {NotebookEditorWorkbenchToolbar} from 'td/workbench/contrib/notebook/browser/viewParts/notebookEditorToolbar';
import {NotebookEditorContextKeys} from 'td/workbench/contrib/notebook/browser/viewParts/notebookEditorWidgetContextKeys';
import {NotebookOverviewRuler} from 'td/workbench/contrib/notebook/browser/viewParts/notebookOverviewRuler';
import {ListTopCellToolbar} from 'td/workbench/contrib/notebook/browser/viewParts/notebookTopCellToolbar';
import {NotebookTextModel} from 'td/workbench/contrib/notebook/common/model/notebookTextModel';
import {CellEditType, CellKind, INotebookSearchOptions, RENDERER_NOT_AVAILABLE, SelectionStateType} from 'td/workbench/contrib/notebook/common/notebookCommon';
import {NOTEBOOK_CURSOR_NAVIGATION_MODE, NOTEBOOK_EDITOR_EDITABLE, NOTEBOOK_EDITOR_FOCUSED, NOTEBOOK_OUTPUT_FOCUSED, NOTEBOOK_OUPTUT_INPUT_FOCUSED} from 'td/workbench/contrib/notebook/common/notebookContextKeys';
import {INotebookExecutionService} from 'td/workbench/contrib/notebook/common/notebookExecutionService';
import {INotebookExecutionStateService} from 'td/workbench/contrib/notebook/common/notebookExecutionStateService';
import {INotebookKernelService} from 'td/workbench/contrib/notebook/common/notebookKernelService';
import {NotebookOptions, OutputInnerContainerTopPadding} from 'td/workbench/contrib/notebook/browser/notebookOptions';
import {ICellRange} from 'td/workbench/contrib/notebook/common/notebookRange';
import {INotebookRendererMessagingService} from 'td/workbench/contrib/notebook/common/notebookRendererMessagingService';
import {INotebookService} from 'td/workbench/contrib/notebook/common/notebookService';
import {IWebviewElement} from 'td/workbench/contrib/webview/browser/webview';
...
import {NotebookPerfMarks} from 'td/workbench/contrib/notebook/common/notebookPerformance';
import {BaseCellEditorOptions} from 'td/workbench/contrib/notebook/browser/viewModel/cellEditorOptions';
import {FloatingEditorClickMenu} from 'td/workbench/browser/codeeditor';
import {IDimension} from 'td/editor/common/core/dimension';
import {CellFindMatchModel} from 'td/workbench/contrib/notebook/browser/contrib/find/findModel';
import {INotebookLoggingService} from 'td/workbench/contrib/notebook/common/notebookLoggingService';
import {Schemas} from 'td/base/common/network';
import {DropIntoEditorController} from 'td/editor/contrib/dropOrPasteInto/browser/dropIntoEditorController';
import {CopyPasteController} from 'td/editor/contrib/dropOrPasteInto/browser/copyPasteController';
import {NotebookStickyScroll} from 'td/workbench/contrib/notebook/browser/viewParts/notebookEditorStickyScroll';
import {NotebookCellOutlineProvider} from 'td/workbench/contrib/notebook/browser/viewModel/notebookOutlineProvider';
...
import {OutlineTarget} from 'td/workbench/services/outline/browser/outline';
import {AccessibilityCommandId} from 'td/workbench/contrib/accessibility/common/accessibilityCommands';
...
export class NotebookEditorWidget extends Disposable implements INotebookEditorDelegate, INotebookEditor {
	...
	constructor(
		...
		if (creationOptions.devWindow) {
			this.layoutService.getContainer(creationOptions.devWindow).appendChild(this._overlayContainer);
		} else {
	...
	private async _resolveWebview(): Promise<BackLayerWebView<ICommonCellInfo> | null> {
		...
		this._webviewResolvePromise = (async () => {
			...
			await this._webview.createWebview(this.creationOptions.devWindow ?? mainWindow);
