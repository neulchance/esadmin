...
import {ToggleCaseSensitiveKeybinding, ToggleRegexKeybinding, ToggleWholeWordKeybinding} from 'td/editor/contrib/find/browser/findModel';
import {localize, localize2} from 'td/nls';
import {Action2, MenuId, registerAction2} from 'td/platform/actions/common/actions';
...
import {Extensions as WorkbenchExtensions, IWorkbenchContribution, IWorkbenchContributionsRegistry} from 'td/workbench/common/contributions';
import {IEditorSerializer, IEditorFactoryRegistry, EditorExtensions, DEFAULT_EDITOR_ASSOCIATION} from 'td/workbench/common/editor';
...
import {getSearchView} from 'td/workbench/contrib/search/browser/searchActionsBase';
import {searchNewEditorIcon, searchRefreshIcon} from 'td/workbench/contrib/search/browser/searchIcons';
import * as SearchConstants from 'td/workbench/contrib/search/common/constants';
import * as SearchEditorConstants from 'td/workbench/contrib/searchEditor/browser/constants';
import {SearchEditor} from 'td/workbench/contrib/searchEditor/browser/searchEditor';
import {createEditorFromSearchResult, modifySearchEditorContextLinesCommand, openNewSearchEditor, openSearchEditor, selectAllSearchEditorMatchesCommand, toggleSearchEditorCaseSensitiveCommand, toggleSearchEditorContextLinesCommand, toggleSearchEditorRegexCommand, toggleSearchEditorWholeWordCommand} from 'td/workbench/contrib/searchEditor/browser/searchEditorActions';
import {getOrMakeSearchEditorInput, SearchConfiguration, SearchEditorInput, SEARCH_EDITOR_EXT} from 'td/workbench/contrib/searchEditor/browser/searchEditorInput';
import {IEditorService} from 'td/workbench/services/editor/common/editorService';
import {VIEW_ID} from 'td/workbench/services/search/common/search';
import {RegisteredEditorPriority, IEditorResolverService} from 'td/workbench/services/editor/common/editorResolverService';
import {IWorkingCopyEditorHandler, IWorkingCopyEditorService} from 'td/workbench/services/workingCopy/common/workingCopyEditorService';
import {Disposable} from 'td/base/common/lifecycle';
import {IWorkingCopyIdentifier} from 'td/workbench/services/workingCopy/common/workingCopy';
