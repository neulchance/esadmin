...
import {FileMatch, Match, searchMatchComparer, SearchResult, FolderMatch, CellMatch} from 'td/workbench/contrib/search/browser/searchModel';
import type {SearchConfiguration} from 'td/workbench/contrib/searchEditor/browser/searchEditorInput';
import {ITextQuery, SearchSortOrder} from 'td/workbench/services/search/common/search';
