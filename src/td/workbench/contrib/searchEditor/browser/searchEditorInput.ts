...
import {extname, isEqual, joinPath} from 'td/base/common/resources';
import {URI} from 'td/base/common/uri';
import {Range} from 'td/editor/common/core/range';
import {ITextModel, TrackedRangeStickiness} from 'td/editor/common/model';
...
import {GroupIdentifier, IRevertOptions, ISaveOptions, EditorResourceAccessor, IMoveResult, EditorInputCapabilities, IUntypedEditorInput} from 'td/workbench/common/editor';
import {Memento} from 'td/workbench/common/memento';
import {SearchEditorFindMatchClass, SearchEditorInputTypeId, SearchEditorScheme, SearchEditorWorkingCopyTypeId} from 'td/workbench/contrib/searchEditor/browser/constants';
import {SearchConfigurationModel, SearchEditorModel, searchEditorModelFactory} from 'td/workbench/contrib/searchEditor/browser/searchEditorModel';
import {defaultSearchConfig, parseSavedSearchEditor, serializeSearchConfiguration} from 'td/workbench/contrib/searchEditor/browser/searchEditorSerialization';
import {IPathService} from 'td/workbench/services/path/common/pathService';
import {ITextFileSaveOptions, ITextFileService} from 'td/workbench/services/textfile/common/textfiles';
import {IWorkingCopyService} from 'td/workbench/services/workingCopy/common/workingCopyService';
import {IWorkingCopy, IWorkingCopyBackup, IWorkingCopySaveEvent, WorkingCopyCapabilities} from 'td/workbench/services/workingCopy/common/workingCopy';
import {CancellationToken} from 'td/base/common/cancellation';
import {IConfigurationService} from 'td/platform/configuration/common/configuration';
import {ISearchComplete, ISearchConfigurationProperties} from 'td/workbench/services/search/common/search';
import {bufferToReadable, VSBuffer} from 'td/base/common/buffer';
