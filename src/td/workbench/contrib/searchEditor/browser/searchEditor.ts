...
import {Delayer} from 'td/base/common/async';
...
import 'td/css!./media/searchEditor';
...
import {ICodeEditorViewState} from 'td/editor/common/editorCommon';
...
import {inputBorder, registerColor} from 'td/platform/theme/common/colorRegistry';
...
import {AbstractTextCodeEditor} from 'td/workbench/browser/parts/editor/textCodeEditor';
import {EditorInputCapabilities, IEditorOpenContext} from 'td/workbench/common/editor';
...
import {InputBoxFocusedKey} from 'td/workbench/contrib/search/common/constants';
import {ITextQueryBuilderOptions, QueryBuilder} from 'td/workbench/services/search/common/queryBuilder';
import {getOutOfWorkspaceEditorResources} from 'td/workbench/contrib/search/common/search';
import {SearchModel, SearchResult} from 'td/workbench/contrib/search/browser/searchModel';
import {InSearchEditor, SearchEditorID, SearchEditorInputTypeId} from 'td/workbench/contrib/searchEditor/browser/constants';
import type {SearchConfiguration, SearchEditorInput} from 'td/workbench/contrib/searchEditor/browser/searchEditorInput';
import {serializeSearchResultForEditor} from 'td/workbench/contrib/searchEditor/browser/searchEditorSerialization';
...
import {IPatternInfo, ISearchComplete, ISearchConfigurationProperties, ITextQuery, SearchSortOrder} from 'td/workbench/services/search/common/search';
...
import {UnusualLineTerminatorsDetector} from 'td/editor/contrib/unusualLineTerminators/browser/unusualLineTerminators';
import {defaultToggleStyles, getInputBoxStyle} from 'td/platform/theme/browser/defaultStyles';
