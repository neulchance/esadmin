...
import {KeyMod, KeyChord, KeyCode} from 'td/base/common/keyCodes';
import {MenuRegistry, MenuId, Action2, registerAction2, ISubmenuItem} from 'td/platform/actions/common/actions';
import {equalsIgnoreCase} from 'td/base/common/strings';
...
import {IWorkbenchThemeService, IWorkbenchTheme, ThemeSettingTarget, IWorkbenchColorTheme, IWorkbenchFileIconTheme, IWorkbenchProductIconTheme, ThemeSettings, ThemeSettingDefaults} from 'td/workbench/services/themes/common/workbenchThemeService';
import {VIEWLET_ID, IExtensionsViewPaneContainer} from 'td/workbench/contrib/extensions/common/extensions';
import {IExtensionGalleryService, IExtensionManagementService, IGalleryExtension} from 'td/platform/extensionManagement/common/extensionManagement';
import {IColorRegistry, Extensions as ColorRegistryExtensions} from 'td/platform/theme/common/colorRegistry';
import {IEditorService} from 'td/workbench/services/editor/common/editorService';
import {Color} from 'td/base/common/color';
import {ColorScheme, isHighContrast} from 'td/platform/theme/common/theme';
import {colorThemeSchemaId} from 'td/workbench/services/themes/common/colorThemeSchema';
import {isCancellationError, onUnexpectedError} from 'td/base/common/errors';
import {IQuickInputButton, IQuickInputService, IQuickPickItem, QuickPickInput} from 'td/platform/quickinput/common/quickInput';
import {DEFAULT_PRODUCT_ICON_THEME_ID, ProductIconThemeData} from 'td/workbench/services/themes/browser/productIconThemeData';
...
import {FileIconThemeData} from 'td/workbench/services/themes/browser/fileIconThemeData';
