...
import {MenuId, registerAction2, Action2, MenuRegistry} from 'td/platform/actions/common/actions';
import {InstantiationType, registerSingleton} from 'td/platform/instantiation/common/extensions';
import {OutputService} from 'td/workbench/contrib/output/browser/outputServices';
import {OUTPUT_MODE_ID, OUTPUT_MIME, OUTPUT_VIEW_ID, IOutputService, CONTEXT_IN_OUTPUT, LOG_MODE_ID, LOG_MIME, CONTEXT_ACTIVE_FILE_OUTPUT, CONTEXT_OUTPUT_SCROLL_LOCK, IOutputChannelDescriptor, IFileOutputChannelDescriptor, ACTIVE_OUTPUT_CHANNEL_CONTEXT, IOutputChannelRegistry, Extensions} from 'td/workbench/services/output/common/output';
...
import {ViewContainer, IViewContainersRegistry, ViewContainerLocation, Extensions as ViewContainerExtensions, IViewsRegistry} from 'td/workbench/common/views';
...
import {IQuickPickItem, IQuickInputService, IQuickPickSeparator} from 'td/platform/quickinput/common/quickInput';
import {AUX_WINDOW_GROUP, AUX_WINDOW_GROUP_TYPE, IEditorService} from 'td/workbench/services/editor/common/editorService';
