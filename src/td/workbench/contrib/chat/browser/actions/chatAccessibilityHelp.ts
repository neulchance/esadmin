...
import {AccessibleViewType, IAccessibleViewService} from 'td/workbench/contrib/accessibility/browser/accessibleView';
...
import {AccessibleDiffViewerNext} from 'td/editor/browser/widget/diffEditor/diffEditor.contribution';
