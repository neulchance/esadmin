...
import {IQuickChatService, IQuickChatOpenOptions} from 'td/workbench/contrib/chat/browser/chat';
import {CONTEXT_PROVIDER_EXISTS} from 'td/workbench/contrib/chat/common/chatContextKeys';
