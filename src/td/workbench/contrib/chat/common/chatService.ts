...
import {Location, ProviderResult} from 'td/editor/common/languages';
...
import {ChatModel, IChatModel, IChatRequestVariableData, ISerializableChatData} from 'td/workbench/contrib/chat/common/chatModel';
