...
import {ProblemMatcher} from 'td/workbench/contrib/tasks/common/problemMatcher';
import {IWorkspaceFolder, IWorkspace} from 'td/platform/workspace/common/workspace';
import {RawContextKey, ContextKeyExpression} from 'td/platform/contextkey/common/contextkey';
import {TaskDefinitionRegistry} from 'td/workbench/contrib/tasks/common/taskDefinitionRegistry';
...
import {TerminalExitReason} from 'td/platform/terminal/common/terminal';
