...
import {StorageClient} from 'td/platform/storage/common/storageIpc';
import {EXTENSION_DEVELOPMENT_EMPTY_WINDOW_WORKSPACE} from 'td/platform/workspace/common/workspace';
import {NON_EMPTY_WORKSPACE_ID_LENGTH} from 'td/platform/workspaces/node/workspaces';
