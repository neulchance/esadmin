...
import {$, addDisposableListener, append, asCSSUrl, EventType, ModifierKeyEmitter, prepend} from 'td/base/browser/dom';
import {StandardKeyboardEvent} from 'td/base/browser/keyboardEvent';
import {ActionViewItem, BaseActionViewItem, SelectActionViewItem} from 'td/base/browser/ui/actionbar/actionViewItems';
import {DropdownMenuActionViewItem, IDropdownMenuActionViewItemOptions} from 'td/base/browser/ui/dropdown/dropdownActionViewItem';
import {ActionRunner, IAction, IRunEvent, Separator, SubmenuAction} from 'td/base/common/actions';
import {Event} from 'td/base/common/event';
import {UILabelProvider} from 'td/base/common/keybindingLabels';
import {KeyCode} from 'td/base/common/keyCodes';
import {combinedDisposable, MutableDisposable, toDisposable} from 'td/base/common/lifecycle';
import {isLinux, isWindows, OS} from 'td/base/common/platform';
import 'td/css!./menuEntryActionViewItem';
import {localize} from 'td/nls';
import {IMenu, IMenuActionOptions, IMenuService, MenuItemAction, SubmenuItemAction} from 'td/platform/actions/common/actions';
import {ICommandAction, isICommandActionToggleInfo} from 'td/platform/action/common/action';
