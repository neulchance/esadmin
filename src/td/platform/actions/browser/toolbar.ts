...
import {addDisposableListener, getWindow} from 'td/base/browser/dom';
import {StandardMouseEvent} from 'td/base/browser/mouseEvent';
import {IToolBarOptions, ToolBar} from 'td/base/browser/ui/toolbar/toolbar';
import {IAction, Separator, SubmenuAction, toAction, WorkbenchActionExecutedClassification, WorkbenchActionExecutedEvent} from 'td/base/common/actions';
import {coalesceInPlace} from 'td/base/common/arrays';
import {intersection} from 'td/base/common/collections';
...
import {IMenuActionOptions, IMenuService, MenuId, MenuItemAction, SubmenuItemAction} from 'td/platform/actions/common/actions';
