...
import {IEnterWorkspaceResult, IRecent, IRecentlyOpened, IWorkspaceFolderCreationData, IWorkspacesService} from 'td/platform/workspaces/common/workspaces';
import {IWorkspaceIdentifier} from 'td/platform/workspace/common/workspace';
