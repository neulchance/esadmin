...
import {Emitter, Event as CommonEvent} from 'td/base/common/event';
import {normalizeDriveLetter, splitRecentLabel} from 'td/base/common/labels';
import {Disposable} from 'td/base/common/lifecycle';
import {Schemas} from 'td/base/common/network';
import {isMacintosh, isWindows} from 'td/base/common/platform';
import {basename, extUriBiasedIgnorePathCase, originalFSPath} from 'td/base/common/resources';
...
import {StorageScope, StorageTarget} from 'td/platform/storage/common/storage';
import {IApplicationStorageMainService} from 'td/platform/storage/electron-main/storageMainService';
import {IRecent, IRecentFile, IRecentFolder, IRecentlyOpened, IRecentWorkspace, isRecentFile, isRecentFolder, isRecentWorkspace, restoreRecentlyOpened, toStoreData} from 'td/platform/workspaces/common/workspaces';
import {IWorkspaceIdentifier, WORKSPACE_EXTENSION} from 'td/platform/workspace/common/workspace';
