...
import {isUNC, toSlashes} from 'td/base/common/extpath';
import * as json from 'td/base/common/json';
import * as jsonEdit from 'td/base/common/jsonEdit';
...
import {isAbsolute, posix} from 'td/base/common/path';
import {isLinux, isMacintosh, isWindows} from 'td/base/common/platform';
import {IExtUri, isEqualAuthority} from 'td/base/common/resources';
import {URI} from 'td/base/common/uri';
import {IWorkspaceBackupInfo, IFolderBackupInfo} from 'td/platform/backup/common/backup';
...
import {IBaseWorkspace, IRawFileWorkspaceFolder, IRawUriWorkspaceFolder, IWorkspaceIdentifier, WorkspaceFolder} from 'td/platform/workspace/common/workspace';
