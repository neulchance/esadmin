...
import {ISocket, SocketCloseEvent, SocketCloseEventType, SocketDiagnostics, SocketDiagnosticsEventType} from 'td/base/parts/ipc/common/ipc.net';
import {ISocketFactory} from 'td/platform/remote/common/remoteSocketFactoryService';
import {RemoteAuthorityResolverError, RemoteAuthorityResolverErrorCode, RemoteConnectionType, WebSocketRemoteConnection} from 'td/platform/remote/common/remoteAuthorityResolver';
