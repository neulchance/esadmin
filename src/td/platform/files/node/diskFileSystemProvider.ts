...
import {Barrier, retry} from 'td/base/common/async';
...
import {isEqual} from 'td/base/common/extpath';
import {DisposableStore, IDisposable, toDisposable} from 'td/base/common/lifecycle';
import {basename, dirname, join} from 'td/base/common/path';
import {isLinux, isWindows} from 'td/base/common/platform';
import {extUriBiasedIgnorePathCase, joinPath, basename as resourcesBasename, dirname as resourcesDirname} from 'td/base/common/resources';
import {newWriteableStream, ReadableStreamEvents} from 'td/base/common/stream';
import {URI} from 'td/base/common/uri';
import {IDirent, Promises, RimRafMode, SymlinkSupport} from 'td/base/node/pfs';
import {localize} from 'td/nls';
import {createFileSystemProviderError, IFileAtomicReadOptions, IFileDeleteOptions, IFileOpenOptions, IFileOverwriteOptions, IFileReadStreamOptions, FileSystemProviderCapabilities, FileSystemProviderError, FileSystemProviderErrorCode, FileType, IFileWriteOptions, IFileSystemProviderWithFileAtomicReadCapability, IFileSystemProviderWithFileCloneCapability, IFileSystemProviderWithFileFolderCopyCapability, IFileSystemProviderWithFileReadStreamCapability, IFileSystemProviderWithFileReadWriteCapability, IFileSystemProviderWithOpenReadWriteCloseCapability, isFileOpenForWriteOptions, IStat, FilePermission, IFileSystemProviderWithFileAtomicWriteCapability, IFileSystemProviderWithFileAtomicDeleteCapability, IFileChange} from 'td/platform/files/common/files';
import {readFileIntoStream} from 'td/platform/files/common/io';
import {AbstractNonRecursiveWatcherClient, AbstractUniversalWatcherClient, ILogMessage} from 'td/platform/files/common/watcher';
import {ILogService} from 'td/platform/log/common/log';
import {AbstractDiskFileSystemProvider, IDiskFileSystemProviderOptions} from 'td/platform/files/common/diskFileSystemProvider';
import {toErrorMessage} from 'td/base/common/errorMessage';
import {UniversalWatcherClient} from 'td/platform/files/node/watcher/watcherClient';
import {NodeJSWatcherClient} from 'td/platform/files/node/watcher/nodejs/nodejsClient';
