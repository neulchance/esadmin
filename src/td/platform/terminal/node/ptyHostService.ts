...
import {IProcessEnvironment, OS, OperatingSystem, isWindows} from 'td/base/common/platform';
...
import {RemoteLoggerChannelClient} from 'td/platform/log/common/logIpc';
...
import {detectAvailableProfiles} from 'td/platform/terminal/node/terminalProfiles';
import * as performance from 'td/base/common/performance';
import {getSystemShell} from 'td/base/node/shell';
