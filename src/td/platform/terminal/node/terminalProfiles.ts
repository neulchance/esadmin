...
import {basename, delimiter, normalize} from 'td/base/common/path';
...
import {enumeratePowerShellInstallations} from 'td/base/node/powershell';
import {IConfigurationService} from 'td/platform/configuration/common/configuration';
import {ILogService} from 'td/platform/log/common/log';
import {ITerminalEnvironment, ITerminalExecutable, ITerminalProfile, ITerminalProfileSource, ITerminalUnsafePath, ProfileSource, TerminalIcon, TerminalSettingId} from 'td/platform/terminal/common/terminal';
import {findExecutable, getWindowsBuildNumber} from 'td/platform/terminal/node/terminalEnvironment';
