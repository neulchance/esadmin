...
import {ITerminalOutputMatch, ITerminalOutputMatcher} from 'td/platform/terminal/common/terminal';
import {ReplayEntry} from 'td/platform/terminal/common/terminalProcess';
