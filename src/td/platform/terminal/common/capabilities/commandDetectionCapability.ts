...
import {Disposable, MandatoryMutableDisposable, MutableDisposable} from 'td/base/common/lifecycle';
import {ILogService} from 'td/platform/log/common/log';
import {CommandInvalidationReason, ICommandDetectionCapability, ICommandInvalidationRequest, IHandleCommandOptions, ISerializedCommandDetectionCapability, ISerializedTerminalCommand, ITerminalCommand, IXtermMarker, TerminalCapability} from 'td/platform/terminal/common/capabilities/capabilities';
import {ITerminalOutputMatcher} from 'td/platform/terminal/common/terminal';

// Importing types is safe in any layer
// eslint-disable-next-line local/code-import-patterns
import type {IBuffer, IDisposable, IMarker, Terminal} from '@xterm/headless';
import {ICurrentPartialCommand, PartialTerminalCommand, TerminalCommand} from 'td/platform/terminal/common/capabilities/commandDetection/terminalCommand';
