...
import {ITerminalCapabilityImplMap, ITerminalCapabilityStore, TerminalCapability, TerminalCapabilityChangeEvent} from 'td/platform/terminal/common/capabilities/capabilities';
