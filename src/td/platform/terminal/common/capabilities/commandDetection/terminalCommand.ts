...
import {IMarkProperties, IMarker, ISerializedTerminalCommand, ITerminalCommand, IXtermMarker} from 'td/platform/terminal/common/capabilities/capabilities';
import {ITerminalOutputMatcher, ITerminalOutputMatch} from 'td/platform/terminal/common/terminal';
