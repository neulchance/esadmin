...
import {dirname, join, resolve} from 'td/base/common/path';
import {isLinux, isMacintosh, isWindows} from 'td/base/common/platform';
import {AddFirstParameterToFunctions} from 'td/base/common/types';
import {URI} from 'td/base/common/uri';
import {realpath} from 'td/base/node/extpath';
import {virtualMachineHint} from 'td/base/node/id';
import {Promises, SymlinkSupport} from 'td/base/node/pfs';
import {findFreePort} from 'td/base/node/ports';
import {localize} from 'td/nls';
import {ISerializableCommandAction} from 'td/platform/action/common/action';
import {INativeOpenDialogOptions} from 'td/platform/dialogs/common/dialogs';
...
import {ILifecycleMainService, IRelaunchOptions} from 'td/platform/lifecycle/electron-main/lifecycleMainService';
import {ILogService} from 'td/platform/log/common/log';
import {ICommonNativeHostService, INativeOptions, IOSProperties, IOSStatistics} from 'td/platform/native/common/native';
import {IProductService} from 'td/platform/product/common/productService';
import {IPartsSplash} from 'td/platform/theme/common/themeService';
...
import {IColorScheme, IOpenedAuxiliaryWindow, IOpenedMainWindow, IOpenEmptyWindowOptions, IOpenWindowOptions, IPoint, IRectangle, IWindowOpenable} from 'td/platform/window/common/window';
import {getFocusedOrLastActiveWindow, IWindowsMainService, OpenContext} from 'td/platform/windows/electron-main/windows';
import {isWorkspaceIdentifier, toWorkspaceIdentifier} from 'td/platform/workspace/common/workspace';
...
import {hasWSLFeatureInstalled} from 'td/platform/remote/node/wsl';
import {WindowProfiler} from 'td/platform/profiling/electron-main/windowProfiling';
import {IV8Profile} from 'td/platform/profiling/common/profiling';
...
export class NativeHostMainService extends Disposable implements INativeHostMainService {
	...
	private windowById(windowId: number | undefined, fallbackCodeWindowId?: number): IDevWindow | IAuxiliaryWindow | undefined {
		return this.codeWindowById(windowId) ?? /* this.auxiliaryWindowById(windowId) ?? */ this.codeWindowById(fallbackCodeWindowId);
	}

	private codeWindowById(windowId: number | undefined): IDevWindow | undefined {
	...
	private getTargetWindow(fallbackWindowId: number | undefined): IDevWindow | IAuxiliaryWindow | undefined {
