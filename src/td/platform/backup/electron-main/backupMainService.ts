...
import {extUriBiasedIgnorePathCase} from 'td/base/common/resources';
import {Promises, RimRafMode} from 'td/base/node/pfs';
import {IBackupMainService} from 'td/platform/backup/electron-main/backup';
import {ISerializedBackupWorkspaces, IEmptyWindowBackupInfo, isEmptyWindowBackupInfo, deserializeWorkspaceInfos, deserializeFolderInfos, ISerializedWorkspaceBackupInfo, ISerializedFolderBackupInfo, ISerializedEmptyWindowBackupInfo} from 'td/platform/backup/node/backup';
...
import {HotExitConfiguration, IFilesConfiguration} from 'td/platform/files/common/files';
import {ILogService} from 'td/platform/log/common/log';
import {IFolderBackupInfo, isFolderBackupInfo, IWorkspaceBackupInfo} from 'td/platform/backup/common/backup';
import {isWorkspaceIdentifier} from 'td/platform/workspace/common/workspace';
import {createEmptyWorkspaceIdentifier} from 'td/platform/workspaces/node/workspaces';
