...
import {IStorage, Storage} from 'td/base/parts/storage/common/storage';
...
import {AbstractStorageService, isProfileUsingDefaultStorage, StorageScope, WillSaveStateReason} from 'td/platform/storage/common/storage';
import {ApplicationStorageDatabaseClient, ProfileStorageDatabaseClient, WorkspaceStorageDatabaseClient} from 'td/platform/storage/common/storageIpc';
import {isUserDataProfile, IUserDataProfile} from 'td/platform/userDataProfile/common/userDataProfile';
