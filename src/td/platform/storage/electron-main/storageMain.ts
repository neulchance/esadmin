...
import {top} from 'td/base/common/arrays';
...
import {InMemoryStorageDatabase, IStorage, Storage, StorageHint, StorageState} from 'td/base/parts/storage/common/storage';
import {ISQLiteStorageDatabaseLoggingOptions, SQLiteStorageDatabase} from 'td/base/parts/storage/node/storage';
...
import {IS_NEW_KEY} from 'td/platform/storage/common/storage';
import {IUserDataProfile, IUserDataProfilesService} from 'td/platform/userDataProfile/common/userDataProfile';
import {currentSessionDateStorageKey, firstSessionDateStorageKey, lastSessionDateStorageKey} from 'td/platform/telemetry/common/telemetry';
import {isSingleFolderWorkspaceIdentifier, isWorkspaceIdentifier, IAnyWorkspaceIdentifier} from 'td/platform/workspace/common/workspace';
