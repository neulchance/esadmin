...
import {IInputBox, IInputOptions, IKeyMods, IPickOptions, IQuickInput, IQuickInputButton, IQuickNavigateConfiguration, IQuickPick, IQuickPickItem, IQuickWidget, QuickInputHideReason, QuickPickInput} from 'td/platform/quickinput/common/quickInput';
import {QuickInputBox} from 'td/platform/quickinput/browser/quickInputBox';
import {QuickInputList, QuickInputListFocus} from 'td/platform/quickinput/browser/quickInputList';
import {QuickInputUI, Writeable, IQuickInputStyles, IQuickInputOptions, QuickPick, backButton, InputBox, Visibilities, QuickWidget} from 'td/platform/quickinput/browser/quickInput';
