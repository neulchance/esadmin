...
import {IHoverDelegate, IHoverWidget} from 'td/base/browser/ui/iconLabel/iconHoverDelegate';
import {IconLabel, IIconLabelValueOptions} from 'td/base/browser/ui/iconLabel/iconLabel';
...
import {IListAccessibilityProvider, IListOptions, IListStyles, List} from 'td/base/browser/ui/list/listWidget';
import {range} from 'td/base/common/arrays';
import {ThrottledDelayer} from 'td/base/common/async';
import {compareAnything} from 'td/base/common/comparers';
...
import {getCodiconAriaLabel, IParsedLabelWithIcons, matchesFuzzyIconAware, parseLabelWithIcons} from 'td/base/common/iconLabels';
...
import {ltrim} from 'td/base/common/strings';
import 'td/css!./media/quickInput';
import {localize} from 'td/nls';
import {IQuickInputOptions} from 'td/platform/quickinput/browser/quickInput';
import {quickInputButtonToAction} from 'td/platform/quickinput/browser/quickInputUtils';
import {IQuickPickItem, IQuickPickItemButtonEvent, IQuickPickSeparator, IQuickPickSeparatorButtonEvent, QuickPickItem} from 'td/platform/quickinput/common/quickInput';
import {Lazy} from 'td/base/common/lazy';
import {URI} from 'td/base/common/uri';
import {isDark} from 'td/platform/theme/common/theme';
