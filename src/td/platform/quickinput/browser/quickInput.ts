...
import {CountBadge, ICountBadgeStyles} from 'td/base/browser/ui/countBadge/countBadge';
import {IHoverDelegate, IHoverDelegateOptions, IHoverWidget} from 'td/base/browser/ui/iconLabel/iconHoverDelegate';
import {IInputBoxStyles} from 'td/base/browser/ui/inputbox/inputBox';
import {IKeybindingLabelStyles} from 'td/base/browser/ui/keybindingLabel/keybindingLabel';
import {IListRenderer, IListVirtualDelegate} from 'td/base/browser/ui/list/list';
import {IListOptions, IListStyles, List} from 'td/base/browser/ui/list/listWidget';
import {IProgressBarStyles, ProgressBar} from 'td/base/browser/ui/progressbar/progressbar';
...
import {isIOS} from 'td/base/common/platform';
...
export interface IQuickInputOptions {
	...
	/**
	 * @todo With IHover in td/editor, can we depend on the service directly
