...
import {ILifecycleMainService, IRelaunchHandler, IRelaunchOptions} from 'td/platform/lifecycle/electron-main/lifecycleMainService';
...
import {IUpdate, State, StateType, UpdateType} from 'td/platform/update/common/update';
import {AbstractUpdateService, createUpdateURL, UpdateErrorClassification, UpdateNotAvailableClassification} from 'td/platform/update/electron-main/abstractUpdateService';
