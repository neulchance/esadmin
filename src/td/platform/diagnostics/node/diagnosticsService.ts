...
import {basename, join} from 'td/base/common/path';
import {isLinux, isWindows} from 'td/base/common/platform';
import {ProcessItem} from 'td/base/common/processes';
import {URI} from 'td/base/common/uri';
import {virtualMachineHint} from 'td/base/node/id';
import {IDirent, Promises as pfs} from 'td/base/node/pfs';
import {listProcesses} from 'td/base/node/ps';
import {IDiagnosticsService, IMachineInfo, IMainProcessDiagnostics, IRemoteDiagnosticError, IRemoteDiagnosticInfo, isRemoteDiagnosticError, IWorkspaceInformation, PerformanceInfo, SystemInfo, WorkspaceStatItem, WorkspaceStats} from 'td/platform/diagnostics/common/diagnostics';
import {ByteSize} from 'td/platform/files/common/files';
