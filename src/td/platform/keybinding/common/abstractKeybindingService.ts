...
import {Keybinding, ResolvedChord, ResolvedKeybinding, SingleModifierChord} from 'td/base/common/keybindings';
...
import {ResolutionResult, KeybindingResolver, ResultKind, NoMatchingKb} from 'td/platform/keybinding/common/keybindingResolver';
