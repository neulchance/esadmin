...
import {decodeKeybinding, Keybinding} from 'td/base/common/keybindings';
import {OperatingSystem, OS} from 'td/base/common/platform';
import {CommandsRegistry, ICommandHandler, ICommandMetadata} from 'td/platform/commands/common/commands';
...
import {combinedDisposable, DisposableStore, IDisposable, toDisposable} from 'td/base/common/lifecycle';
