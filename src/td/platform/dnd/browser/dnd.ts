...
import {IBaseTextResourceEditorInput} from 'td/platform/editor/common/editor';
import {HTMLFileSystemProvider} from 'td/platform/files/browser/htmlFileSystemProvider';
import {WebFileSystemAccess} from 'td/platform/files/browser/webFileSystemAccess';
import {ByteSize, IFileService} from 'td/platform/files/common/files';
