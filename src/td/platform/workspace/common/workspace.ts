...
import {basename, extname} from 'td/base/common/path';
import {TernarySearchTree} from 'td/base/common/ternarySearchTree';
import {extname as resourceExtname, basenameOrAuthority, joinPath, extUriBiasedIgnorePathCase} from 'td/base/common/resources';
