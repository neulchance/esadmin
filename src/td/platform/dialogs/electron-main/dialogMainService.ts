...
import {INativeOpenDialogOptions, massageMessageBoxOptions} from 'td/platform/dialogs/common/dialogs';
...
import {WORKSPACE_FILTER} from 'td/platform/workspace/common/workspace';
