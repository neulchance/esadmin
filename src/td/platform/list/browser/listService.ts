...
import {createStyleSheet, isActiveElement, isKeyboardEvent} from 'td/base/browser/dom';
import {IContextViewProvider} from 'td/base/browser/ui/contextview/contextview';
import {IListMouseEvent, IListRenderer, IListTouchEvent, IListVirtualDelegate} from 'td/base/browser/ui/list/list';
import {IPagedListOptions, IPagedRenderer, PagedList} from 'td/base/browser/ui/list/listPaging';
import {DefaultStyleController, IKeyboardNavigationEventFilter, IListAccessibilityProvider, IListOptions, IListOptionsUpdate, IListStyles, IMultipleSelectionController, isSelectionRangeChangeEvent, isSelectionSingleChangeEvent, List, TypeNavigationMode} from 'td/base/browser/ui/list/listWidget';
import {ITableColumn, ITableRenderer, ITableVirtualDelegate} from 'td/base/browser/ui/table/table';
import {ITableOptions, ITableOptionsUpdate, ITableStyles, Table} from 'td/base/browser/ui/table/tableWidget';
import {TreeFindMode, IAbstractTreeOptions, IAbstractTreeOptionsUpdate, RenderIndentGuides, TreeFindMatchType} from 'td/base/browser/ui/tree/abstractTree';
import {AsyncDataTree, CompressibleAsyncDataTree, IAsyncDataTreeOptions, IAsyncDataTreeOptionsUpdate, ICompressibleAsyncDataTreeOptions, ICompressibleAsyncDataTreeOptionsUpdate, ITreeCompressionDelegate} from 'td/base/browser/ui/tree/asyncDataTree';
import {DataTree, IDataTreeOptions} from 'td/base/browser/ui/tree/dataTree';
import {CompressibleObjectTree, ICompressibleObjectTreeOptions, ICompressibleObjectTreeOptionsUpdate, ICompressibleTreeRenderer, IObjectTreeOptions, ObjectTree} from 'td/base/browser/ui/tree/objectTree';
import {IAsyncDataSource, IDataSource, ITreeEvent, ITreeRenderer} from 'td/base/browser/ui/tree/tree';
...
import {Extensions as ConfigurationExtensions, IConfigurationRegistry} from 'td/platform/configuration/common/configurationRegistry';
...
import {InputFocusedContextKey} from 'td/platform/contextkey/common/contextkeys';
...
import {createDecorator, IInstantiationService, ServicesAccessor} from 'td/platform/instantiation/common/instantiation';
...
import {IStyleOverride, defaultFindWidgetStyles, defaultListStyles, getListStyles} from 'td/platform/theme/browser/defaultStyles';
...
configurationRegistry.registerConfiguration({
	...
	properties: {
		...
		[treeStickyScroll]: {
			type: 'boolean',
			default: 'dev', // only enable as default in insiders
