...
import {FileOperationError, FileOperationResult, IFileContent, IFileService, IFileStat} from 'td/platform/files/common/files';
...
import {AbstractInitializer, AbstractSynchroniser, IAcceptResult, IFileResourcePreview, IMergeResult} from 'td/platform/userDataSync/common/abstractSynchronizer';
import {areSame, IMergeResult as ISnippetsMergeResult, merge} from 'td/platform/userDataSync/common/snippetsMerge';
import {Change, IRemoteUserData, ISyncData, IUserDataSyncLocalStoreService, IUserDataSynchroniser, IUserDataSyncLogService, IUserDataSyncEnablementService, IUserDataSyncStoreService, SyncResource, USER_DATA_SYNC_SCHEME} from 'td/platform/userDataSync/common/userDataSync';
