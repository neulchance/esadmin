...
import {ConfigurationModelParser} from 'td/platform/configuration/common/configurationModels';
...
import {AbstractInitializer, AbstractJsonFileSynchroniser, IAcceptResult, IFileResourcePreview, IMergeResult} from 'td/platform/userDataSync/common/abstractSynchronizer';
import {getIgnoredSettings, isEmpty, merge, updateIgnoredSettings} from 'td/platform/userDataSync/common/settingsMerge';
