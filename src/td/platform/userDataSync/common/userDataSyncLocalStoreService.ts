...
import {FileOperationResult, IFileService, IFileStat, toFileOperationResult} from 'td/platform/files/common/files';
import {IUserDataProfilesService} from 'td/platform/userDataProfile/common/userDataProfile';
import {ALL_SYNC_RESOURCES, IResourceRefHandle, IUserDataSyncLocalStoreService, IUserDataSyncLogService, SyncResource} from 'td/platform/userDataSync/common/userDataSync';
