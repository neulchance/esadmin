...
import {bufferToStream, VSBuffer} from 'td/base/common/buffer';
...
import {FormattingOptions} from 'td/base/common/jsonFormatter';
...
import {DidUninstallExtensionEvent, IExtensionGalleryService, IExtensionManagementService, IGlobalExtensionEnablementService, InstallExtensionResult} from 'td/platform/extensionManagement/common/extensionManagement';
import {IFileService} from 'td/platform/files/common/files';
import {FileService} from 'td/platform/files/common/fileService';
import {InMemoryFileSystemProvider} from 'td/platform/files/common/inMemoryFilesystemProvider';
...
import {InMemoryUserDataProfilesService, IUserDataProfile, IUserDataProfilesService} from 'td/platform/userDataProfile/common/userDataProfile';
import {NullPolicyService} from 'td/platform/policy/common/policy';
import {IUserDataProfileStorageService} from 'td/platform/userDataProfile/common/userDataProfileStorageService';
import {TestUserDataProfileStorageService} from 'td/platform/userDataProfile/test/common/userDataProfileStorageService.test';
