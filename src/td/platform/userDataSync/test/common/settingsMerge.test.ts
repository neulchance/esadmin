...
import {addSetting, merge, updateIgnoredSettings} from 'td/platform/userDataSync/common/settingsMerge';
import type {IConflictSetting} from 'td/platform/userDataSync/common/userDataSync';
