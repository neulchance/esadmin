...
import {merge} from 'td/platform/userDataSync/common/extensionsMerge';
import {ILocalSyncExtension, ISyncExtension} from 'td/platform/userDataSync/common/userDataSync';
