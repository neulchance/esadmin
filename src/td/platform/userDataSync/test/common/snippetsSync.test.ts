...
import {dirname, joinPath} from 'td/base/common/resources';
...
import {IResourcePreview, ISyncData, IUserDataSyncStoreService, PREVIEW_DIR_NAME, SyncResource, SyncStatus} from 'td/platform/userDataSync/common/userDataSync';
