...
import {DidChangeLoggersEvent, ILogger, ILoggerOptions, ILoggerResource, ILoggerService, LogLevel, isLogLevel} from 'td/platform/log/common/log';
import {LoggerService} from 'td/platform/log/node/loggerService';
