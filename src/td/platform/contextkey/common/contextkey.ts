...
import {isChrome, isEdge, isFirefox, isLinux, isMacintosh, isSafari, isWeb, isWindows} from 'td/base/common/platform';
import {isFalsyOrWhitespace} from 'td/base/common/strings';
import {Scanner, LexingError, Token, TokenType} from 'td/platform/contextkey/common/scanner';
