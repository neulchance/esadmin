...
import {Client as TelemetryClient} from 'td/base/parts/ipc/node/ipc.cp';
...
import {ICustomEndpointTelemetryService, ITelemetryData, ITelemetryEndpoint, ITelemetryService} from 'td/platform/telemetry/common/telemetry';
			...
			const client = new TelemetryClient(
				FileAccess.asFileUri('bootstrap-fork').fsPath,
				{
					...
					env: {
						...
						VSCODE_AMD_ENTRYPOINT: 'td/workbench/contrib/debug/node/telemetryApp'
					}
				}
			);
