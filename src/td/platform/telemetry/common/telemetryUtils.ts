...
import {cloneAndChange, safeStringify} from 'td/base/common/objects';
import {isObject} from 'td/base/common/types';
import {Event} from 'td/base/common/event';
import {URI} from 'td/base/common/uri';
import {ConfigurationTarget, ConfigurationTargetToString, IConfigurationService} from 'td/platform/configuration/common/configuration';
...
import {verifyMicrosoftInternalDomain} from 'td/platform/telemetry/common/commonProperties';
import {ICustomEndpointTelemetryService, ITelemetryData, ITelemetryEndpoint, ITelemetryService, TelemetryConfiguration, TelemetryLevel, TELEMETRY_CRASH_REPORTER_SETTING_ID, TELEMETRY_OLD_SETTING_ID, TELEMETRY_SETTING_ID} from 'td/platform/telemetry/common/telemetry';
