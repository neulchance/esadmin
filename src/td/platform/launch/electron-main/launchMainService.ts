...
import {IProcessEnvironment, isMacintosh} from 'td/base/common/platform';
import {URI} from 'td/base/common/uri';
import {whenDeleted} from 'td/base/node/pfs';
...
import {IURLService} from 'td/platform/url/common/url';
import {IDevWindow} from 'td/platform/window/electron-main/window';
import {IWindowSettings} from 'td/platform/window/common/window';
import {IOpenConfiguration, IWindowsMainService, OpenContext} from 'td/platform/windows/electron-main/windows';
import {IProtocolUrl} from 'td/platform/url/electron-main/url';
