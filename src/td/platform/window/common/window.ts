...
import {PerformanceMark} from 'td/base/common/performance';
import {isLinux, isMacintosh, isNative, isWeb, isWindows} from 'td/base/common/platform';
import {URI, UriComponents, UriDto} from 'td/base/common/uri';
import {ISandboxConfiguration} from 'td/base/parts/sandbox/common/sandboxTypes';
...
import {FileType} from 'td/platform/files/common/files';
...
import {IAnyWorkspaceIdentifier, ISingleFolderWorkspaceIdentifier, IWorkspaceIdentifier} from 'td/platform/workspace/common/workspace';
