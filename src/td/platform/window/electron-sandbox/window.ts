...
import {getZoomLevel, setZoomFactor, setZoomLevel} from 'td/base/browser/browser';
import {getActiveWindow, getWindows} from 'td/base/browser/dom';
import {mainWindow} from 'td/base/browser/window';
import {ISandboxGlobals, ipcRenderer, webFrame} from 'td/base/parts/sandbox/electron-sandbox/globals';
import {zoomLevelToZoomFactor} from 'td/platform/window/common/window';
