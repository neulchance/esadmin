...
import {Disposable, MutableDisposable, isDisposable} from 'td/base/common/lifecycle';
import {IStorage, IStorageDatabase, Storage} from 'td/base/parts/storage/common/storage';
import {createDecorator} from 'td/platform/instantiation/common/instantiation';
import {AbstractStorageService, IStorageService, IStorageValueChangeEvent, StorageScope, StorageTarget, isProfileUsingDefaultStorage} from 'td/platform/storage/common/storage';
import {Emitter, Event} from 'td/base/common/event';
import {IRemoteService} from 'td/platform/ipc/common/services';
import {ILogService} from 'td/platform/log/common/log';
import {ApplicationStorageDatabaseClient, ProfileStorageDatabaseClient} from 'td/platform/storage/common/storageIpc';
