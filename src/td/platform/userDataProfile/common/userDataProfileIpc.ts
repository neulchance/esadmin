...
import {DidChangeProfilesEvent, IUserDataProfile, IUserDataProfileOptions, IUserDataProfilesService, IUserDataProfileUpdateOptions, reviveProfile} from 'td/platform/userDataProfile/common/userDataProfile';
import {IAnyWorkspaceIdentifier} from 'td/platform/workspace/common/workspace';
import {IURITransformer, transformIncomingURIs, transformOutgoingURIs} from 'td/base/common/uriIpc';
