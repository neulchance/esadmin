...
import {IResolvedWorkspace, ISingleFolderWorkspaceIdentifier, isSingleFolderWorkspaceIdentifier, isWorkspaceIdentifier, IWorkspaceIdentifier} from 'td/platform/workspace/common/workspace';

export async function findWindowOnFile(windows: IDevWindow[], fileUri: URI, localWorkspaceResolver: (workspace: IWorkspaceIdentifier) => Promise<IResolvedWorkspace | undefined>): Promise<IDevWindow | undefined> {
...
export function findWindowOnWorkspaceOrFolder(windows: IDevWindow[], folderOrWorkspaceConfigUri: URI): IDevWindow | undefined {
...
export function findWindowOnExtensionDevelopmentPath(windows: IDevWindow[], extensionDevelopmentPaths: string[]): IDevWindow | undefined {
