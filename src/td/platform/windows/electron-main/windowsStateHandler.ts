...
import {INativeWindowConfiguration, IWindowSettings} from 'td/platform/window/common/window';
import {IWindowsMainService} from 'td/platform/windows/electron-main/windows';
import {defaultWindowState, IDevWindow, IWindowState as IWindowUIState, WindowMode} from 'td/platform/window/electron-main/window';
import {isSingleFolderWorkspaceIdentifier, isWorkspaceIdentifier, IWorkspaceIdentifier} from 'td/platform/workspace/common/workspace';
...
export class WindowsStateHandler extends Disposable {
	...
	private onBeforeCloseWindow(window: IDevWindow): void {
	...
	private toWindowState(window: IDevWindow): IWindowState {
		return {
			windowId: window.id,
