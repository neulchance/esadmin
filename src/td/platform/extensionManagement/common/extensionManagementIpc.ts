...
import {DefaultURITransformer, IURITransformer, transformAndReviveIncomingURIs} from 'td/base/common/uriIpc';
...
import {ExtensionType, IExtensionManifest, TargetPlatform} from 'td/platform/extensions/common/extensions';
