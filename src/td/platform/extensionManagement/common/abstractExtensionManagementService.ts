...
import {distinct, isNonEmptyArray} from 'td/base/common/arrays';
import {Barrier, CancelablePromise, createCancelablePromise} from 'td/base/common/async';
import {CancellationToken} from 'td/base/common/cancellation';
import {CancellationError, getErrorMessage} from 'td/base/common/errors';
...
import {adoptToGalleryExtensionId, areSameExtensions, ExtensionKey, getGalleryExtensionId, getGalleryExtensionTelemetryData, getLocalExtensionTelemetryData} from 'td/platform/extensionManagement/common/extensionManagementUtil';
import {ExtensionType, IExtensionManifest, isApplicationScopedExtension, TargetPlatform} from 'td/platform/extensions/common/extensions';
