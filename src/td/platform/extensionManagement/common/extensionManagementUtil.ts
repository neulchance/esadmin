...
import {compareIgnoreCase} from 'td/base/common/strings';
import {IExtensionIdentifier, IGalleryExtension, ILocalExtension, getTargetPlatform} from 'td/platform/extensionManagement/common/extensionManagement';
import {ExtensionIdentifier, IExtension, TargetPlatform, UNDEFINED_PUBLISHER} from 'td/platform/extensions/common/extensions';
import {IFileService} from 'td/platform/files/common/files';
import {isLinux, platform} from 'td/base/common/platform';
