...
import {getNodeType, parse, ParseError} from 'td/base/common/json';
import {getParseErrorMessage} from 'td/base/common/jsonErrorMessages';
...
import {basename, isEqual, joinPath} from 'td/base/common/resources';
import * as semver from 'td/base/common/semver/semver';
import Severity from 'td/base/common/severity';
import {isEmptyObject} from 'td/base/common/types';
import {URI} from 'td/base/common/uri';
import {localize} from 'td/nls';
import {IEnvironmentService} from 'td/platform/environment/common/environment';
import {Metadata} from 'td/platform/extensionManagement/common/extensionManagement';
import {areSameExtensions, computeTargetPlatform, ExtensionKey, getExtensionId, getGalleryExtensionId} from 'td/platform/extensionManagement/common/extensionManagementUtil';
import {ExtensionType, ExtensionIdentifier, IExtensionManifest, TargetPlatform, IExtensionIdentifier, IRelaxedExtensionManifest, UNDEFINED_PUBLISHER, IExtensionDescription, BUILTIN_MANIFEST_CACHE_FILE, USER_MANIFEST_CACHE_FILE, ExtensionIdentifierMap} from 'td/platform/extensions/common/extensions';
import {validateExtensionManifest} from 'td/platform/extensions/common/extensionValidator';
...
import {ExtensionsProfileScanningError, ExtensionsProfileScanningErrorCode, IExtensionsProfileScannerService, IProfileExtensionsScanOptions, IScannedProfileExtension} from 'td/platform/extensionManagement/common/extensionsProfileScannerService';
...
import {localizeManifest} from 'td/platform/extensionManagement/common/extensionNls';
...
export abstract class AbstractExtensionsScannerService extends Disposable implements IExtensionsScannerService {
	...
	async scanSystemExtensions(scanOptions: ScanOptions): Promise<IScannedExtension[]> {
		if (false/* Coloring Flow Check */) console.log(`\x1b[32m scanSystemExtensions \x1b[0m`)
	...
	private async scanDefaultSystemExtensions(useCache: boolean, language: string | undefined): Promise<IRelaxedScannedExtension[]> {
		...
		if (false/* Coloring Flow Check */) console.log(`\x1b[32m scanDefaultSystemExtensions \x1b[0m`)
