...
import {IPager} from 'td/base/common/paging';
import {isWeb, platform} from 'td/base/common/platform';
import {arch} from 'td/base/common/process';
...
import {getTargetPlatform, IExtensionGalleryService, IExtensionIdentifier, IExtensionInfo, IGalleryExtension, IGalleryExtensionAsset, IGalleryExtensionAssets, IGalleryExtensionVersion, InstallOperation, IQueryOptions, IExtensionsControlManifest, isNotWebExtensionInWebTargetPlatform, isTargetPlatformCompatible, ITranslation, SortBy, SortOrder, StatisticType, toTargetPlatform, WEB_EXTENSION_TAG, IExtensionQueryOptions, IDeprecationInfo, ISearchPrefferedResults} from 'td/platform/extensionManagement/common/extensionManagement';
import {adoptToGalleryExtensionId, areSameExtensions, getGalleryExtensionId, getGalleryExtensionTelemetryData} from 'td/platform/extensionManagement/common/extensionManagementUtil';
import {IExtensionManifest, TargetPlatform} from 'td/platform/extensions/common/extensions';
...
import {asJson, asTextOrError, IRequestService, isSuccess} from 'td/platform/request/common/request';
