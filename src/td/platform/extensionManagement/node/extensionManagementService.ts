...
import {Promises, Queue} from 'td/base/common/async';
...
import {isBoolean, isUndefined} from 'td/base/common/types';
import {URI} from 'td/base/common/uri';
import {generateUuid} from 'td/base/common/uuid';
import * as pfs from 'td/base/node/pfs';
import {extract, ExtractError, IFile, zip} from 'td/base/node/zip';
...
import {areSameExtensions, computeTargetPlatform, ExtensionKey, getGalleryExtensionId, groupByExtension} from 'td/platform/extensionManagement/common/extensionManagementUtil';
import {IExtensionsProfileScannerService, IScannedProfileExtension} from 'td/platform/extensionManagement/common/extensionsProfileScannerService';
import {IExtensionsScannerService, IScannedExtension, ScanOptions} from 'td/platform/extensionManagement/common/extensionsScannerService';
import {ExtensionsDownloader} from 'td/platform/extensionManagement/node/extensionDownloader';
import {ExtensionsLifecycle} from 'td/platform/extensionManagement/node/extensionLifecycle';
import {getManifest} from 'td/platform/extensionManagement/node/extensionManagementUtil';
import {ExtensionsManifestCache} from 'td/platform/extensionManagement/node/extensionsManifestCache';
import {DidChangeProfileExtensionsEvent, ExtensionsWatcher} from 'td/platform/extensionManagement/node/extensionsWatcher';
import {ExtensionType, IExtension, IExtensionManifest, TargetPlatform} from 'td/platform/extensions/common/extensions';
import {isEngineValid} from 'td/platform/extensions/common/extensionValidator';
import {FileChangesEvent, FileChangeType, FileOperationResult, IFileService, toFileOperationResult} from 'td/platform/files/common/files';
import {IInstantiationService, refineServiceDecorator} from 'td/platform/instantiation/common/instantiation';
