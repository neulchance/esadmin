...
import {Client, IChannel, IClientRouter, IConnectionHub, IServerChannel} from 'td/base/parts/ipc/common/ipc';
import {ILogService} from 'td/platform/log/common/log';
import {IOpenURLOptions, IURLHandler} from 'td/platform/url/common/url';
