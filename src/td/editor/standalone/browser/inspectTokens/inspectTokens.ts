...
import 'td/css!./inspectTokens';
import { $, append, reset } from 'td/base/browser/dom';
...
import { ContentWidgetPositionPreference, IActiveCodeEditor, ICodeEditor, IContentWidget, IContentWidgetPosition } from 'td/editor/browser/editorBrowser';
import { EditorAction, ServicesAccessor, registerEditorAction, registerEditorContribution, EditorContributionInstantiation } from 'td/editor/browser/editorExtensions';
...
import { IState, ITokenizationSupport, TokenizationRegistry, ILanguageIdCodec, Token } from 'td/editor/common/languages';
import { FontStyle, StandardTokenType, TokenMetadata } from 'td/editor/common/encodedTokenAttributes';
import { NullState, nullTokenize, nullTokenizeEncoded } from 'td/editor/common/languages/nullTokenize';
...
import { InspectTokensNLS } from 'td/editor/common/standaloneStrings';
