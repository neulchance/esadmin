...
import { addMatchMediaChangeListener } from 'td/base/browser/browser';
...
import { FontStyle, TokenMetadata } from 'td/editor/common/encodedTokenAttributes';
import { ITokenThemeRule, TokenTheme, generateTokensCSSForColorMap } from 'td/editor/common/languages/supports/tokenization';
import { BuiltinTheme, IStandaloneTheme, IStandaloneThemeData, IStandaloneThemeService } from 'td/editor/standalone/common/standaloneTheme';
import { hc_black, hc_light, vs, vs_dark } from 'td/editor/standalone/common/themes';
...
import { asCssVariableName, ColorIdentifier, Extensions, IColorRegistry } from 'td/platform/theme/common/colorRegistry';
import { Extensions as ThemingExtensions, ICssStyleCollector, IFileIconTheme, IProductIconTheme, IThemingRegistry, ITokenStyle } from 'td/platform/theme/common/themeService';
import { IDisposable, Disposable } from 'td/base/common/lifecycle';
import { ColorScheme, isDark, isHighContrast } from 'td/platform/theme/common/theme';
import { getIconsStyleSheet, UnthemedProductIconTheme } from 'td/platform/theme/browser/iconsStyleSheet';
