...
import { LanguageId, MetadataConsts } from 'td/editor/common/encodedTokenAttributes';
import { IState, Token } from 'td/editor/common/languages';
import { TokenTheme } from 'td/editor/common/languages/supports/tokenization';
import { LanguageService } from 'td/editor/common/services/languageService';
import { ILineTokens, IToken, TokenizationSupportAdapter, TokensProvider } from 'td/editor/standalone/browser/standaloneLanguages';
import { IStandaloneTheme, IStandaloneThemeData, IStandaloneThemeService } from 'td/editor/standalone/common/standaloneTheme';
import { UnthemedProductIconTheme } from 'td/platform/theme/browser/iconsStyleSheet';
import { ColorIdentifier } from 'td/platform/theme/common/colorRegistry';
import { ColorScheme } from 'td/platform/theme/common/theme';
import { IColorTheme, IFileIconTheme, IProductIconTheme, ITokenStyle } from 'td/platform/theme/common/themeService';
