...
import { Token, TokenizationRegistry } from 'td/editor/common/languages';
...
import { StandaloneConfigurationService } from 'td/editor/standalone/browser/standaloneServices';
