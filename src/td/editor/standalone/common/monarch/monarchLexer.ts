...
import { NullState, nullTokenizeEncoded, nullTokenize } from 'td/editor/common/languages/nullTokenize';
...
import * as monarchCommon from 'td/editor/standalone/common/monarch/monarchCommon';
