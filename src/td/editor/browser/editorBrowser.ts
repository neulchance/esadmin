...
import { ConfigurationChangedEvent, EditorLayoutInfo, EditorOption, FindComputedEditorOptionValueById, IComputedEditorOptions, IDiffEditorOptions, IEditorOptions, OverviewRulerPosition } from 'td/editor/common/config/editorOptions';
...
import { ICursorPositionChangedEvent, ICursorSelectionChangedEvent } from 'td/editor/common/cursorEvents';
...
import { GlyphMarginLane, ICursorStateComputer, IIdentifiedSingleEditOperation, IModelDecoration, IModelDeltaDecoration, ITextModel, PositionAffinity } from 'td/editor/common/model';
