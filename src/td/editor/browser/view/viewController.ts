...
import { CoreNavigationCommands, NavigationCommandRevealType } from 'td/editor/browser/coreCommands';
import { IEditorMouseEvent, IPartialEditorMouseEvent } from 'td/editor/browser/editorBrowser';
