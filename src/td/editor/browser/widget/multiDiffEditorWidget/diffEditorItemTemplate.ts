...
import { autorun, derived, observableFromEvent } from 'td/base/common/observable';
import { IObservable, globalTransaction, observableValue } from 'td/base/common/observableInternal/base';
...
import { DocumentDiffItemViewModel } from 'td/editor/browser/widget/multiDiffEditorWidget/multiDiffEditorViewModel';
