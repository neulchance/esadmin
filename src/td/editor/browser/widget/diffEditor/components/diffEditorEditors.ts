...
import { IObservable, IReader, autorunHandleChanges, observableFromEvent } from 'td/base/common/observable';
import { IEditorConstructionOptions } from 'td/editor/browser/config/editorConfiguration';
import { IDiffEditorConstructionOptions } from 'td/editor/browser/editorBrowser';
...
import { EditorOptions, IEditorOptions } from 'td/editor/common/config/editorOptions';
import { IContentSizeChangedEvent } from 'td/editor/common/editorCommon';
...
import { IDiffCodeEditorWidgetOptions } from 'td/editor/browser/widget/diffEditor/diffEditorWidget';
