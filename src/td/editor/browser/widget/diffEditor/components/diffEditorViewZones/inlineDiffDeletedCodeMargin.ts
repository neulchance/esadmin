...
import { addStandardDisposableListener, getDomNodePagePosition } from 'td/base/browser/dom';
...
import { IEditorMouseEvent, MouseTargetType } from 'td/editor/browser/editorBrowser';
