...
import { EditorFontLigatures, EditorOption, FindComputedEditorOptionValueById } from 'td/editor/common/config/editorOptions';
...
import { InlineDecoration, ViewLineRenderingData } from 'td/editor/common/viewModel';
