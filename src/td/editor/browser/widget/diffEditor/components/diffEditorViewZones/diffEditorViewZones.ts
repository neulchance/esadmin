...
import { IObservable, autorun, derived, derivedWithStore, observableFromEvent, observableValue } from 'td/base/common/observable';
...
import { diffDeleteDecoration, diffRemoveIcon } from 'td/editor/browser/widget/diffEditor/registrations.contribution';
import { DiffEditorEditors } from 'td/editor/browser/widget/diffEditor/components/diffEditorEditors';
import { DiffEditorViewModel, DiffMapping } from 'td/editor/browser/widget/diffEditor/diffEditorViewModel';
import { DiffEditorWidget } from 'td/editor/browser/widget/diffEditor/diffEditorWidget';
import { InlineDiffDeletedCodeMargin } from 'td/editor/browser/widget/diffEditor/components/diffEditorViewZones/inlineDiffDeletedCodeMargin';
...
import { IObservableViewZone, animatedObservable, joinCombine } from 'td/editor/browser/widget/diffEditor/utils';
...
import { DetailedLineRangeMapping } from 'td/editor/common/diff/rangeMapping';
import { ScrollType } from 'td/editor/common/editorCommon';
import { BackgroundTokenizationState } from 'td/editor/common/tokenizationTextModelPart';
