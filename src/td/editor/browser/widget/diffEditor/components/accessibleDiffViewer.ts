...
import { addDisposableListener, addStandardDisposableListener, reset } from 'td/base/browser/dom';
...
import { forEachAdjacent, groupAdjacentBy } from 'td/base/common/arrays';
...
import { IObservable, ITransaction, autorun, autorunWithStore, derived, derivedWithStore, observableValue, subtransaction, transaction } from 'td/base/common/observable';
...
import { applyStyle } from 'td/editor/browser/widget/diffEditor/utils';
...
import { DetailedLineRangeMapping, LineRangeMapping } from 'td/editor/common/diff/rangeMapping';
import { ILanguageIdCodec } from 'td/editor/common/languages';
import { ILanguageService } from 'td/editor/common/languages/language';
import { ITextModel, TextModelResolvedOptions } from 'td/editor/common/model';
import { LineTokens } from 'td/editor/common/tokens/lineTokens';
import { RenderLineInput, renderViewLine2 } from 'td/editor/common/viewLayout/viewLineRenderer';
...
import 'td/css!./accessibleDiffViewer';
