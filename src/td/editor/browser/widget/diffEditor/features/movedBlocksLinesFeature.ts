...
import { booleanComparator, compareBy, numberComparator, tieBreakComparators } from 'td/base/common/arrays';
import { findMaxIdxBy } from 'td/base/common/arraysFind';
import { Codicon } from 'td/base/common/codicons';
import { Disposable, toDisposable } from 'td/base/common/lifecycle';
import { IObservable, autorun, autorunHandleChanges, autorunWithStore, constObservable, derived, derivedWithStore, observableFromEvent, observableSignalFromEvent, observableValue, recomputeInitiallyAndOnChange } from 'td/base/common/observable';
...
import { PlaceholderViewZone, ViewZoneOverlayWidget, applyStyle, applyViewZones } from 'td/editor/browser/widget/diffEditor/utils';
import { EditorLayoutInfo } from 'td/editor/common/config/editorOptions';
import { LineRange } from 'td/editor/common/core/lineRange';
import { OffsetRange, OffsetRangeSet } from 'td/editor/common/core/offsetRange';
