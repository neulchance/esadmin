...
import { $, addDisposableListener, getWindow, h, reset } from 'td/base/browser/dom';
...
import { IObservable, IReader, autorun, derived, derivedWithStore, observableFromEvent, observableValue, transaction } from 'td/base/common/observable';
...
import { DiffEditorOptions } from 'td/editor/browser/widget/diffEditor/diffEditorOptions';
import { DiffEditorViewModel, RevealPreference, UnchangedRegion } from 'td/editor/browser/widget/diffEditor/diffEditorViewModel';
import { IObservableViewZone, PlaceholderViewZone, ViewZoneOverlayWidget, applyObservableDecorations, applyStyle } from 'td/editor/browser/widget/diffEditor/utils';
...
import { SymbolKind, SymbolKinds } from 'td/editor/common/languages';
import { IModelDecorationOptions, IModelDeltaDecoration, ITextModel } from 'td/editor/common/model';
