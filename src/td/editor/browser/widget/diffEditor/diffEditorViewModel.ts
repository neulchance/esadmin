...
import { IObservable, IReader, ISettableObservable, ITransaction, autorun, autorunWithStore, derived, observableSignal, observableSignalFromEvent, observableValue, transaction, waitForState } from 'td/base/common/observable';
import { IDiffProviderFactoryService } from 'td/editor/browser/widget/diffEditor/diffProviderFactoryService';
import { filterWithPrevious, readHotReloadableExport } from 'td/editor/browser/widget/diffEditor/utils';
import { ISerializedLineRange, LineRange, LineRangeSet } from 'td/editor/common/core/lineRange';
import { DefaultLinesDiffComputer } from 'td/editor/common/diff/defaultLinesDiffComputer/defaultLinesDiffComputer';
import { IDocumentDiff } from 'td/editor/common/diff/documentDiffProvider';
import { MovedText } from 'td/editor/common/diff/linesDiffComputer';
import { DetailedLineRangeMapping, LineRangeMapping, RangeMapping } from 'td/editor/common/diff/rangeMapping';
import { IDiffEditorModel, IDiffEditorViewModel } from 'td/editor/common/editorCommon';
import { ITextModel } from 'td/editor/common/model';
import { TextEditInfo } from 'td/editor/common/model/bracketPairsTextModelPart/bracketPairsTree/beforeEditPositionMapper';
import { combineTextEditInfos } from 'td/editor/common/model/bracketPairsTextModelPart/bracketPairsTree/combineTextEditInfos';
import { DiffEditorOptions } from './diffEditorOptions';
import { optimizeSequenceDiffs } from 'td/editor/common/diff/defaultLinesDiffComputer/heuristicSequenceOptimizations';
import { isDefined } from 'td/base/common/types';
import { groupAdjacentBy } from 'td/base/common/arrays';
