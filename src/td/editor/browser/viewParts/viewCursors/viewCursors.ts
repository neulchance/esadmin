...
import 'td/css!./viewCursors';
import { FastDomNode, createFastDomNode } from 'td/base/browser/fastDomNode';
import { IntervalTimer, TimeoutTimer } from 'td/base/common/async';
import { ViewPart } from 'td/editor/browser/view/viewPart';
import { IViewCursorRenderData, ViewCursor } from 'td/editor/browser/viewParts/viewCursors/viewCursor';
import { TextEditorCursorBlinkingStyle, TextEditorCursorStyle, EditorOption } from 'td/editor/common/config/editorOptions';
import { Position } from 'td/editor/common/core/position';
import { editorCursorBackground, editorCursorForeground } from 'td/editor/common/core/editorColorRegistry';
...
import { WindowIntervalTimer, getWindow } from 'td/base/browser/dom';
