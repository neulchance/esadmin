...
import { IViewZone, IViewZoneChangeAccessor } from 'td/editor/browser/editorBrowser';
...
import { IEditorWhitespace, IViewWhitespaceViewportData, IWhitespaceChangeAccessor } from 'td/editor/common/viewModel';
