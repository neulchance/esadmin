...
import 'td/css!./overlayWidgets';
import { FastDomNode, createFastDomNode } from 'td/base/browser/fastDomNode';
import { IOverlayWidget, IOverlayWidgetPositionCoordinates, OverlayWidgetPositionPreference } from 'td/editor/browser/editorBrowser';
