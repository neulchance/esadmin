...
import { migrateOptions } from 'td/editor/browser/config/migrateOptions';
import { TabFocus } from 'td/editor/browser/config/tabFocus';
import { ComputeOptionsMemory, ConfigurationChangedEvent, EditorOption, editorOptionsRegistry, FindComputedEditorOptionValueById, IComputedEditorOptions, IEditorOptions, IEnvironmentalOptions } from 'td/editor/common/config/editorOptions';
import { EditorZoom } from 'td/editor/common/config/editorZoom';
import { BareFontInfo, FontInfo, IValidatedEditorOptions } from 'td/editor/common/config/fontInfo';
...
import { AccessibilitySupport, IAccessibilityService } from 'td/platform/accessibility/common/accessibility';
