...
import {SemanticTokensLegend, SemanticTokens} from 'td/editor/common/languages';
import {FontStyle, MetadataConsts, TokenMetadata} from 'td/editor/common/encodedTokenAttributes';
