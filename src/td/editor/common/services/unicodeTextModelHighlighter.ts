...
import {Searcher} from 'td/editor/common/model/textModelSearch';
import * as strings from 'td/base/common/strings';
import {IUnicodeHighlightsResult} from 'td/editor/common/services/editorWorker';
import {assertNever} from 'td/base/common/assert';
import {DEFAULT_WORD_REGEXP, getWordAtText} from 'td/editor/common/core/wordHelper';
