...
import {IMarkerService, IMarker, MarkerSeverity, MarkerTag} from 'td/platform/markers/common/markers';
import {Disposable, toDisposable} from 'td/base/common/lifecycle';
import {URI} from 'td/base/common/uri';
import {IModelDeltaDecoration, ITextModel, IModelDecorationOptions, TrackedRangeStickiness, OverviewRulerLane, IModelDecoration, MinimapPosition, IModelDecorationMinimapOptions} from 'td/editor/common/model';
...
import {overviewRulerWarning, overviewRulerInfo, overviewRulerError} from 'td/editor/common/core/editorColorRegistry';
...
import {minimapInfo, minimapWarning, minimapError} from 'td/platform/theme/common/colorRegistry';
import {BidirectionalMap, ResourceMap} from 'td/base/common/map';
import {diffSets} from 'td/base/common/collections';
