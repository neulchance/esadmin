...
import {ParsedPattern, parse} from 'td/base/common/glob';
import {Mimes} from 'td/base/common/mime';
import {Schemas} from 'td/base/common/network';
import {basename, posix} from 'td/base/common/path';
import {DataUri} from 'td/base/common/resources';
import {startsWithUTF8BOM} from 'td/base/common/strings';
