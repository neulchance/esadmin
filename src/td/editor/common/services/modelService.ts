...
import {Disposable, IDisposable, DisposableStore} from 'td/base/common/lifecycle';
...
import {DefaultEndOfLine, EndOfLinePreference, EndOfLineSequence, ITextBuffer, ITextBufferFactory, ITextModel, ITextModelCreationOptions} from 'td/editor/common/model';
import {TextModel, createTextBuffer} from 'td/editor/common/model/textModel';
import {EDITOR_MODEL_DEFAULTS} from 'td/editor/common/core/textModelDefaults';
import {IModelLanguageChangedEvent} from 'td/editor/common/textModelEvents';
...
import {IUndoRedoService, ResourceEditStackSnapshot} from 'td/platform/undoRedo/common/undoRedo';
import {StringSHA1} from 'td/base/common/hash';
import {isEditStackElement} from 'td/editor/common/model/editStack';
