...
import {stringDiff} from 'td/base/common/diff/diff';
import {IDisposable} from 'td/base/common/lifecycle';
import {URI} from 'td/base/common/uri';
import {IRequestHandler} from 'td/base/common/worker/simpleWorker';
import {IPosition, Position} from 'td/editor/common/core/position';
import {IRange, Range} from 'td/editor/common/core/range';
import {EndOfLineSequence, ITextModel} from 'td/editor/common/model';
import {IMirrorTextModel, IModelChangedEvent, MirrorTextModel as BaseMirrorModel} from 'td/editor/common/model/mirrorTextModel';
import {ensureValidWordDefinition, getWordAtText, IWordAtPosition} from 'td/editor/common/core/wordHelper';
import {IColorInformation, IInplaceReplaceSupportResult, ILink, TextEdit} from 'td/editor/common/languages';
import {ILinkComputerTarget, computeLinks} from 'td/editor/common/languages/linkComputer';
import {BasicInplaceReplace} from 'td/editor/common/languages/supports/inplaceReplaceSupport';
import {DiffAlgorithmName, IDiffComputationResult, ILineChange, IUnicodeHighlightsResult} from 'td/editor/common/services/editorWorker';
import {createMonacoBaseAPI} from 'td/editor/common/services/editorBaseApi';
import {IEditorWorkerHost} from 'td/editor/common/services/editorWorkerHost';
import {StopWatch} from 'td/base/common/stopwatch';
import {UnicodeTextModelHighlighter, UnicodeHighlighterOptions} from 'td/editor/common/services/unicodeTextModelHighlighter';
import {DiffComputer, IChange} from 'td/editor/common/diff/legacyLinesDiffComputer';
import {ILinesDiffComputer, ILinesDiffComputerOptions} from 'td/editor/common/diff/linesDiffComputer';
...
import {createProxyObject, getAllMethodNames} from 'td/base/common/objects';
...
import {IDocumentColorComputerTarget, computeDefaultDocumentColors} from 'td/editor/common/languages/defaultDocumentColorsComputer';
