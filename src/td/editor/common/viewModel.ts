...
import {IScrollPosition, Scrollable} from 'td/base/common/scrollable';
...
import {CursorConfiguration, CursorState, EditOperationType, IColumnSelectData, ICursorSimpleModel, PartialCursorState} from 'td/editor/common/cursorCommon';
import {CursorChangeReason} from 'td/editor/common/cursorEvents';
import {INewScrollPosition, ScrollType} from 'td/editor/common/editorCommon';
import {EditorTheme} from 'td/editor/common/editorTheme';
import {EndOfLinePreference, IGlyphMarginLanesModel, IModelDecorationOptions, ITextModel, PositionAffinity} from 'td/editor/common/model';
import {ILineBreaksComputer, InjectedText} from 'td/editor/common/modelLineProjectionData';
import {BracketGuideOptions, IActiveIndentGuideInfo, IndentGuide} from 'td/editor/common/textModelGuides';
