...
import {DiffAlgorithmResult, IDiffAlgorithm, ISequence, ITimeout, InfiniteTimeout, SequenceDiff} from 'td/editor/common/diff/defaultLinesDiffComputer/algorithms/diffAlgorithm';
