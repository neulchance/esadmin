...
import {equals, groupAdjacentBy} from 'td/base/common/arrays';
import {assertFn, checkAdjacentItems} from 'td/base/common/assert';
import {LineRange} from 'td/editor/common/core/lineRange';
import {OffsetRange} from 'td/editor/common/core/offsetRange';
import {Position} from 'td/editor/common/core/position';
import {Range} from 'td/editor/common/core/range';
import {DateTimeout, ITimeout, InfiniteTimeout, SequenceDiff} from 'td/editor/common/diff/defaultLinesDiffComputer/algorithms/diffAlgorithm';
import {DynamicProgrammingDiffing} from 'td/editor/common/diff/defaultLinesDiffComputer/algorithms/dynamicProgrammingDiffing';
import {MyersDiffAlgorithm} from 'td/editor/common/diff/defaultLinesDiffComputer/algorithms/myersDiffAlgorithm';
import {computeMovedLines} from 'td/editor/common/diff/defaultLinesDiffComputer/computeMovedLines';
import {extendDiffsToEntireWordIfAppropriate, optimizeSequenceDiffs, removeVeryShortMatchingLinesBetweenDiffs, removeVeryShortMatchingTextBetweenLongDiffs, removeShortMatches} from 'td/editor/common/diff/defaultLinesDiffComputer/heuristicSequenceOptimizations';
import {ILinesDiffComputer, ILinesDiffComputerOptions, LinesDiff, MovedText} from 'td/editor/common/diff/linesDiffComputer';
import {DetailedLineRangeMapping, RangeMapping} from '../rangeMapping';
import {LinesSliceCharSequence} from 'td/editor/common/diff/defaultLinesDiffComputer/linesSliceCharSequence';
import {LineSequence} from 'td/editor/common/diff/defaultLinesDiffComputer/lineSequence';
