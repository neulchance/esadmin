...
import {IDiffChange, ISequence, LcsDiff, IDiffResult} from 'td/base/common/diff/diff';
import {ILinesDiffComputer, ILinesDiffComputerOptions, LinesDiff} from 'td/editor/common/diff/linesDiffComputer';
