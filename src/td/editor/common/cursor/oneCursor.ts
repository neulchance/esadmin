...
import {CursorState, ICursorSimpleModel, SelectionStartKind, SingleCursorState} from 'td/editor/common/cursorCommon';
...
import {PositionAffinity, TrackedRangeStickiness} from 'td/editor/common/model';
