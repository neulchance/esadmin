...
import {ReplaceCommand, ReplaceCommandWithOffsetCursorState, ReplaceCommandWithoutChangingPosition, ReplaceCommandThatPreservesSelection} from 'td/editor/common/commands/replaceCommand';
import {ShiftCommand} from 'td/editor/common/commands/shiftCommand';
import {CompositionSurroundSelectionCommand, SurroundSelectionCommand} from 'td/editor/common/commands/surroundSelectionCommand';
import {CursorConfiguration, EditOperationResult, EditOperationType, ICursorSimpleModel, isQuote} from 'td/editor/common/cursorCommon';
...
import {ICommand, ICursorStateComputerData} from 'td/editor/common/editorCommon';
import {ITextModel} from 'td/editor/common/model';
import {EnterAction, IndentAction, StandardAutoClosingPairConditional} from 'td/editor/common/languages/languageConfiguration';
import {getIndentationAtPosition} from 'td/editor/common/languages/languageConfigurationRegistry';
import {IElectricAction} from 'td/editor/common/languages/supports/electricCharacter';
import {EditorAutoClosingStrategy, EditorAutoIndentStrategy} from 'td/editor/common/config/editorOptions';
import {createScopedLineTokens} from 'td/editor/common/languages/supports';
import {getIndentActionForType, getIndentForEnter, getInheritIndentForLine} from 'td/editor/common/languages/autoIndent';
import {getEnterAction} from 'td/editor/common/languages/enterAction';
