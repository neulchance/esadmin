...
import {Disposable, DisposableMap, MutableDisposable} from 'td/base/common/lifecycle';
...
import {IWordAtPosition, getWordAtText} from 'td/editor/common/core/wordHelper';
import {StandardTokenType} from 'td/editor/common/encodedTokenAttributes';
import {IBackgroundTokenizationStore, IBackgroundTokenizer, ILanguageIdCodec, IState, ITokenizationSupport, TokenizationRegistry} from 'td/editor/common/languages';
import {ILanguageService} from 'td/editor/common/languages/language';
import {ILanguageConfigurationService, ResolvedLanguageConfiguration} from 'td/editor/common/languages/languageConfigurationRegistry';
import {IAttachedView} from 'td/editor/common/model';
import {BracketPairsTextModelPart} from 'td/editor/common/model/bracketPairsTextModelPart/bracketPairsImpl';
import {AttachedViews, IAttachedViewState, TextModel} from 'td/editor/common/model/textModel';
import {TextModelPart} from 'td/editor/common/model/textModelPart';
import {DefaultBackgroundTokenizer, TokenizerWithStateStoreAndTextModel, TrackingTokenizationStateStore} from 'td/editor/common/model/textModelTokens';
import {IModelContentChangedEvent, IModelLanguageChangedEvent, IModelLanguageConfigurationChangedEvent, IModelTokensChangedEvent} from 'td/editor/common/textModelEvents';
import {BackgroundTokenizationState, ITokenizationTextModelPart} from 'td/editor/common/tokenizationTextModelPart';
import {ContiguousMultilineTokens} from 'td/editor/common/tokens/contiguousMultilineTokens';
import {ContiguousMultilineTokensBuilder} from 'td/editor/common/tokens/contiguousMultilineTokensBuilder';
import {ContiguousTokensStore} from 'td/editor/common/tokens/contiguousTokensStore';
import {LineTokens} from 'td/editor/common/tokens/lineTokens';
import {SparseMultilineTokens} from 'td/editor/common/tokens/sparseMultilineTokens';
import {SparseTokensStore} from 'td/editor/common/tokens/sparseTokensStore';
