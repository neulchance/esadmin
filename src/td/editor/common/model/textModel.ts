...
import {ArrayQueue, pushMany} from 'td/base/common/arrays';
import {VSBuffer, VSBufferReadableStream} from 'td/base/common/buffer';
import {Color} from 'td/base/common/color';
import {BugIndicatingError, illegalArgument, onUnexpectedError} from 'td/base/common/errors';
import {Emitter, Event} from 'td/base/common/event';
import {IMarkdownString} from 'td/base/common/htmlContent';
import {Disposable, IDisposable, MutableDisposable, combinedDisposable} from 'td/base/common/lifecycle';
import {listenStream} from 'td/base/common/stream';
import * as strings from 'td/base/common/strings';
import {ThemeColor} from 'td/base/common/themables';
import {Constants} from 'td/base/common/uint';
...
import {normalizeIndentation} from 'td/editor/common/core/indentation';
...
import {EDITOR_MODEL_DEFAULTS} from 'td/editor/common/core/textModelDefaults';
import {IWordAtPosition} from 'td/editor/common/core/wordHelper';
import {FormattingOptions} from 'td/editor/common/languages';
...
import * as model from 'td/editor/common/model';
import {BracketPairsTextModelPart} from 'td/editor/common/model/bracketPairsTextModelPart/bracketPairsImpl';
import {ColorizedBracketPairsDecorationProvider} from 'td/editor/common/model/bracketPairsTextModelPart/colorizedBracketPairsDecorationProvider';
import {EditStack} from 'td/editor/common/model/editStack';
import {GuidesTextModelPart} from 'td/editor/common/model/guidesTextModelPart';
import {guessIndentation} from 'td/editor/common/model/indentationGuesser';
import {IntervalNode, IntervalTree, recomputeMaxEnd} from 'td/editor/common/model/intervalTree';
import {PieceTreeTextBuffer} from 'td/editor/common/model/pieceTreeTextBuffer/pieceTreeTextBuffer';
import {PieceTreeTextBufferBuilder} from 'td/editor/common/model/pieceTreeTextBuffer/pieceTreeTextBufferBuilder';
import {SearchParams, TextModelSearch} from 'td/editor/common/model/textModelSearch';
import {TokenizationTextModelPart} from 'td/editor/common/model/tokenizationTextModelPart';
import {IBracketPairsTextModelPart} from 'td/editor/common/textModelBracketPairs';
import {IModelContentChangedEvent, IModelDecorationsChangedEvent, IModelOptionsChangedEvent, InternalModelContentChangeEvent, LineInjectedText, ModelInjectedTextChangedEvent, ModelRawChange, ModelRawContentChangedEvent, ModelRawEOLChanged, ModelRawFlush, ModelRawLineChanged, ModelRawLinesDeleted, ModelRawLinesInserted} from 'td/editor/common/textModelEvents';
import {IGuidesTextModelPart} from 'td/editor/common/textModelGuides';
import {ITokenizationTextModelPart} from 'td/editor/common/tokenizationTextModelPart';
import {IColorTheme} from 'td/platform/theme/common/themeService';
import {IUndoRedoService, ResourceEditStackSnapshot, UndoRedoGroup} from 'td/platform/undoRedo/common/undoRedo';
