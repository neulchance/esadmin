...
import {ApplyEditsResult, EndOfLinePreference, FindMatch, IInternalModelContentChange, ISingleEditOperationIdentifier, ITextBuffer, ITextSnapshot, ValidAnnotatedEditOperation, IValidEditOperation, SearchData} from 'td/editor/common/model';
import {PieceTreeBase, StringBuffer} from 'td/editor/common/model/pieceTreeTextBuffer/pieceTreeBase';
import {countEOL, StringEOL} from 'td/editor/common/core/eolCounter';
