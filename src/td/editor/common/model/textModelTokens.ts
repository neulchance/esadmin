...
import {IdleDeadline, runWhenGlobalIdle} from 'td/base/common/async';
...
import {EncodedTokenizationResult, IBackgroundTokenizationStore, IBackgroundTokenizer, ILanguageIdCodec, IState, ITokenizationSupport} from 'td/editor/common/languages';
import {nullTokenizeEncoded} from 'td/editor/common/languages/nullTokenize';
import {ITextModel} from 'td/editor/common/model';
import {FixedArray} from 'td/editor/common/model/fixedArray';
import {IModelContentChange} from 'td/editor/common/textModelEvents';
