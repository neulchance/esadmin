...
import {ScopedLineTokens, ignoreBracketsInToken} from 'td/editor/common/languages/supports';
import {BracketsUtils, RichEditBrackets} from 'td/editor/common/languages/supports/richEditBrackets';
