...
import {Token, TokenizationResult, EncodedTokenizationResult, IState} from 'td/editor/common/languages';
import {LanguageId, FontStyle, ColorId, StandardTokenType, MetadataConsts} from 'td/editor/common/encodedTokenAttributes';
