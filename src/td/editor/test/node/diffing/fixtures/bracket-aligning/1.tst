...
import { CompareResult } from 'td/base/common/arrays';
import { autorun, derived } from 'td/base/common/observable';
import { IModelDeltaDecoration, MinimapPosition, OverviewRulerLane } from 'td/editor/common/model';
import { localize } from 'td/nls';
import { IInstantiationService } from 'td/platform/instantiation/common/instantiation';
import { LineRange } from 'td/workbench/contrib/mergeEditor/browser/model/lineRange';
import { applyObservableDecorations, join } from 'td/workbench/contrib/mergeEditor/browser/utils';
import { handledConflictMinimapOverViewRulerColor, unhandledConflictMinimapOverViewRulerColor } from 'td/workbench/contrib/mergeEditor/browser/view/colors';
