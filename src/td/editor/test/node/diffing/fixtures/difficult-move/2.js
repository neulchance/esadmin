...
const serverEntryPoints = [
	{
		name: 'td/server/node/server.main',
		exclude: ['td/css', 'td/nls']
	},
	{
		name: 'td/server/node/server.cli',
		exclude: ['td/css', 'td/nls']
	},
	{
		name: 'td/workbench/api/node/extensionHostProcess',
		exclude: ['td/css', 'td/nls']
	},
	{
		name: 'td/platform/files/node/watcher/watcherMain',
		exclude: ['td/css', 'td/nls']
	},
	{
		name: 'td/platform/terminal/node/ptyHostMain',
		exclude: ['td/css', 'td/nls']
	}
];
