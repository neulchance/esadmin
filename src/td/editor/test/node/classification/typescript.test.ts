...
// import { getPathFromAmdModule } from 'td/base/test/node/testUtils';
// import { parse } from 'td/editor/common/modes/tokenization/typescript';
import { toStandardTokenType } from 'td/editor/common/languages/supports/tokenization';
...
suite('Classification', () => {
	test('TypeScript', () => {
		// executeTest(getPathFromAmdModule(require, 'td/editor/test/node/classification/typescript-test.ts').replace(/\bout\b/, 'src'), parse);
	});
});
