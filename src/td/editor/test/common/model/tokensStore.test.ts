...
import { ColorId, FontStyle, MetadataConsts, TokenMetadata } from 'td/editor/common/encodedTokenAttributes';
import { ILanguageConfigurationService, LanguageConfigurationService } from 'td/editor/common/languages/languageConfigurationRegistry';
import { TextModel } from 'td/editor/common/model/textModel';
import { LanguageIdCodec } from 'td/editor/common/services/languagesRegistry';
...
suite('TokensStore', () => {
	...
	test('deleting a newline', () => {
		testTokensAdjustment(
			...
			[
				`import { |URI| } from 'td/base/common/uri';const foo = |URI|.parse('hey');`
			]
		);
	});
	...
	test('deleting a newline 2', () => {
		testTokensAdjustment(
			[
				`import { `,
				`    |URI| } from 'td/base/common/uri';const foo = |URI|.parse('hey');`
			],
			[
