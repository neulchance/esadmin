...
import { getMapForWordSeparators } from 'td/editor/common/core/wordCharacterClassifier';
import { USUAL_WORD_SEPARATORS } from 'td/editor/common/core/wordHelper';
import { EndOfLineSequence, FindMatch, SearchData } from 'td/editor/common/model';
import { TextModel } from 'td/editor/common/model/textModel';
import { SearchParams, TextModelSearch, isMultilineRegexSource } from 'td/editor/common/model/textModelSearch';
