...
import { createModelServices } from 'td/editor/test/common/testTextModel';
import { TestInstantiationService } from 'td/platform/instantiation/test/common/instantiationServiceMock';
import { IColorTheme, IThemeService, ITokenStyle } from 'td/platform/theme/common/themeService';
