...
import { AbstractCodeEditorService, GlobalStyleSheet } from 'td/editor/browser/services/abstractCodeEditorService';
import { CommandsRegistry, ICommandEvent, ICommandService } from 'td/platform/commands/common/commands';
