...
import { IEnvConfiguration } from 'td/editor/browser/config/editorConfiguration';
import { migrateOptions } from 'td/editor/browser/config/migrateOptions';
import { ConfigurationChangedEvent, EditorOption, IEditorHoverOptions, IQuickSuggestionsOptions } from 'td/editor/common/config/editorOptions';
