...
import { EditorConfiguration, IEnvConfiguration } from 'td/editor/browser/config/editorConfiguration';
import { EditorFontLigatures, EditorFontVariations, IEditorOptions } from 'td/editor/common/config/editorOptions';
