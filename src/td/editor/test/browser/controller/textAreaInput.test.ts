...
import { ClipboardDataToCopy, IBrowser, ICompleteTextAreaWrapper, ITextAreaInputHost, TextAreaInput } from 'td/editor/browser/controller/textAreaInput';
import { TextAreaState } from 'td/editor/browser/controller/textAreaState';
import { Position } from 'td/editor/common/core/position';
import { IRecorded, IRecordedEvent, IRecordedTextareaState } from 'td/editor/test/browser/controller/imeRecordedTypes';
