...
import { ITextAreaInputHost, TextAreaInput, TextAreaWrapper } from 'td/editor/browser/controller/textAreaInput';
import { ISimpleModel, PagedScreenReaderStrategy, TextAreaState } from 'td/editor/browser/controller/textAreaState';
