...
import { TextAreaWrapper } from 'td/editor/browser/controller/textAreaInput';
import { DisposableStore, toDisposable } from 'td/base/common/lifecycle';
import { IRecorded, IRecordedCompositionEvent, IRecordedEvent, IRecordedInputEvent, IRecordedKeyboardEvent, IRecordedTextareaState } from 'td/editor/test/browser/controller/imeRecordedTypes';
