...
import { TestCodeEditorService } from 'td/editor/test/browser/editorTestServices';
import { CommandsRegistry, ICommandService } from 'td/platform/commands/common/commands';
import { NullCommandService } from 'td/platform/commands/test/common/nullCommandService';
import { ITextEditorOptions } from 'td/platform/editor/common/editor';
import { matchesScheme, matchesSomeScheme } from 'td/base/common/network';
