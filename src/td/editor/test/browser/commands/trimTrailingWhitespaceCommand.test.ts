...
import { TrimTrailingWhitespaceCommand, trimTrailingWhitespace } from 'td/editor/common/commands/trimTrailingWhitespaceCommand';
...
import { getEditOperation } from 'td/editor/test/browser/testCommand';
