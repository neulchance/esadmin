...
import {IModelDecorationOptions, IModelDecorationsChangeAccessor, MinimapPosition, TrackedRangeStickiness} from 'td/editor/common/model';
import {ModelDecorationOptions} from 'td/editor/common/model/textModel';
import {IDecorationProvider} from 'td/editor/contrib/folding/browser/foldingModel';
import {localize} from 'td/nls';
import {editorSelectionBackground, iconForeground, registerColor, transparent} from 'td/platform/theme/common/colorRegistry';
