...
import {CancelablePromise, createCancelablePromise, Delayer, RunOnceScheduler} from 'td/base/common/async';
import {CancellationToken} from 'td/base/common/cancellation';
import {illegalArgument, onUnexpectedError} from 'td/base/common/errors';
...
import {EditorAction, EditorContributionInstantiation, registerEditorAction, registerEditorContribution, registerInstantiatedEditorAction, ServicesAccessor} from 'td/editor/browser/editorExtensions';
...
import {FoldingRange, FoldingRangeKind, FoldingRangeProvider} from 'td/editor/common/languages';
import {ILanguageConfigurationService} from 'td/editor/common/languages/languageConfigurationRegistry';
import {CollapseMemento, FoldingModel, getNextFoldLine, getParentFoldLine as getParentFoldLine, getPreviousFoldLine, setCollapseStateAtLevel, setCollapseStateForMatchingLines, setCollapseStateForRest, setCollapseStateForType, setCollapseStateLevelsDown, setCollapseStateLevelsUp, setCollapseStateUp, toggleCollapseState} from 'td/editor/contrib/folding/browser/foldingModel';
import {HiddenRangeModel} from 'td/editor/contrib/folding/browser/hiddenRangeModel';
import {IndentRangeProvider} from 'td/editor/contrib/folding/browser/indentRangeProvider';
