...
import {FoldingMarkers} from 'td/editor/common/languages/languageConfiguration';
import {MAX_FOLDING_REGIONS, FoldRange, FoldingRegions, FoldSource} from 'td/editor/contrib/folding/browser/foldingRanges';
import {RangesCollector, computeRanges} from 'td/editor/contrib/folding/browser/indentRangeProvider';
