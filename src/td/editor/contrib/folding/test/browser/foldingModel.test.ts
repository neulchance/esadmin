...
import {IModelDecorationsChangeAccessor, ITextModel, TrackedRangeStickiness} from 'td/editor/common/model';
import {ModelDecorationOptions} from 'td/editor/common/model/textModel';
import {FoldingModel, getNextFoldLine, getParentFoldLine, getPreviousFoldLine, setCollapseStateAtLevel, setCollapseStateForMatchingLines, setCollapseStateForRest, setCollapseStateLevelsDown, setCollapseStateLevelsUp, setCollapseStateUp} from 'td/editor/contrib/folding/browser/foldingModel';
import {FoldingRegion} from 'td/editor/contrib/folding/browser/foldingRanges';
import {computeRanges} from 'td/editor/contrib/folding/browser/indentRangeProvider';
