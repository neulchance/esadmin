...
import {IMouseEvent} from 'td/base/browser/mouseEvent';
import {alert as alertFn} from 'td/base/browser/ui/aria/aria';
...
import {ISashEvent, IVerticalSashLayoutProvider, Orientation, Sash} from 'td/base/browser/ui/sash/sash';
...
import 'td/css!./findWidget';
import {ICodeEditor, IOverlayWidget, IOverlayWidgetPosition, IViewZone, OverlayWidgetPositionPreference} from 'td/editor/browser/editorBrowser';
...
import {CONTEXT_FIND_INPUT_FOCUSED, CONTEXT_REPLACE_INPUT_FOCUSED, FIND_IDS, MATCHES_LIMIT} from 'td/editor/contrib/find/browser/findModel';
...
import {ContextScopedFindInput, ContextScopedReplaceInput} from 'td/platform/history/browser/contextScopedHistoryWidget';
