...
import {EditorAction, EditorCommand, EditorContributionInstantiation, MultiEditorAction, registerEditorAction, registerEditorCommand, registerEditorContribution, registerMultiEditorAction, ServicesAccessor} from 'td/editor/browser/editorExtensions';
import {EditorOption} from 'td/editor/common/config/editorOptions';
import {overviewRulerRangeHighlight} from 'td/editor/common/core/editorColorRegistry';
...
import {CONTEXT_FIND_INPUT_FOCUSED, CONTEXT_FIND_WIDGET_VISIBLE, CONTEXT_REPLACE_INPUT_FOCUSED, FindModelBoundToEditorModel, FIND_IDS, ToggleCaseSensitiveKeybinding, TogglePreserveCaseKeybinding, ToggleRegexKeybinding, ToggleSearchScopeKeybinding, ToggleWholeWordKeybinding} from 'td/editor/contrib/find/browser/findModel';
import {FindOptionsWidget} from 'td/editor/contrib/find/browser/findOptionsWidget';
import {FindReplaceState, FindReplaceStateChangedEvent, INewFindReplaceState} from 'td/editor/contrib/find/browser/findState';
import {FindWidget, IFindController} from 'td/editor/contrib/find/browser/findWidget';
...
import {IThemeService, themeColorFromId} from 'td/platform/theme/common/themeService';
