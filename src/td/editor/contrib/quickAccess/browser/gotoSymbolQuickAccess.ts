...
import {IPreparedQuery, pieceToQuery, prepareQuery, scoreFuzzy2} from 'td/base/common/fuzzyScorer';
import {Disposable, DisposableStore, IDisposable, toDisposable} from 'td/base/common/lifecycle';
import {format, trim} from 'td/base/common/strings';
...
import {DocumentSymbol, SymbolKind, SymbolKinds, SymbolTag, getAriaLabelForSymbol} from 'td/editor/common/languages';
import {IOutlineModelService} from 'td/editor/contrib/documentSymbols/browser/outlineModel';
import {AbstractEditorNavigationQuickAccessProvider, IEditorNavigationQuickAccessOptions, IQuickAccessTextEditorContext} from 'td/editor/contrib/quickAccess/browser/editorNavigationQuickAccess';
import {localize} from 'td/nls';
import {IQuickInputButton, IQuickPick, IQuickPickItem, IQuickPickSeparator} from 'td/platform/quickinput/common/quickInput';
