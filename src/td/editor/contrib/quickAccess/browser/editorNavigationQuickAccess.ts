...
import {getCodeEditor, isDiffEditor} from 'td/editor/browser/editorBrowser';
import {IRange} from 'td/editor/common/core/range';
import {IDiffEditor, IEditor, ScrollType} from 'td/editor/common/editorCommon';
import {IModelDeltaDecoration, ITextModel, OverviewRulerLane} from 'td/editor/common/model';
import {overviewRulerRangeHighlight} from 'td/editor/common/core/editorColorRegistry';
import {IQuickAccessProvider} from 'td/platform/quickinput/common/quickAccess';
import {IKeyMods, IQuickPick, IQuickPickItem} from 'td/platform/quickinput/common/quickInput';
