...
import {CancelablePromise, createCancelablePromise, RunOnceScheduler} from 'td/base/common/async';
...
import {getDocumentRangeSemanticTokens, hasDocumentRangeSemanticTokensProvider} from 'td/editor/contrib/semanticTokens/common/getSemanticTokens';
import {isSemanticColoringEnabled, SEMANTIC_HIGHLIGHTING_SETTING_ID} from 'td/editor/contrib/semanticTokens/common/semanticTokensConfig';
import {toMultilineTokens2} from 'td/editor/common/services/semanticTokensProviderStyling';
...
import {DocumentRangeSemanticTokensProvider} from 'td/editor/common/languages';
