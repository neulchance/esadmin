...
import {Disposable, IDisposable, dispose} from 'td/base/common/lifecycle';
...
import {DocumentSemanticTokensProvider, SemanticTokens, SemanticTokensEdits} from 'td/editor/common/languages';
...
import {SemanticTokensProviderStyling, toMultilineTokens2} from 'td/editor/common/services/semanticTokensProviderStyling';
import {getDocumentSemanticTokens, hasDocumentSemanticTokensProvider, isSemanticTokens, isSemanticTokensEdits} from 'td/editor/contrib/semanticTokens/common/getSemanticTokens';
...
import {ISemanticTokensStylingService} from 'td/editor/common/services/semanticTokensStyling';
import {registerEditorFeature} from 'td/editor/common/editorFeatures';
import {SEMANTIC_HIGHLIGHTING_SETTING_ID, isSemanticColoringEnabled} from 'td/editor/contrib/semanticTokens/common/semanticTokensConfig';
