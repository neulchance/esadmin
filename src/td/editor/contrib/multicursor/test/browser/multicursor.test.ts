...
import {AddSelectionToNextFindMatchAction, InsertCursorAbove, InsertCursorBelow, MultiCursorSelectionController, SelectHighlightsAction} from 'td/editor/contrib/multicursor/browser/multicursor';
import {ITestCodeEditor, withTestCodeEditor} from 'td/editor/test/browser/testCodeEditor';
