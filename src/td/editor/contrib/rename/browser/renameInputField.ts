...
import 'td/css!./renameInputField';
...
import {editorWidgetBackground, inputBackground, inputBorder, inputForeground, widgetBorder, widgetShadow} from 'td/platform/theme/common/colorRegistry';
