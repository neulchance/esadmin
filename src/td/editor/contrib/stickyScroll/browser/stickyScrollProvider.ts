...
import {EditorOption, IEditorStickyScrollOptions} from 'td/editor/common/config/editorOptions';
import {RunOnceScheduler} from 'td/base/common/async';
import {Range} from 'td/editor/common/core/range';
import {binarySearch} from 'td/base/common/arrays';
...
import {StickyModelProvider, IStickyModelProvider} from 'td/editor/contrib/stickyScroll/browser/stickyScrollModelProvider';
