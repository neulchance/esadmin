...
import {CancellationError, onUnexpectedExternalError} from 'td/base/common/errors';
...
import {InlayHint, InlayHintList, InlayHintsProvider, Command} from 'td/editor/common/languages';
