...
import {DefinitionAction, SymbolNavigationAction, SymbolNavigationAnchor} from 'td/editor/contrib/gotoSymbol/browser/goToCommands';
import {ClickLinkMouseEvent} from 'td/editor/contrib/gotoSymbol/browser/link/clickLinkGesture';
import {RenderedInlayHintLabelPart} from 'td/editor/contrib/inlayHints/browser/inlayHintsController';
import {PeekContext} from 'td/editor/contrib/peekView/browser/peekView';
import {isIMenuItem, MenuId, MenuItemAction, MenuRegistry} from 'td/platform/actions/common/actions';
