...
import {LRUCache} from 'td/base/common/map';
import {IRange} from 'td/base/common/range';
import {assertType} from 'td/base/common/types';
import {URI} from 'td/base/common/uri';
import {IActiveCodeEditor, ICodeEditor, IEditorMouseEvent, MouseTargetType} from 'td/editor/browser/editorBrowser';
import {ClassNameReference, CssProperties, DynamicCssRules} from 'td/editor/browser/editorDom';
import {StableEditorScrollState} from 'td/editor/browser/stableEditorScroll';
import {EditorOption, EDITOR_FONT_DEFAULTS} from 'td/editor/common/config/editorOptions';
...
import {IModelDeltaDecoration, InjectedTextCursorStops, InjectedTextOptions, ITextModel, TrackedRangeStickiness} from 'td/editor/common/model';
import {ModelDecorationInjectedTextOptions} from 'td/editor/common/model/textModel';
...
import {ClickLinkGesture, ClickLinkMouseEvent} from 'td/editor/contrib/gotoSymbol/browser/link/clickLinkGesture';
import {InlayHintAnchor, InlayHintItem, InlayHintsFragments} from 'td/editor/contrib/inlayHints/browser/inlayHints';
import {goToDefinitionWithLocation, showGoToContextMenu} from 'td/editor/contrib/inlayHints/browser/inlayHintsLocations';
...
import * as colors from 'td/platform/theme/common/colorRegistry';
