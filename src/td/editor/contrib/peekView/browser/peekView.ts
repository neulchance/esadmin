...
import {ActionBar, ActionsOrientation, IActionBarOptions} from 'td/base/browser/ui/actionbar/actionbar';
...
import 'td/css!./media/peekViewWidget';
...
import {IOptions, IStyles, ZoneWidget} from 'td/editor/contrib/zoneWidget/browser/zoneWidget';
...
import {activeContrastBorder, contrastBorder, editorForeground, editorInfoForeground, registerColor} from 'td/platform/theme/common/colorRegistry';
