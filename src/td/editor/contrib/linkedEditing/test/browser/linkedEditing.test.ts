...
import {DeleteAllLeftAction} from 'td/editor/contrib/linesOperations/browser/linesOperations';
import {LinkedEditingContribution} from 'td/editor/contrib/linkedEditing/browser/linkedEditing';
import {DeleteWordLeft} from 'td/editor/contrib/wordOperations/browser/wordOperations';
import {ITestCodeEditor, createCodeEditorServices, instantiateTestCodeEditor} from 'td/editor/test/browser/testCodeEditor';
