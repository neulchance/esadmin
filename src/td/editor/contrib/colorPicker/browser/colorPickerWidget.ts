...
import {Color, HSVA, RGBA} from 'td/base/common/color';
...
import {IEditorHoverColorPickerWidget} from 'td/editor/contrib/hover/browser/hoverTypes';
import {localize} from 'td/nls';
import {editorHoverBackground} from 'td/platform/theme/common/colorRegistry';
