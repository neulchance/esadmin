...
import {DocumentColorProvider, IColor, IColorInformation, IColorPresentation} from 'td/editor/common/languages';
import {EditorWorkerClient} from 'td/editor/browser/services/editorWorkerService';
