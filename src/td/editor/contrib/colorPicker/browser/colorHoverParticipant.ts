...
import {IModelDecoration, ITextModel, TrackedRangeStickiness} from 'td/editor/common/model';
import {DocumentColorProvider, IColorInformation} from 'td/editor/common/languages';
import {getColorPresentations, getColors} from 'td/editor/contrib/colorPicker/browser/color';
import {ColorDetector} from 'td/editor/contrib/colorPicker/browser/colorDetector';
import {ColorPickerModel} from 'td/editor/contrib/colorPicker/browser/colorPickerModel';
import {ColorPickerWidget} from 'td/editor/contrib/colorPicker/browser/colorPickerWidget';
