...
import {EditorAction, EditorCommand, ICommandOptions, registerEditorAction, registerEditorCommand, ServicesAccessor} from 'td/editor/browser/editorExtensions';
import {ReplaceCommand} from 'td/editor/common/commands/replaceCommand';
import {EditorOption, EditorOptions} from 'td/editor/common/config/editorOptions';
import {CursorState} from 'td/editor/common/cursorCommon';
import {CursorChangeReason} from 'td/editor/common/cursorEvents';
import {DeleteWordContext, WordNavigationType, WordOperations} from 'td/editor/common/cursor/cursorWordOperations';
import {getMapForWordSeparators, WordCharacterClassifier} from 'td/editor/common/core/wordCharacterClassifier';
...
import {IsWindowsContext} from 'td/platform/contextkey/common/contextkeys';
