...
import {commonPrefixLength, getLeadingWhitespace, isFalsyOrWhitespace, splitLines} from 'td/base/common/strings';
...
import {Text, Variable, VariableResolver} from 'td/editor/contrib/snippet/browser/snippetParser';
import {OvertypingCapturer} from 'td/editor/contrib/suggest/browser/suggestOvertypingCapturer';
import * as nls from 'td/nls';
import {ILabelService} from 'td/platform/label/common/label';
import {WORKSPACE_EXTENSION, isSingleFolderWorkspaceIdentifier, toWorkspaceIdentifier, IWorkspaceContextService, ISingleFolderWorkspaceIdentifier, IWorkspaceIdentifier, isEmptyWorkspaceIdentifier} from 'td/platform/workspace/common/workspace';
