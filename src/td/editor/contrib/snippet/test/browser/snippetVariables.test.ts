...
import {SnippetParser, Variable, VariableResolver} from 'td/editor/contrib/snippet/browser/snippetParser';
import {ClipboardBasedVariableResolver, CompositeSnippetVariableResolver, ModelBasedVariableResolver, SelectionBasedVariableResolver, TimeBasedVariableResolver, WorkspaceBasedVariableResolver} from 'td/editor/contrib/snippet/browser/snippetVariables';
import {createTextModel} from 'td/editor/test/common/testTextModel';
import {ILabelService} from 'td/platform/label/common/label';
import {IWorkspace, IWorkspaceContextService, toWorkspaceFolder} from 'td/platform/workspace/common/workspace';
import {Workspace} from 'td/platform/workspace/test/common/testWorkspace';
import {toWorkspaceFolders} from 'td/platform/workspaces/common/workspaces';
