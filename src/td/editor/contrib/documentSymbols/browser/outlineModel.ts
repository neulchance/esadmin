...
import { binarySearch, coalesceInPlace, equals } from 'td/base/common/arrays';
...
import { DocumentSymbol, DocumentSymbolProvider } from 'td/editor/common/languages';
import { MarkerSeverity } from 'td/platform/markers/common/markers';
