...
import {EditorAction, EditorCommand, EditorContributionInstantiation, IActionOptions, registerEditorAction, registerEditorCommand, registerEditorContribution, ServicesAccessor} from 'td/editor/browser/editorExtensions';
...
import {IMarkerNavigationService, MarkerList} from 'td/editor/contrib/gotoError/browser/markerNavigationService';
...
import {TextEditorSelectionRevealType} from 'td/platform/editor/common/editor';
