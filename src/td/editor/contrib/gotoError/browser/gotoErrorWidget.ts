...
import 'td/css!./media/gotoErrorWidget';
...
import {peekViewTitleForeground, peekViewTitleInfoForeground, PeekViewWidget} from 'td/editor/contrib/peekView/browser/peekView';
...
import {IMarker, IRelatedInformation, MarkerSeverity} from 'td/platform/markers/common/markers';
...
import {contrastBorder, editorBackground, editorErrorBorder, editorErrorForeground, editorInfoBorder, editorInfoForeground, editorWarningBorder, editorWarningForeground, oneOf, registerColor, transparent} from 'td/platform/theme/common/colorRegistry';
