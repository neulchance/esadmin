...
import {Sizing, SplitView} from 'td/base/browser/ui/splitview/splitview';
...
import {DisposableStore, dispose, IDisposable, IReference} from 'td/base/common/lifecycle';
import {Schemas} from 'td/base/common/network';
import {basenameOrAuthority, dirname} from 'td/base/common/resources';
import 'td/css!./referencesWidget';
...
import {IModelDeltaDecoration, TrackedRangeStickiness} from 'td/editor/common/model';
import {ModelDecorationOptions, TextModel} from 'td/editor/common/model/textModel';
import {Location} from 'td/editor/common/languages';
...
import {ITextEditorModel, ITextModelService} from 'td/editor/common/services/resolverService';
import {AccessibilityProvider, DataSource, Delegate, FileReferencesRenderer, IdentityProvider, OneReferenceRenderer, StringRepresentationProvider, TreeElement} from 'td/editor/contrib/gotoSymbol/browser/peek/referencesTree';
import * as peekView from 'td/editor/contrib/peekView/browser/peekView';
...
import {IWorkbenchAsyncDataTreeOptions, WorkbenchAsyncDataTree} from 'td/platform/list/browser/listService';
