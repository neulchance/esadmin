...
import {combinedDisposable, DisposableStore, dispose, IDisposable} from 'td/base/common/lifecycle';
import {isEqual} from 'td/base/common/resources';
import {ICodeEditor} from 'td/editor/browser/editorBrowser';
import {EditorCommand, registerEditorCommand} from 'td/editor/browser/editorExtensions';
import {ICodeEditorService} from 'td/editor/browser/services/codeEditorService';
import {Range} from 'td/editor/common/core/range';
import {OneReference, ReferencesModel} from 'td/editor/contrib/gotoSymbol/browser/referencesModel';
