...
import {EditorCommand} from 'td/editor/browser/editorExtensions';
...
import {deserializePipePositions, serializePipePositions, testRepeatedActionAndExtractPositions} from 'td/editor/contrib/wordOperations/test/browser/wordTestUtils';
import {CursorWordPartLeft, CursorWordPartLeftSelect, CursorWordPartRight, CursorWordPartRightSelect, DeleteWordPartLeft, DeleteWordPartRight} from 'td/editor/contrib/wordPartOperations/browser/wordPartOperations';
import {StaticServiceAccessor} from 'td/editor/contrib/wordPartOperations/test/browser/utils';
