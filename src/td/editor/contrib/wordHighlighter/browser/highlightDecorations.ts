...
import 'td/css!./highlightDecorations';
import {MinimapPosition, OverviewRulerLane, TrackedRangeStickiness} from 'td/editor/common/model';
import {ModelDecorationOptions} from 'td/editor/common/model/textModel';
import {DocumentHighlightKind} from 'td/editor/common/languages';
import * as nls from 'td/nls';
import {activeContrastBorder, editorSelectionHighlight, minimapSelectionOccurrenceHighlight, overviewRulerSelectionHighlightForeground, registerColor} from 'td/platform/theme/common/colorRegistry';
import {registerThemingParticipant, themeColorFromId} from 'td/platform/theme/common/themeService';
