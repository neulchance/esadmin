...
import {CancelablePromise, createCancelablePromise, first, timeout} from 'td/base/common/async';
import {CancellationToken} from 'td/base/common/cancellation';
import {onUnexpectedError, onUnexpectedExternalError} from 'td/base/common/errors';
import {KeyCode, KeyMod} from 'td/base/common/keyCodes';
import {Disposable, DisposableStore} from 'td/base/common/lifecycle';
import {IActiveCodeEditor, ICodeEditor, isDiffEditor} from 'td/editor/browser/editorBrowser';
import {EditorAction, EditorContributionInstantiation, IActionOptions, registerEditorAction, registerEditorContribution, registerModelAndPositionCommand} from 'td/editor/browser/editorExtensions';
...
import {CursorChangeReason, ICursorPositionChangedEvent} from 'td/editor/common/cursorEvents';
import {IDiffEditor, IEditorContribution, IEditorDecorationsCollection} from 'td/editor/common/editorCommon';
...
import {DocumentHighlight, DocumentHighlightKind, DocumentHighlightProvider, MultiDocumentHighlightProvider} from 'td/editor/common/languages';
...
import {getHighlightDecorationOptions} from 'td/editor/contrib/wordHighlighter/browser/highlightDecorations';
...
// import { TextualMultiDocumentHighlightFeature } from 'td/editor/contrib/wordHighlighter/browser/textualHighlightProvider';
