...
import {Disposable, MutableDisposable, toDisposable} from 'td/base/common/lifecycle';
import 'td/css!./postEditWidget';
...
import {IBulkEditResult, IBulkEditService} from 'td/editor/browser/services/bulkEditService';
...
import {createCombinedWorkspaceEdit} from 'td/editor/contrib/dropOrPasteInto/browser/edit';
