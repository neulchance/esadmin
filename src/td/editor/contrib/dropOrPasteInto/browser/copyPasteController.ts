...
import {addDisposableListener, getActiveDocument} from 'td/base/browser/dom';
import {coalesce} from 'td/base/common/arrays';
import {CancelablePromise, createCancelablePromise, raceCancellation} from 'td/base/common/async';
import {CancellationToken} from 'td/base/common/cancellation';
import {UriList, VSDataTransfer, createStringDataTransferItem, matchesMimeType} from 'td/base/common/dataTransfer';
...
import {ClipboardEventUtils} from 'td/editor/browser/controller/textAreaInput';
import {toExternalVSDataTransfer, toVSDataTransfer} from 'td/editor/browser/dnd';
...
import {Handler, IEditorContribution, PastePayload} from 'td/editor/common/editorCommon';
import {DocumentPasteContext, DocumentPasteEdit, DocumentPasteEditProvider} from 'td/editor/common/languages';
...
import {createCombinedWorkspaceEdit, sortEditsByYieldTo} from 'td/editor/contrib/dropOrPasteInto/browser/edit';
import {CodeEditorStateFlag, EditorStateCancellationTokenSource} from 'td/editor/contrib/editorState/browser/editorState';
import {InlineProgressManager} from 'td/editor/contrib/inlineProgress/browser/inlineProgress';
