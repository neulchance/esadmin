...
import {getCodeActions} from 'td/editor/contrib/codeAction/browser/codeAction';
import {CodeActionItem, CodeActionKind, CodeActionTriggerSource} from 'td/editor/contrib/codeAction/common/types';
