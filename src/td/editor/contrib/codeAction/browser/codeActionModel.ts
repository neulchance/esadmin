...
import {CancelablePromise, createCancelablePromise, TimeoutTimer} from 'td/base/common/async';
...
import {EditorOption, ShowLightbulbIconMode} from 'td/editor/common/config/editorOptions';
...
import {CodeActionProvider, CodeActionTriggerType} from 'td/editor/common/languages';
