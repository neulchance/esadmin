...
import {getDomNodePagePosition} from 'td/base/browser/dom';
import * as aria from 'td/base/browser/ui/aria/aria';
import {IAnchor} from 'td/base/browser/ui/contextview/contextview';
...
import {ApplyCodeActionReason, applyCodeAction} from 'td/editor/contrib/codeAction/browser/codeAction';
import {CodeActionKeybindingResolver} from 'td/editor/contrib/codeAction/browser/codeActionKeybindingResolver';
import {toMenuItems} from 'td/editor/contrib/codeAction/browser/codeActionMenu';
...
import {IActionListDelegate} from 'td/platform/actionWidget/browser/actionList';
import {IActionWidgetService} from 'td/platform/actionWidget/browser/actionWidget';
...
import {editorFindMatchHighlight, editorFindMatchHighlightBorder} from 'td/platform/theme/common/colorRegistry';
