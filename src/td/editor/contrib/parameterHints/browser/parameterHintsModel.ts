...
import {ICursorSelectionChangedEvent} from 'td/editor/common/cursorEvents';
...
import {provideSignatureHelp} from 'td/editor/contrib/parameterHints/browser/provideSignatureHelp';
