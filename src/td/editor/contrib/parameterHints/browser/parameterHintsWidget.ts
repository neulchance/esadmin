...
import {ParameterHintsModel} from 'td/editor/contrib/parameterHints/browser/parameterHintsModel';
...
import {listHighlightForeground, registerColor} from 'td/platform/theme/common/colorRegistry';
