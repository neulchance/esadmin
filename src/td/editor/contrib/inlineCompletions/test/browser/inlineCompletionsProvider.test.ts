...
import {InlineCompletionsProvider} from 'td/editor/common/languages';
...
import {GhostTextContext, MockInlineCompletionsProvider} from 'td/editor/contrib/inlineCompletions/test/browser/utils';
