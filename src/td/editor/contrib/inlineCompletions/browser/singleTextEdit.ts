...
import {IDiffChange, LcsDiff} from 'td/base/common/diff/diff';
import {commonPrefixLength, getLeadingWhitespace, splitLines} from 'td/base/common/strings';
...
import {GhostText, GhostTextPart} from 'td/editor/contrib/inlineCompletions/browser/ghostText';
