...
import {mapFindFirst} from 'td/base/common/arraysFind';
import {BugIndicatingError, onUnexpectedExternalError} from 'td/base/common/errors';
import {Disposable} from 'td/base/common/lifecycle';
import {IObservable, IReader, ITransaction, autorun, derived, derivedHandleChanges, derivedOpts, recomputeInitiallyAndOnChange, observableSignal, observableValue, subtransaction, transaction} from 'td/base/common/observable';
...
import {InlineCompletionContext, InlineCompletionTriggerKind} from 'td/editor/common/languages';
...
import {IFeatureDebounceInformation} from 'td/editor/common/services/languageFeatureDebounce';
import {GhostText, GhostTextOrReplacement, ghostTextOrReplacementEquals} from 'td/editor/contrib/inlineCompletions/browser/ghostText';
import {InlineCompletionWithUpdatedRange, InlineCompletionsSource} from 'td/editor/contrib/inlineCompletions/browser/inlineCompletionsSource';
import {SingleTextEdit} from 'td/editor/contrib/inlineCompletions/browser/singleTextEdit';
import {SuggestItemInfo} from 'td/editor/contrib/inlineCompletions/browser/suggestWidgetInlineCompletionProvider';
import {addPositions, lengthOfText} from 'td/editor/contrib/inlineCompletions/browser/utils';
