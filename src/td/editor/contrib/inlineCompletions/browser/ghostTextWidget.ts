...
import {IObservable, autorun, derived, observableFromEvent, observableSignalFromEvent, observableValue} from 'td/base/common/observable';
import * as strings from 'td/base/common/strings';
import 'td/css!./ghostText';
import {applyFontInfo} from 'td/editor/browser/config/domFontInfo';
import {ICodeEditor} from 'td/editor/browser/editorBrowser';
import {EditorFontLigatures, EditorOption, IComputedEditorOptions} from 'td/editor/common/config/editorOptions';
import {Position} from 'td/editor/common/core/position';
import {Range} from 'td/editor/common/core/range';
import {StringBuilder} from 'td/editor/common/core/stringBuilder';
import {ILanguageIdCodec} from 'td/editor/common/languages';
import {ILanguageService} from 'td/editor/common/languages/language';
import {IModelDeltaDecoration, ITextModel, InjectedTextCursorStops, PositionAffinity} from 'td/editor/common/model';
import {LineTokens} from 'td/editor/common/tokens/lineTokens';
import {LineDecoration} from 'td/editor/common/viewLayout/lineDecorations';
import {RenderLineInput, renderViewLine} from 'td/editor/common/viewLayout/viewLineRenderer';
import {InlineDecorationType} from 'td/editor/common/viewModel';
import {GhostText, GhostTextReplacement} from 'td/editor/contrib/inlineCompletions/browser/ghostText';
import {ColumnRange, applyObservableDecorations} from 'td/editor/contrib/inlineCompletions/browser/utils';
