...
import {CompletionItemInsertTextRule, CompletionItemKind, SelectedSuggestionInfo} from 'td/editor/common/languages';
import {SnippetParser} from 'td/editor/contrib/snippet/browser/snippetParser';
import {SnippetSession} from 'td/editor/contrib/snippet/browser/snippetSession';
import {CompletionItem} from 'td/editor/contrib/suggest/browser/suggest';
import {SuggestController} from 'td/editor/contrib/suggest/browser/suggestController';
import {IObservable, ITransaction, observableValue, transaction} from 'td/base/common/observable';
...
import {compareBy, numberComparator} from 'td/base/common/arrays';
