...
import {HoverAction, HoverWidget, getHoverAccessibleViewHint} from 'td/base/browser/ui/hover/hoverWidget';
...
import {ContentWidgetPositionPreference, IActiveCodeEditor, ICodeEditor, IContentWidgetPosition, IEditorMouseEvent, MouseTargetType} from 'td/editor/browser/editorBrowser';
...
import {IModelDecoration, PositionAffinity} from 'td/editor/common/model';
...
import {HoverOperation, HoverStartMode, HoverStartSource, IHoverComputer} from 'td/editor/contrib/hover/browser/hoverOperation';
import {HoverAnchor, HoverAnchorType, HoverParticipantRegistry, HoverRangeAnchor, IEditorHoverColorPickerWidget, IEditorHoverAction, IEditorHoverParticipant, IEditorHoverRenderContext, IEditorHoverStatusBar, IHoverPart} from 'td/editor/contrib/hover/browser/hoverTypes';
...
import {ResizableContentWidget} from 'td/editor/contrib/hover/browser/resizableContentWidget';
