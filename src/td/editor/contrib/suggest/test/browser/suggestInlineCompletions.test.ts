...
import { CompletionContext, CompletionItem, CompletionItemKind, CompletionItemProvider, CompletionList, InlineCompletionTriggerKind, ProviderResult } from 'td/editor/common/languages';
...
import { SuggestInlineCompletions } from 'td/editor/contrib/suggest/browser/suggestInlineCompletions';
import { ISuggestMemoryService } from 'td/editor/contrib/suggest/browser/suggestMemory';
import { createCodeEditorServices, instantiateTestCodeEditor, ITestCodeEditor } from 'td/editor/test/browser/testCodeEditor';
