...
import { CompletionItemInsertTextRule, CompletionItemKind } from 'td/editor/common/languages';
...
import { DeleteLinesAction } from 'td/editor/contrib/linesOperations/browser/linesOperations';
