...
import { DEFAULT_WORD_REGEXP } from 'td/editor/common/core/wordHelper';
...
import { createCodeEditorServices, instantiateTestCodeEditor } from 'td/editor/test/browser/testCodeEditor';
