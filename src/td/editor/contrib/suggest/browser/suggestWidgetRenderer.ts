...
import { $, append, hide, show } from 'td/base/browser/dom';
import { IconLabel, IIconLabelValueOptions } from 'td/base/browser/ui/iconLabel/iconLabel';
import { IListRenderer } from 'td/base/browser/ui/list/list';
...
import { createMatches } from 'td/base/common/filters';
...
import { CompletionItemKind, CompletionItemKinds, CompletionItemTag } from 'td/editor/common/languages';
