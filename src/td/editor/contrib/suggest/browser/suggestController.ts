...
import { DisposableStore, dispose, IDisposable, MutableDisposable, toDisposable } from 'td/base/common/lifecycle';
...
import { EditorAction, EditorCommand, EditorContributionInstantiation, registerEditorAction, registerEditorCommand, registerEditorContribution, ServicesAccessor } from 'td/editor/browser/editorExtensions';
...
import { CompletionItemInsertTextRule, CompletionItemProvider, CompletionTriggerKind } from 'td/editor/common/languages';
...
import { WordContextKey } from 'td/editor/contrib/suggest/browser/wordContextKey';
...
import { WindowIdleValue, getWindow } from 'td/base/browser/dom';
